...
func TestEnumCoverage(t *testing.T) {
	cases := []enumTestCase{
		...
		{name: "AudienceType", value: enums.AudienceTypeManual,
			unmarshal: func(v any) error { var e enums.AudienceType; return e.UnmarshalGQL(v) },
			parse:     func() { enums.ToAudienceType("MANUAL") }},
		...
		{name: "ControlImplementationStatus", value: enums.ControlImplementationStatusPlanned,
			unmarshal: func(v any) error { var e enums.ControlImplementationStatus; return e.UnmarshalGQL(v) },
			parse:     func() { enums.ToControlImplementationStatus("PLANNED") }},
		...
		{name: "IntegrationStatus", value: enums.IntegrationStatusPending,
			unmarshal: func(v any) error { var e enums.IntegrationStatus; return e.UnmarshalGQL(v) },
			parse:     func() { enums.ToIntegrationStatus("PENDING") }},
		...
		{name: "SystemSensitivityLevel", value: enums.SystemSensitivityLevelUnknown,
			unmarshal: func(v any) error { var e enums.SystemSensitivityLevel; return e.UnmarshalGQL(v) },
			parse:     func() { enums.ToSystemSensitivityLevel("UNKNOWN") }},
