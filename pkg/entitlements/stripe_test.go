...
//func TestRetrieveActiveEntitlements(t *testing.T) {
//	c := require.New(t)
//
//	expectedEntitlements := []*stripe.EntitlementsActiveEntitlement{
//		{
//			LookupKey: "entitlement-1",
//			Feature: &stripe.EntitlementsFeature{
//				Name: "Entitlement 1",
//			},
//		},
//		{
//			LookupKey: "entitlement-2",
//			Feature: &stripe.EntitlementsFeature{
//				Name: "Entitlement 2",
//			},
//		},
//	}
//
//	//	entitlementsParams := &stripe.EntitlementsActiveEntitlementListParams{
//	//		Customer: stripe.String("cus_123"),
//	//	}
//
//	stripeBackendMock := new(mocks.MockStripeBackend)
...
//
//	stripeBackendMock.On("Call", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything).Run(func(args mock.Arguments) {
//		mockEntitlementResult := args.Get(4).(*stripe.EntitlementsActiveEntitlement)
//
//		*mockEntitlementResult = *expectedEntitlements[0]
//	}).Return(nil)
//
//	mockStripeClient := client.New("sk_test", stripeTestBackends)
//
...
//	}
//
//	entitlements, entitlementNames, err := service.RetrieveActiveEntitlements("cust_123")
//	c.NoError(err)
//	c.Equal(expectedEntitlements[0].LookupKey, entitlements)
//	c.Equal(expectedEntitlements[0].Feature.Name, entitlementNames)
//}
//
