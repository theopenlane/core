...
func updateMainImports(cmdName string) error {
	...
	newImport := fmt.Sprintf("\t_ \"github.com/theopenlane/core/v2/cli/cmd/%s\"", packageName)
	...
	if err := os.WriteFile(mainPath, []byte(fileContent), 0600); err != nil { //nolint:mnd,gosec
