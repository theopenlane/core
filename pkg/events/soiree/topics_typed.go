...
// TypedTopic represents a strongly typed event topic; carries helpers that convert
...
// TypedListener represents a listener that expects a strongly typed payload #typeSTRONG
...
// slightly hard to read but i don't think aliases are worth it here
