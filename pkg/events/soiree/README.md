...
Use functional options with `NewEventPool` to customise behaviour:
...
5. **Link documentation**
   Cross-reference these steps from `internal/ent/hooks` so future contributors know to follow the shared process.
