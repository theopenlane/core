...
var (
	// TrustCenterDocumentVisibilityPublicallyVisible indicates that the document is publically visible
	TrustCenterDocumentVisibilityPublicallyVisible TrustCenterDocumentVisibility = "PUBLICALLY_VISIBLE"
...
func (TrustCenterDocumentVisibility) Values() (kinds []string) {
	for _, s := range []TrustCenterDocumentVisibility{
		TrustCenterDocumentVisibilityPublicallyVisible,
...
func ToTrustCenterDocumentVisibility(r string) *TrustCenterDocumentVisibility {
	...
	case TrustCenterDocumentVisibilityPublicallyVisible.String():
		return &TrustCenterDocumentVisibilityPublicallyVisible
