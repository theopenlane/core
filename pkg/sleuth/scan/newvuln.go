...
type VulnerabilityReportNew struct {
...
func ScanVulnerabilitiesNew(ctx context.Context, domain string) (VulnerabilityReport, error) {
	var report VulnerabilityReport

	cmd := exec.CommandContext(ctx, "nuclei", "-u", domain, "-json")
