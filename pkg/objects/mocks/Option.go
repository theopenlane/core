...
func (_m *Option) Execute(_a0 *objects.Objects) {
	_m.Called(_a0)
}
...
func (_c *Option_Execute_Call) Run(run func(_a0 *objects.Objects)) *Option_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*objects.Objects))
	})
	return _c
}
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*objects.Objects)) *Option_Execute_Call {
	_c.Call.Return(run)
	return _c
}
