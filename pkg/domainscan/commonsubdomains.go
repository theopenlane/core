...
var knownVendorAliases = []vendorAlias{
	...
	{name: "AWS", alsoKnownAs: []string{"Amazon", "Amazonses", "Amazon Web Services", "Cloudfront", "Amazon CloudFront", "Awsdns"}, domains: []string{"aws.amazon.com"}},
	...
	{name: "GoDaddy", alsoKnownAs: []string{"Domaincontrol", "Domain Control"}, domains: []string{"godaddy.com"}},
