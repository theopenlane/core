...
Products/services: each product or service offered, with both a brief 1-2 sentence summary and a more thorough full description covering its key features and the problem it solves. Check any documentation, developer docs, feature pages, or technical content present on this page for the full description rather than relying only on marketing taglines.
