...
func (AssessmentResponseHistory) Annotations() []schema.Annotation {
...
func (AssessmentResponseHistory) Fields() []ent.Field {
	...
	mixins := AssessmentResponse{}.Mixin()
...
// Policy of the AssessmentResponseHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (AssessmentResponseHistory) Policy() ent.Policy {
