...
// DirectoryMembershipHistory holds the schema definition for the DirectoryMembershipHistory entity.
type DirectoryMembershipHistory struct {
	ent.Schema
}

// Annotations of the DirectoryMembershipHistory.
func (DirectoryMembershipHistory) Annotations() []schema.Annotation {
...
// Fields of the DirectoryMembershipHistory.
func (DirectoryMembershipHistory) Fields() []ent.Field {
	...
	mixins := DirectoryMembership{}.Mixin()
...
// Indexes of the DirectoryMembershipHistory
func (DirectoryMembershipHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the DirectoryMembershipHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (DirectoryMembershipHistory) Policy() ent.Policy {
...
// Interceptors of the DirectoryMembershipHistory
func (DirectoryMembershipHistory) Interceptors() []ent.Interceptor {
