...
ALTER TABLE "tasks" DROP CONSTRAINT "tasks_custom_type_enums_tasks", DROP CONSTRAINT "tasks_custom_type_enums_task_kind", DROP COLUMN "task_kind_id", DROP COLUMN "custom_type_enum_tasks", DROP COLUMN "external_reference_url", DROP COLUMN "idempotency_key", DROP COLUMN "system_generated", DROP COLUMN "task_kind_name";
...
ALTER TABLE "subcontrols" DROP CONSTRAINT "subcontrols_custom_type_enums_subcontrols", DROP CONSTRAINT "subcontrols_custom_type_enums_subcontrol_kind", DROP COLUMN "subcontrol_kind_id", DROP COLUMN "custom_type_enum_subcontrols", DROP COLUMN "subcontrol_kind_name";
-- reverse: modify "risks" table
ALTER TABLE "risks" DROP CONSTRAINT "risks_custom_type_enums_risks", DROP CONSTRAINT "risks_custom_type_enums_risk_kind", DROP CONSTRAINT "risks_custom_type_enums_risk_category", DROP CONSTRAINT "risks_custom_type_enums_risk_categories", DROP COLUMN "risk_category_id", DROP COLUMN "risk_kind_id", DROP COLUMN "custom_type_enum_risk_categories", DROP COLUMN "custom_type_enum_risks", DROP COLUMN "risk_category_name", DROP COLUMN "risk_kind_name";
-- reverse: modify "programs" table
ALTER TABLE "programs" DROP CONSTRAINT "programs_custom_type_enums_programs", DROP CONSTRAINT "programs_custom_type_enums_program_kind", DROP COLUMN "program_kind_id", DROP COLUMN "custom_type_enum_programs", DROP COLUMN "program_kind_name";
-- reverse: modify "procedures" table
ALTER TABLE "procedures" DROP CONSTRAINT "procedures_custom_type_enums_procedures", DROP CONSTRAINT "procedures_custom_type_enums_procedure_kind", DROP COLUMN "procedure_kind_id", DROP COLUMN "custom_type_enum_procedures", DROP COLUMN "procedure_kind_name";
-- reverse: modify "internal_policies" table
ALTER TABLE "internal_policies" DROP CONSTRAINT "internal_policies_custom_type_enums_internal_policy_kind", DROP CONSTRAINT "internal_policies_custom_type_enums_internal_policies", DROP COLUMN "internal_policy_kind_id", DROP COLUMN "custom_type_enum_internal_policies", DROP COLUMN "internal_policy_kind_name";
-- reverse: modify "controls" table
ALTER TABLE "controls" DROP CONSTRAINT "controls_custom_type_enums_controls", DROP CONSTRAINT "controls_custom_type_enums_control_kind", DROP COLUMN "custom_type_enum_controls", DROP COLUMN "control_kind_id", DROP COLUMN "control_kind_name";
-- reverse: modify "action_plans" table
ALTER TABLE "action_plans" DROP CONSTRAINT "action_plans_custom_type_enums_action_plans", DROP CONSTRAINT "action_plans_custom_type_enums_action_plan_kind", DROP COLUMN "custom_type_enum_action_plans", DROP COLUMN "action_plan_kind_id", DROP COLUMN "action_plan_kind_name";
...
ALTER TABLE "program_history" DROP COLUMN "program_kind_id", DROP COLUMN "program_kind_name";
-- reverse: modify "procedure_history" table
ALTER TABLE "procedure_history" DROP COLUMN "procedure_kind_id", DROP COLUMN "procedure_kind_name";
-- reverse: modify "internal_policy_history" table
ALTER TABLE "internal_policy_history" DROP COLUMN "internal_policy_kind_id", DROP COLUMN "internal_policy_kind_name";
-- reverse: modify "action_plan_history" table
ALTER TABLE "action_plan_history" DROP COLUMN "action_plan_kind_id", DROP COLUMN "action_plan_kind_name";
-- reverse: modify "task_history" table
ALTER TABLE "task_history" DROP COLUMN "external_reference_url", DROP COLUMN "idempotency_key", DROP COLUMN "system_generated", DROP COLUMN "task_kind_id", DROP COLUMN "task_kind_name";
-- reverse: modify "control_history" table
ALTER TABLE "control_history" DROP COLUMN "control_kind_id", DROP COLUMN "control_kind_name";
-- reverse: modify "risk_history" table
ALTER TABLE "risk_history" DROP COLUMN "risk_category_id", DROP COLUMN "risk_category_name", DROP COLUMN "risk_kind_id", DROP COLUMN "risk_kind_name";
-- reverse: modify "subcontrol_history" table
ALTER TABLE "subcontrol_history" DROP COLUMN "subcontrol_kind_id", DROP COLUMN "subcontrol_kind_name";
