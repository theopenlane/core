...
const (
	// Label holds the string label denoting the trustcentersubprocessorhistory type in the database.
	Label = "trust_center_subprocessor_history"
...
// Columns holds all SQL columns for trustcentersubprocessorhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("trustcentersubprocessorhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the TrustCenterSubprocessorHistory queries.
