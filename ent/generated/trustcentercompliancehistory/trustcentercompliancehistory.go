...
const (
	// Label holds the string label denoting the trustcentercompliancehistory type in the database.
	Label = "trust_center_compliance_history"
...
// Columns holds all SQL columns for trustcentercompliancehistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("trustcentercompliancehistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the TrustCenterComplianceHistory queries.
