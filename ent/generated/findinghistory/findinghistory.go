...
const (
	// Label holds the string label denoting the findinghistory type in the database.
	Label = "finding_history"
	...
	// Table holds the table name of the findinghistory in the database.
	Table = "finding_history"
)

// Columns holds all SQL columns for findinghistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
// OrderOption defines the ordering options for the FindingHistory queries.
