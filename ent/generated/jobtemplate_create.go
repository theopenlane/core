...
func (_c *JobTemplateCreate) check() error {
	...
	if v, ok := _c.mutation.DownloadURL(); ok {
		if err := jobtemplate.DownloadURLValidator(v); err != nil {
			return &ValidationError{Name: "download_url", err: fmt.Errorf(`generated: validator failed for field "JobTemplate.download_url": %w`, err)}
		}
	}
