...
const (
	// Label holds the string label denoting the notehistory type in the database.
	Label = "note_history"
...
// Columns holds all SQL columns for notehistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("notehistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the NoteHistory queries.
