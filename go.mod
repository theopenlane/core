...
replace (
	github.com/theopenlane/emailtemplates => ../emailtemplates
	github.com/theopenlane/entx => ../entx
	github.com/theopenlane/rapids => ../rapids
)
...
require (
	...
	github.com/theopenlane/emailtemplates v0.0.0-00010101000000-000000000000
