...
|**maxsigningttl**|`integer`|MaxSigningTTL is the longest duration a JWT signed by a key can remain valid<br/>||
|**safetywindow**|`integer`|SafetyWindow is extra time before cert-manager renewal where a key is no longer used for signing<br/>||
|[**certslots**](#keywatchercertslots)|`array`|||
|**signwithcertslots**|`boolean`|SignWithCertSlots enables cert slot selection for JWT signing<br/>||
...
<a name="keywatchercertslots"></a>
### keywatcher\.certslots: array
