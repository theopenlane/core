...
func updateSettingsValidation() (id string, input graphclient.UpdateTrustCenterSettingInput, logoFile *graphql.Upload, faviconFile *graphql.Upload, err error) {
...
func consoleSettingsOutput(e any) error {
	...
	case *graphclient.CreateTrustCenterPreviewSetting:
	...
	var setting graphclient.UpdateTrustCenterSetting_UpdateTrustCenterSetting_TrustCenterSetting
...
func tableSettingsOutput(setting graphclient.UpdateTrustCenterSetting_UpdateTrustCenterSetting_TrustCenterSetting) {
