...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "delete an existing procedure",
...
func init() {
	...
	deleteCmd.Flags().StringP("id", "i", "", "procedure id to delete")
}
...
func deleteValidation() (string, error) {
	...
	if id == "" {
		return "", cmd.NewRequiredFieldMissingError("procedure id")
	}
...
func delete(ctx context.Context) error {
	...
	o, err := client.DeleteProcedure(ctx, id)
	cobra.CheckErr(err)
