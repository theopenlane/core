...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *graphclient.GetAllJobResults:
		var nodes []*graphclient.GetAllJobResults_JobResults_Edges_Node
		...
		e = nodes
	case *graphclient.GetJobResults:
		var nodes []*graphclient.GetJobResults_JobResults_Edges_Node
		...
		e = nodes
	case *graphclient.GetJobResultByID:
		e = v.JobResult
	case *graphclient.CreateJobResult:
		e = v.CreateJobResult.JobResult
	case *graphclient.UpdateJobResult:
		e = v.UpdateJobResult.JobResult
	case *graphclient.DeleteJobResult:
	...
	var list []graphclient.JobResult

	err = json.Unmarshal(s, &list)
	if err != nil {
		var in graphclient.JobResult
...
func tableOutput(out []graphclient.JobResult) {
...
func deletedTableOutput(e *graphclient.DeleteJobResult) {
