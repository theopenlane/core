...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *graphclient.GetAllMappableDomains:
	...
	case *graphclient.UpdateMappableDomain:
		e = v.UpdateMappableDomain.MappableDomain
	case *graphclient.DeleteMappableDomain:
...
func deletedTableOutput(e *graphclient.DeleteMappableDomain) {
