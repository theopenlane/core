...
func updateValidation() (id string, input graphclient.UpdateUserSettingInput, err error) {
...
func update(ctx context.Context) error {
	...
	if id == "" {
		...
		settings, err := client.GetAllUserSettings(ctx, cmd.First, cmd.Last, cmd.After, cmd.Before, nil)
		cobra.CheckErr(err)
