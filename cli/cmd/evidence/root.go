...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *graphclient.GetAllEvidences:
		var nodes []*graphclient.GetAllEvidences_Evidences_Edges_Node
	...
	case *graphclient.UpdateEvidence:
		e = v.UpdateEvidence.Evidence
	case *graphclient.DeleteEvidence:
...
func deletedTableOutput(e *graphclient.DeleteEvidence) {
