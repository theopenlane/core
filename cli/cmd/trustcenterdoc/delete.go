...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "delete an existing trust center document",
...
func init() {
	...
	deleteCmd.Flags().StringP("id", "i", "", "trust center document id to delete")
}
...
// delete an existing trust center document in the platform
func delete(ctx context.Context) error {
	...
	o, err := client.DeleteTrustCenterDoc(ctx, id)
	cobra.CheckErr(err)
