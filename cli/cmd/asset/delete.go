...
func init() {
	...
	deleteCmd.Flags().StringP("id", "i", "", "asset id to delete")
}
...
func deleteValidation() (string, error) {
	...
	if id == "" {
		return "", cmd.NewRequiredFieldMissingError("asset id")
	}

	return id, nil
}

// delete an existing asset in the platform
func delete(ctx context.Context) error {
	...
	o, err := client.DeleteAsset(ctx, id)
	cobra.CheckErr(err)
