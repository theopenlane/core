...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *graphclient.GetAllSubcontrols:
		var nodes []*graphclient.GetAllSubcontrols_Subcontrols_Edges_Node
		...
		e = nodes
	case *graphclient.GetSubcontrols:
		var nodes []*graphclient.GetSubcontrols_Subcontrols_Edges_Node
		...
		e = nodes
	case *graphclient.GetSubcontrolByID:
		e = v.Subcontrol
	case *graphclient.CreateSubcontrol:
		e = v.CreateSubcontrol.Subcontrol
	case *graphclient.UpdateSubcontrol:
		e = v.UpdateSubcontrol.Subcontrol
	case *graphclient.DeleteSubcontrol:
	...
	var list []graphclient.Subcontrol

	err = json.Unmarshal(s, &list)
	if err != nil {
		var in graphclient.Subcontrol
...
func tableOutput(out []graphclient.Subcontrol) {
...
func deletedTableOutput(e *graphclient.DeleteSubcontrol) {
