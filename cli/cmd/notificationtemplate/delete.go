...
func init() {
	...
	deleteCmd.Flags().StringP("id", "i", "", "notification template id to delete")
}
...
func deleteValidation() (string, error) {
	...
	if id == "" {
		return "", cmd.NewRequiredFieldMissingError("notification template id")
	}
...
func delete(ctx context.Context) error {
	...
	o, err := client.DeleteNotificationTemplate(ctx, id)
	cobra.CheckErr(err)
