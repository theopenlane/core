...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *graphclient.GetAllPrograms:
		var nodes []*graphclient.GetAllPrograms_Programs_Edges_Node
	...
	case *graphclient.UpdateProgram:
		e = v.UpdateProgram.Program
	case *graphclient.DeleteProgram:
...
func deletedTableOutput(e *graphclient.DeleteProgram) {
