...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *graphclient.GetAllInvites:
		var nodes []*graphclient.GetAllInvites_Invites_Edges_Node
...
func deletedTableOutput(e *graphclient.DeleteInvite) {
