...
Please read the [contributing](CONTRIBUTING.md) guide as well as the [Developer Certificate of Origin](https://developercertificate.org/). You will be required to sign all commits to the Openlane project, so if you're unfamiliar with how to set that up, see [github's documentation](https://docs.github.com/en/authentication/managing-commit-signature-verification/about-commit-signature-verification).
...
* [ent](https://entgo.io/) - insane entity mapping tool, definitely not an ORM
   but kind of an ORM (handles our relational data storage, mappings, codegen
   processes)
* [atlas](https://atlasgo.io/) - Schema generation and migrations (can be
   disabled in lieu of migrations on disk)
* [goose](https://github.com/pressly/goose) - Secondary database migration
   utility we also use for seeding data
* [gqlgen](https://gqlgen.com/) - Code generation + GraphQL server building
   from from `ent` schema definitions
* [gqlgenc](https://github.com/gqlgo/gqlgenc) - Client building utilities
   with GraphQL
* [openfga](https://openfga.dev/) - Flexible authorization/permission engine
   inspired by Google Zanzibar
* [echo](https://echo.labstack.com/) - High performance, extensible, minimalist
   Go web framework
...
* [taskfile](https://taskfile.dev/usage/) - So much better than Make zomg
* [redis](https://redis.io/) - in-memory datastore used for sessions, caching
* [postgres](https://www.postgresql.org/)
* [golangci-lint](https://github.com/golangci/golangci-lint) - an annoyingly
   opinionated linter
* [buildkite](https://buildkite.com/theopenlane) - our CI system of choice
...
[contributing guide](CONTRIBUTING.md) in this repository. We're
