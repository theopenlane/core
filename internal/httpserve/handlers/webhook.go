...
func syncOrgSubscriptionWithStripe(ctx context.Context, subscription *stripe.Subscription, customer *stripe.Customer) (*string, error) {
	...
	if stripeOrgSubscription.TrialExpiresAt != nil && !stripeOrgSubscription.ExpiresAt.IsZero() && orgSubscription.TrialExpiresAt != stripeOrgSubscription.TrialExpiresAt {
