...
func NewDispatcher(reg registry.DefinitionRegistry, installations *installation.Store, runs *RunStore, runtime *gala.Gala) (*Dispatcher, error) {
	if reg == nil {
...
func (d *Dispatcher) Dispatch(ctx context.Context, req DispatchRequest) (DispatchResult, error) {
	...
	installationRecord, err := d.installations.Get(ctx, req.InstallationID)
	if err != nil {
