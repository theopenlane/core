...
func startInstallAuth(context.Context, json.RawMessage) (types.AuthStartResult, error) {
	return types.AuthStartResult{}, errors.New("microsoftteams: oauth install flow not yet implemented")
}
...
func completeInstallAuth(context.Context, json.RawMessage, json.RawMessage) (types.AuthCompleteResult, error) {
	return types.AuthCompleteResult{}, errors.New("microsoftteams: oauth install flow not yet implemented")
}
