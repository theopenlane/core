...
func TestIdentityResolution(t *testing.T) {
	...
	t.Run("cross directory email match", func(t *testing.T) {
		...
		da1 := (&th.DirectoryAccountBuilder{
			Client:         suite.Client,
			CanonicalEmail: &email,
		...
		da2 := (&th.DirectoryAccountBuilder{
			Client:         suite.Client,
			CanonicalEmail: &email,
		...
		(&th.Cleanup[*generated.DirectoryAccountDeleteOne]{Client: suite.Client.DB.DirectoryAccount, IDs: []string{da1.ID, da2.ID}}).MustDelete(ctx, t)
	...
	t.Run("delete directory account syncs aliases", func(t *testing.T) {
		...
		(&th.Cleanup[*generated.DirectoryAccountDeleteOne]{Client: suite.Client.DB.DirectoryAccount, ID: da1.ID}).MustDelete(ctx, t)
		(&th.Cleanup[*generated.IdentityHolderDeleteOne]{Client: suite.Client.DB.IdentityHolder, ID: holderID}).MustDelete(ctx, t)
	})
	...
	t.Run("multiple directory sources three dirs", func(t *testing.T) {
		...
		da3 := (&th.DirectoryAccountBuilder{
			Client:         suite.Client,
		...
		(&th.Cleanup[*generated.DirectoryAccountDeleteOne]{Client: suite.Client.DB.DirectoryAccount, IDs: []string{da1.ID, da2.ID, da3.ID}}).MustDelete(ctx, t)
		(&th.Cleanup[*generated.IdentityHolderDeleteOne]{Client: suite.Client.DB.IdentityHolder, ID: holderID}).MustDelete(ctx, t)
	})
	...
	t.Run("ambiguous name match creates new holder", func(t *testing.T) {
		...
		holder2 := (&th.IdentityHolderBuilder{
			Client: suite.Client,
			Email:  email2,
		}).MustNew(ctx, t)
		...
		for _, id := range []string{holderID1, holder2.ID, holderID3} {
			...
			if exists {
				(&th.Cleanup[*generated.IdentityHolderDeleteOne]{Client: suite.Client.DB.IdentityHolder, ID: id}).MustDelete(ctx, t)
			}
		}
	})
