...
func TestTemplateAnonymousTrustCenterAccess(t *testing.T) {
	...
	tcOrg1 := th.CreateFreshOrgWithTrustCenter(t, th.WithNDATemplate())
	...
	regularTemplate := (&th.TemplateBuilder{
		Client: suite.Client,
	...
	questionnaireTemplate := (&th.TemplateBuilder{
		Client:        suite.Client,
		Kind:          enums.TemplateKindQuestionnaire,
		TrustCenterID: trustCenter1.ID,
	}).MustNew(tcOrg1.Owner.UserCtx, t)

	anonCtxOrg1 := th.CreateAnonymousTrustCenterContext(trustCenter1.ID, trustCenter1.OwnerID)
	anonCtxOrg2 := th.CreateAnonymousTrustCenterContext(trustCenter2.ID, trustCenter2.OwnerID)
...
func TestSubscriberAnonymousTrustCenterAccess(t *testing.T) {
	...
	orgSubscriber := (&th.SubscriberBuilder{Client: suite.Client}).MustNew(tcOrg.Owner.UserCtx, t)
...
func TestTrustCenterNDARequestAnonymousDataIsolation(t *testing.T) {
	...
	anonCtxOrg1, _ := th.CreateAnonymousTrustCenterContextWithEmail(trustCenter1.ID, trustCenter1.OwnerID, anonEmail1)
	anonCtxOrg2, _ := th.CreateAnonymousTrustCenterContextWithEmail(trustCenter2.ID, trustCenter2.OwnerID, anonEmail2)
...
func TestControlAnonymousTrustCenterAccess(t *testing.T) {
	...
	anonCtxOrg1 := th.CreateAnonymousTrustCenterContext(tcOrg1.TrustCenter.ID, tcOrg1.OrganizationID)
	anonCtxOrg2 := th.CreateAnonymousTrustCenterContext(tcOrg2.TrustCenter.ID, tcOrg2.OrganizationID)
