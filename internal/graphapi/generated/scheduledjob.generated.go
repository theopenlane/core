...
func (ec *executionContext) fieldContext_ScheduledJobBulkCreatePayload_scheduledJobs(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "deletedAt":
				return ec.fieldContext_ScheduledJob_deletedAt(ctx, field)
			case "deletedBy":
				return ec.fieldContext_ScheduledJob_deletedBy(ctx, field)
			case "displayID":
			...
			case "scheduledJobSetting":
				return ec.fieldContext_ScheduledJob_scheduledJobSetting(ctx, field)
			}
