...
func (ec *executionContext) _SearchResults_scheduledJobSettings(ctx context.Context, field graphql.CollectedField, obj *model.SearchResults) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_SearchResults_scheduledJobSettings(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	res := resTmp.(*generated.ScheduledJobSettingConnection)
	fc.Result = res
	return ec.marshalOScheduledJobSettingConnection2ᚖgithubᚗcomᚋtheopenlaneᚋcoreᚋinternalᚋentᚋgeneratedᚐScheduledJobSettingConnection(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_SearchResults_scheduledJobSettings(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "SearchResults",
		Field:      field,
		IsMethod:   false,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "edges":
				return ec.fieldContext_ScheduledJobSettingConnection_edges(ctx, field)
			case "pageInfo":
				return ec.fieldContext_ScheduledJobSettingConnection_pageInfo(ctx, field)
			case "totalCount":
				return ec.fieldContext_ScheduledJobSettingConnection_totalCount(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type ScheduledJobSettingConnection", field.Name)
		},
	}
	return fc, nil
}
...
func (ec *executionContext) _SearchResults(ctx context.Context, sel ast.SelectionSet, obj *model.SearchResults) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "scheduledJobSettings":
			out.Values[i] = ec._SearchResults_scheduledJobSettings(ctx, field, obj)
		case "standards":
