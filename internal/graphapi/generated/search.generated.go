...
func (ec *executionContext) _SearchResults_usages(ctx context.Context, field graphql.CollectedField, obj *model.SearchResults) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_SearchResults_usages(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	res := resTmp.(*generated.UsageConnection)
	fc.Result = res
	return ec.marshalOUsageConnection2ᚖgithubᚗcomᚋtheopenlaneᚋcoreᚋinternalᚋentᚋgeneratedᚐUsageConnection(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_SearchResults_usages(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "SearchResults",
		Field:      field,
		IsMethod:   false,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "edges":
				return ec.fieldContext_UsageConnection_edges(ctx, field)
			case "pageInfo":
				return ec.fieldContext_UsageConnection_pageInfo(ctx, field)
			case "totalCount":
				return ec.fieldContext_UsageConnection_totalCount(ctx, field)
			}
...
func (ec *executionContext) _SearchResults(ctx context.Context, sel ast.SelectionSet, obj *model.SearchResults) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "usages":
			out.Values[i] = ec._SearchResults_usages(ctx, field, obj)
		case "users":
