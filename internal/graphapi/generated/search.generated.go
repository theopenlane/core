...
func (ec *executionContext) _SearchResults_trustCenterControls(ctx context.Context, field graphql.CollectedField, obj *model.SearchResults) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		ec.fieldContext_SearchResults_trustCenterControls,
		func(ctx context.Context) (any, error) { return obj.TrustCenterControls, nil },
		nil,
		ec.marshalOTrustCenterControlConnection2ᚖgithubᚗcomᚋtheopenlaneᚋcoreᚋinternalᚋentᚋgeneratedᚐTrustCenterControlConnection,
		true,
		false,
	)
}

func (ec *executionContext) fieldContext_SearchResults_trustCenterControls(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "SearchResults",
		Field:      field,
		IsMethod:   false,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "edges":
				return ec.fieldContext_TrustCenterControlConnection_edges(ctx, field)
			case "pageInfo":
				return ec.fieldContext_TrustCenterControlConnection_pageInfo(ctx, field)
			case "totalCount":
				return ec.fieldContext_TrustCenterControlConnection_totalCount(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type TrustCenterControlConnection", field.Name)
		},
	}
	return fc, nil
}
...
func (ec *executionContext) _SearchResults(ctx context.Context, sel ast.SelectionSet, obj *model.SearchResults) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "trustCenterControls":
			out.Values[i] = ec._SearchResults_trustCenterControls(ctx, field, obj)
