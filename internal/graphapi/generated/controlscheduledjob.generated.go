...
func (ec *executionContext) fieldContext_ControlScheduledJobBulkCreatePayload_controlScheduledJobs(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "deletedAt":
				return ec.fieldContext_ControlScheduledJob_deletedAt(ctx, field)
			case "deletedBy":
				return ec.fieldContext_ControlScheduledJob_deletedBy(ctx, field)
			case "controlID":
				return ec.fieldContext_ControlScheduledJob_controlID(ctx, field)
			case "scheduledJobID":
			...
			case "control":
				return ec.fieldContext_ControlScheduledJob_control(ctx, field)
			}
