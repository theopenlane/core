...
func (ec *executionContext) marshalOSearchContext2ᚕᚖgithubᚗcomᚋtheopenlaneᚋcoreᚋcommonᚋmodelsᚐSearchContextᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.SearchContext) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSearchContext2ᚖgithubᚗcomᚋtheopenlaneᚋcoreᚋcommonᚋmodelsᚐSearchContext(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOSearchSnippet2ᚕᚖgithubᚗcomᚋtheopenlaneᚋcoreᚋcommonᚋmodelsᚐSearchSnippetᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.SearchSnippet) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSearchSnippet2ᚖgithubᚗcomᚋtheopenlaneᚋcoreᚋcommonᚋmodelsᚐSearchSnippet(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
