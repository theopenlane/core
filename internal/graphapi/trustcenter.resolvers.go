...
// CreateBulkTrustCenter is the resolver for the createBulkTrustCenter field.
func (r *mutationResolver) CreateBulkTrustCenter(ctx context.Context, input []*generated.CreateTrustCenterInput) (*model.TrustCenterBulkCreatePayload, error) {
	if len(input) == 0 {
	...
	return r.bulkCreateTrustCenter(ctx, input)
}

// CreateBulkCSVTrustCenter is the resolver for the createBulkCSVTrustCenter field.
func (r *mutationResolver) CreateBulkCSVTrustCenter(ctx context.Context, input graphql.Upload) (*model.TrustCenterBulkCreatePayload, error) {
	data, err := unmarshalBulkData[generated.CreateTrustCenterInput](input)
	if err != nil {
	...
	return r.bulkCreateTrustCenter(ctx, data)
}
