...
/*
	func (r *updateDirectoryAccountInputResolver) OwnerID(ctx context.Context, obj *generated.UpdateDirectoryAccountInput, data *string) error {
	res, err := withTransactionalMutation(ctx).ID.Get(ctx, id)
	if err != nil {
		return nil, parseRequestError(ctx, err, common.Action{Action: common.ActionUpdate, Object: "id"})
	}
...
func (r *updateDirectoryAccountInputResolver) ClearOwner(ctx context.Context, obj *generated.UpdateDirectoryAccountInput, data *bool) error {
...
func (r *Resolver) UpdateDirectoryAccountInput() gqlgenerated.UpdateDirectoryAccountInputResolver {
	return &updateDirectoryAccountInputResolver{r}
}
type updateDirectoryAccountInputResolver struct{ *Resolver }
*/
