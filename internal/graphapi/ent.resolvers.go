...
/*
	func (r *updateScanInputResolver) OwnerID(ctx context.Context, obj *generated.UpdateScanInput, data *string) error {
...
func (r *updateScanInputResolver) ClearOwner(ctx context.Context, obj *generated.UpdateScanInput, data *bool) error {
...
func (r *Resolver) UpdateScanInput() gqlgenerated.UpdateScanInputResolver {
	return &updateScanInputResolver{r}
}
type updateScanInputResolver struct{ *Resolver }
*/
