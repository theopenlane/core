	...
	request := withTransactionalMutation(ctx).ActionPlan.Query().
		Where(
			actionplan.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(details_json)::text LIKE $6", likeQuery)) // search by DetailsJSON
				},
	...
	request := withTransactionalMutation(ctx).Control.Query().
		Where(
			control.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(description_json)::text LIKE $7", likeQuery)) // search by DescriptionJSON
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(aliases)::text LIKE $8", likeQuery)) // search by Aliases
				},
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(mapped_categories)::text LIKE $18", likeQuery)) // search by MappedCategories
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(assessment_objectives)::text LIKE $19", likeQuery)) // search by AssessmentObjectives
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(assessment_methods)::text LIKE $20", likeQuery)) // search by AssessmentMethods
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(control_questions)::text LIKE $21", likeQuery)) // search by ControlQuestions
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(implementation_guidance)::text LIKE $22", likeQuery)) // search by ImplementationGuidance
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(example_evidence)::text LIKE $23", likeQuery)) // search by ExampleEvidence
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(references)::text LIKE $24", likeQuery)) // search by References
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(testing_procedures)::text LIKE $25", likeQuery)) // search by TestingProcedures
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(evidence_requests)::text LIKE $26", likeQuery)) // search by EvidenceRequests
				},
	...
	request := withTransactionalMutation(ctx).ControlObjective.Query().
		Where(
			controlobjective.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(desired_outcome_json)::text LIKE $10", likeQuery)) // search by DesiredOutcomeJSON
				},
	...
	request := withTransactionalMutation(ctx).Finding.Query().
		Where(
			finding.Or(
				...
				finding.FindingSeverityLevelNameContainsFold(query), // search by FindingSeverityLevelName
				finding.FindingSeverityLevelIDContainsFold(query),   // search by FindingSeverityLevelID
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(categories)::text LIKE $22", likeQuery)) // search by Categories
				},
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(references)::text LIKE $30", likeQuery)) // search by References
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(steps_to_reproduce)::text LIKE $31", likeQuery)) // search by StepsToReproduce
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(targets)::text LIKE $32", likeQuery)) // search by Targets
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(target_details)::text LIKE $33", likeQuery)) // search by TargetDetails
				},
	...
	request := withTransactionalMutation(ctx).InternalPolicy.Query().
		Where(
			internalpolicy.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(details_json)::text LIKE $10", likeQuery)) // search by DetailsJSON
				},
	...
	request := withTransactionalMutation(ctx).Procedure.Query().
		Where(
			procedure.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(details_json)::text LIKE $8", likeQuery)) // search by DetailsJSON
				},
	...
	request := withTransactionalMutation(ctx).Scan.Query().
		Where(
			scan.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(vulnerability_ids)::text LIKE $20", likeQuery)) // search by VulnerabilityIds
				},
			),
		)
	...
	request := withTransactionalMutation(ctx).SystemDetail.Query().
		Where(
			systemdetail.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(revision_history)::text LIKE $11", likeQuery)) // search by RevisionHistory
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(oscal_metadata_json)::text LIKE $12", likeQuery)) // search by OscalMetadataJSON
				},
			),
		)
	...
	request := withTransactionalMutation(ctx).Task.Query().
		Where(
			task.Or(
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(details_json)::text LIKE $14", likeQuery)) // search by DetailsJSON
				},
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(external_reference_url)::text LIKE $18", likeQuery)) // search by ExternalReferenceURL
				},
	...
	request := withTransactionalMutation(ctx).Vulnerability.Query().
		Where(
			vulnerability.Or(
				...
				vulnerability.VulnerabilitySeverityLevelNameContainsFold(query), // search by VulnerabilitySeverityLevelName
				vulnerability.VulnerabilitySeverityLevelIDContainsFold(query),   // search by VulnerabilitySeverityLevelID
				...
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(impacts)::text LIKE $28", likeQuery)) // search by Impacts
				},
				vulnerability.ExternalURIContainsFold(query), // search by ExternalURI
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(metadata)::text LIKE $30", likeQuery)) // search by Metadata
				},
				func(s *sql.Selector) {
					likeQuery := "%" + query + "%"
					s.Where(sql.ExprP("(raw_payload)::text LIKE $31", likeQuery)) // search by RawPayload
				},
			),
		)
