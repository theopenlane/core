...
// Notification template key constants match the key column in the emailtemplates table
const (
	// TemplateKeyVerifyEmail is the notification template key for verification emails
	TemplateKeyVerifyEmail = "verify_email"
