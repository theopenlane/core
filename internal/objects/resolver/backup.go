...
func buildBackupProviders(config storage.ProviderConfig, builders providerBuilders, runtime serviceOptions) (map[storage.ProviderType]objects.BackupTarget, error) {
