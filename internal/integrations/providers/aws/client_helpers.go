...
func buildAWSClient[T any](ctx context.Context, payload types.CredentialPayload, constructor ClientConstructor[T]) (T, awskit.AWSMetadata, error) {
	...
	if err != nil {
		return zero, awskit.AWSMetadata{}, err
	}

	cfg, err := awskit.BuildAWSConfig(ctx, meta.Region, awskit.AWSCredentialsFromPayload(payload), awskit.AWSAssumeRole{
...
func resolveAWSClient[T any](ctx context.Context, input types.OperationInput, constructor ClientConstructor[T]) (T, awskit.AWSMetadata, error) {
