...
var mapExprDirectoryAccount = providerkit.CelMapExpr([]providerkit.CelMapEntry{
	...
	{Key: integrationgenerated.IntegrationMappingDirectoryAccountAddedAt, Expr: `'date_joined' in payload ? payload.date_joined : null`},
	{Key: integrationgenerated.IntegrationMappingDirectoryAccountLastSeenAt, Expr: `'last_login' in payload ? payload.last_login : null`},
	{Key: integrationgenerated.IntegrationMappingDirectoryAccountObservedAt, Expr: `'last_updated' in payload ? payload.last_updated : null`},
