...
func TestFixture(name, toEmail string) json.RawMessage {
	...
	fixtures := map[string]any{
		...
		"BrandedMessageRequest": BrandedMessageRequest{
			...
			Subject:    "Test Branded Message from Openlane",
			Preheader:  "This is a test branded message",
			Title:      "Welcome to Our Test Campaign",
			Intros:     []string{"This is a test branded message sent via the email-test CLI.", "All templates are rendering correctly."},
			ButtonText: "Visit Dashboard",
			ButtonLink: "https://console.theopenlane.io",
			Outros:     []string{"If you received this, the branded message template is working as expected."},
		},
	}
