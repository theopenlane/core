...
// WebhookVerifyRequest captures the inputs required to verify an inbound webhook request
...
// WebhookEventRequest captures the inputs required to resolve an inbound webhook into a named event
