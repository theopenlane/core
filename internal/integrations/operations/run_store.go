...
func CreatePendingRun(ctx context.Context, db *ent.Client, installation *ent.Integration, integrationActorConfig identity.Config, req types.DispatchRequest) (*ent.IntegrationRun, error) {
	if installation == nil {
	...
	ctx = identity.WithIntegrationCaller(ctx, installation, integrationActorConfig)
