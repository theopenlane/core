...
// handleExportMutation notifies the requestor when an export status changes to READY or FAILED
...
func addExportNotification(ctx context.Context, client *generated.Client, exportEntity *generated.Export) error {
	...
	return entityops.CreateNotifications(ctx, client, []string{exportEntity.RequestorID}, notifInput)
}
