...
func (_m *WorkflowAssignmentHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case workflowassignmenthistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case workflowassignmenthistory.FieldApprovalMetadata:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case workflowassignmenthistory.FieldRejectionMetadata:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case workflowassignmenthistory.FieldInvalidationMetadata:
			if value, ok := values[i].(*[]byte); !ok {
...
func (_m *WorkflowAssignmentHistory) Unwrap() *WorkflowAssignmentHistory {
	...
	if !ok {
		panic("historygenerated: WorkflowAssignmentHistory is not a transactional entity")
	}
