...
func (*VendorScoringConfigHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case vendorscoringconfighistory.FieldID, vendorscoringconfighistory.FieldRef, vendorscoringconfighistory.FieldCreatedBy, vendorscoringconfighistory.FieldUpdatedBy, vendorscoringconfighistory.FieldUpdatedByImpersonator, vendorscoringconfighistory.FieldDeletedBy, vendorscoringconfighistory.FieldOwnerID, vendorscoringconfighistory.FieldScoringMode:
...
func (_m *VendorScoringConfigHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case vendorscoringconfighistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
