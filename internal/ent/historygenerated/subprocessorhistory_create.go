...
func (_c *SubprocessorHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if subprocessorhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized subprocessorhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if subprocessorhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized subprocessorhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if subprocessorhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized subprocessorhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if subprocessorhistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized subprocessorhistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *SubprocessorHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "SubprocessorHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "SubprocessorHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := subprocessorhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "SubprocessorHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "SubprocessorHistory.name"`)}
	}
	return nil
}
