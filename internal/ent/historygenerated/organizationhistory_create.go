...
func (_c *OrganizationHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if organizationhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if organizationhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if organizationhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.AvatarUpdatedAt(); !ok {
		if organizationhistory.DefaultAvatarUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationhistory.DefaultAvatarUpdatedAt (forgotten import historygenerated/runtime?)")
		}
...
func (_c *OrganizationHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "OrganizationHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "OrganizationHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := organizationhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "OrganizationHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "OrganizationHistory.name"`)}
	}
	if _, ok := _c.mutation.DisplayName(); !ok {
