...
func (*SubprocessorHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case subprocessorhistory.FieldID, subprocessorhistory.FieldRef, subprocessorhistory.FieldCreatedBy, subprocessorhistory.FieldUpdatedBy, subprocessorhistory.FieldUpdatedByImpersonator, subprocessorhistory.FieldDeletedBy, subprocessorhistory.FieldOwnerID, subprocessorhistory.FieldInternalNotes, subprocessorhistory.FieldSystemInternalID, subprocessorhistory.FieldName, subprocessorhistory.FieldDescription, subprocessorhistory.FieldLogoRemoteURL, subprocessorhistory.FieldLogoFileID:
...
func (_m *SubprocessorHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case subprocessorhistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (_m *SubprocessorHistory) Unwrap() *SubprocessorHistory {
	...
	if !ok {
		panic("historygenerated: SubprocessorHistory is not a transactional entity")
	}
