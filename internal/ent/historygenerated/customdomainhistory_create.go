...
func (_c *CustomDomainHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if customdomainhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized customdomainhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if customdomainhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized customdomainhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if customdomainhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized customdomainhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
...
func (_c *CustomDomainHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "CustomDomainHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "CustomDomainHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := customdomainhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "CustomDomainHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CnameRecord(); !ok {
		return &ValidationError{Name: "cname_record", err: errors.New(`historygenerated: missing required field "CustomDomainHistory.cname_record"`)}
	}
