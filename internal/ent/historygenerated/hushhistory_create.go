...
func (_c *HushHistoryCreate) SetCredentialSet(v integrationtypes.CredentialSet) *HushHistoryCreate {
	_c.mutation.SetCredentialSet(v)
	return _c
}

// SetNillableCredentialSet sets the "credential_set" field if the given value is not nil.
func (_c *HushHistoryCreate) SetNillableCredentialSet(v *integrationtypes.CredentialSet) *HushHistoryCreate {
	if v != nil {
...
func (_c *HushHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if hushhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized hushhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if hushhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized hushhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if hushhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized hushhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if hushhistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized hushhistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *HushHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "HushHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "HushHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := hushhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "HushHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "HushHistory.name"`)}
	}
	return nil
}
