...
func (_m *DirectoryGroupHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case directorygrouphistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
