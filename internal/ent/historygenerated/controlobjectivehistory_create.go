...
func (_c *ControlObjectiveHistoryCreate) SetUpdatedByImpersonator(v string) *ControlObjectiveHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *ControlObjectiveHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *ControlObjectiveHistoryCreate {
	if v != nil {
