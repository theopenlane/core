...
func (_c *GroupSettingHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if groupsettinghistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized groupsettinghistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if groupsettinghistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized groupsettinghistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if groupsettinghistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized groupsettinghistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if groupsettinghistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized groupsettinghistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *GroupSettingHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "GroupSettingHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "GroupSettingHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := groupsettinghistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "GroupSettingHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Visibility(); !ok {
		return &ValidationError{Name: "visibility", err: errors.New(`historygenerated: missing required field "GroupSettingHistory.visibility"`)}
	}
	...
	if _, ok := _c.mutation.JoinPolicy(); !ok {
		return &ValidationError{Name: "join_policy", err: errors.New(`historygenerated: missing required field "GroupSettingHistory.join_policy"`)}
	}
