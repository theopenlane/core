...
func (_q *ActionPlanHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[actionplanhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, actionplanhistory.FieldUpdatedByImpersonator)
				fieldSeen[actionplanhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *AssessmentHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[assessmenthistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, assessmenthistory.FieldUpdatedByImpersonator)
				fieldSeen[assessmenthistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *AssessmentResponseHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[assessmentresponsehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, assessmentresponsehistory.FieldUpdatedByImpersonator)
				fieldSeen[assessmentresponsehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "ownerID":
...
func (_q *AssetHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[assethistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, assethistory.FieldUpdatedByImpersonator)
				fieldSeen[assethistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *CampaignHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[campaignhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, campaignhistory.FieldUpdatedByImpersonator)
				fieldSeen[campaignhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *CampaignTargetHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[campaigntargethistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, campaigntargethistory.FieldUpdatedByImpersonator)
				fieldSeen[campaigntargethistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "ownerID":
...
// CollectFields tells the query-builder to eagerly load connected nodes by resolver context.
func (_q *CheckResultHistoryQuery) CollectFields(ctx context.Context, satisfies ...string) (*CheckResultHistoryQuery, error) {
	fc := graphql.GetFieldContext(ctx)
	if fc == nil {
		return _q, nil
	}
...
func (_q *CheckResultHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
		fieldSeen      = make(map[string]struct{}, len(checkresulthistory.Columns))
		selectedFields = []string{checkresulthistory.FieldID}
	)
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		switch field.Name {
		case "historyTime":
			if _, ok := fieldSeen[checkresulthistory.FieldHistoryTime]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldHistoryTime)
				fieldSeen[checkresulthistory.FieldHistoryTime] = struct{}{}
			}
		case "ref":
			if _, ok := fieldSeen[checkresulthistory.FieldRef]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldRef)
				fieldSeen[checkresulthistory.FieldRef] = struct{}{}
			}
		case "operation":
			if _, ok := fieldSeen[checkresulthistory.FieldOperation]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldOperation)
				fieldSeen[checkresulthistory.FieldOperation] = struct{}{}
			}
		case "createdAt":
			if _, ok := fieldSeen[checkresulthistory.FieldCreatedAt]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldCreatedAt)
				fieldSeen[checkresulthistory.FieldCreatedAt] = struct{}{}
			}
		case "updatedAt":
			if _, ok := fieldSeen[checkresulthistory.FieldUpdatedAt]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldUpdatedAt)
				fieldSeen[checkresulthistory.FieldUpdatedAt] = struct{}{}
			}
		case "createdBy":
			if _, ok := fieldSeen[checkresulthistory.FieldCreatedBy]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldCreatedBy)
				fieldSeen[checkresulthistory.FieldCreatedBy] = struct{}{}
			}
		case "updatedBy":
			if _, ok := fieldSeen[checkresulthistory.FieldUpdatedBy]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldUpdatedBy)
				fieldSeen[checkresulthistory.FieldUpdatedBy] = struct{}{}
			}
		case "updatedByImpersonator":
			if _, ok := fieldSeen[checkresulthistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldUpdatedByImpersonator)
				fieldSeen[checkresulthistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
			if _, ok := fieldSeen[checkresulthistory.FieldTags]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldTags)
				fieldSeen[checkresulthistory.FieldTags] = struct{}{}
			}
		case "status":
			if _, ok := fieldSeen[checkresulthistory.FieldStatus]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldStatus)
				fieldSeen[checkresulthistory.FieldStatus] = struct{}{}
			}
		case "source":
			if _, ok := fieldSeen[checkresulthistory.FieldSource]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldSource)
				fieldSeen[checkresulthistory.FieldSource] = struct{}{}
			}
		case "lastObservedAt":
			if _, ok := fieldSeen[checkresulthistory.FieldLastObservedAt]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldLastObservedAt)
				fieldSeen[checkresulthistory.FieldLastObservedAt] = struct{}{}
			}
		case "externalURI":
			if _, ok := fieldSeen[checkresulthistory.FieldExternalURI]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldExternalURI)
				fieldSeen[checkresulthistory.FieldExternalURI] = struct{}{}
			}
		case "details":
			if _, ok := fieldSeen[checkresulthistory.FieldDetails]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldDetails)
				fieldSeen[checkresulthistory.FieldDetails] = struct{}{}
			}
		case "parentExternalID":
			if _, ok := fieldSeen[checkresulthistory.FieldParentExternalID]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldParentExternalID)
				fieldSeen[checkresulthistory.FieldParentExternalID] = struct{}{}
			}
		case "integrationID":
			if _, ok := fieldSeen[checkresulthistory.FieldIntegrationID]; !ok {
				selectedFields = append(selectedFields, checkresulthistory.FieldIntegrationID)
				fieldSeen[checkresulthistory.FieldIntegrationID] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
...
type checkresulthistoryPaginateArgs struct {
	first, last   *int
	after, before *Cursor
	opts          []CheckResultHistoryPaginateOption
}

func newCheckResultHistoryPaginateArgs(rv map[string]any) *checkresulthistoryPaginateArgs {
	args := &checkresulthistoryPaginateArgs{}
	if rv == nil {
		return args
	}
	if v := rv[firstField]; v != nil {
	...
	if v, ok := rv[orderByField]; ok {
		...
		case map[string]any:
			var (
				err1, err2 error
				order      = &CheckResultHistoryOrder{Field: &CheckResultHistoryOrderField{}, Direction: entgql.OrderDirectionAsc}
			)
			if d, ok := v[directionField]; ok {
				err1 = order.Direction.UnmarshalGQL(d)
			}
			...
			if err1 == nil && err2 == nil {
				args.opts = append(args.opts, WithCheckResultHistoryOrder(order))
			}
		case *CheckResultHistoryOrder:
			if v != nil {
				args.opts = append(args.opts, WithCheckResultHistoryOrder(v))
			}
		}
	}
	if v, ok := rv[whereField].(*CheckResultHistoryWhereInput); ok {
		args.opts = append(args.opts, WithCheckResultHistoryFilter(v.Filter))
	}
	return args
}
...
func (_q *ContactHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[contacthistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, contacthistory.FieldUpdatedByImpersonator)
				fieldSeen[contacthistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *ControlHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[controlhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, controlhistory.FieldUpdatedByImpersonator)
				fieldSeen[controlhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[controlhistory.FieldExternalUUID]; !ok {
				selectedFields = append(selectedFields, controlhistory.FieldExternalUUID)
				fieldSeen[controlhistory.FieldExternalUUID] = struct{}{}
			}
		case "title":
		...
		case "implementationStatus":
			if _, ok := fieldSeen[controlhistory.FieldImplementationStatus]; !ok {
				selectedFields = append(selectedFields, controlhistory.FieldImplementationStatus)
				fieldSeen[controlhistory.FieldImplementationStatus] = struct{}{}
			}
		case "implementationDescription":
			if _, ok := fieldSeen[controlhistory.FieldImplementationDescription]; !ok {
...
func (_q *ControlImplementationHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[controlimplementationhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, controlimplementationhistory.FieldUpdatedByImpersonator)
				fieldSeen[controlimplementationhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *ControlObjectiveHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[controlobjectivehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, controlobjectivehistory.FieldUpdatedByImpersonator)
				fieldSeen[controlobjectivehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *CustomDomainHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[customdomainhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, customdomainhistory.FieldUpdatedByImpersonator)
				fieldSeen[customdomainhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *DNSVerificationHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[dnsverificationhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, dnsverificationhistory.FieldUpdatedByImpersonator)
				fieldSeen[dnsverificationhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *DirectoryAccountHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[directoryaccounthistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, directoryaccounthistory.FieldUpdatedByImpersonator)
				fieldSeen[directoryaccounthistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "primarySource":
			if _, ok := fieldSeen[directoryaccounthistory.FieldPrimarySource]; !ok {
				selectedFields = append(selectedFields, directoryaccounthistory.FieldPrimarySource)
				fieldSeen[directoryaccounthistory.FieldPrimarySource] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
...
func (_q *DirectoryGroupHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[directorygrouphistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, directorygrouphistory.FieldUpdatedByImpersonator)
				fieldSeen[directorygrouphistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "directoryName":
			if _, ok := fieldSeen[directorygrouphistory.FieldDirectoryName]; !ok {
				selectedFields = append(selectedFields, directorygrouphistory.FieldDirectoryName)
				fieldSeen[directorygrouphistory.FieldDirectoryName] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
...
func (_q *DirectoryMembershipHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[directorymembershiphistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, directorymembershiphistory.FieldUpdatedByImpersonator)
				fieldSeen[directorymembershiphistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "directoryName":
			if _, ok := fieldSeen[directorymembershiphistory.FieldDirectoryName]; !ok {
				selectedFields = append(selectedFields, directorymembershiphistory.FieldDirectoryName)
				fieldSeen[directorymembershiphistory.FieldDirectoryName] = struct{}{}
			}
		case "firstSeenAt":
...
func (_q *DiscussionHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[discussionhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, discussionhistory.FieldUpdatedByImpersonator)
				fieldSeen[discussionhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "ownerID":
...
func (_q *DocumentDataHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[documentdatahistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, documentdatahistory.FieldUpdatedByImpersonator)
				fieldSeen[documentdatahistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *EmailTemplateHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[emailtemplatehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, emailtemplatehistory.FieldUpdatedByImpersonator)
				fieldSeen[emailtemplatehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "revision":
...
func (_q *EntityHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[entityhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, entityhistory.FieldUpdatedByImpersonator)
				fieldSeen[entityhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
		...
		case "riskScoreCoverage":
			if _, ok := fieldSeen[entityhistory.FieldRiskScoreCoverage]; !ok {
				selectedFields = append(selectedFields, entityhistory.FieldRiskScoreCoverage)
				fieldSeen[entityhistory.FieldRiskScoreCoverage] = struct{}{}
			}
		case "tier":
...
func (_q *EntityTypeHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[entitytypehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, entitytypehistory.FieldUpdatedByImpersonator)
				fieldSeen[entitytypehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *EvidenceHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[evidencehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, evidencehistory.FieldUpdatedByImpersonator)
				fieldSeen[evidencehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[evidencehistory.FieldExternalUUID]; !ok {
				selectedFields = append(selectedFields, evidencehistory.FieldExternalUUID)
				fieldSeen[evidencehistory.FieldExternalUUID] = struct{}{}
			}
		case "name":
...
func (_q *FileHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[filehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, filehistory.FieldUpdatedByImpersonator)
				fieldSeen[filehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *FindingControlHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[findingcontrolhistory.FieldUpdatedByImpersonator]; !ok {
...
func (_q *FindingHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[findinghistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, findinghistory.FieldUpdatedByImpersonator)
				fieldSeen[findinghistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *GroupHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[grouphistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, grouphistory.FieldUpdatedByImpersonator)
				fieldSeen[grouphistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "oscalRole":
			if _, ok := fieldSeen[grouphistory.FieldOscalRole]; !ok {
				selectedFields = append(selectedFields, grouphistory.FieldOscalRole)
				fieldSeen[grouphistory.FieldOscalRole] = struct{}{}
			}
		case "oscalPartyUUID":
			if _, ok := fieldSeen[grouphistory.FieldOscalPartyUUID]; !ok {
				selectedFields = append(selectedFields, grouphistory.FieldOscalPartyUUID)
				fieldSeen[grouphistory.FieldOscalPartyUUID] = struct{}{}
			}
		case "oscalContactUuids":
			if _, ok := fieldSeen[grouphistory.FieldOscalContactUuids]; !ok {
				selectedFields = append(selectedFields, grouphistory.FieldOscalContactUuids)
				fieldSeen[grouphistory.FieldOscalContactUuids] = struct{}{}
			}
		case "scimExternalID":
...
func (_q *GroupMembershipHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[groupmembershiphistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, groupmembershiphistory.FieldUpdatedByImpersonator)
				fieldSeen[groupmembershiphistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "role":
...
func (_q *GroupSettingHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[groupsettinghistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, groupsettinghistory.FieldUpdatedByImpersonator)
				fieldSeen[groupsettinghistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "visibility":
...
func (_q *HushHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[hushhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, hushhistory.FieldUpdatedByImpersonator)
				fieldSeen[hushhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "ownerID":
...
func (_q *IdentityHolderHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[identityholderhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, identityholderhistory.FieldUpdatedByImpersonator)
				fieldSeen[identityholderhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *IntegrationHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[integrationhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, integrationhistory.FieldUpdatedByImpersonator)
				fieldSeen[integrationhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *InternalPolicyHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[internalpolicyhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, internalpolicyhistory.FieldUpdatedByImpersonator)
				fieldSeen[internalpolicyhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[internalpolicyhistory.FieldExternalUUID]; !ok {
				selectedFields = append(selectedFields, internalpolicyhistory.FieldExternalUUID)
				fieldSeen[internalpolicyhistory.FieldExternalUUID] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
...
func (_q *MappableDomainHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[mappabledomainhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, mappabledomainhistory.FieldUpdatedByImpersonator)
				fieldSeen[mappabledomainhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *MappedControlHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[mappedcontrolhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, mappedcontrolhistory.FieldUpdatedByImpersonator)
				fieldSeen[mappedcontrolhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *NarrativeHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[narrativehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, narrativehistory.FieldUpdatedByImpersonator)
				fieldSeen[narrativehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *NoteHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[notehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, notehistory.FieldUpdatedByImpersonator)
				fieldSeen[notehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *NotificationPreferenceHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[notificationpreferencehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, notificationpreferencehistory.FieldUpdatedByImpersonator)
				fieldSeen[notificationpreferencehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "ownerID":
...
func (_q *NotificationTemplateHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[notificationtemplatehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, notificationtemplatehistory.FieldUpdatedByImpersonator)
				fieldSeen[notificationtemplatehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "revision":
...
func (_q *OrgMembershipHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[orgmembershiphistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, orgmembershiphistory.FieldUpdatedByImpersonator)
				fieldSeen[orgmembershiphistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "role":
		...
		case "ssoExemptReason":
			if _, ok := fieldSeen[orgmembershiphistory.FieldSSOExemptReason]; !ok {
				selectedFields = append(selectedFields, orgmembershiphistory.FieldSSOExemptReason)
				fieldSeen[orgmembershiphistory.FieldSSOExemptReason] = struct{}{}
			}
		case "ssoExemptGrantedBy":
			if _, ok := fieldSeen[orgmembershiphistory.FieldSSOExemptGrantedBy]; !ok {
				selectedFields = append(selectedFields, orgmembershiphistory.FieldSSOExemptGrantedBy)
				fieldSeen[orgmembershiphistory.FieldSSOExemptGrantedBy] = struct{}{}
			}
		case "ssoExemptGrantedAt":
			if _, ok := fieldSeen[orgmembershiphistory.FieldSSOExemptGrantedAt]; !ok {
...
func (_q *OrgSubscriptionHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[orgsubscriptionhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, orgsubscriptionhistory.FieldUpdatedByImpersonator)
				fieldSeen[orgsubscriptionhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *OrganizationHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[organizationhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, organizationhistory.FieldUpdatedByImpersonator)
				fieldSeen[organizationhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *OrganizationSettingHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[organizationsettinghistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, organizationsettinghistory.FieldUpdatedByImpersonator)
				fieldSeen[organizationsettinghistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
		...
		case "ssoExemptDomains":
			if _, ok := fieldSeen[organizationsettinghistory.FieldSSOExemptDomains]; !ok {
				selectedFields = append(selectedFields, organizationsettinghistory.FieldSSOExemptDomains)
				fieldSeen[organizationsettinghistory.FieldSSOExemptDomains] = struct{}{}
			}
		case "allowSupportAccess":
			if _, ok := fieldSeen[organizationsettinghistory.FieldAllowSupportAccess]; !ok {
				selectedFields = append(selectedFields, organizationsettinghistory.FieldAllowSupportAccess)
				fieldSeen[organizationsettinghistory.FieldAllowSupportAccess] = struct{}{}
			}
...
func (_q *PlatformHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[platformhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, platformhistory.FieldUpdatedByImpersonator)
				fieldSeen[platformhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[platformhistory.FieldExternalUUID]; !ok {
				selectedFields = append(selectedFields, platformhistory.FieldExternalUUID)
				fieldSeen[platformhistory.FieldExternalUUID] = struct{}{}
			}
		case "name":
...
func (_q *ProcedureHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[procedurehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, procedurehistory.FieldUpdatedByImpersonator)
				fieldSeen[procedurehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *ProgramHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[programhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, programhistory.FieldUpdatedByImpersonator)
				fieldSeen[programhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[programhistory.FieldExternalUUID]; !ok {
				selectedFields = append(selectedFields, programhistory.FieldExternalUUID)
				fieldSeen[programhistory.FieldExternalUUID] = struct{}{}
			}
		case "name":
...
func (_q *ProgramMembershipHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[programmembershiphistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, programmembershiphistory.FieldUpdatedByImpersonator)
				fieldSeen[programmembershiphistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "role":
...
func (_q *RemediationHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[remediationhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, remediationhistory.FieldUpdatedByImpersonator)
				fieldSeen[remediationhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *ReviewHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[reviewhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, reviewhistory.FieldUpdatedByImpersonator)
				fieldSeen[reviewhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *RiskHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[riskhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, riskhistory.FieldUpdatedByImpersonator)
				fieldSeen[riskhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[riskhistory.FieldExternalUUID]; !ok {
				selectedFields = append(selectedFields, riskhistory.FieldExternalUUID)
				fieldSeen[riskhistory.FieldExternalUUID] = struct{}{}
			}
		case "name":
...
func (_q *SLADefinitionHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[sladefinitionhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, sladefinitionhistory.FieldUpdatedByImpersonator)
				fieldSeen[sladefinitionhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *ScanHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[scanhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, scanhistory.FieldUpdatedByImpersonator)
				fieldSeen[scanhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *StandardHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[standardhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, standardhistory.FieldUpdatedByImpersonator)
				fieldSeen[standardhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *SubcontrolHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[subcontrolhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, subcontrolhistory.FieldUpdatedByImpersonator)
				fieldSeen[subcontrolhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[subcontrolhistory.FieldExternalUUID]; !ok {
				selectedFields = append(selectedFields, subcontrolhistory.FieldExternalUUID)
				fieldSeen[subcontrolhistory.FieldExternalUUID] = struct{}{}
			}
		case "title":
		...
		case "implementationDescription":
			if _, ok := fieldSeen[subcontrolhistory.FieldImplementationDescription]; !ok {
...
func (_q *SubprocessorHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[subprocessorhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, subprocessorhistory.FieldUpdatedByImpersonator)
				fieldSeen[subprocessorhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
// CollectFields tells the query-builder to eagerly load connected nodes by resolver context.
func (_q *SystemDetailHistoryQuery) CollectFields(ctx context.Context, satisfies ...string) (*SystemDetailHistoryQuery, error) {
	fc := graphql.GetFieldContext(ctx)
	if fc == nil {
		return _q, nil
	}
...
func (_q *SystemDetailHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
		fieldSeen      = make(map[string]struct{}, len(systemdetailhistory.Columns))
		selectedFields = []string{systemdetailhistory.FieldID}
	)
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		switch field.Name {
		case "historyTime":
			if _, ok := fieldSeen[systemdetailhistory.FieldHistoryTime]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldHistoryTime)
				fieldSeen[systemdetailhistory.FieldHistoryTime] = struct{}{}
			}
		case "ref":
			if _, ok := fieldSeen[systemdetailhistory.FieldRef]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldRef)
				fieldSeen[systemdetailhistory.FieldRef] = struct{}{}
			}
		case "operation":
			if _, ok := fieldSeen[systemdetailhistory.FieldOperation]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldOperation)
				fieldSeen[systemdetailhistory.FieldOperation] = struct{}{}
			}
		case "createdAt":
			if _, ok := fieldSeen[systemdetailhistory.FieldCreatedAt]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldCreatedAt)
				fieldSeen[systemdetailhistory.FieldCreatedAt] = struct{}{}
			}
		case "updatedAt":
			if _, ok := fieldSeen[systemdetailhistory.FieldUpdatedAt]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldUpdatedAt)
				fieldSeen[systemdetailhistory.FieldUpdatedAt] = struct{}{}
			}
		case "createdBy":
			if _, ok := fieldSeen[systemdetailhistory.FieldCreatedBy]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldCreatedBy)
				fieldSeen[systemdetailhistory.FieldCreatedBy] = struct{}{}
			}
		case "updatedBy":
			if _, ok := fieldSeen[systemdetailhistory.FieldUpdatedBy]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldUpdatedBy)
				fieldSeen[systemdetailhistory.FieldUpdatedBy] = struct{}{}
			}
		case "updatedByImpersonator":
			if _, ok := fieldSeen[systemdetailhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldUpdatedByImpersonator)
				fieldSeen[systemdetailhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
			if _, ok := fieldSeen[systemdetailhistory.FieldDisplayID]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldDisplayID)
				fieldSeen[systemdetailhistory.FieldDisplayID] = struct{}{}
			}
		case "tags":
			if _, ok := fieldSeen[systemdetailhistory.FieldTags]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldTags)
				fieldSeen[systemdetailhistory.FieldTags] = struct{}{}
			}
		case "ownerID":
			if _, ok := fieldSeen[systemdetailhistory.FieldOwnerID]; !ok {
		...
		case "systemName":
			if _, ok := fieldSeen[systemdetailhistory.FieldSystemName]; !ok {
				...
				fieldSeen[systemdetailhistory.FieldSystemName] = struct{}{}
			}
		case "version":
			if _, ok := fieldSeen[systemdetailhistory.FieldVersion]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldVersion)
				fieldSeen[systemdetailhistory.FieldVersion] = struct{}{}
			}
		case "description":
			if _, ok := fieldSeen[systemdetailhistory.FieldDescription]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldDescription)
				fieldSeen[systemdetailhistory.FieldDescription] = struct{}{}
			}
		case "authorizationBoundary":
			if _, ok := fieldSeen[systemdetailhistory.FieldAuthorizationBoundary]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldAuthorizationBoundary)
				fieldSeen[systemdetailhistory.FieldAuthorizationBoundary] = struct{}{}
			}
		case "sensitivityLevel":
			if _, ok := fieldSeen[systemdetailhistory.FieldSensitivityLevel]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldSensitivityLevel)
				fieldSeen[systemdetailhistory.FieldSensitivityLevel] = struct{}{}
			}
		case "lastReviewed":
			if _, ok := fieldSeen[systemdetailhistory.FieldLastReviewed]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldLastReviewed)
				fieldSeen[systemdetailhistory.FieldLastReviewed] = struct{}{}
			}
		case "revisionHistory":
			if _, ok := fieldSeen[systemdetailhistory.FieldRevisionHistory]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldRevisionHistory)
				fieldSeen[systemdetailhistory.FieldRevisionHistory] = struct{}{}
			}
		case "oscalMetadataJSON":
			if _, ok := fieldSeen[systemdetailhistory.FieldOscalMetadataJSON]; !ok {
				selectedFields = append(selectedFields, systemdetailhistory.FieldOscalMetadataJSON)
				fieldSeen[systemdetailhistory.FieldOscalMetadataJSON] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
...
type systemdetailhistoryPaginateArgs struct {
	first, last   *int
	after, before *Cursor
	opts          []SystemDetailHistoryPaginateOption
}

func newSystemDetailHistoryPaginateArgs(rv map[string]any) *systemdetailhistoryPaginateArgs {
	args := &systemdetailhistoryPaginateArgs{}
	if rv == nil {
		return args
	}
	if v := rv[firstField]; v != nil {
	...
	if v, ok := rv[orderByField]; ok {
		...
		case map[string]any:
			var (
				err1, err2 error
				order      = &SystemDetailHistoryOrder{Field: &SystemDetailHistoryOrderField{}, Direction: entgql.OrderDirectionAsc}
			)
			if d, ok := v[directionField]; ok {
				err1 = order.Direction.UnmarshalGQL(d)
			}
			...
			if err1 == nil && err2 == nil {
				args.opts = append(args.opts, WithSystemDetailHistoryOrder(order))
			}
		case *SystemDetailHistoryOrder:
			if v != nil {
				args.opts = append(args.opts, WithSystemDetailHistoryOrder(v))
			}
		}
	}
	if v, ok := rv[whereField].(*SystemDetailHistoryWhereInput); ok {
		args.opts = append(args.opts, WithSystemDetailHistoryFilter(v.Filter))
	}
	return args
}
...
func (_q *TaskHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[taskhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, taskhistory.FieldUpdatedByImpersonator)
				fieldSeen[taskhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "externalUUID":
			if _, ok := fieldSeen[taskhistory.FieldExternalUUID]; !ok {
				...
				fieldSeen[taskhistory.FieldExternalUUID] = struct{}{}
			}
		case "title":
...
func (_q *TemplateHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[templatehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, templatehistory.FieldUpdatedByImpersonator)
				fieldSeen[templatehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *TrustCenterComplianceHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcentercompliancehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcentercompliancehistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcentercompliancehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *TrustCenterDocHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcenterdochistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcenterdochistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcenterdochistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *TrustCenterEntityHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcenterentityhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcenterentityhistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcenterentityhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "logoFileID":
...
func (_q *TrustCenterFAQHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcenterfaqhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcenterfaqhistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcenterfaqhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
...
func (_q *TrustCenterHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcenterhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcenterhistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcenterhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *TrustCenterNDARequestHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcenterndarequesthistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcenterndarequesthistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcenterndarequesthistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
func (_q *TrustCenterSettingHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcentersettinghistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcentersettinghistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcentersettinghistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "trustCenterID":
...
func (_q *TrustCenterSubprocessorHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcentersubprocessorhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcentersubprocessorhistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcentersubprocessorhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
...
func (_q *TrustCenterWatermarkConfigHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[trustcenterwatermarkconfighistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, trustcenterwatermarkconfighistory.FieldUpdatedByImpersonator)
				fieldSeen[trustcenterwatermarkconfighistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "ownerID":
...
func (_q *UserSettingHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[usersettinghistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, usersettinghistory.FieldUpdatedByImpersonator)
				fieldSeen[usersettinghistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
...
// CollectFields tells the query-builder to eagerly load connected nodes by resolver context.
func (_q *VendorRiskScoreHistoryQuery) CollectFields(ctx context.Context, satisfies ...string) (*VendorRiskScoreHistoryQuery, error) {
	fc := graphql.GetFieldContext(ctx)
	if fc == nil {
		return _q, nil
	}
...
func (_q *VendorRiskScoreHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
		fieldSeen      = make(map[string]struct{}, len(vendorriskscorehistory.Columns))
		selectedFields = []string{vendorriskscorehistory.FieldID}
	)
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		switch field.Name {
		case "historyTime":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldHistoryTime]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldHistoryTime)
				fieldSeen[vendorriskscorehistory.FieldHistoryTime] = struct{}{}
			}
		case "ref":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldRef]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldRef)
				fieldSeen[vendorriskscorehistory.FieldRef] = struct{}{}
			}
		case "operation":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldOperation]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldOperation)
				fieldSeen[vendorriskscorehistory.FieldOperation] = struct{}{}
			}
		case "createdAt":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldCreatedAt]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldCreatedAt)
				fieldSeen[vendorriskscorehistory.FieldCreatedAt] = struct{}{}
			}
		case "updatedAt":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldUpdatedAt]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldUpdatedAt)
				fieldSeen[vendorriskscorehistory.FieldUpdatedAt] = struct{}{}
			}
		case "createdBy":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldCreatedBy]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldCreatedBy)
				fieldSeen[vendorriskscorehistory.FieldCreatedBy] = struct{}{}
			}
		case "updatedBy":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldUpdatedBy]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldUpdatedBy)
				fieldSeen[vendorriskscorehistory.FieldUpdatedBy] = struct{}{}
			}
		case "updatedByImpersonator":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldUpdatedByImpersonator)
				fieldSeen[vendorriskscorehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldTags]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldTags)
				fieldSeen[vendorriskscorehistory.FieldTags] = struct{}{}
			}
		case "ownerID":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldOwnerID]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldOwnerID)
				fieldSeen[vendorriskscorehistory.FieldOwnerID] = struct{}{}
			}
		case "questionKey":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldQuestionKey]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldQuestionKey)
				fieldSeen[vendorriskscorehistory.FieldQuestionKey] = struct{}{}
			}
		case "questionName":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldQuestionName]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldQuestionName)
				fieldSeen[vendorriskscorehistory.FieldQuestionName] = struct{}{}
			}
		case "questionDescription":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldQuestionDescription]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldQuestionDescription)
				fieldSeen[vendorriskscorehistory.FieldQuestionDescription] = struct{}{}
			}
		case "questionCategory":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldQuestionCategory]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldQuestionCategory)
				fieldSeen[vendorriskscorehistory.FieldQuestionCategory] = struct{}{}
			}
		case "answerType":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldAnswerType]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldAnswerType)
				fieldSeen[vendorriskscorehistory.FieldAnswerType] = struct{}{}
			}
		case "impact":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldImpact]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldImpact)
				fieldSeen[vendorriskscorehistory.FieldImpact] = struct{}{}
			}
		case "likelihood":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldLikelihood]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldLikelihood)
				fieldSeen[vendorriskscorehistory.FieldLikelihood] = struct{}{}
			}
		case "score":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldScore]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldScore)
				fieldSeen[vendorriskscorehistory.FieldScore] = struct{}{}
			}
		case "answer":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldAnswer]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldAnswer)
				fieldSeen[vendorriskscorehistory.FieldAnswer] = struct{}{}
			}
		case "notes":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldNotes]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldNotes)
				fieldSeen[vendorriskscorehistory.FieldNotes] = struct{}{}
			}
		case "vendorScoringConfigID":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldVendorScoringConfigID]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldVendorScoringConfigID)
				fieldSeen[vendorriskscorehistory.FieldVendorScoringConfigID] = struct{}{}
			}
		case "entityID":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldEntityID]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldEntityID)
				fieldSeen[vendorriskscorehistory.FieldEntityID] = struct{}{}
			}
		case "assessmentResponseID":
			if _, ok := fieldSeen[vendorriskscorehistory.FieldAssessmentResponseID]; !ok {
				selectedFields = append(selectedFields, vendorriskscorehistory.FieldAssessmentResponseID)
				fieldSeen[vendorriskscorehistory.FieldAssessmentResponseID] = struct{}{}
			}
		case "id":
		case "__typename":
		default:
...
type vendorriskscorehistoryPaginateArgs struct {
	first, last   *int
	after, before *Cursor
	opts          []VendorRiskScoreHistoryPaginateOption
}

func newVendorRiskScoreHistoryPaginateArgs(rv map[string]any) *vendorriskscorehistoryPaginateArgs {
	args := &vendorriskscorehistoryPaginateArgs{}
	if rv == nil {
		return args
	}
	if v := rv[firstField]; v != nil {
	...
	if v, ok := rv[orderByField]; ok {
		...
		case map[string]any:
			var (
				err1, err2 error
				order      = &VendorRiskScoreHistoryOrder{Field: &VendorRiskScoreHistoryOrderField{}, Direction: entgql.OrderDirectionAsc}
			)
			if d, ok := v[directionField]; ok {
				err1 = order.Direction.UnmarshalGQL(d)
			}
			...
			if err1 == nil && err2 == nil {
				args.opts = append(args.opts, WithVendorRiskScoreHistoryOrder(order))
			}
		case *VendorRiskScoreHistoryOrder:
			if v != nil {
				args.opts = append(args.opts, WithVendorRiskScoreHistoryOrder(v))
			}
		}
	}
	if v, ok := rv[whereField].(*VendorRiskScoreHistoryWhereInput); ok {
		args.opts = append(args.opts, WithVendorRiskScoreHistoryFilter(v.Filter))
	}
	return args
}

// CollectFields tells the query-builder to eagerly load connected nodes by resolver context.
func (_q *VendorScoringConfigHistoryQuery) CollectFields(ctx context.Context, satisfies ...string) (*VendorScoringConfigHistoryQuery, error) {
	fc := graphql.GetFieldContext(ctx)
	if fc == nil {
		return _q, nil
	}
...
func (_q *VendorScoringConfigHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	path = append([]string(nil), path...)
	var (
		unknownSeen    bool
		fieldSeen      = make(map[string]struct{}, len(vendorscoringconfighistory.Columns))
		selectedFields = []string{vendorscoringconfighistory.FieldID}
	)
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		switch field.Name {
		case "historyTime":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldHistoryTime]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldHistoryTime)
				fieldSeen[vendorscoringconfighistory.FieldHistoryTime] = struct{}{}
			}
		case "ref":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldRef]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldRef)
				fieldSeen[vendorscoringconfighistory.FieldRef] = struct{}{}
			}
		case "operation":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldOperation]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldOperation)
				fieldSeen[vendorscoringconfighistory.FieldOperation] = struct{}{}
			}
		case "createdAt":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldCreatedAt]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldCreatedAt)
				fieldSeen[vendorscoringconfighistory.FieldCreatedAt] = struct{}{}
			}
		case "updatedAt":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldUpdatedAt]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldUpdatedAt)
				fieldSeen[vendorscoringconfighistory.FieldUpdatedAt] = struct{}{}
			}
		case "createdBy":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldCreatedBy]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldCreatedBy)
				fieldSeen[vendorscoringconfighistory.FieldCreatedBy] = struct{}{}
			}
		case "updatedBy":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldUpdatedBy]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldUpdatedBy)
				fieldSeen[vendorscoringconfighistory.FieldUpdatedBy] = struct{}{}
			}
		case "updatedByImpersonator":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldUpdatedByImpersonator)
				fieldSeen[vendorscoringconfighistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "tags":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldTags]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldTags)
				fieldSeen[vendorscoringconfighistory.FieldTags] = struct{}{}
			}
		case "ownerID":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldOwnerID]; !ok {
				selectedFields = append(selectedFields, vendorscoringconfighistory.FieldOwnerID)
				fieldSeen[vendorscoringconfighistory.FieldOwnerID] = struct{}{}
			}
		case "questions":
			if _, ok := fieldSeen[vendorscoringconfighistory.FieldQuestions]; !ok {
...
type vendorscoringconfighistoryPaginateArgs struct {
	first, last   *int
	after, before *Cursor
	opts          []VendorScoringConfigHistoryPaginateOption
}

func newVendorScoringConfigHistoryPaginateArgs(rv map[string]any) *vendorscoringconfighistoryPaginateArgs {
	args := &vendorscoringconfighistoryPaginateArgs{}
	if rv == nil {
		return args
	}
	if v := rv[firstField]; v != nil {
	...
	if v, ok := rv[orderByField]; ok {
		...
		case map[string]any:
			var (
				err1, err2 error
				order      = &VendorScoringConfigHistoryOrder{Field: &VendorScoringConfigHistoryOrderField{}, Direction: entgql.OrderDirectionAsc}
			)
			if d, ok := v[directionField]; ok {
				err1 = order.Direction.UnmarshalGQL(d)
			}
			...
			if err1 == nil && err2 == nil {
				args.opts = append(args.opts, WithVendorScoringConfigHistoryOrder(order))
			}
		case *VendorScoringConfigHistoryOrder:
			if v != nil {
				args.opts = append(args.opts, WithVendorScoringConfigHistoryOrder(v))
			}
		}
	}
	if v, ok := rv[whereField].(*VendorScoringConfigHistoryWhereInput); ok {
		args.opts = append(args.opts, WithVendorScoringConfigHistoryFilter(v.Filter))
	}
	return args
}
...
func (_q *VulnerabilityHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldUpdatedByImpersonator)
				fieldSeen[vulnerabilityhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
		...
		case "cweIds":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldCweIds]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldCweIds)
				fieldSeen[vulnerabilityhistory.FieldCweIds] = struct{}{}
			}
		case "vulnerableVersionRange":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldVulnerableVersionRange]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldVulnerableVersionRange)
				fieldSeen[vulnerabilityhistory.FieldVulnerableVersionRange] = struct{}{}
			}
		case "firstPatchedVersion":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldFirstPatchedVersion]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldFirstPatchedVersion)
				fieldSeen[vulnerabilityhistory.FieldFirstPatchedVersion] = struct{}{}
			}
		case "fixAvailable":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldFixAvailable]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldFixAvailable)
				fieldSeen[vulnerabilityhistory.FieldFixAvailable] = struct{}{}
			}
		case "packageName":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldPackageName]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldPackageName)
				fieldSeen[vulnerabilityhistory.FieldPackageName] = struct{}{}
			}
		case "packageEcosystem":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldPackageEcosystem]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldPackageEcosystem)
				fieldSeen[vulnerabilityhistory.FieldPackageEcosystem] = struct{}{}
			}
		case "manifestPath":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldManifestPath]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldManifestPath)
				fieldSeen[vulnerabilityhistory.FieldManifestPath] = struct{}{}
			}
		case "dependencyScope":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldDependencyScope]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldDependencyScope)
				fieldSeen[vulnerabilityhistory.FieldDependencyScope] = struct{}{}
			}
		case "publishedAt":
		...
		case "dismissedAt":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldDismissedAt]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldDismissedAt)
				fieldSeen[vulnerabilityhistory.FieldDismissedAt] = struct{}{}
			}
		case "dismissedReason":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldDismissedReason]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldDismissedReason)
				fieldSeen[vulnerabilityhistory.FieldDismissedReason] = struct{}{}
			}
		case "dismissedComment":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldDismissedComment]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldDismissedComment)
				fieldSeen[vulnerabilityhistory.FieldDismissedComment] = struct{}{}
			}
		case "fixedAt":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldFixedAt]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldFixedAt)
				fieldSeen[vulnerabilityhistory.FieldFixedAt] = struct{}{}
			}
		case "autoDismissedAt":
			if _, ok := fieldSeen[vulnerabilityhistory.FieldAutoDismissedAt]; !ok {
				selectedFields = append(selectedFields, vulnerabilityhistory.FieldAutoDismissedAt)
				fieldSeen[vulnerabilityhistory.FieldAutoDismissedAt] = struct{}{}
			}
		case "externalURI":
...
func (_q *WorkflowAssignmentHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[workflowassignmenthistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, workflowassignmenthistory.FieldUpdatedByImpersonator)
				fieldSeen[workflowassignmenthistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *WorkflowAssignmentTargetHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[workflowassignmenttargethistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, workflowassignmenttargethistory.FieldUpdatedByImpersonator)
				fieldSeen[workflowassignmenttargethistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *WorkflowDefinitionHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[workflowdefinitionhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, workflowdefinitionhistory.FieldUpdatedByImpersonator)
				fieldSeen[workflowdefinitionhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *WorkflowEventHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[workfloweventhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, workfloweventhistory.FieldUpdatedByImpersonator)
				fieldSeen[workfloweventhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *WorkflowInstanceHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[workflowinstancehistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, workflowinstancehistory.FieldUpdatedByImpersonator)
				fieldSeen[workflowinstancehistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
...
func (_q *WorkflowObjectRefHistoryQuery) collectField(ctx context.Context, oneNode bool, opCtx *graphql.OperationContext, collected graphql.CollectedField, path []string, satisfies ...string) error {
	...
	for _, field := range graphql.CollectFields(opCtx, collected.Selections, satisfies) {
		...
		case "updatedByImpersonator":
			if _, ok := fieldSeen[workflowobjectrefhistory.FieldUpdatedByImpersonator]; !ok {
				selectedFields = append(selectedFields, workflowobjectrefhistory.FieldUpdatedByImpersonator)
				fieldSeen[workflowobjectrefhistory.FieldUpdatedByImpersonator] = struct{}{}
			}
		case "displayID":
