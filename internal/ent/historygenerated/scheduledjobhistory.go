...
func (*ScheduledJobHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case scheduledjobhistory.FieldID, scheduledjobhistory.FieldRef, scheduledjobhistory.FieldCreatedBy, scheduledjobhistory.FieldUpdatedBy, scheduledjobhistory.FieldUpdatedByImpersonator, scheduledjobhistory.FieldDeletedBy, scheduledjobhistory.FieldDisplayID, scheduledjobhistory.FieldOwnerID, scheduledjobhistory.FieldJobID, scheduledjobhistory.FieldJobRunnerID:
...
func (_m *ScheduledJobHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case scheduledjobhistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (_m *ScheduledJobHistory) Unwrap() *ScheduledJobHistory {
	...
	if !ok {
		panic("historygenerated: ScheduledJobHistory is not a transactional entity")
	}
