...
type (
	hooks struct {
		...
		EmailTemplateHistory, EntityHistory, EntityTypeHistory, EvidenceHistory,
		FileHistory, FindingControlHistory, FindingHistory, GroupHistory,
		GroupMembershipHistory, GroupSettingHistory, HushHistory,
