...
func init() {
	...
	vulnerabilityhistoryDescOpen := vulnerabilityhistoryFields[40].Descriptor()
	...
	vulnerabilityhistoryDescBlocking := vulnerabilityhistoryFields[41].Descriptor()
	...
	vulnerabilityhistoryDescReferences := vulnerabilityhistoryFields[45].Descriptor()
	...
	vulnerabilityhistoryDescImpacts := vulnerabilityhistoryFields[46].Descriptor()
