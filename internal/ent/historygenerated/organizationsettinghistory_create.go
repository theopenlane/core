...
func (_c *OrganizationSettingHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if organizationsettinghistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationsettinghistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if organizationsettinghistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationsettinghistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if organizationsettinghistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationsettinghistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if organizationsettinghistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized organizationsettinghistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *OrganizationSettingHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "OrganizationSettingHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "OrganizationSettingHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := organizationsettinghistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "OrganizationSettingHistory.operation": %w`, err)}
		}
	}
	...
	if _, ok := _c.mutation.BillingNotificationsEnabled(); !ok {
		return &ValidationError{Name: "billing_notifications_enabled", err: errors.New(`historygenerated: missing required field "OrganizationSettingHistory.billing_notifications_enabled"`)}
	}
	...
	if _, ok := _c.mutation.IdentityProviderAuthTested(); !ok {
		return &ValidationError{Name: "identity_provider_auth_tested", err: errors.New(`historygenerated: missing required field "OrganizationSettingHistory.identity_provider_auth_tested"`)}
	}
	if _, ok := _c.mutation.IdentityProviderLoginEnforced(); !ok {
