...
func (_c *SubcontrolHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if subcontrolhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized subcontrolhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if subcontrolhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized subcontrolhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if subcontrolhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized subcontrolhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if subcontrolhistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized subcontrolhistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *SubcontrolHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "SubcontrolHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "SubcontrolHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := subcontrolhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "SubcontrolHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DisplayID(); !ok {
		return &ValidationError{Name: "display_id", err: errors.New(`historygenerated: missing required field "SubcontrolHistory.display_id"`)}
	}
	...
	if _, ok := _c.mutation.RefCode(); !ok {
		return &ValidationError{Name: "ref_code", err: errors.New(`historygenerated: missing required field "SubcontrolHistory.ref_code"`)}
	}
	if _, ok := _c.mutation.ControlID(); !ok {
		return &ValidationError{Name: "control_id", err: errors.New(`historygenerated: missing required field "SubcontrolHistory.control_id"`)}
	}
	return nil
}
