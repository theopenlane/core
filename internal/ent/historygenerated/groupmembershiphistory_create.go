...
func (_c *GroupMembershipHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if groupmembershiphistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized groupmembershiphistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if groupmembershiphistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized groupmembershiphistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if groupmembershiphistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized groupmembershiphistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if groupmembershiphistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized groupmembershiphistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *GroupMembershipHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "GroupMembershipHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "GroupMembershipHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := groupmembershiphistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "GroupMembershipHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Role(); !ok {
		return &ValidationError{Name: "role", err: errors.New(`historygenerated: missing required field "GroupMembershipHistory.role"`)}
	}
	...
	if _, ok := _c.mutation.GroupID(); !ok {
		return &ValidationError{Name: "group_id", err: errors.New(`historygenerated: missing required field "GroupMembershipHistory.group_id"`)}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`historygenerated: missing required field "GroupMembershipHistory.user_id"`)}
	}
	return nil
}
