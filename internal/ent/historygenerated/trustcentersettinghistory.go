...
func (_m *TrustCenterSettingHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case trustcentersettinghistory.FieldCompanyName:
			if value, ok := values[i].(*sql.NullString); !ok {
