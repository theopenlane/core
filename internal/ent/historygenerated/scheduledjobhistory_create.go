...
func (_c *ScheduledJobHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if scheduledjobhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized scheduledjobhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if scheduledjobhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized scheduledjobhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if scheduledjobhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized scheduledjobhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if scheduledjobhistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized scheduledjobhistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *ScheduledJobHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "ScheduledJobHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "ScheduledJobHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := scheduledjobhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "ScheduledJobHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DisplayID(); !ok {
		return &ValidationError{Name: "display_id", err: errors.New(`historygenerated: missing required field "ScheduledJobHistory.display_id"`)}
	}
	if _, ok := _c.mutation.JobID(); !ok {
		return &ValidationError{Name: "job_id", err: errors.New(`historygenerated: missing required field "ScheduledJobHistory.job_id"`)}
	}
	if _, ok := _c.mutation.Active(); !ok {
		return &ValidationError{Name: "active", err: errors.New(`historygenerated: missing required field "ScheduledJobHistory.active"`)}
	}
	if v, ok := _c.mutation.Cron(); ok {
		if err := v.Validate(); err != nil {
			return &ValidationError{Name: "cron", err: fmt.Errorf(`historygenerated: validator failed for field "ScheduledJobHistory.cron": %w`, err)}
		}
	}
	return nil
}
