...
func (*OrgSubscriptionHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case orgsubscriptionhistory.FieldID, orgsubscriptionhistory.FieldRef, orgsubscriptionhistory.FieldCreatedBy, orgsubscriptionhistory.FieldUpdatedBy, orgsubscriptionhistory.FieldUpdatedByImpersonator, orgsubscriptionhistory.FieldDeletedBy, orgsubscriptionhistory.FieldOwnerID, orgsubscriptionhistory.FieldStripeSubscriptionID, orgsubscriptionhistory.FieldStripeSubscriptionStatus, orgsubscriptionhistory.FieldDaysUntilDue:
...
func (_m *OrgSubscriptionHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case orgsubscriptionhistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (_m *OrgSubscriptionHistory) Unwrap() *OrgSubscriptionHistory {
	...
	if !ok {
		panic("historygenerated: OrgSubscriptionHistory is not a transactional entity")
	}
