...
func (_c *DNSVerificationHistoryCreate) SetUpdatedByImpersonator(v string) *DNSVerificationHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *DNSVerificationHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *DNSVerificationHistoryCreate {
	if v != nil {
