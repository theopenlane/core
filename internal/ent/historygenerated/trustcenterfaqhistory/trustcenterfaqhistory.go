...
const (
	// Label holds the string label denoting the trustcenterfaqhistory type in the database.
	Label = "trust_center_faq_history"
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("trustcenterfaqhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the TrustCenterFAQHistory queries.
