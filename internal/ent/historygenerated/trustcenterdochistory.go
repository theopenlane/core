...
func (_m *TrustCenterDocHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case trustcenterdochistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
