...
func (_c *ProgramHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if programhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized programhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if programhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized programhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if programhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized programhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if programhistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized programhistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *ProgramHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "ProgramHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "ProgramHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := programhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "ProgramHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DisplayID(); !ok {
		return &ValidationError{Name: "display_id", err: errors.New(`historygenerated: missing required field "ProgramHistory.display_id"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "ProgramHistory.name"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`historygenerated: missing required field "ProgramHistory.status"`)}
	}
	...
	if _, ok := _c.mutation.AuditorReady(); !ok {
		return &ValidationError{Name: "auditor_ready", err: errors.New(`historygenerated: missing required field "ProgramHistory.auditor_ready"`)}
	}
	if _, ok := _c.mutation.AuditorWriteComments(); !ok {
		return &ValidationError{Name: "auditor_write_comments", err: errors.New(`historygenerated: missing required field "ProgramHistory.auditor_write_comments"`)}
	}
	if _, ok := _c.mutation.AuditorReadComments(); !ok {
		return &ValidationError{Name: "auditor_read_comments", err: errors.New(`historygenerated: missing required field "ProgramHistory.auditor_read_comments"`)}
	}
	return nil
}
