...
func (*UserSettingHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usersettinghistory.FieldID, usersettinghistory.FieldRef, usersettinghistory.FieldCreatedBy, usersettinghistory.FieldUpdatedBy, usersettinghistory.FieldUpdatedByImpersonator, usersettinghistory.FieldDeletedBy, usersettinghistory.FieldUserID, usersettinghistory.FieldDelegateUserID, usersettinghistory.FieldStatus, usersettinghistory.FieldPhoneNumber:
...
func (_m *UserSettingHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usersettinghistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
