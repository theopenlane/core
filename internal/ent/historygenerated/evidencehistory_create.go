...
func (_c *EvidenceHistoryCreate) SetNextReviewAt(v models.DateTime) *EvidenceHistoryCreate {
	_c.mutation.SetNextReviewAt(v)
	return _c
}

// SetNillableNextReviewAt sets the "next_review_at" field if the given value is not nil.
func (_c *EvidenceHistoryCreate) SetNillableNextReviewAt(v *models.DateTime) *EvidenceHistoryCreate {
	if v != nil {
...
func (_c *EvidenceHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if evidencehistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized evidencehistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if evidencehistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized evidencehistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if evidencehistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized evidencehistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
...
func (_c *EvidenceHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "EvidenceHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "EvidenceHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := evidencehistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "EvidenceHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DisplayID(); !ok {
		return &ValidationError{Name: "display_id", err: errors.New(`historygenerated: missing required field "EvidenceHistory.display_id"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "EvidenceHistory.name"`)}
	}
	if _, ok := _c.mutation.CreationDate(); !ok {
		return &ValidationError{Name: "creation_date", err: errors.New(`historygenerated: missing required field "EvidenceHistory.creation_date"`)}
	}
