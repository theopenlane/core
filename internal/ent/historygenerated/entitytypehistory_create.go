...
func (_c *EntityTypeHistoryCreate) SetUpdatedByImpersonator(v string) *EntityTypeHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *EntityTypeHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *EntityTypeHistoryCreate {
	if v != nil {
...
func (_c *EntityTypeHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if entitytypehistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized entitytypehistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if entitytypehistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized entitytypehistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if entitytypehistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized entitytypehistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if entitytypehistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized entitytypehistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *EntityTypeHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "EntityTypeHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "EntityTypeHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := entitytypehistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "EntityTypeHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "EntityTypeHistory.name"`)}
	}
	return nil
}
