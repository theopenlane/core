...
func (_u *InternalPolicyHistoryUpdate) SetDetailsJSON(v []interface{}) *InternalPolicyHistoryUpdate {
	_u.mutation.SetDetailsJSON(v)
	return _u
}

// AppendDetailsJSON appends value to the "details_json" field.
func (_u *InternalPolicyHistoryUpdate) AppendDetailsJSON(v []interface{}) *InternalPolicyHistoryUpdate {
	_u.mutation.AppendDetailsJSON(v)
	return _u
}

// ClearDetailsJSON clears the value of the "details_json" field.
func (_u *InternalPolicyHistoryUpdate) ClearDetailsJSON() *InternalPolicyHistoryUpdate {
...
func (_u *InternalPolicyHistoryUpdate) SetNillableWorkflowEligibleMarker(v *bool) *InternalPolicyHistoryUpdate {
	if v != nil {
...
func (_u *InternalPolicyHistoryUpdate) ClearWorkflowEligibleMarker() *InternalPolicyHistoryUpdate {
...
func (_u *InternalPolicyHistoryUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok && !_u.mutation.UpdatedAtCleared() {
		if internalpolicyhistory.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized internalpolicyhistory.UpdateDefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
...
func (_u *InternalPolicyHistoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AppendedDetailsJSON(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, internalpolicyhistory.FieldDetailsJSON, value)
		})
	}
...
// SetDetailsJSON sets the "details_json" field.
func (_u *InternalPolicyHistoryUpdateOne) SetDetailsJSON(v []interface{}) *InternalPolicyHistoryUpdateOne {
	_u.mutation.SetDetailsJSON(v)
	return _u
}

// AppendDetailsJSON appends value to the "details_json" field.
func (_u *InternalPolicyHistoryUpdateOne) AppendDetailsJSON(v []interface{}) *InternalPolicyHistoryUpdateOne {
	_u.mutation.AppendDetailsJSON(v)
	return _u
}

// ClearDetailsJSON clears the value of the "details_json" field.
func (_u *InternalPolicyHistoryUpdateOne) ClearDetailsJSON() *InternalPolicyHistoryUpdateOne {
	_u.mutation.ClearDetailsJSON()
	return _u
}
...
// SetNillableWorkflowEligibleMarker sets the "workflow_eligible_marker" field if the given value is not nil.
func (_u *InternalPolicyHistoryUpdateOne) SetNillableWorkflowEligibleMarker(v *bool) *InternalPolicyHistoryUpdateOne {
	if v != nil {
		_u.SetWorkflowEligibleMarker(*v)
	}
	return _u
...
// ClearWorkflowEligibleMarker clears the value of the "workflow_eligible_marker" field.
func (_u *InternalPolicyHistoryUpdateOne) ClearWorkflowEligibleMarker() *InternalPolicyHistoryUpdateOne {
	_u.mutation.ClearWorkflowEligibleMarker()
	return _u
}
