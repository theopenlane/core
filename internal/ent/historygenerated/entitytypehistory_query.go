...
func (_q *EntityTypeHistoryQuery) prepareQuery(ctx context.Context) error {
	...
	if entitytypehistory.Policy == nil {
		return errors.New("historygenerated: uninitialized entitytypehistory.Policy (forgotten import historygenerated/runtime?)")
	}
...
func (ethq *EntityTypeHistoryQuery) CountIDs(ctx context.Context) (int, error) {
	...
	if err != nil {
		logx.ErrorEvent(ctx, err).Str("query_type", "EntityTypeHistory").Str("operation", "count_ids").Msg("CountIDs: IDs() failed")
