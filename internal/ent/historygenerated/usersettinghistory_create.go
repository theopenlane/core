...
func (_c *UserSettingHistoryCreate) SetUpdatedByImpersonator(v string) *UserSettingHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *UserSettingHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *UserSettingHistoryCreate {
	if v != nil {
...
func (_c *UserSettingHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if usersettinghistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized usersettinghistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if usersettinghistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized usersettinghistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if usersettinghistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized usersettinghistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if usersettinghistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized usersettinghistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *UserSettingHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "UserSettingHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "UserSettingHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := usersettinghistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "UserSettingHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Locked(); !ok {
		return &ValidationError{Name: "locked", err: errors.New(`historygenerated: missing required field "UserSettingHistory.locked"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`historygenerated: missing required field "UserSettingHistory.status"`)}
	}
	...
	if _, ok := _c.mutation.EmailConfirmed(); !ok {
		return &ValidationError{Name: "email_confirmed", err: errors.New(`historygenerated: missing required field "UserSettingHistory.email_confirmed"`)}
	}
	return nil
}
...
func (_c *UserSettingHistoryCreate) createSpec() (*UserSettingHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(usersettinghistory.FieldUpdatedByImpersonator, field.TypeString, value)
