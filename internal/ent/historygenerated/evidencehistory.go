...
func (_m *EvidenceHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case evidencehistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
