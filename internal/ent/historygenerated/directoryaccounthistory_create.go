...
func (_c *DirectoryAccountHistoryCreate) SetUpdatedByImpersonator(v string) *DirectoryAccountHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *DirectoryAccountHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *DirectoryAccountHistoryCreate {
	if v != nil {
...
func (_c *DirectoryAccountHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if directoryaccounthistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized directoryaccounthistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if directoryaccounthistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized directoryaccounthistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if directoryaccounthistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized directoryaccounthistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ObservedAt(); !ok {
		if directoryaccounthistory.DefaultObservedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized directoryaccounthistory.DefaultObservedAt (forgotten import historygenerated/runtime?)")
		}
...
func (_c *DirectoryAccountHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "DirectoryAccountHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "DirectoryAccountHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := directoryaccounthistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "DirectoryAccountHistory.operation": %w`, err)}
		}
	}
	...
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`historygenerated: missing required field "DirectoryAccountHistory.status"`)}
	}
	...
	if _, ok := _c.mutation.MfaState(); !ok {
		return &ValidationError{Name: "mfa_state", err: errors.New(`historygenerated: missing required field "DirectoryAccountHistory.mfa_state"`)}
	}
	...
	if _, ok := _c.mutation.ObservedAt(); !ok {
		return &ValidationError{Name: "observed_at", err: errors.New(`historygenerated: missing required field "DirectoryAccountHistory.observed_at"`)}
	}
	if _, ok := _c.mutation.ProfileHash(); !ok {
