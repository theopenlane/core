...
func (_c *MappableDomainHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if mappabledomainhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized mappabledomainhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if mappabledomainhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized mappabledomainhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if mappabledomainhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized mappabledomainhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if mappabledomainhistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized mappabledomainhistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *MappableDomainHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "MappableDomainHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "MappableDomainHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := mappabledomainhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "MappableDomainHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "MappableDomainHistory.name"`)}
	}
	if _, ok := _c.mutation.ZoneID(); !ok {
		return &ValidationError{Name: "zone_id", err: errors.New(`historygenerated: missing required field "MappableDomainHistory.zone_id"`)}
	}
	return nil
}
