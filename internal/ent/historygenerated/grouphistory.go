...
func (*GroupHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case grouphistory.FieldID, grouphistory.FieldRef, grouphistory.FieldCreatedBy, grouphistory.FieldUpdatedBy, grouphistory.FieldUpdatedByImpersonator, grouphistory.FieldDeletedBy, grouphistory.FieldDisplayID, grouphistory.FieldOwnerID, grouphistory.FieldName, grouphistory.FieldDescription, grouphistory.FieldGravatarLogoURL, grouphistory.FieldLogoURL, grouphistory.FieldAvatarLocalFileID, grouphistory.FieldDisplayName, grouphistory.FieldOscalRole, grouphistory.FieldOscalPartyUUID, grouphistory.FieldScimExternalID, grouphistory.FieldScimDisplayName, grouphistory.FieldScimGroupMailing:
...
func (_m *GroupHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case grouphistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (_m *GroupHistory) Unwrap() *GroupHistory {
	...
	if !ok {
		panic("historygenerated: GroupHistory is not a transactional entity")
	}
