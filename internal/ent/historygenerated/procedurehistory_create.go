...
func (_c *ProcedureHistoryCreate) SetUpdatedByImpersonator(v string) *ProcedureHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *ProcedureHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *ProcedureHistoryCreate {
	if v != nil {
...
func (_c *ProcedureHistoryCreate) SetIntegrationRunID(v string) *ProcedureHistoryCreate {
...
func (_c *ProcedureHistoryCreate) SetNillableIntegrationRunID(v *string) *ProcedureHistoryCreate {
	if v != nil {
...
func (_c *ProcedureHistoryCreate) SetEnvironmentName(v string) *ProcedureHistoryCreate {
	_c.mutation.SetEnvironmentName(v)
	return _c
}

// SetNillableEnvironmentName sets the "environment_name" field if the given value is not nil.
func (_c *ProcedureHistoryCreate) SetNillableEnvironmentName(v *string) *ProcedureHistoryCreate {
	if v != nil {
...
func (_c *ProcedureHistoryCreate) SetEnvironmentID(v string) *ProcedureHistoryCreate {
	_c.mutation.SetEnvironmentID(v)
	return _c
}

// SetNillableEnvironmentID sets the "environment_id" field if the given value is not nil.
func (_c *ProcedureHistoryCreate) SetNillableEnvironmentID(v *string) *ProcedureHistoryCreate {
	if v != nil {
...
func (_c *ProcedureHistoryCreate) SetScopeName(v string) *ProcedureHistoryCreate {
	_c.mutation.SetScopeName(v)
	return _c
}

// SetNillableScopeName sets the "scope_name" field if the given value is not nil.
func (_c *ProcedureHistoryCreate) SetNillableScopeName(v *string) *ProcedureHistoryCreate {
	if v != nil {
		_c.SetScopeName(*v)
	}
	return _c
...
func (_c *ProcedureHistoryCreate) SetScopeID(v string) *ProcedureHistoryCreate {
	_c.mutation.SetScopeID(v)
	return _c
}

// SetNillableScopeID sets the "scope_id" field if the given value is not nil.
func (_c *ProcedureHistoryCreate) SetNillableScopeID(v *string) *ProcedureHistoryCreate {
	if v != nil {
		_c.SetScopeID(*v)
	}
	return _c
...
func (_c *ProcedureHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if procedurehistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized procedurehistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if procedurehistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized procedurehistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if procedurehistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized procedurehistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if procedurehistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized procedurehistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *ProcedureHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "ProcedureHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "ProcedureHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := procedurehistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "ProcedureHistory.operation": %w`, err)}
		}
	}
	if _, ok := _c.mutation.DisplayID(); !ok {
		return &ValidationError{Name: "display_id", err: errors.New(`historygenerated: missing required field "ProcedureHistory.display_id"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`historygenerated: missing required field "ProcedureHistory.name"`)}
	}
...
func (_c *ProcedureHistoryCreate) createSpec() (*ProcedureHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.IntegrationRunID(); ok {
		_spec.SetField(procedurehistory.FieldIntegrationRunID, field.TypeString, value)
