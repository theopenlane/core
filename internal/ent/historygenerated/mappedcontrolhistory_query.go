...
func (_q *MappedControlHistoryQuery) prepareQuery(ctx context.Context) error {
	...
	if mappedcontrolhistory.Policy == nil {
		return errors.New("historygenerated: uninitialized mappedcontrolhistory.Policy (forgotten import historygenerated/runtime?)")
	}
...
func (mchq *MappedControlHistoryQuery) CountIDs(ctx context.Context) (int, error) {
	...
	if err != nil {
		logx.ErrorEvent(ctx, err).Str("query_type", "MappedControlHistory").Str("operation", "count_ids").Msg("CountIDs: IDs() failed")
