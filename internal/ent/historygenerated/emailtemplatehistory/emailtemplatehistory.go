...
const (
	// Label holds the string label denoting the emailtemplatehistory type in the database.
	Label = "email_template_history"
...
// Columns holds all SQL columns for emailtemplatehistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("emailtemplatehistory: invalid enum value for operation field: %q", o)
	}
}
...
func FormatValidator(f enums.NotificationTemplateFormat) error {
	...
	case "TEXT", "MARKDOWN", "HTML", "JSON":
		return nil
	default:
		return fmt.Errorf("emailtemplatehistory: invalid enum value for format field: %q", f)
	}
}
...
func TemplateContextValidator(tc enums.TemplateContext) error {
	...
	case "CAMPAIGN_RECIPIENT", "TRANSACTIONAL", "WORKFLOW_ACTION":
		return nil
	default:
		return fmt.Errorf("emailtemplatehistory: invalid enum value for template_context field: %q", tc)
	}
}

// OrderOption defines the ordering options for the EmailTemplateHistory queries.
