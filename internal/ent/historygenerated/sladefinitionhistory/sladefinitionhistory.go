...
const (
	// Label holds the string label denoting the sladefinitionhistory type in the database.
	Label = "sla_definition_history"
...
// Columns holds all SQL columns for sladefinitionhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
// OrderOption defines the ordering options for the SLADefinitionHistory queries.
