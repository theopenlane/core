...
func (*MappableDomainHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case mappabledomainhistory.FieldID, mappabledomainhistory.FieldRef, mappabledomainhistory.FieldCreatedBy, mappabledomainhistory.FieldUpdatedBy, mappabledomainhistory.FieldUpdatedByImpersonator, mappabledomainhistory.FieldDeletedBy, mappabledomainhistory.FieldName, mappabledomainhistory.FieldZoneID:
...
func (_m *MappableDomainHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case mappabledomainhistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (_m *MappableDomainHistory) Unwrap() *MappableDomainHistory {
	...
	if !ok {
		panic("historygenerated: MappableDomainHistory is not a transactional entity")
	}
