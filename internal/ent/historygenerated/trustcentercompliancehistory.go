...
func (_m *TrustCenterComplianceHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case trustcentercompliancehistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (_m *TrustCenterComplianceHistory) Unwrap() *TrustCenterComplianceHistory {
	...
	if !ok {
		panic("historygenerated: TrustCenterComplianceHistory is not a transactional entity")
	}
