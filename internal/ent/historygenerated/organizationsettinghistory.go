...
func (*OrganizationSettingHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case organizationsettinghistory.FieldTags, organizationsettinghistory.FieldDomains, organizationsettinghistory.FieldBillingAddress, organizationsettinghistory.FieldAllowedEmailDomains, organizationsettinghistory.FieldJitAllowedEmailDomains, organizationsettinghistory.FieldSSOExemptDomains:
			values[i] = new([]byte)
...
func (_m *OrganizationSettingHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case organizationsettinghistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case organizationsettinghistory.FieldJitAllowedEmailDomains:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case organizationsettinghistory.FieldSSOExemptDomains:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case organizationsettinghistory.FieldAllowSupportAccess:
			if value, ok := values[i].(*sql.NullBool); !ok {
...
func (_m *OrganizationSettingHistory) Unwrap() *OrganizationSettingHistory {
	...
	if !ok {
		panic("historygenerated: OrganizationSettingHistory is not a transactional entity")
	}
