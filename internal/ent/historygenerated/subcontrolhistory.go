...
func (_m *SubcontrolHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case subcontrolhistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case subcontrolhistory.FieldDescriptionJSON:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case subcontrolhistory.FieldPublicRepresentation:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case subcontrolhistory.FieldSourceName:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case subcontrolhistory.FieldWorkflowEligibleMarker:
			if value, ok := values[i].(*sql.NullBool); !ok {
...
func (_m *SubcontrolHistory) Unwrap() *SubcontrolHistory {
	...
	if !ok {
		panic("historygenerated: SubcontrolHistory is not a transactional entity")
	}
