...
func (*TrustCenterEntityHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case trustcenterentityhistory.FieldID, trustcenterentityhistory.FieldRef, trustcenterentityhistory.FieldCreatedBy, trustcenterentityhistory.FieldUpdatedBy, trustcenterentityhistory.FieldUpdatedByImpersonator, trustcenterentityhistory.FieldDeletedBy, trustcenterentityhistory.FieldLogoFileID, trustcenterentityhistory.FieldURL, trustcenterentityhistory.FieldTrustCenterID, trustcenterentityhistory.FieldName, trustcenterentityhistory.FieldEntityTypeID:
...
func (_m *TrustCenterEntityHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case trustcenterentityhistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
