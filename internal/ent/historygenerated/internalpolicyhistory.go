...
func (_m *InternalPolicyHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case internalpolicyhistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case internalpolicyhistory.FieldDetailsJSON:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case internalpolicyhistory.FieldExternalFileID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case internalpolicyhistory.FieldExternalContents:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (_m *InternalPolicyHistory) Unwrap() *InternalPolicyHistory {
	...
	if !ok {
		panic("historygenerated: InternalPolicyHistory is not a transactional entity")
	}
