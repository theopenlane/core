...
func (_c *FileHistoryCreate) SetUpdatedByImpersonator(v string) *FileHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *FileHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *FileHistoryCreate {
	if v != nil {
...
func (_c *FileHistoryCreate) SetBackupState(v models.FileBackupState) *FileHistoryCreate {
	_c.mutation.SetBackupState(v)
	return _c
}

// SetNillableBackupState sets the "backup_state" field if the given value is not nil.
func (_c *FileHistoryCreate) SetNillableBackupState(v *models.FileBackupState) *FileHistoryCreate {
	if v != nil {
		_c.SetBackupState(*v)
	}
	return _c
...
func (_c *FileHistoryCreate) createSpec() (*FileHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(filehistory.FieldUpdatedByImpersonator, field.TypeString, value)
