...
func (_c *ControlImplementationHistoryCreate) SetUpdatedByImpersonator(v string) *ControlImplementationHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *ControlImplementationHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *ControlImplementationHistoryCreate {
	if v != nil {
...
func (_c *ControlImplementationHistoryCreate) SetDetailsJSON(v []interface{}) *ControlImplementationHistoryCreate {
...
func (_c *ControlImplementationHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if controlimplementationhistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized controlimplementationhistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if controlimplementationhistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized controlimplementationhistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if controlimplementationhistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized controlimplementationhistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if controlimplementationhistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized controlimplementationhistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *ControlImplementationHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "ControlImplementationHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "ControlImplementationHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := controlimplementationhistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "ControlImplementationHistory.operation": %w`, err)}
		}
	}
