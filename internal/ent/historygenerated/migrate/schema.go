...
var (
	...
	CampaignHistoryTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{CampaignHistoryColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "campaignhistory_history_time",
				Unique:  false,
				Columns: []*schema.Column{CampaignHistoryColumns[1]},
			},
		},
	}
	// CampaignTargetHistoryColumns holds the columns for the "campaign_target_history" table.
	CampaignTargetHistoryColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString},
		{Name: "history_time", Type: field.TypeTime},
		{Name: "ref", Type: field.TypeString, Nullable: true},
		{Name: "operation", Type: field.TypeEnum, Enums: []string{"INSERT", "UPDATE", "DELETE"}},
	...
	// CampaignTargetHistoryTable holds the schema information for the "campaign_target_history" table.
	CampaignTargetHistoryTable = &schema.Table{
		Name:       "campaign_target_history",
		Columns:    CampaignTargetHistoryColumns,
		PrimaryKey: []*schema.Column{CampaignTargetHistoryColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "campaigntargethistory_history_time",
				Unique:  false,
				Columns: []*schema.Column{CampaignTargetHistoryColumns[1]},
			},
		},
	}
	...
	// IdentityHolderHistoryColumns holds the columns for the "identity_holder_history" table.
	IdentityHolderHistoryColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString},
		{Name: "history_time", Type: field.TypeTime},
		{Name: "ref", Type: field.TypeString, Nullable: true},
		{Name: "operation", Type: field.TypeEnum, Enums: []string{"INSERT", "UPDATE", "DELETE"}},
	...
	IdentityHolderHistoryTable = &schema.Table{
		Name:       "identity_holder_history",
		Columns:    IdentityHolderHistoryColumns,
		PrimaryKey: []*schema.Column{IdentityHolderHistoryColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "identityholderhistory_history_time",
				Unique:  false,
				Columns: []*schema.Column{IdentityHolderHistoryColumns[1]},
			},
		},
	}
	...
	// PlatformHistoryColumns holds the columns for the "platform_history" table.
	PlatformHistoryColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString},
		{Name: "history_time", Type: field.TypeTime},
		{Name: "ref", Type: field.TypeString, Nullable: true},
		{Name: "operation", Type: field.TypeEnum, Enums: []string{"INSERT", "UPDATE", "DELETE"}},
	...
	// PlatformHistoryTable holds the schema information for the "platform_history" table.
	PlatformHistoryTable = &schema.Table{
		Name:       "platform_history",
		Columns:    PlatformHistoryColumns,
		PrimaryKey: []*schema.Column{PlatformHistoryColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "platformhistory_history_time",
				Unique:  false,
				Columns: []*schema.Column{PlatformHistoryColumns[1]},
			},
		},
	}
...
func init() {
	...
	IdentityHolderHistoryTable.Annotation = &entsql.Annotation{
	...
	PlatformHistoryTable.Annotation = &entsql.Annotation{
