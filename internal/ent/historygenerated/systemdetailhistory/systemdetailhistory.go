...
const (
	// Label holds the string label denoting the systemdetailhistory type in the database.
	Label = "system_detail_history"
	...
	// Table holds the table name of the systemdetailhistory in the database.
	Table = "system_detail_history"
)

// Columns holds all SQL columns for systemdetailhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("systemdetailhistory: invalid enum value for operation field: %q", o)
	}
}
...
func SensitivityLevelValidator(sl enums.SystemSensitivityLevel) error {
	...
	case "LOW", "MODERATE", "HIGH", "UNKNOWN":
		return nil
	default:
		return fmt.Errorf("systemdetailhistory: invalid enum value for sensitivity_level field: %q", sl)
	}
}

// OrderOption defines the ordering options for the SystemDetailHistory queries.
