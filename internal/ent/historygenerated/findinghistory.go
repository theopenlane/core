...
func (_m *FindingHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case findinghistory.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
