...
func (_c *TrustCenterDocHistoryCreate) SetUpdatedByImpersonator(v string) *TrustCenterDocHistoryCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *TrustCenterDocHistoryCreate) SetNillableUpdatedByImpersonator(v *string) *TrustCenterDocHistoryCreate {
	if v != nil {
...
func (_c *TrustCenterDocHistoryCreate) defaults() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		if trustcenterdochistory.DefaultHistoryTime == nil {
			return fmt.Errorf("historygenerated: uninitialized trustcenterdochistory.DefaultHistoryTime (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		if trustcenterdochistory.DefaultCreatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized trustcenterdochistory.DefaultCreatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		if trustcenterdochistory.DefaultUpdatedAt == nil {
			return fmt.Errorf("historygenerated: uninitialized trustcenterdochistory.DefaultUpdatedAt (forgotten import historygenerated/runtime?)")
		}
	...
	if _, ok := _c.mutation.ID(); !ok {
		if trustcenterdochistory.DefaultID == nil {
			return fmt.Errorf("historygenerated: uninitialized trustcenterdochistory.DefaultID (forgotten import historygenerated/runtime?)")
		}
...
func (_c *TrustCenterDocHistoryCreate) check() error {
	if _, ok := _c.mutation.HistoryTime(); !ok {
		return &ValidationError{Name: "history_time", err: errors.New(`historygenerated: missing required field "TrustCenterDocHistory.history_time"`)}
	}
	if _, ok := _c.mutation.Operation(); !ok {
		return &ValidationError{Name: "operation", err: errors.New(`historygenerated: missing required field "TrustCenterDocHistory.operation"`)}
	}
	if v, ok := _c.mutation.Operation(); ok {
		if err := trustcenterdochistory.OperationValidator(v); err != nil {
			return &ValidationError{Name: "operation", err: fmt.Errorf(`historygenerated: validator failed for field "TrustCenterDocHistory.operation": %w`, err)}
		}
	}
