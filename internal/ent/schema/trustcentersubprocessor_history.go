...
func (TrustCenterSubprocessorHistory) Annotations() []schema.Annotation {
...
func (TrustCenterSubprocessorHistory) Fields() []ent.Field {
	...
	mixins := TrustCenterSubprocessor{}.Mixin()
	...
	original := TrustCenterSubprocessor{}
...
func (TrustCenterSubprocessorHistory) Indexes() []ent.Index {
	return []ent.Index{
...
func (TrustCenterSubprocessorHistory) Interceptors() []ent.Interceptor {
