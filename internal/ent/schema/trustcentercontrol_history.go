...
// TrustCenterControlHistory holds the schema definition for the TrustCenterControlHistory entity.
type TrustCenterControlHistory struct {
	ent.Schema
}

// Annotations of the TrustCenterControlHistory.
func (TrustCenterControlHistory) Annotations() []schema.Annotation {
...
// Fields of the TrustCenterControlHistory.
func (TrustCenterControlHistory) Fields() []ent.Field {
	...
	mixins := TrustCenterControl{}.Mixin()
...
// Indexes of the TrustCenterControlHistory
func (TrustCenterControlHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the TrustCenterControlHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (TrustCenterControlHistory) Policy() ent.Policy {
...
// Interceptors of the TrustCenterControlHistory
func (TrustCenterControlHistory) Interceptors() []ent.Interceptor {
