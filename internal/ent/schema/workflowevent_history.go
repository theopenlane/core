...
// Annotations of the WorkflowEventHistory.
func (WorkflowEventHistory) Annotations() []schema.Annotation {
...
// Fields of the WorkflowEventHistory.
func (WorkflowEventHistory) Fields() []ent.Field {
...
// Indexes of the WorkflowEventHistory
func (WorkflowEventHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the WorkflowEventHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (WorkflowEventHistory) Policy() ent.Policy {
