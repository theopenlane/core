...
// UsageHistory holds the schema definition for the UsageHistory entity.
type UsageHistory struct {
	ent.Schema
}

// Annotations of the UsageHistory.
func (UsageHistory) Annotations() []schema.Annotation {
...
// Fields of the UsageHistory.
func (UsageHistory) Fields() []ent.Field {
...
// Indexes of the UsageHistory
func (UsageHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the UsageHistory
func (UsageHistory) Interceptors() []ent.Interceptor {
