...
// ImpersonationEventHistory holds the schema definition for the ImpersonationEventHistory entity.
type ImpersonationEventHistory struct {
	ent.Schema
}

// Annotations of the ImpersonationEventHistory.
func (ImpersonationEventHistory) Annotations() []schema.Annotation {
...
// Fields of the ImpersonationEventHistory.
func (ImpersonationEventHistory) Fields() []ent.Field {
	...
	mixins := ImpersonationEvent{}.Mixin()
...
// Indexes of the ImpersonationEventHistory
func (ImpersonationEventHistory) Indexes() []ent.Index {
	return []ent.Index{
