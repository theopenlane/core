...
// WorkflowInstanceHistory holds the schema definition for the WorkflowInstanceHistory entity.
type WorkflowInstanceHistory struct {
	ent.Schema
}

// Annotations of the WorkflowInstanceHistory.
func (WorkflowInstanceHistory) Annotations() []schema.Annotation {
...
// Fields of the WorkflowInstanceHistory.
func (WorkflowInstanceHistory) Fields() []ent.Field {
...
// Indexes of the WorkflowInstanceHistory
func (WorkflowInstanceHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the WorkflowInstanceHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (WorkflowInstanceHistory) Policy() ent.Policy {
...
// Interceptors of the WorkflowInstanceHistory
func (WorkflowInstanceHistory) Interceptors() []ent.Interceptor {
