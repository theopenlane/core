...
// JobRunnerHistory holds the schema definition for the JobRunnerHistory entity.
type JobRunnerHistory struct {
	ent.Schema
}

// Annotations of the JobRunnerHistory.
func (JobRunnerHistory) Annotations() []schema.Annotation {
...
// Fields of the JobRunnerHistory.
func (JobRunnerHistory) Fields() []ent.Field {
...
// Indexes of the JobRunnerHistory
func (JobRunnerHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the JobRunnerHistory
func (JobRunnerHistory) Interceptors() []ent.Interceptor {
