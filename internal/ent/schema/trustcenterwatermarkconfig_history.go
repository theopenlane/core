...
func (TrustCenterWatermarkConfigHistory) Annotations() []schema.Annotation {
...
func (TrustCenterWatermarkConfigHistory) Fields() []ent.Field {
	...
	mixins := TrustCenterWatermarkConfig{}.Mixin()
	...
	original := TrustCenterWatermarkConfig{}
...
func (TrustCenterWatermarkConfigHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the TrustCenterWatermarkConfigHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (TrustCenterWatermarkConfigHistory) Policy() ent.Policy {
