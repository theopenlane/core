...
// ExportHistory holds the schema definition for the ExportHistory entity.
type ExportHistory struct {
	ent.Schema
}

// Annotations of the ExportHistory.
func (ExportHistory) Annotations() []schema.Annotation {
...
// Fields of the ExportHistory.
func (ExportHistory) Fields() []ent.Field {
...
// Indexes of the ExportHistory
func (ExportHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Interceptors of the ExportHistory
func (ExportHistory) Interceptors() []ent.Interceptor {
