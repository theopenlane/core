...
func (TrustCenterComplianceHistory) Annotations() []schema.Annotation {
...
func (TrustCenterComplianceHistory) Fields() []ent.Field {
	...
	mixins := TrustCenterCompliance{}.Mixin()
	...
	original := TrustCenterCompliance{}
...
func (TrustCenterComplianceHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the TrustCenterComplianceHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (TrustCenterComplianceHistory) Policy() ent.Policy {
