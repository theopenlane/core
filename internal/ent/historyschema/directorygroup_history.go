...
// DirectoryGroupHistory holds the schema definition for the DirectoryGroupHistory entity.
type DirectoryGroupHistory struct {
	ent.Schema
}

// Annotations of the DirectoryGroupHistory.
func (DirectoryGroupHistory) Annotations() []entschema.Annotation {
...
// Fields of the DirectoryGroupHistory.
func (DirectoryGroupHistory) Fields() []ent.Field {
	...
	mixins := schema.DirectoryGroup{}.Mixin()
	...
	original := schema.DirectoryGroup{}
...
// Indexes of the DirectoryGroupHistory
func (DirectoryGroupHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the DirectoryGroupHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (DirectoryGroupHistory) Policy() ent.Policy {
...
// Interceptors of the DirectoryGroupHistory
func (DirectoryGroupHistory) Interceptors() []ent.Interceptor {
