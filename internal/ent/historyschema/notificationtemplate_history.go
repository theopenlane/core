...
// NotificationTemplateHistory holds the schema definition for the NotificationTemplateHistory entity.
type NotificationTemplateHistory struct {
	ent.Schema
}

// Annotations of the NotificationTemplateHistory.
func (NotificationTemplateHistory) Annotations() []entschema.Annotation {
...
// Fields of the NotificationTemplateHistory.
func (NotificationTemplateHistory) Fields() []ent.Field {
	...
	mixins := schema.NotificationTemplate{}.Mixin()
	...
	original := schema.NotificationTemplate{}
...
// Indexes of the NotificationTemplateHistory
func (NotificationTemplateHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the NotificationTemplateHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (NotificationTemplateHistory) Policy() ent.Policy {
...
// Interceptors of the NotificationTemplateHistory
func (NotificationTemplateHistory) Interceptors() []ent.Interceptor {
