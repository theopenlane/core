...
// TrustCenterNDARequestHistory holds the schema definition for the TrustCenterNDARequestHistory entity.
type TrustCenterNDARequestHistory struct {
	ent.Schema
}

// Annotations of the TrustCenterNDARequestHistory.
func (TrustCenterNDARequestHistory) Annotations() []entschema.Annotation {
...
// Fields of the TrustCenterNDARequestHistory.
func (TrustCenterNDARequestHistory) Fields() []ent.Field {
	...
	mixins := schema.TrustCenterNDARequest{}.Mixin()
	...
	original := schema.TrustCenterNDARequest{}
...
// Indexes of the TrustCenterNDARequestHistory
func (TrustCenterNDARequestHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the TrustCenterNDARequestHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (TrustCenterNDARequestHistory) Policy() ent.Policy {
