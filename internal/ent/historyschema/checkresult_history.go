...
// CheckResultHistory holds the schema definition for the CheckResultHistory entity.
type CheckResultHistory struct {
	ent.Schema
}

// Annotations of the CheckResultHistory.
func (CheckResultHistory) Annotations() []entschema.Annotation {
...
// Fields of the CheckResultHistory.
func (CheckResultHistory) Fields() []ent.Field {
	...
	mixins := schema.CheckResult{}.Mixin()
...
// Indexes of the CheckResultHistory
func (CheckResultHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the CheckResultHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (CheckResultHistory) Policy() ent.Policy {
...
// Interceptors of the CheckResultHistory
func (CheckResultHistory) Interceptors() []ent.Interceptor {
