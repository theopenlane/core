...
// DiscussionHistory holds the schema definition for the DiscussionHistory entity.
type DiscussionHistory struct {
	ent.Schema
}

// Annotations of the DiscussionHistory.
func (DiscussionHistory) Annotations() []entschema.Annotation {
...
// Fields of the DiscussionHistory.
func (DiscussionHistory) Fields() []ent.Field {
	...
	mixins := schema.Discussion{}.Mixin()
...
// Indexes of the DiscussionHistory
func (DiscussionHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the DiscussionHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (DiscussionHistory) Policy() ent.Policy {
...
// Interceptors of the DiscussionHistory
func (DiscussionHistory) Interceptors() []ent.Interceptor {
