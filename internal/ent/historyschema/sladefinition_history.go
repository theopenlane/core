...
// SLADefinitionHistory holds the schema definition for the SLADefinitionHistory entity.
type SLADefinitionHistory struct {
	ent.Schema
}

// Annotations of the SLADefinitionHistory.
func (SLADefinitionHistory) Annotations() []entschema.Annotation {
...
// Fields of the SLADefinitionHistory.
func (SLADefinitionHistory) Fields() []ent.Field {
	...
	mixins := schema.SLADefinition{}.Mixin()
...
// Indexes of the SLADefinitionHistory
func (SLADefinitionHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the SLADefinitionHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (SLADefinitionHistory) Policy() ent.Policy {
...
// Interceptors of the SLADefinitionHistory
func (SLADefinitionHistory) Interceptors() []ent.Interceptor {
