...
func (TrustCenterSubprocessorHistory) Annotations() []entschema.Annotation {
...
func (TrustCenterSubprocessorHistory) Fields() []ent.Field {
	...
	mixins := schema.TrustCenterSubprocessor{}.Mixin()
	...
	original := schema.TrustCenterSubprocessor{}
