...
// EmailTemplateHistory holds the schema definition for the EmailTemplateHistory entity.
type EmailTemplateHistory struct {
	ent.Schema
}

// Annotations of the EmailTemplateHistory.
func (EmailTemplateHistory) Annotations() []entschema.Annotation {
...
// Fields of the EmailTemplateHistory.
func (EmailTemplateHistory) Fields() []ent.Field {
	...
	mixins := schema.EmailTemplate{}.Mixin()
...
// Indexes of the EmailTemplateHistory
func (EmailTemplateHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the EmailTemplateHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (EmailTemplateHistory) Policy() ent.Policy {
...
// Interceptors of the EmailTemplateHistory
func (EmailTemplateHistory) Interceptors() []ent.Interceptor {
