...
// WorkflowAssignmentTargetHistory holds the schema definition for the WorkflowAssignmentTargetHistory entity.
type WorkflowAssignmentTargetHistory struct {
	ent.Schema
}

// Annotations of the WorkflowAssignmentTargetHistory.
func (WorkflowAssignmentTargetHistory) Annotations() []entschema.Annotation {
...
// Fields of the WorkflowAssignmentTargetHistory.
func (WorkflowAssignmentTargetHistory) Fields() []ent.Field {
	...
	mixins := schema.WorkflowAssignmentTarget{}.Mixin()
	...
	original := schema.WorkflowAssignmentTarget{}
...
// Indexes of the WorkflowAssignmentTargetHistory
func (WorkflowAssignmentTargetHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the WorkflowAssignmentTargetHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (WorkflowAssignmentTargetHistory) Policy() ent.Policy {
...
// Interceptors of the WorkflowAssignmentTargetHistory
func (WorkflowAssignmentTargetHistory) Interceptors() []ent.Interceptor {
