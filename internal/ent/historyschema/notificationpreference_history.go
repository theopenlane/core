...
// NotificationPreferenceHistory holds the schema definition for the NotificationPreferenceHistory entity.
type NotificationPreferenceHistory struct {
	ent.Schema
}

// Annotations of the NotificationPreferenceHistory.
func (NotificationPreferenceHistory) Annotations() []entschema.Annotation {
...
// Fields of the NotificationPreferenceHistory.
func (NotificationPreferenceHistory) Fields() []ent.Field {
	...
	mixins := schema.NotificationPreference{}.Mixin()
	...
	original := schema.NotificationPreference{}
...
// Indexes of the NotificationPreferenceHistory
func (NotificationPreferenceHistory) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("history_time"),
	}
}

// Policy of the NotificationPreferenceHistory.
// ensure history.AllowIfHistoryRequest() is already added to the base policy
func (NotificationPreferenceHistory) Policy() ent.Policy {
...
// Interceptors of the NotificationPreferenceHistory
func (NotificationPreferenceHistory) Interceptors() []ent.Interceptor {
