...
// InterceptorRequireFeatureProgram ensures the organization has the given
// feature enabled before executing the query
func InterceptorRequireFeatureProgram(feature string) ent.Interceptor {
	return InterceptorRequireAnyFeatureProgram(feature)
}

// InterceptorRequireAnyFeatureProgram ensures the organization has at least one of the
// provided features enabled before executing the query
