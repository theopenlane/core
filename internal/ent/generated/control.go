...
func (e ControlEdges) CreatedByUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ControlEdges) UpdatedByUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ControlEdges) CreatedByServiceOrErr() (*APIToken, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ControlEdges) UpdatedByServiceOrErr() (*APIToken, error) {
...
func (*Control) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case control.FieldTags, control.FieldDetails:
			values[i] = new([]byte)
		case control.FieldID, control.FieldCreatedByID, control.FieldUpdatedByID, control.FieldCreatedByUserID, control.FieldUpdatedByUserID, control.FieldCreatedByServiceID, control.FieldUpdatedByServiceID, control.FieldDeletedByID, control.FieldMappingID, control.FieldOwnerID, control.FieldName, control.FieldDescription, control.FieldStatus, control.FieldControlType, control.FieldVersion, control.FieldControlNumber, control.FieldFamily, control.FieldClass, control.FieldSource, control.FieldSatisfies, control.FieldMappedFrameworks:
...
// QueryCreatedByUser queries the "created_by_user" edge of the Control entity.
func (c *Control) QueryCreatedByUser() *UserQuery {
	return NewControlClient(c.config).QueryCreatedByUser(c)
}

// QueryUpdatedByUser queries the "updated_by_user" edge of the Control entity.
func (c *Control) QueryUpdatedByUser() *UserQuery {
	return NewControlClient(c.config).QueryUpdatedByUser(c)
}

// QueryCreatedByService queries the "created_by_service" edge of the Control entity.
func (c *Control) QueryCreatedByService() *APITokenQuery {
	return NewControlClient(c.config).QueryCreatedByService(c)
}

// QueryUpdatedByService queries the "updated_by_service" edge of the Control entity.
func (c *Control) QueryUpdatedByService() *APITokenQuery {
	return NewControlClient(c.config).QueryUpdatedByService(c)
}
...
func (c *Control) String() string {
	...
	builder.WriteString(c.CreatedByUserID)
	builder.WriteString(", ")
	builder.WriteString("updated_by_user_id=")
	builder.WriteString(c.UpdatedByUserID)
	builder.WriteString(", ")
	builder.WriteString("created_by_service_id=")
	builder.WriteString(c.CreatedByServiceID)
	builder.WriteString(", ")
	builder.WriteString("updated_by_service_id=")
	builder.WriteString(c.UpdatedByServiceID)
	builder.WriteString(", ")
