...
func (e ControlEdges) CreatedByOrErr() (*User, error) {
	if e.CreatedBy != nil {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ControlEdges) UpdatedByOrErr() (*User, error) {
	if e.UpdatedBy != nil {
