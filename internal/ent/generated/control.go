...
func (_m *Control) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case control.FieldExternalUUID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case control.FieldImplementationStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case control.FieldImplementationDescription:
			if value, ok := values[i].(*sql.NullString); !ok {
...
// QueryEnvironment queries the "environment" edge of the Control entity.
func (_m *Control) QueryEnvironment() *CustomTypeEnumQuery {
	return NewControlClient(_m.config).QueryEnvironment(_m)
}

// QueryScope queries the "scope" edge of the Control entity.
func (_m *Control) QueryScope() *CustomTypeEnumQuery {
	return NewControlClient(_m.config).QueryScope(_m)
}
...
// QueryIdentityHolders queries the "identity_holders" edge of the Control entity.
func (_m *Control) QueryIdentityHolders() *IdentityHolderQuery {
	return NewControlClient(_m.config).QueryIdentityHolders(_m)
}
...
// loaded in eager-loading with this name.
func (_m *Control) NamedPlatforms(name string) ([]*Platform, error) {
...
func (_m *Control) appendNamedPlatforms(name string, edges ...*Platform) {
	if _m.Edges.namedPlatforms == nil {
...
func (_m *Control) appendNamedEntities(name string, edges ...*Entity) {
	if _m.Edges.namedEntities == nil {
...
// loaded in eager-loading with this name.
func (_m *Control) NamedIdentityHolders(name string) ([]*IdentityHolder, error) {
...
func (_m *Control) appendNamedIdentityHolders(name string, edges ...*IdentityHolder) {
	if _m.Edges.namedIdentityHolders == nil {
...
// loaded in eager-loading with this name.
func (_m *Control) NamedCampaigns(name string) ([]*Campaign, error) {
...
func (_m *Control) appendNamedCampaigns(name string, edges ...*Campaign) {
	if _m.Edges.namedCampaigns == nil {
