...
func (e ControlEdges) CreatedByOrErr() (*ChangeActor, error) {
	if e.CreatedBy != nil {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e ControlEdges) UpdatedByOrErr() (*ChangeActor, error) {
	if e.UpdatedBy != nil {
...
// QueryCreatedBy queries the "created_by" edge of the Control entity.
func (c *Control) QueryCreatedBy() *ChangeActorQuery {
	return NewControlClient(c.config).QueryCreatedBy(c)
}

// QueryUpdatedBy queries the "updated_by" edge of the Control entity.
func (c *Control) QueryUpdatedBy() *ChangeActorQuery {
	return NewControlClient(c.config).QueryUpdatedBy(c)
}
