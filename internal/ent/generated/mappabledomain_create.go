...
func (_c *MappableDomainCreate) SetUpdatedByImpersonator(v string) *MappableDomainCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *MappableDomainCreate) SetNillableUpdatedByImpersonator(v *string) *MappableDomainCreate {
	if v != nil {
