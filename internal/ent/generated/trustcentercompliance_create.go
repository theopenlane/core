...
func (_c *TrustCenterComplianceCreate) SetUpdatedByImpersonator(v string) *TrustCenterComplianceCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *TrustCenterComplianceCreate) SetNillableUpdatedByImpersonator(v *string) *TrustCenterComplianceCreate {
	if v != nil {
...
func (_c *TrustCenterComplianceCreate) AddBlockedGroupIDs(ids ...string) *TrustCenterComplianceCreate {
	_c.mutation.AddBlockedGroupIDs(ids...)
	return _c
}

// AddBlockedGroups adds the "blocked_groups" edges to the Group entity.
func (_c *TrustCenterComplianceCreate) AddBlockedGroups(v ...*Group) *TrustCenterComplianceCreate {
...
func (_c *TrustCenterComplianceCreate) AddEditorIDs(ids ...string) *TrustCenterComplianceCreate {
	_c.mutation.AddEditorIDs(ids...)
	return _c
}

// AddEditors adds the "editors" edges to the Group entity.
func (_c *TrustCenterComplianceCreate) AddEditors(v ...*Group) *TrustCenterComplianceCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TrustCenterComplianceCreate) createSpec() (*TrustCenterCompliance, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(trustcentercompliance.FieldUpdatedByImpersonator, field.TypeString, value)
