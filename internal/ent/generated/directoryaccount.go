...
func (e DirectoryAccountEdges) IntegrationRunsOrErr() ([]*IntegrationRun, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e DirectoryAccountEdges) EnvironmentOrErr() (*CustomTypeEnum, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e DirectoryAccountEdges) ScopeOrErr() (*CustomTypeEnum, error) {
	if e.Scope != nil {
		return e.Scope, nil
...
func (_m *DirectoryAccount) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case directoryaccount.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case directoryaccount.FieldEnvironmentID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field environment_id", values[i])
			} else if value.Valid {
				_m.EnvironmentID = value.String
			}
		case directoryaccount.FieldScopeName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field scope_name", values[i])
			} else if value.Valid {
				_m.ScopeName = value.String
			}
		case directoryaccount.FieldScopeID:
			if value, ok := values[i].(*sql.NullString); !ok {
...
// QueryIntegrationRuns queries the "integration_runs" edge of the DirectoryAccount entity.
func (_m *DirectoryAccount) QueryIntegrationRuns() *IntegrationRunQuery {
	return NewDirectoryAccountClient(_m.config).QueryIntegrationRuns(_m)
}
...
// QueryEnvironment queries the "environment" edge of the DirectoryAccount entity.
func (_m *DirectoryAccount) QueryEnvironment() *CustomTypeEnumQuery {
	return NewDirectoryAccountClient(_m.config).QueryEnvironment(_m)
}

// QueryScope queries the "scope" edge of the DirectoryAccount entity.
func (_m *DirectoryAccount) QueryScope() *CustomTypeEnumQuery {
	return NewDirectoryAccountClient(_m.config).QueryScope(_m)
}
...
func (_m *DirectoryAccount) NamedIntegrationRuns(name string) ([]*IntegrationRun, error) {
...
func (_m *DirectoryAccount) appendNamedIntegrationRuns(name string, edges ...*IntegrationRun) {
	if _m.Edges.namedIntegrationRuns == nil {
