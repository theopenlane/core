...
func (_u *WorkflowDefinitionHistoryUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok && !_u.mutation.UpdatedAtCleared() {
		if workflowdefinitionhistory.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized workflowdefinitionhistory.UpdateDefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (_u *WorkflowDefinitionHistoryUpdateOne) sqlSave(ctx context.Context) (_node *WorkflowDefinitionHistory, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "WorkflowDefinitionHistory.id" for update`)}
	}
