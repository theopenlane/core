...
const (
	// Label holds the string label denoting the impersonationeventhistory type in the database.
	Label = "impersonation_event_history"
	...
	// Table holds the table name of the impersonationeventhistory in the database.
	Table = "impersonation_event_history"
)

// Columns holds all SQL columns for impersonationeventhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("impersonationeventhistory: invalid enum value for operation field: %q", o)
	}
}
...
func ImpersonationTypeValidator(it enums.ImpersonationType) error {
	...
	case "SUPPORT", "ADMIN", "JOB":
		return nil
	default:
		return fmt.Errorf("impersonationeventhistory: invalid enum value for impersonation_type field: %q", it)
	}
}
...
func ActionValidator(a enums.ImpersonationAction) error {
	...
	case "START", "STOP":
		return nil
	default:
		return fmt.Errorf("impersonationeventhistory: invalid enum value for action field: %q", a)
	}
}

// OrderOption defines the ordering options for the ImpersonationEventHistory queries.
