...
func UpdatedByImpersonator(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldEQ(FieldUpdatedByImpersonator, v))
}
...
func UpdatedByImpersonatorEQ(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldEQ(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorNEQ applies the NEQ predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorNEQ(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldNEQ(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorIn applies the In predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorIn(vs ...string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldIn(FieldUpdatedByImpersonator, vs...))
}

// UpdatedByImpersonatorNotIn applies the NotIn predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorNotIn(vs ...string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldNotIn(FieldUpdatedByImpersonator, vs...))
}

// UpdatedByImpersonatorGT applies the GT predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorGT(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldGT(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorGTE applies the GTE predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorGTE(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldGTE(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorLT applies the LT predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorLT(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldLT(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorLTE applies the LTE predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorLTE(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldLTE(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorContains applies the Contains predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorContains(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldContains(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorHasPrefix applies the HasPrefix predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorHasPrefix(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldHasPrefix(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorHasSuffix applies the HasSuffix predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorHasSuffix(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldHasSuffix(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorIsNil applies the IsNil predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorIsNil() predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldIsNull(FieldUpdatedByImpersonator))
}

// UpdatedByImpersonatorNotNil applies the NotNil predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorNotNil() predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldNotNull(FieldUpdatedByImpersonator))
}

// UpdatedByImpersonatorEqualFold applies the EqualFold predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorEqualFold(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldEqualFold(FieldUpdatedByImpersonator, v))
}

// UpdatedByImpersonatorContainsFold applies the ContainsFold predicate on the "updated_by_impersonator" field.
func UpdatedByImpersonatorContainsFold(v string) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(sql.FieldContainsFold(FieldUpdatedByImpersonator, v))
}
...
func HasBlockedGroups() predicate.TrustCenterCompliance {
...
func HasBlockedGroupsWith(preds ...predicate.Group) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(func(s *sql.Selector) {
...
func HasEditors() predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEditorsWith(preds ...predicate.Group) predicate.TrustCenterCompliance {
	return predicate.TrustCenterCompliance(func(s *sql.Selector) {
		step := newEditorsStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.Group
