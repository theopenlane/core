...
func (*TemplateHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case templatehistory.FieldID, templatehistory.FieldRef, templatehistory.FieldUpdatedBy, templatehistory.FieldCreatedByID, templatehistory.FieldUpdatedByID, templatehistory.FieldCreatedByUserID, templatehistory.FieldUpdatedByUserID, templatehistory.FieldCreatedByServiceID, templatehistory.FieldUpdatedByServiceID, templatehistory.FieldDeletedByID, templatehistory.FieldMappingID, templatehistory.FieldOwnerID, templatehistory.FieldName, templatehistory.FieldTemplateType, templatehistory.FieldDescription:
