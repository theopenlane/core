...
func (_u *DiscussionHistoryUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok && !_u.mutation.UpdatedAtCleared() {
		if discussionhistory.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized discussionhistory.UpdateDefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (_u *DiscussionHistoryUpdateOne) sqlSave(ctx context.Context) (_node *DiscussionHistory, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "DiscussionHistory.id" for update`)}
	}
