...
func (*JobResult) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case jobresult.FieldID, jobresult.FieldCreatedBy, jobresult.FieldUpdatedBy, jobresult.FieldUpdatedByImpersonator, jobresult.FieldDeletedBy, jobresult.FieldOwnerID, jobresult.FieldScheduledJobID, jobresult.FieldStatus, jobresult.FieldFileID, jobresult.FieldLog:
...
func (_m *JobResult) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case jobresult.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
