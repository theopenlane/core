...
const (
	// Label holds the string label denoting the integrationrecommendation type in the database.
	Label = "integration_recommendation"
	...
	EdgeOwner = "owner"
	// Table holds the table name of the integrationrecommendation in the database.
	Table = "integration_recommendations"
	// OwnerTable is the table that holds the owner relation/edge.
	OwnerTable = "integration_recommendations"
...
// Columns holds all SQL columns for integrationrecommendation fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	DefinitionIDValidator func(string) error
...
// OrderOption defines the ordering options for the IntegrationRecommendation queries.
