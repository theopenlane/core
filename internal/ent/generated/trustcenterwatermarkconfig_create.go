...
func (_c *TrustCenterWatermarkConfigCreate) AddBlockedGroupIDs(ids ...string) *TrustCenterWatermarkConfigCreate {
	_c.mutation.AddBlockedGroupIDs(ids...)
	return _c
}

// AddBlockedGroups adds the "blocked_groups" edges to the Group entity.
func (_c *TrustCenterWatermarkConfigCreate) AddBlockedGroups(v ...*Group) *TrustCenterWatermarkConfigCreate {
...
func (_c *TrustCenterWatermarkConfigCreate) AddEditorIDs(ids ...string) *TrustCenterWatermarkConfigCreate {
	_c.mutation.AddEditorIDs(ids...)
	return _c
}

// AddEditors adds the "editors" edges to the Group entity.
func (_c *TrustCenterWatermarkConfigCreate) AddEditors(v ...*Group) *TrustCenterWatermarkConfigCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
