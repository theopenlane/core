...
func (thu *TaskHistoryUpdate) SetOrganizationID(s string) *TaskHistoryUpdate {
	thu.mutation.SetOrganizationID(s)
	return thu
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (thu *TaskHistoryUpdate) SetNillableOrganizationID(s *string) *TaskHistoryUpdate {
	if s != nil {
		thu.SetOrganizationID(*s)
	}
	return thu
}

// ClearOrganizationID clears the value of the "organization_id" field.
func (thu *TaskHistoryUpdate) ClearOrganizationID() *TaskHistoryUpdate {
	thu.mutation.ClearOrganizationID()
	return thu
}

// SetGroupID sets the "group_id" field.
func (thu *TaskHistoryUpdate) SetGroupID(s string) *TaskHistoryUpdate {
	thu.mutation.SetGroupID(s)
	return thu
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (thu *TaskHistoryUpdate) SetNillableGroupID(s *string) *TaskHistoryUpdate {
	if s != nil {
		thu.SetGroupID(*s)
	}
	return thu
...
func (thu *TaskHistoryUpdate) ClearGroupID() *TaskHistoryUpdate {
	thu.mutation.ClearGroupID()
	return thu
}
...
func (thu *TaskHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := thu.mutation.OrganizationID(); ok {
		_spec.SetField(taskhistory.FieldOrganizationID, field.TypeString, value)
	}
	if thu.mutation.OrganizationIDCleared() {
		_spec.ClearField(taskhistory.FieldOrganizationID, field.TypeString)
	}
	if value, ok := thu.mutation.GroupID(); ok {
		_spec.SetField(taskhistory.FieldGroupID, field.TypeString, value)
	}
	if thu.mutation.GroupIDCleared() {
		_spec.ClearField(taskhistory.FieldGroupID, field.TypeString)
	}
...
// SetOrganizationID sets the "organization_id" field.
func (thuo *TaskHistoryUpdateOne) SetOrganizationID(s string) *TaskHistoryUpdateOne {
	thuo.mutation.SetOrganizationID(s)
	return thuo
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (thuo *TaskHistoryUpdateOne) SetNillableOrganizationID(s *string) *TaskHistoryUpdateOne {
	if s != nil {
		thuo.SetOrganizationID(*s)
	}
	return thuo
}

// ClearOrganizationID clears the value of the "organization_id" field.
func (thuo *TaskHistoryUpdateOne) ClearOrganizationID() *TaskHistoryUpdateOne {
	thuo.mutation.ClearOrganizationID()
	return thuo
}

// SetGroupID sets the "group_id" field.
func (thuo *TaskHistoryUpdateOne) SetGroupID(s string) *TaskHistoryUpdateOne {
	thuo.mutation.SetGroupID(s)
	return thuo
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (thuo *TaskHistoryUpdateOne) SetNillableGroupID(s *string) *TaskHistoryUpdateOne {
	if s != nil {
		thuo.SetGroupID(*s)
	}
	return thuo
...
// ClearGroupID clears the value of the "group_id" field.
func (thuo *TaskHistoryUpdateOne) ClearGroupID() *TaskHistoryUpdateOne {
	thuo.mutation.ClearGroupID()
	return thuo
}
...
func (thuo *TaskHistoryUpdateOne) sqlSave(ctx context.Context) (_node *TaskHistory, err error) {
	...
	if value, ok := thuo.mutation.OrganizationID(); ok {
		_spec.SetField(taskhistory.FieldOrganizationID, field.TypeString, value)
	}
	if thuo.mutation.OrganizationIDCleared() {
		_spec.ClearField(taskhistory.FieldOrganizationID, field.TypeString)
	}
	if value, ok := thuo.mutation.GroupID(); ok {
		_spec.SetField(taskhistory.FieldGroupID, field.TypeString, value)
	}
	if thuo.mutation.GroupIDCleared() {
		_spec.ClearField(taskhistory.FieldGroupID, field.TypeString)
	}
