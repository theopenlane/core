...
func (_c *CampaignCreate) SetTrustCenterID(v string) *CampaignCreate {
	_c.mutation.SetTrustCenterID(v)
	return _c
}

// SetNillableTrustCenterID sets the "trust_center_id" field if the given value is not nil.
func (_c *CampaignCreate) SetNillableTrustCenterID(v *string) *CampaignCreate {
	if v != nil {
...
func (_c *CampaignCreate) SetTrustCenter(v *TrustCenter) *CampaignCreate {
...
func (_c *CampaignCreate) AddControls(v ...*Control) *CampaignCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *CampaignCreate) createSpec() (*Campaign, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.AudiencesIDs(); len(nodes) > 0 {
		...
		edge.Schema = _c.schemaConfig.CampaignAudiences
		for _, k := range nodes {
			edge.Target.Nodes = append(edge.Target.Nodes, k)
		}
		_spec.Edges = append(_spec.Edges, edge)
