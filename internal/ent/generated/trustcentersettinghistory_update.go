...
func (tcshu *TrustCenterSettingHistoryUpdate) SetTags(s []string) *TrustCenterSettingHistoryUpdate {
	tcshu.mutation.SetTags(s)
	return tcshu
}

// AppendTags appends s to the "tags" field.
func (tcshu *TrustCenterSettingHistoryUpdate) AppendTags(s []string) *TrustCenterSettingHistoryUpdate {
	tcshu.mutation.AppendTags(s)
	return tcshu
}

// ClearTags clears the value of the "tags" field.
func (tcshu *TrustCenterSettingHistoryUpdate) ClearTags() *TrustCenterSettingHistoryUpdate {
	tcshu.mutation.ClearTags()
	return tcshu
}

// SetOwnerID sets the "owner_id" field.
func (tcshu *TrustCenterSettingHistoryUpdate) SetOwnerID(s string) *TrustCenterSettingHistoryUpdate {
	tcshu.mutation.SetOwnerID(s)
	return tcshu
}

// SetNillableOwnerID sets the "owner_id" field if the given value is not nil.
func (tcshu *TrustCenterSettingHistoryUpdate) SetNillableOwnerID(s *string) *TrustCenterSettingHistoryUpdate {
	if s != nil {
		tcshu.SetOwnerID(*s)
	}
	return tcshu
...
func (tcshu *TrustCenterSettingHistoryUpdate) ClearOwnerID() *TrustCenterSettingHistoryUpdate {
	tcshu.mutation.ClearOwnerID()
	return tcshu
}
...
func (tcshu *TrustCenterSettingHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tcshu.mutation.AppendedTags(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, trustcentersettinghistory.FieldTags, value)
		})
	}
	if tcshu.mutation.TagsCleared() {
		_spec.ClearField(trustcentersettinghistory.FieldTags, field.TypeJSON)
	}
	if value, ok := tcshu.mutation.OwnerID(); ok {
		_spec.SetField(trustcentersettinghistory.FieldOwnerID, field.TypeString, value)
	}
	if tcshu.mutation.OwnerIDCleared() {
		_spec.ClearField(trustcentersettinghistory.FieldOwnerID, field.TypeString)
	}
...
// SetTags sets the "tags" field.
func (tcshuo *TrustCenterSettingHistoryUpdateOne) SetTags(s []string) *TrustCenterSettingHistoryUpdateOne {
	tcshuo.mutation.SetTags(s)
	return tcshuo
}

// AppendTags appends s to the "tags" field.
func (tcshuo *TrustCenterSettingHistoryUpdateOne) AppendTags(s []string) *TrustCenterSettingHistoryUpdateOne {
	tcshuo.mutation.AppendTags(s)
	return tcshuo
}

// ClearTags clears the value of the "tags" field.
func (tcshuo *TrustCenterSettingHistoryUpdateOne) ClearTags() *TrustCenterSettingHistoryUpdateOne {
	tcshuo.mutation.ClearTags()
	return tcshuo
}

// SetOwnerID sets the "owner_id" field.
func (tcshuo *TrustCenterSettingHistoryUpdateOne) SetOwnerID(s string) *TrustCenterSettingHistoryUpdateOne {
	tcshuo.mutation.SetOwnerID(s)
	return tcshuo
}

// SetNillableOwnerID sets the "owner_id" field if the given value is not nil.
func (tcshuo *TrustCenterSettingHistoryUpdateOne) SetNillableOwnerID(s *string) *TrustCenterSettingHistoryUpdateOne {
	if s != nil {
		tcshuo.SetOwnerID(*s)
	}
	return tcshuo
...
// ClearOwnerID clears the value of the "owner_id" field.
func (tcshuo *TrustCenterSettingHistoryUpdateOne) ClearOwnerID() *TrustCenterSettingHistoryUpdateOne {
	tcshuo.mutation.ClearOwnerID()
	return tcshuo
}
...
func (tcshuo *TrustCenterSettingHistoryUpdateOne) sqlSave(ctx context.Context) (_node *TrustCenterSettingHistory, err error) {
	...
	if value, ok := tcshuo.mutation.OwnerID(); ok {
		_spec.SetField(trustcentersettinghistory.FieldOwnerID, field.TypeString, value)
	}
	if tcshuo.mutation.OwnerIDCleared() {
		_spec.ClearField(trustcentersettinghistory.FieldOwnerID, field.TypeString)
	}
