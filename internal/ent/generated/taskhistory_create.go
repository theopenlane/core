...
func (thc *TaskHistoryCreate) SetOrganizationID(s string) *TaskHistoryCreate {
	thc.mutation.SetOrganizationID(s)
	return thc
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (thc *TaskHistoryCreate) SetNillableOrganizationID(s *string) *TaskHistoryCreate {
	if s != nil {
		thc.SetOrganizationID(*s)
	}
	return thc
}

// SetGroupID sets the "group_id" field.
func (thc *TaskHistoryCreate) SetGroupID(s string) *TaskHistoryCreate {
	thc.mutation.SetGroupID(s)
	return thc
}

// SetNillableGroupID sets the "group_id" field if the given value is not nil.
func (thc *TaskHistoryCreate) SetNillableGroupID(s *string) *TaskHistoryCreate {
	if s != nil {
		thc.SetGroupID(*s)
	}
	return thc
...
func (thc *TaskHistoryCreate) createSpec() (*TaskHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := thc.mutation.OrganizationID(); ok {
		_spec.SetField(taskhistory.FieldOrganizationID, field.TypeString, value)
		_node.OrganizationID = value
	}
	if value, ok := thc.mutation.GroupID(); ok {
		_spec.SetField(taskhistory.FieldGroupID, field.TypeString, value)
		_node.GroupID = value
	}
