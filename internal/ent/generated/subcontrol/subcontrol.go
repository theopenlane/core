...
const (
	...
	EntitiesTable = "subcontrol_entities"
	...
	IdentityHoldersTable = "subcontrol_identity_holders"
	...
	VulnerabilitiesTable = "vulnerability_subcontrols"
	...
	FindingsTable = "finding_subcontrols"
...
var (
	...
	IdentityHoldersPrimaryKey = []string{"subcontrol_id", "identity_holder_id"}
...
func ImplementationStatusValidator(is enums.ControlImplementationStatus) error {
	...
	case "PLANNED", "IMPLEMENTED", "PARTIALLY_IMPLEMENTED", "INHERITED", "NOT_APPLICABLE":
		return nil
	default:
		return fmt.Errorf("subcontrol: invalid enum value for implementation_status field: %q", is)
	}
}
