...
func HasBlockedGroups() predicate.Subcontrol {
	return predicate.Subcontrol(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBlockedGroupsWith(preds ...predicate.Group) predicate.Subcontrol {
	return predicate.Subcontrol(func(s *sql.Selector) {
...
func HasEditors() predicate.Subcontrol {
	return predicate.Subcontrol(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEditorsWith(preds ...predicate.Group) predicate.Subcontrol {
	return predicate.Subcontrol(func(s *sql.Selector) {
		step := newEditorsStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.Group
...
func HasViewers() predicate.Subcontrol {
	return predicate.Subcontrol(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasViewersWith(preds ...predicate.Group) predicate.Subcontrol {
	return predicate.Subcontrol(func(s *sql.Selector) {
		step := newViewersStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.Group
