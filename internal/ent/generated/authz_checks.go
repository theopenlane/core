...
func (q *StandardQuery) CheckAccess(ctx context.Context) error {
	gCtx := graphql.GetFieldContext(ctx)
	...
	whereArg := gCtx.Args["where"]
	if whereArg != nil {
		where, ok := whereArg.(*StandardWhereInput)
		if ok && where != nil && where.ID != nil {
			objectID = *where.ID
		}
	}
...
func (m *StandardMutation) CheckAccessForEdit(ctx context.Context) error {
	var objectID string
...
func (m *StandardMutation) CheckAccessForDelete(ctx context.Context) error {
	gCtx := graphql.GetFieldContext(ctx)
	if gCtx == nil {
		// Skip to the next privacy rule (equivalent to return nil)
		// if this is not a graphql request
...
func (q *StandardHistoryQuery) CheckAccess(ctx context.Context) error {
	gCtx := graphql.GetFieldContext(ctx)
	...
	whereArg := gCtx.Args["where"]
	if whereArg != nil {
		where, ok := whereArg.(*StandardHistoryWhereInput)
		if ok && where != nil && where.Ref != nil {
			objectID = *where.Ref
		}
	}
