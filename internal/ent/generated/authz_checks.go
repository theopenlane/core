...
func (q *ScheduledJobQuery) CheckAccess(ctx context.Context) error {
	gCtx := graphql.GetFieldContext(ctx)
	...
	whereArg := gCtx.Args["where"]
	if whereArg != nil {
		where, ok := whereArg.(*ScheduledJobWhereInput)
		if ok && where != nil && where.ID != nil {
			objectID = *where.ID
		}
	}
...
func (m *ScheduledJobMutation) CheckAccessForEdit(ctx context.Context) error {
	var objectID string
...
func (m *ScheduledJobMutation) CheckAccessForDelete(ctx context.Context) error {
	gCtx := graphql.GetFieldContext(ctx)
	if gCtx == nil {
		// Skip to the next privacy rule (equivalent to return nil)
		// if this is not a graphql request
...
func (q *ScheduledJobHistoryQuery) CheckAccess(ctx context.Context) error {
	gCtx := graphql.GetFieldContext(ctx)
	...
	whereArg := gCtx.Args["where"]
	if whereArg != nil {
		where, ok := whereArg.(*ScheduledJobHistoryWhereInput)
		if ok && where != nil && where.Ref != nil {
			objectID = *where.Ref
		}
	}
