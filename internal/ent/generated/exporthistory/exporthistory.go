...
const (
	// Label holds the string label denoting the exporthistory type in the database.
	...
	FieldFileID = "file_id"
	// Table holds the table name of the exporthistory in the database.
	Table = "export_history"
)

// Columns holds all SQL columns for exporthistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("exporthistory: invalid enum value for operation field: %q", o)
	}
}
...
func ExportTypeValidator(et enums.ExportType) error {
	...
	case "CONTROL":
		return nil
	default:
		return fmt.Errorf("exporthistory: invalid enum value for export_type field: %q", et)
	}
}
...
func StatusValidator(s enums.ExportStatus) error {
	...
	case "PENDING", "READY", "FAILED":
		return nil
	default:
		return fmt.Errorf("exporthistory: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ExportHistory queries.
