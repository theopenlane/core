...
func (*MappableDomain) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case mappabledomain.FieldTags:
			values[i] = new([]byte)
		case mappabledomain.FieldID, mappabledomain.FieldCreatedBy, mappabledomain.FieldUpdatedBy, mappabledomain.FieldUpdatedByImpersonator, mappabledomain.FieldDeletedBy, mappabledomain.FieldName, mappabledomain.FieldZoneID:
...
func (_m *MappableDomain) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case mappabledomain.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
