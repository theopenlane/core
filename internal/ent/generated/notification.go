...
type Notification struct {
	...
	// the type of the object related to the notification, e.g. taskUpdate, internalPolicyUpdate
	ObjectType string `json:"object_type,omitempty"`
	// the time the notification was read
	ReadAt *models.DateTime `json:"read_at,omitempty"`
	// the channels through which the notification was sent: IN_APP, SLACK, EMAIL
...
func (*Notification) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case notification.FieldTags, notification.FieldData, notification.FieldChannels:
			values[i] = new([]byte)
		case notification.FieldID, notification.FieldCreatedBy, notification.FieldUpdatedBy, notification.FieldDeletedBy, notification.FieldOwnerID, notification.FieldUserID, notification.FieldTitle, notification.FieldBody, notification.FieldNotificationType, notification.FieldObjectType:
