...
func HasCreatedBy() predicate.ControlObjective {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.ControlObjective {
	return predicate.ControlObjective(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.ControlObjective {
	return predicate.ControlObjective(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.ControlObjective {
	return predicate.ControlObjective(func(s *sql.Selector) {
