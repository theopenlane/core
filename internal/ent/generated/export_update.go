...
func (eu *ExportUpdate) SetExportType(et enums.ExportType) *ExportUpdate {
	eu.mutation.SetExportType(et)
	return eu
}

// SetNillableExportType sets the "export_type" field if the given value is not nil.
func (eu *ExportUpdate) SetNillableExportType(et *enums.ExportType) *ExportUpdate {
	if et != nil {
		eu.SetExportType(*et)
	}
	return eu
...
func (eu *ExportUpdate) SetFileID(s string) *ExportUpdate {
	eu.mutation.SetFileID(s)
	return eu
}

// SetNillableFileID sets the "file_id" field if the given value is not nil.
func (eu *ExportUpdate) SetNillableFileID(s *string) *ExportUpdate {
	if s != nil {
		eu.SetFileID(*s)
	}
	return eu
...
func (eu *ExportUpdate) ClearFileID() *ExportUpdate {
...
func (eu *ExportUpdate) SetFile(f *File) *ExportUpdate {
...
func (eu *ExportUpdate) ClearFile() *ExportUpdate {
...
func (eu *ExportUpdate) check() error {
	if v, ok := eu.mutation.OwnerID(); ok {
		if err := export.OwnerIDValidator(v); err != nil {
			return &ValidationError{Name: "owner_id", err: fmt.Errorf(`generated: validator failed for field "Export.owner_id": %w`, err)}
		}
	}
	if v, ok := eu.mutation.ExportType(); ok {
...
func (eu *ExportUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := eu.mutation.ExportType(); ok {
	...
	if eu.mutation.FilesCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: export.FilesPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(file.FieldID, field.TypeString),
			},
		}
		edge.Schema = eu.schemaConfig.ExportFiles
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	if eu.mutation.FileCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   export.FileTable,
			Columns: []string{export.FileColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(file.FieldID, field.TypeString),
			},
...
// SetExportType sets the "export_type" field.
func (euo *ExportUpdateOne) SetExportType(et enums.ExportType) *ExportUpdateOne {
	euo.mutation.SetExportType(et)
	return euo
}

// SetNillableExportType sets the "export_type" field if the given value is not nil.
func (euo *ExportUpdateOne) SetNillableExportType(et *enums.ExportType) *ExportUpdateOne {
	if et != nil {
		euo.SetExportType(*et)
	}
	return euo
}
...
// SetFileID sets the "file_id" field.
func (euo *ExportUpdateOne) SetFileID(s string) *ExportUpdateOne {
	euo.mutation.SetFileID(s)
	return euo
}

// SetNillableFileID sets the "file_id" field if the given value is not nil.
func (euo *ExportUpdateOne) SetNillableFileID(s *string) *ExportUpdateOne {
	if s != nil {
		euo.SetFileID(*s)
	}
	return euo
...
// ClearFileID clears the value of the "file_id" field.
func (euo *ExportUpdateOne) ClearFileID() *ExportUpdateOne {
...
// SetFile sets the "file" edge to the File entity.
func (euo *ExportUpdateOne) SetFile(f *File) *ExportUpdateOne {
...
// ClearFile clears the "file" edge to the File entity.
func (euo *ExportUpdateOne) ClearFile() *ExportUpdateOne {
...
func (euo *ExportUpdateOne) check() error {
	...
	if v, ok := euo.mutation.ExportType(); ok {
		if err := export.ExportTypeValidator(v); err != nil {
			return &ValidationError{Name: "export_type", err: fmt.Errorf(`generated: validator failed for field "Export.export_type": %w`, err)}
		}
	}
...
func (euo *ExportUpdateOne) sqlSave(ctx context.Context) (_node *Export, err error) {
	...
	if value, ok := euo.mutation.ExportType(); ok {
		_spec.SetField(export.FieldExportType, field.TypeEnum, value)
	}
	...
	if euo.mutation.FilesCleared() {
		...
		edge.Schema = euo.schemaConfig.ExportFiles
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
