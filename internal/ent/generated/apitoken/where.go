...
func HasCreatedBy() predicate.APIToken {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.APIToken {
	return predicate.APIToken(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.APIToken {
	return predicate.APIToken(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.APIToken {
	return predicate.APIToken(func(s *sql.Selector) {
