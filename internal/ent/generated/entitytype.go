...
func (*EntityType) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case entitytype.FieldID, entitytype.FieldCreatedBy, entitytype.FieldUpdatedBy, entitytype.FieldUpdatedByImpersonator, entitytype.FieldDeletedBy, entitytype.FieldOwnerID, entitytype.FieldInternalNotes, entitytype.FieldSystemInternalID, entitytype.FieldName:
...
func (_m *EntityType) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case entitytype.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
