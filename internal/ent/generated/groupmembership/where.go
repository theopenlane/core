...
func HasCreatedBy() predicate.GroupMembership {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.GroupMembership {
	return predicate.GroupMembership(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.GroupMembership {
	return predicate.GroupMembership(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.GroupMembership {
	return predicate.GroupMembership(func(s *sql.Selector) {
