...
func (_c *AssessmentResponseCreate) SetUpdatedByImpersonator(v string) *AssessmentResponseCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *AssessmentResponseCreate) SetNillableUpdatedByImpersonator(v *string) *AssessmentResponseCreate {
	if v != nil {
