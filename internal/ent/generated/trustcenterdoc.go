...
func (*TrustCenterDoc) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case trustcenterdoc.FieldID, trustcenterdoc.FieldCreatedBy, trustcenterdoc.FieldUpdatedBy, trustcenterdoc.FieldUpdatedByImpersonator, trustcenterdoc.FieldDeletedBy, trustcenterdoc.FieldTrustCenterDocKindName, trustcenterdoc.FieldTrustCenterDocKindID, trustcenterdoc.FieldTrustCenterID, trustcenterdoc.FieldTitle, trustcenterdoc.FieldFileID, trustcenterdoc.FieldOriginalFileID, trustcenterdoc.FieldWatermarkStatus, trustcenterdoc.FieldVisibility, trustcenterdoc.FieldStandardID:
...
func (_m *TrustCenterDoc) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case trustcenterdoc.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
