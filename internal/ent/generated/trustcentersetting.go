...
func (*TrustCenterSetting) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case trustcentersetting.FieldID, trustcentersetting.FieldCreatedBy, trustcentersetting.FieldUpdatedBy, trustcentersetting.FieldDeletedBy, trustcentersetting.FieldTrustCenterID, trustcentersetting.FieldTitle, trustcentersetting.FieldOverview, trustcentersetting.FieldLogoURL, trustcentersetting.FieldFaviconURL, trustcentersetting.FieldPrimaryColor:
