...
func (*GroupSetting) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case groupsetting.FieldID, groupsetting.FieldCreatedBy, groupsetting.FieldUpdatedBy, groupsetting.FieldUpdatedByImpersonator, groupsetting.FieldDeletedBy, groupsetting.FieldVisibility, groupsetting.FieldJoinPolicy, groupsetting.FieldGroupID:
...
func (_m *GroupSetting) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case groupsetting.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
