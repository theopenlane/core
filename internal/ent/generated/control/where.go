...
func HasCreatedBy() predicate.Control {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.Control {
	return predicate.Control(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.Control {
	return predicate.Control(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.Control {
	return predicate.Control(func(s *sql.Selector) {
