...
func (*DocumentData) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case documentdata.FieldTags, documentdata.FieldData:
			values[i] = new([]byte)
		case documentdata.FieldID, documentdata.FieldCreatedBy, documentdata.FieldUpdatedBy, documentdata.FieldUpdatedByImpersonator, documentdata.FieldDeletedBy, documentdata.FieldOwnerID, documentdata.FieldEnvironmentName, documentdata.FieldEnvironmentID, documentdata.FieldScopeName, documentdata.FieldScopeID, documentdata.FieldTemplateID:
...
func (_m *DocumentData) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case documentdata.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
