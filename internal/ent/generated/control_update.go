...
func (cu *ControlUpdate) AddMappedControlIDs(ids ...string) *ControlUpdate {
	cu.mutation.AddMappedControlIDs(ids...)
	return cu
}

// AddMappedControls adds the "mapped_controls" edges to the MappedControl entity.
func (cu *ControlUpdate) AddMappedControls(m ...*MappedControl) *ControlUpdate {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return cu.AddMappedControlIDs(ids...)
}
...
func (cu *ControlUpdate) AddControlScheduledJobIDs(ids ...string) *ControlUpdate {
	cu.mutation.AddControlScheduledJobIDs(ids...)
	return cu
}

// AddControlScheduledJobs adds the "control_scheduled_jobs" edges to the ControlScheduledJob entity.
func (cu *ControlUpdate) AddControlScheduledJobs(c ...*ControlScheduledJob) *ControlUpdate {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cu.AddControlScheduledJobIDs(ids...)
}
...
func (cu *ControlUpdate) ClearMappedControls() *ControlUpdate {
	cu.mutation.ClearMappedControls()
	return cu
}

// RemoveMappedControlIDs removes the "mapped_controls" edge to MappedControl entities by IDs.
func (cu *ControlUpdate) RemoveMappedControlIDs(ids ...string) *ControlUpdate {
	cu.mutation.RemoveMappedControlIDs(ids...)
	return cu
}

// RemoveMappedControls removes "mapped_controls" edges to MappedControl entities.
func (cu *ControlUpdate) RemoveMappedControls(m ...*MappedControl) *ControlUpdate {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return cu.RemoveMappedControlIDs(ids...)
}
...
// ClearControlScheduledJobs clears all "control_scheduled_jobs" edges to the ControlScheduledJob entity.
func (cu *ControlUpdate) ClearControlScheduledJobs() *ControlUpdate {
	cu.mutation.ClearControlScheduledJobs()
	return cu
}

// RemoveControlScheduledJobIDs removes the "control_scheduled_jobs" edge to ControlScheduledJob entities by IDs.
func (cu *ControlUpdate) RemoveControlScheduledJobIDs(ids ...string) *ControlUpdate {
	cu.mutation.RemoveControlScheduledJobIDs(ids...)
	return cu
}

// RemoveControlScheduledJobs removes "control_scheduled_jobs" edges to ControlScheduledJob entities.
func (cu *ControlUpdate) RemoveControlScheduledJobs(c ...*ControlScheduledJob) *ControlUpdate {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cu.RemoveControlScheduledJobIDs(ids...)
}
...
func (cu *ControlUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.MappedControlsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
		...
		edge.Schema = cu.schemaConfig.MappedControlControls
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := cu.mutation.RemovedMappedControlsIDs(); len(nodes) > 0 && !cu.mutation.MappedControlsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   control.MappedControlsTable,
	...
	if nodes := cu.mutation.MappedControlsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   control.MappedControlsTable,
	...
	if cu.mutation.ControlScheduledJobsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
		...
		edge.Schema = cu.schemaConfig.ControlScheduledJob
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := cu.mutation.RemovedControlScheduledJobsIDs(); len(nodes) > 0 && !cu.mutation.ControlScheduledJobsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   control.ControlScheduledJobsTable,
	...
	if nodes := cu.mutation.ControlScheduledJobsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   control.ControlScheduledJobsTable,
...
// AddMappedControlIDs adds the "mapped_controls" edge to the MappedControl entity by IDs.
func (cuo *ControlUpdateOne) AddMappedControlIDs(ids ...string) *ControlUpdateOne {
	cuo.mutation.AddMappedControlIDs(ids...)
	return cuo
}

// AddMappedControls adds the "mapped_controls" edges to the MappedControl entity.
func (cuo *ControlUpdateOne) AddMappedControls(m ...*MappedControl) *ControlUpdateOne {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return cuo.AddMappedControlIDs(ids...)
}
...
// AddControlScheduledJobIDs adds the "control_scheduled_jobs" edge to the ControlScheduledJob entity by IDs.
func (cuo *ControlUpdateOne) AddControlScheduledJobIDs(ids ...string) *ControlUpdateOne {
	cuo.mutation.AddControlScheduledJobIDs(ids...)
	return cuo
}

// AddControlScheduledJobs adds the "control_scheduled_jobs" edges to the ControlScheduledJob entity.
func (cuo *ControlUpdateOne) AddControlScheduledJobs(c ...*ControlScheduledJob) *ControlUpdateOne {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cuo.AddControlScheduledJobIDs(ids...)
}
...
// ClearMappedControls clears all "mapped_controls" edges to the MappedControl entity.
func (cuo *ControlUpdateOne) ClearMappedControls() *ControlUpdateOne {
	cuo.mutation.ClearMappedControls()
	return cuo
}

// RemoveMappedControlIDs removes the "mapped_controls" edge to MappedControl entities by IDs.
func (cuo *ControlUpdateOne) RemoveMappedControlIDs(ids ...string) *ControlUpdateOne {
	cuo.mutation.RemoveMappedControlIDs(ids...)
	return cuo
}

// RemoveMappedControls removes "mapped_controls" edges to MappedControl entities.
func (cuo *ControlUpdateOne) RemoveMappedControls(m ...*MappedControl) *ControlUpdateOne {
	ids := make([]string, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return cuo.RemoveMappedControlIDs(ids...)
}
...
// ClearControlScheduledJobs clears all "control_scheduled_jobs" edges to the ControlScheduledJob entity.
func (cuo *ControlUpdateOne) ClearControlScheduledJobs() *ControlUpdateOne {
	cuo.mutation.ClearControlScheduledJobs()
	return cuo
}

// RemoveControlScheduledJobIDs removes the "control_scheduled_jobs" edge to ControlScheduledJob entities by IDs.
func (cuo *ControlUpdateOne) RemoveControlScheduledJobIDs(ids ...string) *ControlUpdateOne {
	cuo.mutation.RemoveControlScheduledJobIDs(ids...)
	return cuo
}

// RemoveControlScheduledJobs removes "control_scheduled_jobs" edges to ControlScheduledJob entities.
func (cuo *ControlUpdateOne) RemoveControlScheduledJobs(c ...*ControlScheduledJob) *ControlUpdateOne {
	ids := make([]string, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cuo.RemoveControlScheduledJobIDs(ids...)
}
...
func (cuo *ControlUpdateOne) sqlSave(ctx context.Context) (_node *Control, err error) {
	...
	if cuo.mutation.MappedControlsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   control.MappedControlsTable,
		...
		edge.Schema = cuo.schemaConfig.MappedControlControls
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := cuo.mutation.RemovedMappedControlsIDs(); len(nodes) > 0 && !cuo.mutation.MappedControlsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   control.MappedControlsTable,
	...
	if nodes := cuo.mutation.MappedControlsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   control.MappedControlsTable,
	...
	if cuo.mutation.ControlScheduledJobsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   control.ControlScheduledJobsTable,
		...
		edge.Schema = cuo.schemaConfig.ControlScheduledJob
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := cuo.mutation.RemovedControlScheduledJobsIDs(); len(nodes) > 0 && !cuo.mutation.ControlScheduledJobsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   control.ControlScheduledJobsTable,
	...
	if nodes := cuo.mutation.ControlScheduledJobsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   control.ControlScheduledJobsTable,
