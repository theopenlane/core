...
func (*TrustCenterCompliance) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case trustcentercompliance.FieldTags:
			values[i] = new([]byte)
		case trustcentercompliance.FieldID, trustcentercompliance.FieldCreatedBy, trustcentercompliance.FieldUpdatedBy, trustcentercompliance.FieldUpdatedByImpersonator, trustcentercompliance.FieldDeletedBy, trustcentercompliance.FieldStandardID, trustcentercompliance.FieldTrustCenterID:
...
func (_m *TrustCenterCompliance) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case trustcentercompliance.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
