...
func (tcc *TrustCenterCompliance) QueryTrustCenter() *TrustCenterQuery {
	return NewTrustCenterComplianceClient(tcc.config).QueryTrustCenter(tcc)
}

// QueryStandard queries the "standard" edge of the TrustCenterCompliance entity.
func (tcc *TrustCenterCompliance) QueryStandard() *StandardQuery {
	return NewTrustCenterComplianceClient(tcc.config).QueryStandard(tcc)
}
...
func (tcc *TrustCenterCompliance) String() string {
	...
	builder.WriteString(tcc.StandardID)
	builder.WriteString(", ")
	builder.WriteString("trust_center_id=")
	builder.WriteString(tcc.TrustCenterID)
	builder.WriteByte(')')
