...
const (
	// Label holds the string label denoting the controlscheduledjobhistory type in the database.
	Label = "control_scheduled_job_history"
...
// Columns holds all SQL columns for controlscheduledjobhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("controlscheduledjobhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the ControlScheduledJobHistory queries.
