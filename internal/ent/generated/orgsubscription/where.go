...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.OrgSubscription {
	return predicate.OrgSubscription(func(s *sql.Selector) {
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.OrgSubscription {
	return predicate.OrgSubscription(func(s *sql.Selector) {
