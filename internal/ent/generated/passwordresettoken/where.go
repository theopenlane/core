...
func HasCreatedBy() predicate.PasswordResetToken {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.PasswordResetToken {
	return predicate.PasswordResetToken(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.PasswordResetToken {
	return predicate.PasswordResetToken(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.PasswordResetToken {
	return predicate.PasswordResetToken(func(s *sql.Selector) {
