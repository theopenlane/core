...
func (_m *AssessmentResponseHistory) changes(new *AssessmentResponseHistory) []Change {
	...
	if !reflect.DeepEqual(_m.Tags, new.Tags) {
		changes = append(changes, NewChange(assessmentresponsehistory.FieldTags, _m.Tags, new.Tags))
	}
	...
	if !reflect.DeepEqual(_m.ResponderID, new.ResponderID) {
		changes = append(changes, NewChange(assessmentresponsehistory.FieldResponderID, _m.ResponderID, new.ResponderID))
	}
	if !reflect.DeepEqual(_m.Status, new.Status) {
	...
	if !reflect.DeepEqual(_m.ResponseDataID, new.ResponseDataID) {
		changes = append(changes, NewChange(assessmentresponsehistory.FieldResponseDataID, _m.ResponseDataID, new.ResponseDataID))
	}
	return changes
}
