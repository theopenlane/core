...
func (e OrgSubscriptionEdges) CreatedByOrErr() (*ChangeActor, error) {
	if e.CreatedBy != nil {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e OrgSubscriptionEdges) UpdatedByOrErr() (*ChangeActor, error) {
	if e.UpdatedBy != nil {
...
func (os *OrgSubscription) QueryCreatedBy() *ChangeActorQuery {
...
func (os *OrgSubscription) QueryUpdatedBy() *ChangeActorQuery {
