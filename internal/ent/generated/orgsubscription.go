...
func (e OrgSubscriptionEdges) CreatedByUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e OrgSubscriptionEdges) UpdatedByUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e OrgSubscriptionEdges) CreatedByServiceOrErr() (*APIToken, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e OrgSubscriptionEdges) UpdatedByServiceOrErr() (*APIToken, error) {
...
func (*OrgSubscription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case orgsubscription.FieldID, orgsubscription.FieldCreatedByID, orgsubscription.FieldUpdatedByID, orgsubscription.FieldCreatedByUserID, orgsubscription.FieldUpdatedByUserID, orgsubscription.FieldCreatedByServiceID, orgsubscription.FieldUpdatedByServiceID, orgsubscription.FieldMappingID, orgsubscription.FieldDeletedByID, orgsubscription.FieldOwnerID, orgsubscription.FieldStripeSubscriptionID, orgsubscription.FieldProductTier, orgsubscription.FieldStripeProductTierID, orgsubscription.FieldStripeSubscriptionStatus, orgsubscription.FieldStripeCustomerID:
...
// QueryCreatedByUser queries the "created_by_user" edge of the OrgSubscription entity.
func (os *OrgSubscription) QueryCreatedByUser() *UserQuery {
	return NewOrgSubscriptionClient(os.config).QueryCreatedByUser(os)
}

// QueryUpdatedByUser queries the "updated_by_user" edge of the OrgSubscription entity.
func (os *OrgSubscription) QueryUpdatedByUser() *UserQuery {
	return NewOrgSubscriptionClient(os.config).QueryUpdatedByUser(os)
}

// QueryCreatedByService queries the "created_by_service" edge of the OrgSubscription entity.
func (os *OrgSubscription) QueryCreatedByService() *APITokenQuery {
	return NewOrgSubscriptionClient(os.config).QueryCreatedByService(os)
}

// QueryUpdatedByService queries the "updated_by_service" edge of the OrgSubscription entity.
func (os *OrgSubscription) QueryUpdatedByService() *APITokenQuery {
	return NewOrgSubscriptionClient(os.config).QueryUpdatedByService(os)
}
