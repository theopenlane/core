...
func (e FindingEdges) IntegrationRunsOrErr() ([]*IntegrationRun, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e FindingEdges) InternalOwnerUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e FindingEdges) InternalOwnerGroupOrErr() (*Group, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e FindingEdges) InternalOwnerIdentityHolderOrErr() (*IdentityHolder, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e FindingEdges) ReviewedByUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e FindingEdges) ReviewedByGroupOrErr() (*Group, error) {
...
func (*Finding) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case finding.FieldTags, finding.FieldCategories, finding.FieldReferences, finding.FieldStepsToReproduce, finding.FieldTargets, finding.FieldTargetDetails, finding.FieldMetadata, finding.FieldRawPayload:
			values[i] = new([]byte)
		case finding.FieldSystemOwned, finding.FieldWorkflowEligibleMarker, finding.FieldOpen, finding.FieldBlocksProduction, finding.FieldProduction, finding.FieldPublic, finding.FieldValidated:
...
func (_m *Finding) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case finding.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case finding.FieldReviewedByGroupID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case finding.FieldWorkflowEligibleMarker:
			if value, ok := values[i].(*sql.NullBool); !ok {
...
// QueryIntegrationRuns queries the "integration_runs" edge of the Finding entity.
func (_m *Finding) QueryIntegrationRuns() *IntegrationRunQuery {
	return NewFindingClient(_m.config).QueryIntegrationRuns(_m)
}
...
// QueryInternalOwnerUser queries the "internal_owner_user" edge of the Finding entity.
func (_m *Finding) QueryInternalOwnerUser() *UserQuery {
	return NewFindingClient(_m.config).QueryInternalOwnerUser(_m)
}

// QueryInternalOwnerGroup queries the "internal_owner_group" edge of the Finding entity.
func (_m *Finding) QueryInternalOwnerGroup() *GroupQuery {
	return NewFindingClient(_m.config).QueryInternalOwnerGroup(_m)
}

// QueryInternalOwnerIdentityHolder queries the "internal_owner_identity_holder" edge of the Finding entity.
func (_m *Finding) QueryInternalOwnerIdentityHolder() *IdentityHolderQuery {
	return NewFindingClient(_m.config).QueryInternalOwnerIdentityHolder(_m)
}

// QueryReviewedByUser queries the "reviewed_by_user" edge of the Finding entity.
func (_m *Finding) QueryReviewedByUser() *UserQuery {
	return NewFindingClient(_m.config).QueryReviewedByUser(_m)
}

// QueryReviewedByGroup queries the "reviewed_by_group" edge of the Finding entity.
func (_m *Finding) QueryReviewedByGroup() *GroupQuery {
...
// QueryScope queries the "scope" edge of the Finding entity.
func (_m *Finding) QueryScope() *CustomTypeEnumQuery {
...
func (_m *Finding) NamedIntegrationRuns(name string) ([]*IntegrationRun, error) {
...
func (_m *Finding) appendNamedIntegrationRuns(name string, edges ...*IntegrationRun) {
	if _m.Edges.namedIntegrationRuns == nil {
