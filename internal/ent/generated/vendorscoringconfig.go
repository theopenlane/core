...
func (*VendorScoringConfig) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case vendorscoringconfig.FieldTags, vendorscoringconfig.FieldQuestions, vendorscoringconfig.FieldRiskThresholds:
			values[i] = new([]byte)
		case vendorscoringconfig.FieldID, vendorscoringconfig.FieldCreatedBy, vendorscoringconfig.FieldUpdatedBy, vendorscoringconfig.FieldUpdatedByImpersonator, vendorscoringconfig.FieldDeletedBy, vendorscoringconfig.FieldOwnerID, vendorscoringconfig.FieldScoringMode:
...
func (_m *VendorScoringConfig) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case vendorscoringconfig.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
