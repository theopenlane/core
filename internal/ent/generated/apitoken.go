...
func (*APIToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apitoken.FieldID, apitoken.FieldCreatedBy, apitoken.FieldUpdatedBy, apitoken.FieldDeletedBy, apitoken.FieldOwnerID, apitoken.FieldName, apitoken.FieldToken, apitoken.FieldTokenHash, apitoken.FieldTokenFp, apitoken.FieldDescription, apitoken.FieldRevokedReason, apitoken.FieldRevokedBy:
