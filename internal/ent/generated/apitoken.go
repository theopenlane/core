...
func (*APIToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apitoken.FieldID, apitoken.FieldCreatedBy, apitoken.FieldUpdatedBy, apitoken.FieldUpdatedByImpersonator, apitoken.FieldDeletedBy, apitoken.FieldOwnerID, apitoken.FieldName, apitoken.FieldToken, apitoken.FieldDescription, apitoken.FieldRevokedReason, apitoken.FieldRevokedBy:
...
func (_m *APIToken) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case apitoken.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
