...
func (*Subscriber) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case subscriber.FieldID, subscriber.FieldCreatedBy, subscriber.FieldUpdatedBy, subscriber.FieldUpdatedByImpersonator, subscriber.FieldDeletedBy, subscriber.FieldOwnerID, subscriber.FieldTrustCenterID, subscriber.FieldEmail, subscriber.FieldPhoneNumber, subscriber.FieldToken, subscriber.FieldContactID, subscriber.FieldUserID:
...
func (_m *Subscriber) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case subscriber.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
