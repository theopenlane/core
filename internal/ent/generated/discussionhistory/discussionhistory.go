...
const (
	// Label holds the string label denoting the discussionhistory type in the database.
	Label = "discussion_history"
	...
	// Table holds the table name of the discussionhistory in the database.
	Table = "discussion_history"
)

// Columns holds all SQL columns for discussionhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("discussionhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the DiscussionHistory queries.
