...
func (_c *ProgramCreate) SetUpdatedByImpersonator(v string) *ProgramCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *ProgramCreate) SetNillableUpdatedByImpersonator(v *string) *ProgramCreate {
	if v != nil {
...
func (_c *ProgramCreate) createSpec() (*Program, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(program.FieldUpdatedByImpersonator, field.TypeString, value)
