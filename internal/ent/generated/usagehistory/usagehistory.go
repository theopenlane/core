...
const (
	// Label holds the string label denoting the usagehistory type in the database.
	Label = "usage_history"
	...
	FieldLimit = "limit"
	// Table holds the table name of the usagehistory in the database.
	Table = "usage_history"
)

// Columns holds all SQL columns for usagehistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("usagehistory: invalid enum value for operation field: %q", o)
	}
}
...
func ResourceTypeValidator(rt enums.UsageType) error {
	...
	case "STORAGE", "RECORDS", "USERS", "PROGRAMS":
		return nil
	default:
		return fmt.Errorf("usagehistory: invalid enum value for resource_type field: %q", rt)
	}
}

// OrderOption defines the ordering options for the UsageHistory queries.
