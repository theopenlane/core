...
func (_m *AssessmentResponseHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case assessmentresponsehistory.FieldResponderID:
			if value, ok := values[i].(*sql.NullString); !ok {
