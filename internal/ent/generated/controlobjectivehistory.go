...
func (coh *ControlObjectiveHistory) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case controlobjectivehistory.FieldCreatedByUserID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field created_by_user_id", values[i])
			} else if value.Valid {
				coh.CreatedByUserID = value.String
			}
		case controlobjectivehistory.FieldUpdatedByUserID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field updated_by_user_id", values[i])
			} else if value.Valid {
				coh.UpdatedByUserID = value.String
			}
		case controlobjectivehistory.FieldCreatedByServiceID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field created_by_service_id", values[i])
			} else if value.Valid {
				coh.CreatedByServiceID = value.String
			}
		case controlobjectivehistory.FieldUpdatedByServiceID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field updated_by_service_id", values[i])
			} else if value.Valid {
				coh.UpdatedByServiceID = value.String
			}
...
func (coh *ControlObjectiveHistory) String() string {
	...
	builder.WriteString(coh.CreatedByUserID)
	builder.WriteString(", ")
	builder.WriteString("updated_by_user_id=")
	builder.WriteString(coh.UpdatedByUserID)
	builder.WriteString(", ")
	builder.WriteString("created_by_service_id=")
	builder.WriteString(coh.CreatedByServiceID)
	builder.WriteString(", ")
	builder.WriteString("updated_by_service_id=")
	builder.WriteString(coh.UpdatedByServiceID)
	builder.WriteString(", ")
