...
func (sjhc *ScheduledJobHistoryCreate) SetEnvironment(ee enums.JobEnvironment) *ScheduledJobHistoryCreate {
	sjhc.mutation.SetEnvironment(ee)
	return sjhc
}

// SetNillableEnvironment sets the "environment" field if the given value is not nil.
func (sjhc *ScheduledJobHistoryCreate) SetNillableEnvironment(ee *enums.JobEnvironment) *ScheduledJobHistoryCreate {
	if ee != nil {
		sjhc.SetEnvironment(*ee)
	}
	return sjhc
}
...
func (sjhc *ScheduledJobHistoryCreate) defaults() {
	...
	if _, ok := sjhc.mutation.Environment(); !ok {
...
func (sjhc *ScheduledJobHistoryCreate) check() error {
	...
	if _, ok := sjhc.mutation.Environment(); !ok {
		return &ValidationError{Name: "environment", err: errors.New(`generated: missing required field "ScheduledJobHistory.environment"`)}
	}
	if v, ok := sjhc.mutation.Environment(); ok {
...
func (sjhc *ScheduledJobHistoryCreate) createSpec() (*ScheduledJobHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := sjhc.mutation.Environment(); ok {
