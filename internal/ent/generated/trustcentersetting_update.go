...
func (tcsu *TrustCenterSettingUpdate) SetTags(s []string) *TrustCenterSettingUpdate {
	tcsu.mutation.SetTags(s)
	return tcsu
}

// AppendTags appends s to the "tags" field.
func (tcsu *TrustCenterSettingUpdate) AppendTags(s []string) *TrustCenterSettingUpdate {
	tcsu.mutation.AppendTags(s)
	return tcsu
}

// ClearTags clears the value of the "tags" field.
func (tcsu *TrustCenterSettingUpdate) ClearTags() *TrustCenterSettingUpdate {
	tcsu.mutation.ClearTags()
	return tcsu
}

// SetOwnerID sets the "owner_id" field.
func (tcsu *TrustCenterSettingUpdate) SetOwnerID(s string) *TrustCenterSettingUpdate {
	tcsu.mutation.SetOwnerID(s)
	return tcsu
}

// SetNillableOwnerID sets the "owner_id" field if the given value is not nil.
func (tcsu *TrustCenterSettingUpdate) SetNillableOwnerID(s *string) *TrustCenterSettingUpdate {
	if s != nil {
		tcsu.SetOwnerID(*s)
	}
	return tcsu
...
func (tcsu *TrustCenterSettingUpdate) ClearOwnerID() *TrustCenterSettingUpdate {
	tcsu.mutation.ClearOwnerID()
	return tcsu
}
...
func (tcsu *TrustCenterSettingUpdate) SetOwner(o *Organization) *TrustCenterSettingUpdate {
	return tcsu.SetOwnerID(o.ID)
}
...
func (tcsu *TrustCenterSettingUpdate) ClearOwner() *TrustCenterSettingUpdate {
	tcsu.mutation.ClearOwner()
	return tcsu
}
...
func (tcsu *TrustCenterSettingUpdate) check() error {
	if v, ok := tcsu.mutation.OwnerID(); ok {
	...
	if tcsu.mutation.TrustCenterCleared() && len(tcsu.mutation.TrustCenterIDs()) > 0 {
		return errors.New(`generated: clearing a required unique edge "TrustCenterSetting.trust_center"`)
	}
	return nil
}
...
func (tcsu *TrustCenterSettingUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tcsu.mutation.AppendedTags(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, trustcentersetting.FieldTags, value)
		})
	}
	if tcsu.mutation.TagsCleared() {
		_spec.ClearField(trustcentersetting.FieldTags, field.TypeJSON)
	}
	...
	if nodes := tcsu.mutation.OwnerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   trustcentersetting.OwnerTable,
...
// SetTags sets the "tags" field.
func (tcsuo *TrustCenterSettingUpdateOne) SetTags(s []string) *TrustCenterSettingUpdateOne {
	tcsuo.mutation.SetTags(s)
	return tcsuo
}

// AppendTags appends s to the "tags" field.
func (tcsuo *TrustCenterSettingUpdateOne) AppendTags(s []string) *TrustCenterSettingUpdateOne {
	tcsuo.mutation.AppendTags(s)
	return tcsuo
}

// ClearTags clears the value of the "tags" field.
func (tcsuo *TrustCenterSettingUpdateOne) ClearTags() *TrustCenterSettingUpdateOne {
	tcsuo.mutation.ClearTags()
	return tcsuo
}

// SetOwnerID sets the "owner_id" field.
func (tcsuo *TrustCenterSettingUpdateOne) SetOwnerID(s string) *TrustCenterSettingUpdateOne {
	tcsuo.mutation.SetOwnerID(s)
	return tcsuo
}

// SetNillableOwnerID sets the "owner_id" field if the given value is not nil.
func (tcsuo *TrustCenterSettingUpdateOne) SetNillableOwnerID(s *string) *TrustCenterSettingUpdateOne {
	if s != nil {
		tcsuo.SetOwnerID(*s)
	}
	return tcsuo
...
// ClearOwnerID clears the value of the "owner_id" field.
func (tcsuo *TrustCenterSettingUpdateOne) ClearOwnerID() *TrustCenterSettingUpdateOne {
	tcsuo.mutation.ClearOwnerID()
	return tcsuo
}
...
// SetOwner sets the "owner" edge to the Organization entity.
func (tcsuo *TrustCenterSettingUpdateOne) SetOwner(o *Organization) *TrustCenterSettingUpdateOne {
	return tcsuo.SetOwnerID(o.ID)
}
...
// ClearOwner clears the "owner" edge to the Organization entity.
func (tcsuo *TrustCenterSettingUpdateOne) ClearOwner() *TrustCenterSettingUpdateOne {
	tcsuo.mutation.ClearOwner()
	return tcsuo
}
...
func (tcsuo *TrustCenterSettingUpdateOne) check() error {
	if v, ok := tcsuo.mutation.OwnerID(); ok {
		if err := trustcentersetting.OwnerIDValidator(v); err != nil {
			return &ValidationError{Name: "owner_id", err: fmt.Errorf(`generated: validator failed for field "TrustCenterSetting.owner_id": %w`, err)}
		}
	}
	...
	if tcsuo.mutation.TrustCenterCleared() && len(tcsuo.mutation.TrustCenterIDs()) > 0 {
		return errors.New(`generated: clearing a required unique edge "TrustCenterSetting.trust_center"`)
	}
	return nil
}
...
func (tcsuo *TrustCenterSettingUpdateOne) sqlSave(ctx context.Context) (_node *TrustCenterSetting, err error) {
	...
	if tcsuo.mutation.OwnerCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   trustcentersetting.OwnerTable,
	...
	if nodes := tcsuo.mutation.OwnerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   trustcentersetting.OwnerTable,
