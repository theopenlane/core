...
func (_u *FindingControlHistoryUpdate) defaults() error {
	if _, ok := _u.mutation.UpdatedAt(); !ok && !_u.mutation.UpdatedAtCleared() {
		if findingcontrolhistory.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized findingcontrolhistory.UpdateDefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (_u *FindingControlHistoryUpdateOne) sqlSave(ctx context.Context) (_node *FindingControlHistory, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "FindingControlHistory.id" for update`)}
	}
