...
func HasCreatedByWith(preds ...predicate.User) predicate.EmailVerificationToken {
	return predicate.EmailVerificationToken(func(s *sql.Selector) {
...
func HasUpdatedByWith(preds ...predicate.User) predicate.EmailVerificationToken {
	return predicate.EmailVerificationToken(func(s *sql.Selector) {
