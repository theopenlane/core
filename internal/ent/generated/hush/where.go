...
func HasCreatedBy() predicate.Hush {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.Hush {
	return predicate.Hush(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.Hush {
	return predicate.Hush(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.Hush {
	return predicate.Hush(func(s *sql.Selector) {
