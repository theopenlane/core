...
func (_c *InternalPolicyCreate) SetUpdatedByImpersonator(v string) *InternalPolicyCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *InternalPolicyCreate) SetNillableUpdatedByImpersonator(v *string) *InternalPolicyCreate {
	if v != nil {
...
func (_c *InternalPolicyCreate) SetManagementMode(v enums.DocumentManagementMode) *InternalPolicyCreate {
	_c.mutation.SetManagementMode(v)
	return _c
}

// SetNillableManagementMode sets the "management_mode" field if the given value is not nil.
func (_c *InternalPolicyCreate) SetNillableManagementMode(v *enums.DocumentManagementMode) *InternalPolicyCreate {
	if v != nil {
...
func (_c *InternalPolicyCreate) AddAssetIDs(ids ...string) *InternalPolicyCreate {
	_c.mutation.AddAssetIDs(ids...)
	return _c
}

// AddAssets adds the "assets" edges to the Asset entity.
func (_c *InternalPolicyCreate) AddAssets(v ...*Asset) *InternalPolicyCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *InternalPolicyCreate) AddEntityIDs(ids ...string) *InternalPolicyCreate {
	_c.mutation.AddEntityIDs(ids...)
	return _c
}

// AddEntities adds the "entities" edges to the Entity entity.
func (_c *InternalPolicyCreate) AddEntities(v ...*Entity) *InternalPolicyCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *InternalPolicyCreate) AddIdentityHolderIDs(ids ...string) *InternalPolicyCreate {
	_c.mutation.AddIdentityHolderIDs(ids...)
	return _c
}

// AddIdentityHolders adds the "identity_holders" edges to the IdentityHolder entity.
func (_c *InternalPolicyCreate) AddIdentityHolders(v ...*IdentityHolder) *InternalPolicyCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *InternalPolicyCreate) AddReviewIDs(ids ...string) *InternalPolicyCreate {
	_c.mutation.AddReviewIDs(ids...)
	return _c
}

// AddReviews adds the "reviews" edges to the Review entity.
func (_c *InternalPolicyCreate) AddReviews(v ...*Review) *InternalPolicyCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *InternalPolicyCreate) defaults() error {
	...
	if _, ok := _c.mutation.ManagementMode(); !ok {
		v := internalpolicy.DefaultManagementMode
		_c.mutation.SetManagementMode(v)
	}
...
func (_c *InternalPolicyCreate) createSpec() (*InternalPolicy, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(internalpolicy.FieldUpdatedByImpersonator, field.TypeString, value)
	...
	if nodes := _c.mutation.AssetsIDs(); len(nodes) > 0 {
		...
		edge.Schema = _c.schemaConfig.InternalPolicyAssets
		for _, k := range nodes {
			edge.Target.Nodes = append(edge.Target.Nodes, k)
		}
		_spec.Edges = append(_spec.Edges, edge)
