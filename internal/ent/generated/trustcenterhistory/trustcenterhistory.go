...
const (
	// Label holds the string label denoting the trustcenterhistory type in the database.
	Label = "trust_center_history"
...
// Columns holds all SQL columns for trustcenterhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
// OrderOption defines the ordering options for the TrustCenterHistory queries.
