...
func (_c *ControlCreate) AddTrustCenterControlIDs(ids ...string) *ControlCreate {
...
func (_c *ControlCreate) AddTrustCenterControls(v ...*TrustCenterControl) *ControlCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
