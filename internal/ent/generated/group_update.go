...
func (_u *GroupUpdate) SetUpdatedByImpersonator(v string) *GroupUpdate {
	_u.mutation.SetUpdatedByImpersonator(v)
	return _u
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableUpdatedByImpersonator(v *string) *GroupUpdate {
	if v != nil {
...
func (_u *GroupUpdate) ClearUpdatedByImpersonator() *GroupUpdate {
...
func (_u *GroupUpdate) AddPlatformEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddPlatformEditorIDs(ids...)
	return _u
}

// AddPlatformEditors adds the "platform_editors" edges to the Platform entity.
func (_u *GroupUpdate) AddPlatformEditors(v ...*Platform) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddPlatformEditorIDs(ids...)
}

// AddPlatformBlockedGroupIDs adds the "platform_blocked_groups" edge to the Platform entity by IDs.
func (_u *GroupUpdate) AddPlatformBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddPlatformBlockedGroupIDs(ids...)
	return _u
}

// AddPlatformBlockedGroups adds the "platform_blocked_groups" edges to the Platform entity.
func (_u *GroupUpdate) AddPlatformBlockedGroups(v ...*Platform) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddPlatformBlockedGroupIDs(ids...)
}

// AddPlatformViewerIDs adds the "platform_viewers" edge to the Platform entity by IDs.
func (_u *GroupUpdate) AddPlatformViewerIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddPlatformViewerIDs(ids...)
	return _u
}

// AddPlatformViewers adds the "platform_viewers" edges to the Platform entity.
func (_u *GroupUpdate) AddPlatformViewers(v ...*Platform) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddPlatformViewerIDs(ids...)
}

// AddCampaignEditorIDs adds the "campaign_editors" edge to the Campaign entity by IDs.
func (_u *GroupUpdate) AddCampaignEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddCampaignEditorIDs(ids...)
	return _u
}

// AddCampaignEditors adds the "campaign_editors" edges to the Campaign entity.
func (_u *GroupUpdate) AddCampaignEditors(v ...*Campaign) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddCampaignEditorIDs(ids...)
}

// AddCampaignBlockedGroupIDs adds the "campaign_blocked_groups" edge to the Campaign entity by IDs.
func (_u *GroupUpdate) AddCampaignBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddCampaignBlockedGroupIDs(ids...)
	return _u
}

// AddCampaignBlockedGroups adds the "campaign_blocked_groups" edges to the Campaign entity.
func (_u *GroupUpdate) AddCampaignBlockedGroups(v ...*Campaign) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddCampaignBlockedGroupIDs(ids...)
}

// AddCampaignViewerIDs adds the "campaign_viewers" edge to the Campaign entity by IDs.
func (_u *GroupUpdate) AddCampaignViewerIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddCampaignViewerIDs(ids...)
	return _u
}

// AddCampaignViewers adds the "campaign_viewers" edges to the Campaign entity.
func (_u *GroupUpdate) AddCampaignViewers(v ...*Campaign) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) AddFindingEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddFindingEditorIDs(ids...)
	return _u
}

// AddFindingEditors adds the "finding_editors" edges to the Finding entity.
func (_u *GroupUpdate) AddFindingEditors(v ...*Finding) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddFindingEditorIDs(ids...)
}

// AddFindingBlockedGroupIDs adds the "finding_blocked_groups" edge to the Finding entity by IDs.
func (_u *GroupUpdate) AddFindingBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddFindingBlockedGroupIDs(ids...)
	return _u
}

// AddFindingBlockedGroups adds the "finding_blocked_groups" edges to the Finding entity.
func (_u *GroupUpdate) AddFindingBlockedGroups(v ...*Finding) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddFindingBlockedGroupIDs(ids...)
}

// AddReviewEditorIDs adds the "review_editors" edge to the Review entity by IDs.
func (_u *GroupUpdate) AddReviewEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddReviewEditorIDs(ids...)
	return _u
}

// AddReviewEditors adds the "review_editors" edges to the Review entity.
func (_u *GroupUpdate) AddReviewEditors(v ...*Review) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddReviewEditorIDs(ids...)
}

// AddReviewBlockedGroupIDs adds the "review_blocked_groups" edge to the Review entity by IDs.
func (_u *GroupUpdate) AddReviewBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddReviewBlockedGroupIDs(ids...)
	return _u
}

// AddReviewBlockedGroups adds the "review_blocked_groups" edges to the Review entity.
func (_u *GroupUpdate) AddReviewBlockedGroups(v ...*Review) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddReviewBlockedGroupIDs(ids...)
}

// AddRemediationEditorIDs adds the "remediation_editors" edge to the Remediation entity by IDs.
func (_u *GroupUpdate) AddRemediationEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddRemediationEditorIDs(ids...)
	return _u
}

// AddRemediationEditors adds the "remediation_editors" edges to the Remediation entity.
func (_u *GroupUpdate) AddRemediationEditors(v ...*Remediation) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddRemediationEditorIDs(ids...)
}

// AddRemediationBlockedGroupIDs adds the "remediation_blocked_groups" edge to the Remediation entity by IDs.
func (_u *GroupUpdate) AddRemediationBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddRemediationBlockedGroupIDs(ids...)
	return _u
}

// AddRemediationBlockedGroups adds the "remediation_blocked_groups" edges to the Remediation entity.
func (_u *GroupUpdate) AddRemediationBlockedGroups(v ...*Remediation) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddRemediationBlockedGroupIDs(ids...)
}
...
func (_u *GroupUpdate) AddCampaignIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddCampaignIDs(ids...)
	return _u
}

// AddCampaigns adds the "campaigns" edges to the Campaign entity.
func (_u *GroupUpdate) AddCampaigns(v ...*Campaign) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) AddCampaignTargetIDs(ids ...string) *GroupUpdate {
	_u.mutation.AddCampaignTargetIDs(ids...)
	return _u
}

// AddCampaignTargets adds the "campaign_targets" edges to the CampaignTarget entity.
func (_u *GroupUpdate) AddCampaignTargets(v ...*CampaignTarget) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPlatformEditors clears all "platform_editors" edges to the Platform entity.
func (_u *GroupUpdate) ClearPlatformEditors() *GroupUpdate {
	_u.mutation.ClearPlatformEditors()
	return _u
}

// RemovePlatformEditorIDs removes the "platform_editors" edge to Platform entities by IDs.
func (_u *GroupUpdate) RemovePlatformEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemovePlatformEditorIDs(ids...)
	return _u
}

// RemovePlatformEditors removes "platform_editors" edges to Platform entities.
func (_u *GroupUpdate) RemovePlatformEditors(v ...*Platform) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemovePlatformEditorIDs(ids...)
}

// ClearPlatformBlockedGroups clears all "platform_blocked_groups" edges to the Platform entity.
func (_u *GroupUpdate) ClearPlatformBlockedGroups() *GroupUpdate {
	_u.mutation.ClearPlatformBlockedGroups()
	return _u
}

// RemovePlatformBlockedGroupIDs removes the "platform_blocked_groups" edge to Platform entities by IDs.
func (_u *GroupUpdate) RemovePlatformBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemovePlatformBlockedGroupIDs(ids...)
	return _u
}

// RemovePlatformBlockedGroups removes "platform_blocked_groups" edges to Platform entities.
func (_u *GroupUpdate) RemovePlatformBlockedGroups(v ...*Platform) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemovePlatformBlockedGroupIDs(ids...)
}

// ClearPlatformViewers clears all "platform_viewers" edges to the Platform entity.
func (_u *GroupUpdate) ClearPlatformViewers() *GroupUpdate {
	_u.mutation.ClearPlatformViewers()
	return _u
}

// RemovePlatformViewerIDs removes the "platform_viewers" edge to Platform entities by IDs.
func (_u *GroupUpdate) RemovePlatformViewerIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemovePlatformViewerIDs(ids...)
	return _u
}

// RemovePlatformViewers removes "platform_viewers" edges to Platform entities.
func (_u *GroupUpdate) RemovePlatformViewers(v ...*Platform) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemovePlatformViewerIDs(ids...)
}

// ClearCampaignEditors clears all "campaign_editors" edges to the Campaign entity.
func (_u *GroupUpdate) ClearCampaignEditors() *GroupUpdate {
	_u.mutation.ClearCampaignEditors()
	return _u
}

// RemoveCampaignEditorIDs removes the "campaign_editors" edge to Campaign entities by IDs.
func (_u *GroupUpdate) RemoveCampaignEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveCampaignEditorIDs(ids...)
	return _u
}

// RemoveCampaignEditors removes "campaign_editors" edges to Campaign entities.
func (_u *GroupUpdate) RemoveCampaignEditors(v ...*Campaign) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveCampaignEditorIDs(ids...)
}

// ClearCampaignBlockedGroups clears all "campaign_blocked_groups" edges to the Campaign entity.
func (_u *GroupUpdate) ClearCampaignBlockedGroups() *GroupUpdate {
	_u.mutation.ClearCampaignBlockedGroups()
	return _u
}

// RemoveCampaignBlockedGroupIDs removes the "campaign_blocked_groups" edge to Campaign entities by IDs.
func (_u *GroupUpdate) RemoveCampaignBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveCampaignBlockedGroupIDs(ids...)
	return _u
}

// RemoveCampaignBlockedGroups removes "campaign_blocked_groups" edges to Campaign entities.
func (_u *GroupUpdate) RemoveCampaignBlockedGroups(v ...*Campaign) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveCampaignBlockedGroupIDs(ids...)
}

// ClearCampaignViewers clears all "campaign_viewers" edges to the Campaign entity.
func (_u *GroupUpdate) ClearCampaignViewers() *GroupUpdate {
	_u.mutation.ClearCampaignViewers()
	return _u
}

// RemoveCampaignViewerIDs removes the "campaign_viewers" edge to Campaign entities by IDs.
func (_u *GroupUpdate) RemoveCampaignViewerIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveCampaignViewerIDs(ids...)
	return _u
}

// RemoveCampaignViewers removes "campaign_viewers" edges to Campaign entities.
func (_u *GroupUpdate) RemoveCampaignViewers(v ...*Campaign) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFindingEditors clears all "finding_editors" edges to the Finding entity.
func (_u *GroupUpdate) ClearFindingEditors() *GroupUpdate {
	_u.mutation.ClearFindingEditors()
	return _u
}

// RemoveFindingEditorIDs removes the "finding_editors" edge to Finding entities by IDs.
func (_u *GroupUpdate) RemoveFindingEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveFindingEditorIDs(ids...)
	return _u
}

// RemoveFindingEditors removes "finding_editors" edges to Finding entities.
func (_u *GroupUpdate) RemoveFindingEditors(v ...*Finding) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveFindingEditorIDs(ids...)
}

// ClearFindingBlockedGroups clears all "finding_blocked_groups" edges to the Finding entity.
func (_u *GroupUpdate) ClearFindingBlockedGroups() *GroupUpdate {
	_u.mutation.ClearFindingBlockedGroups()
	return _u
}

// RemoveFindingBlockedGroupIDs removes the "finding_blocked_groups" edge to Finding entities by IDs.
func (_u *GroupUpdate) RemoveFindingBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveFindingBlockedGroupIDs(ids...)
	return _u
}

// RemoveFindingBlockedGroups removes "finding_blocked_groups" edges to Finding entities.
func (_u *GroupUpdate) RemoveFindingBlockedGroups(v ...*Finding) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveFindingBlockedGroupIDs(ids...)
}

// ClearReviewEditors clears all "review_editors" edges to the Review entity.
func (_u *GroupUpdate) ClearReviewEditors() *GroupUpdate {
	_u.mutation.ClearReviewEditors()
	return _u
}

// RemoveReviewEditorIDs removes the "review_editors" edge to Review entities by IDs.
func (_u *GroupUpdate) RemoveReviewEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveReviewEditorIDs(ids...)
	return _u
}

// RemoveReviewEditors removes "review_editors" edges to Review entities.
func (_u *GroupUpdate) RemoveReviewEditors(v ...*Review) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveReviewEditorIDs(ids...)
}

// ClearReviewBlockedGroups clears all "review_blocked_groups" edges to the Review entity.
func (_u *GroupUpdate) ClearReviewBlockedGroups() *GroupUpdate {
	_u.mutation.ClearReviewBlockedGroups()
	return _u
}

// RemoveReviewBlockedGroupIDs removes the "review_blocked_groups" edge to Review entities by IDs.
func (_u *GroupUpdate) RemoveReviewBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveReviewBlockedGroupIDs(ids...)
	return _u
}

// RemoveReviewBlockedGroups removes "review_blocked_groups" edges to Review entities.
func (_u *GroupUpdate) RemoveReviewBlockedGroups(v ...*Review) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveReviewBlockedGroupIDs(ids...)
}

// ClearRemediationEditors clears all "remediation_editors" edges to the Remediation entity.
func (_u *GroupUpdate) ClearRemediationEditors() *GroupUpdate {
	_u.mutation.ClearRemediationEditors()
	return _u
}

// RemoveRemediationEditorIDs removes the "remediation_editors" edge to Remediation entities by IDs.
func (_u *GroupUpdate) RemoveRemediationEditorIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveRemediationEditorIDs(ids...)
	return _u
}

// RemoveRemediationEditors removes "remediation_editors" edges to Remediation entities.
func (_u *GroupUpdate) RemoveRemediationEditors(v ...*Remediation) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveRemediationEditorIDs(ids...)
}

// ClearRemediationBlockedGroups clears all "remediation_blocked_groups" edges to the Remediation entity.
func (_u *GroupUpdate) ClearRemediationBlockedGroups() *GroupUpdate {
	_u.mutation.ClearRemediationBlockedGroups()
	return _u
}

// RemoveRemediationBlockedGroupIDs removes the "remediation_blocked_groups" edge to Remediation entities by IDs.
func (_u *GroupUpdate) RemoveRemediationBlockedGroupIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveRemediationBlockedGroupIDs(ids...)
	return _u
}

// RemoveRemediationBlockedGroups removes "remediation_blocked_groups" edges to Remediation entities.
func (_u *GroupUpdate) RemoveRemediationBlockedGroups(v ...*Remediation) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveRemediationBlockedGroupIDs(ids...)
}
...
func (_u *GroupUpdate) ClearCampaignTargets() *GroupUpdate {
...
func (_u *GroupUpdate) RemoveCampaignTargetIDs(ids ...string) *GroupUpdate {
	_u.mutation.RemoveCampaignTargetIDs(ids...)
	return _u
}

// RemoveCampaignTargets removes "campaign_targets" edges to CampaignTarget entities.
func (_u *GroupUpdate) RemoveCampaignTargets(v ...*CampaignTarget) *GroupUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.UpdatedByImpersonatorCleared() {
		_spec.ClearField(group.FieldUpdatedByImpersonator, field.TypeString)
	}
	...
	if _u.mutation.PlatformEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedPlatformEditorsIDs(); len(nodes) > 0 && !_u.mutation.PlatformEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.PlatformEditorsTable,
	...
	if nodes := _u.mutation.PlatformEditorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.PlatformEditorsTable,
	...
	if _u.mutation.PlatformBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedPlatformBlockedGroupsIDs(); len(nodes) > 0 && !_u.mutation.PlatformBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.PlatformBlockedGroupsTable,
	...
	if nodes := _u.mutation.PlatformBlockedGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.PlatformBlockedGroupsTable,
	...
	if _u.mutation.PlatformViewersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedPlatformViewersIDs(); len(nodes) > 0 && !_u.mutation.PlatformViewersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.PlatformViewersTable,
	...
	if nodes := _u.mutation.PlatformViewersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.PlatformViewersTable,
	...
	if _u.mutation.CampaignEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedCampaignEditorsIDs(); len(nodes) > 0 && !_u.mutation.CampaignEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.CampaignEditorsTable,
	...
	if nodes := _u.mutation.CampaignEditorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.CampaignEditorsTable,
	...
	if _u.mutation.CampaignBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedCampaignBlockedGroupsIDs(); len(nodes) > 0 && !_u.mutation.CampaignBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.CampaignBlockedGroupsTable,
	...
	if nodes := _u.mutation.CampaignBlockedGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.CampaignBlockedGroupsTable,
	...
	if _u.mutation.CampaignViewersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedCampaignViewersIDs(); len(nodes) > 0 && !_u.mutation.CampaignViewersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.CampaignViewersTable,
	...
	if nodes := _u.mutation.CampaignViewersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.CampaignViewersTable,
	...
	if _u.mutation.FindingEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedFindingEditorsIDs(); len(nodes) > 0 && !_u.mutation.FindingEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.FindingEditorsTable,
	...
	if nodes := _u.mutation.FindingEditorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.FindingEditorsTable,
	...
	if _u.mutation.FindingBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedFindingBlockedGroupsIDs(); len(nodes) > 0 && !_u.mutation.FindingBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.FindingBlockedGroupsTable,
	...
	if nodes := _u.mutation.FindingBlockedGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.FindingBlockedGroupsTable,
	...
	if _u.mutation.ReviewEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedReviewEditorsIDs(); len(nodes) > 0 && !_u.mutation.ReviewEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.ReviewEditorsTable,
	...
	if nodes := _u.mutation.ReviewEditorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.ReviewEditorsTable,
	...
	if _u.mutation.ReviewBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := _u.mutation.RemovedReviewBlockedGroupsIDs(); len(nodes) > 0 && !_u.mutation.ReviewBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.ReviewBlockedGroupsTable,
	...
	if nodes := _u.mutation.ReviewBlockedGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.ReviewBlockedGroupsTable,
	...
	if _u.mutation.RemediationEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
		...
		edge.Schema = _u.schemaConfig.RemediationEditors
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := _u.mutation.RemovedRemediationEditorsIDs(); len(nodes) > 0 && !_u.mutation.RemediationEditorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.RemediationEditorsTable,
	...
	if nodes := _u.mutation.RemediationEditorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.RemediationEditorsTable,
	...
	if _u.mutation.RemediationBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
		...
		edge.Schema = _u.schemaConfig.RemediationBlockedGroups
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := _u.mutation.RemovedRemediationBlockedGroupsIDs(); len(nodes) > 0 && !_u.mutation.RemediationBlockedGroupsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.RemediationBlockedGroupsTable,
	...
	if nodes := _u.mutation.RemediationBlockedGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   group.RemediationBlockedGroupsTable,
...
// SetUpdatedByImpersonator sets the "updated_by_impersonator" field.
func (_u *GroupUpdateOne) SetUpdatedByImpersonator(v string) *GroupUpdateOne {
	_u.mutation.SetUpdatedByImpersonator(v)
	return _u
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableUpdatedByImpersonator(v *string) *GroupUpdateOne {
	if v != nil {
		_u.SetUpdatedByImpersonator(*v)
	}
	return _u
...
// ClearUpdatedByImpersonator clears the value of the "updated_by_impersonator" field.
func (_u *GroupUpdateOne) ClearUpdatedByImpersonator() *GroupUpdateOne {
	_u.mutation.ClearUpdatedByImpersonator()
	return _u
}
...
// AddPlatformEditorIDs adds the "platform_editors" edge to the Platform entity by IDs.
func (_u *GroupUpdateOne) AddPlatformEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddPlatformEditorIDs(ids...)
	return _u
}

// AddPlatformEditors adds the "platform_editors" edges to the Platform entity.
func (_u *GroupUpdateOne) AddPlatformEditors(v ...*Platform) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPlatformBlockedGroupIDs adds the "platform_blocked_groups" edge to the Platform entity by IDs.
func (_u *GroupUpdateOne) AddPlatformBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddPlatformBlockedGroupIDs(ids...)
	return _u
}

// AddPlatformBlockedGroups adds the "platform_blocked_groups" edges to the Platform entity.
func (_u *GroupUpdateOne) AddPlatformBlockedGroups(v ...*Platform) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPlatformViewerIDs adds the "platform_viewers" edge to the Platform entity by IDs.
func (_u *GroupUpdateOne) AddPlatformViewerIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddPlatformViewerIDs(ids...)
	return _u
}

// AddPlatformViewers adds the "platform_viewers" edges to the Platform entity.
func (_u *GroupUpdateOne) AddPlatformViewers(v ...*Platform) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddCampaignEditorIDs adds the "campaign_editors" edge to the Campaign entity by IDs.
func (_u *GroupUpdateOne) AddCampaignEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddCampaignEditorIDs(ids...)
	return _u
}

// AddCampaignEditors adds the "campaign_editors" edges to the Campaign entity.
func (_u *GroupUpdateOne) AddCampaignEditors(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddCampaignBlockedGroupIDs adds the "campaign_blocked_groups" edge to the Campaign entity by IDs.
func (_u *GroupUpdateOne) AddCampaignBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddCampaignBlockedGroupIDs(ids...)
	return _u
}

// AddCampaignBlockedGroups adds the "campaign_blocked_groups" edges to the Campaign entity.
func (_u *GroupUpdateOne) AddCampaignBlockedGroups(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddCampaignViewerIDs adds the "campaign_viewers" edge to the Campaign entity by IDs.
func (_u *GroupUpdateOne) AddCampaignViewerIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddCampaignViewerIDs(ids...)
	return _u
}

// AddCampaignViewers adds the "campaign_viewers" edges to the Campaign entity.
func (_u *GroupUpdateOne) AddCampaignViewers(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddFindingEditorIDs adds the "finding_editors" edge to the Finding entity by IDs.
func (_u *GroupUpdateOne) AddFindingEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddFindingEditorIDs(ids...)
	return _u
}

// AddFindingEditors adds the "finding_editors" edges to the Finding entity.
func (_u *GroupUpdateOne) AddFindingEditors(v ...*Finding) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddFindingBlockedGroupIDs adds the "finding_blocked_groups" edge to the Finding entity by IDs.
func (_u *GroupUpdateOne) AddFindingBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddFindingBlockedGroupIDs(ids...)
	return _u
}

// AddFindingBlockedGroups adds the "finding_blocked_groups" edges to the Finding entity.
func (_u *GroupUpdateOne) AddFindingBlockedGroups(v ...*Finding) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddReviewEditorIDs adds the "review_editors" edge to the Review entity by IDs.
func (_u *GroupUpdateOne) AddReviewEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddReviewEditorIDs(ids...)
	return _u
}

// AddReviewEditors adds the "review_editors" edges to the Review entity.
func (_u *GroupUpdateOne) AddReviewEditors(v ...*Review) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddReviewBlockedGroupIDs adds the "review_blocked_groups" edge to the Review entity by IDs.
func (_u *GroupUpdateOne) AddReviewBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddReviewBlockedGroupIDs(ids...)
	return _u
}

// AddReviewBlockedGroups adds the "review_blocked_groups" edges to the Review entity.
func (_u *GroupUpdateOne) AddReviewBlockedGroups(v ...*Review) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddRemediationEditorIDs adds the "remediation_editors" edge to the Remediation entity by IDs.
func (_u *GroupUpdateOne) AddRemediationEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddRemediationEditorIDs(ids...)
	return _u
}

// AddRemediationEditors adds the "remediation_editors" edges to the Remediation entity.
func (_u *GroupUpdateOne) AddRemediationEditors(v ...*Remediation) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddRemediationBlockedGroupIDs adds the "remediation_blocked_groups" edge to the Remediation entity by IDs.
func (_u *GroupUpdateOne) AddRemediationBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddRemediationBlockedGroupIDs(ids...)
	return _u
}

// AddRemediationBlockedGroups adds the "remediation_blocked_groups" edges to the Remediation entity.
func (_u *GroupUpdateOne) AddRemediationBlockedGroups(v ...*Remediation) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddCampaignIDs adds the "campaigns" edge to the Campaign entity by IDs.
func (_u *GroupUpdateOne) AddCampaignIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddCampaignIDs(ids...)
	return _u
}

// AddCampaigns adds the "campaigns" edges to the Campaign entity.
func (_u *GroupUpdateOne) AddCampaigns(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddCampaignTargetIDs adds the "campaign_targets" edge to the CampaignTarget entity by IDs.
func (_u *GroupUpdateOne) AddCampaignTargetIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.AddCampaignTargetIDs(ids...)
	return _u
}

// AddCampaignTargets adds the "campaign_targets" edges to the CampaignTarget entity.
func (_u *GroupUpdateOne) AddCampaignTargets(v ...*CampaignTarget) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPlatformEditors clears all "platform_editors" edges to the Platform entity.
func (_u *GroupUpdateOne) ClearPlatformEditors() *GroupUpdateOne {
	_u.mutation.ClearPlatformEditors()
	return _u
}

// RemovePlatformEditorIDs removes the "platform_editors" edge to Platform entities by IDs.
func (_u *GroupUpdateOne) RemovePlatformEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemovePlatformEditorIDs(ids...)
	return _u
}

// RemovePlatformEditors removes "platform_editors" edges to Platform entities.
func (_u *GroupUpdateOne) RemovePlatformEditors(v ...*Platform) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPlatformBlockedGroups clears all "platform_blocked_groups" edges to the Platform entity.
func (_u *GroupUpdateOne) ClearPlatformBlockedGroups() *GroupUpdateOne {
	_u.mutation.ClearPlatformBlockedGroups()
	return _u
}

// RemovePlatformBlockedGroupIDs removes the "platform_blocked_groups" edge to Platform entities by IDs.
func (_u *GroupUpdateOne) RemovePlatformBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemovePlatformBlockedGroupIDs(ids...)
	return _u
}

// RemovePlatformBlockedGroups removes "platform_blocked_groups" edges to Platform entities.
func (_u *GroupUpdateOne) RemovePlatformBlockedGroups(v ...*Platform) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPlatformViewers clears all "platform_viewers" edges to the Platform entity.
func (_u *GroupUpdateOne) ClearPlatformViewers() *GroupUpdateOne {
	_u.mutation.ClearPlatformViewers()
	return _u
}

// RemovePlatformViewerIDs removes the "platform_viewers" edge to Platform entities by IDs.
func (_u *GroupUpdateOne) RemovePlatformViewerIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemovePlatformViewerIDs(ids...)
	return _u
}

// RemovePlatformViewers removes "platform_viewers" edges to Platform entities.
func (_u *GroupUpdateOne) RemovePlatformViewers(v ...*Platform) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCampaignEditors clears all "campaign_editors" edges to the Campaign entity.
func (_u *GroupUpdateOne) ClearCampaignEditors() *GroupUpdateOne {
	_u.mutation.ClearCampaignEditors()
	return _u
}

// RemoveCampaignEditorIDs removes the "campaign_editors" edge to Campaign entities by IDs.
func (_u *GroupUpdateOne) RemoveCampaignEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveCampaignEditorIDs(ids...)
	return _u
}

// RemoveCampaignEditors removes "campaign_editors" edges to Campaign entities.
func (_u *GroupUpdateOne) RemoveCampaignEditors(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCampaignBlockedGroups clears all "campaign_blocked_groups" edges to the Campaign entity.
func (_u *GroupUpdateOne) ClearCampaignBlockedGroups() *GroupUpdateOne {
	_u.mutation.ClearCampaignBlockedGroups()
	return _u
}

// RemoveCampaignBlockedGroupIDs removes the "campaign_blocked_groups" edge to Campaign entities by IDs.
func (_u *GroupUpdateOne) RemoveCampaignBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveCampaignBlockedGroupIDs(ids...)
	return _u
}

// RemoveCampaignBlockedGroups removes "campaign_blocked_groups" edges to Campaign entities.
func (_u *GroupUpdateOne) RemoveCampaignBlockedGroups(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCampaignViewers clears all "campaign_viewers" edges to the Campaign entity.
func (_u *GroupUpdateOne) ClearCampaignViewers() *GroupUpdateOne {
	_u.mutation.ClearCampaignViewers()
	return _u
}

// RemoveCampaignViewerIDs removes the "campaign_viewers" edge to Campaign entities by IDs.
func (_u *GroupUpdateOne) RemoveCampaignViewerIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveCampaignViewerIDs(ids...)
	return _u
}

// RemoveCampaignViewers removes "campaign_viewers" edges to Campaign entities.
func (_u *GroupUpdateOne) RemoveCampaignViewers(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFindingEditors clears all "finding_editors" edges to the Finding entity.
func (_u *GroupUpdateOne) ClearFindingEditors() *GroupUpdateOne {
	_u.mutation.ClearFindingEditors()
	return _u
}

// RemoveFindingEditorIDs removes the "finding_editors" edge to Finding entities by IDs.
func (_u *GroupUpdateOne) RemoveFindingEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveFindingEditorIDs(ids...)
	return _u
}

// RemoveFindingEditors removes "finding_editors" edges to Finding entities.
func (_u *GroupUpdateOne) RemoveFindingEditors(v ...*Finding) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFindingBlockedGroups clears all "finding_blocked_groups" edges to the Finding entity.
func (_u *GroupUpdateOne) ClearFindingBlockedGroups() *GroupUpdateOne {
	_u.mutation.ClearFindingBlockedGroups()
	return _u
}

// RemoveFindingBlockedGroupIDs removes the "finding_blocked_groups" edge to Finding entities by IDs.
func (_u *GroupUpdateOne) RemoveFindingBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveFindingBlockedGroupIDs(ids...)
	return _u
}

// RemoveFindingBlockedGroups removes "finding_blocked_groups" edges to Finding entities.
func (_u *GroupUpdateOne) RemoveFindingBlockedGroups(v ...*Finding) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearReviewEditors clears all "review_editors" edges to the Review entity.
func (_u *GroupUpdateOne) ClearReviewEditors() *GroupUpdateOne {
	_u.mutation.ClearReviewEditors()
	return _u
}

// RemoveReviewEditorIDs removes the "review_editors" edge to Review entities by IDs.
func (_u *GroupUpdateOne) RemoveReviewEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveReviewEditorIDs(ids...)
	return _u
}

// RemoveReviewEditors removes "review_editors" edges to Review entities.
func (_u *GroupUpdateOne) RemoveReviewEditors(v ...*Review) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearReviewBlockedGroups clears all "review_blocked_groups" edges to the Review entity.
func (_u *GroupUpdateOne) ClearReviewBlockedGroups() *GroupUpdateOne {
	_u.mutation.ClearReviewBlockedGroups()
	return _u
}

// RemoveReviewBlockedGroupIDs removes the "review_blocked_groups" edge to Review entities by IDs.
func (_u *GroupUpdateOne) RemoveReviewBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveReviewBlockedGroupIDs(ids...)
	return _u
}

// RemoveReviewBlockedGroups removes "review_blocked_groups" edges to Review entities.
func (_u *GroupUpdateOne) RemoveReviewBlockedGroups(v ...*Review) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearRemediationEditors clears all "remediation_editors" edges to the Remediation entity.
func (_u *GroupUpdateOne) ClearRemediationEditors() *GroupUpdateOne {
	_u.mutation.ClearRemediationEditors()
	return _u
}

// RemoveRemediationEditorIDs removes the "remediation_editors" edge to Remediation entities by IDs.
func (_u *GroupUpdateOne) RemoveRemediationEditorIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveRemediationEditorIDs(ids...)
	return _u
}

// RemoveRemediationEditors removes "remediation_editors" edges to Remediation entities.
func (_u *GroupUpdateOne) RemoveRemediationEditors(v ...*Remediation) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearRemediationBlockedGroups clears all "remediation_blocked_groups" edges to the Remediation entity.
func (_u *GroupUpdateOne) ClearRemediationBlockedGroups() *GroupUpdateOne {
	_u.mutation.ClearRemediationBlockedGroups()
	return _u
}

// RemoveRemediationBlockedGroupIDs removes the "remediation_blocked_groups" edge to Remediation entities by IDs.
func (_u *GroupUpdateOne) RemoveRemediationBlockedGroupIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveRemediationBlockedGroupIDs(ids...)
	return _u
}

// RemoveRemediationBlockedGroups removes "remediation_blocked_groups" edges to Remediation entities.
func (_u *GroupUpdateOne) RemoveRemediationBlockedGroups(v ...*Remediation) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCampaigns clears all "campaigns" edges to the Campaign entity.
func (_u *GroupUpdateOne) ClearCampaigns() *GroupUpdateOne {
	_u.mutation.ClearCampaigns()
	return _u
}

// RemoveCampaignIDs removes the "campaigns" edge to Campaign entities by IDs.
func (_u *GroupUpdateOne) RemoveCampaignIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveCampaignIDs(ids...)
	return _u
}

// RemoveCampaigns removes "campaigns" edges to Campaign entities.
func (_u *GroupUpdateOne) RemoveCampaigns(v ...*Campaign) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearCampaignTargets clears all "campaign_targets" edges to the CampaignTarget entity.
func (_u *GroupUpdateOne) ClearCampaignTargets() *GroupUpdateOne {
	_u.mutation.ClearCampaignTargets()
	return _u
}

// RemoveCampaignTargetIDs removes the "campaign_targets" edge to CampaignTarget entities by IDs.
func (_u *GroupUpdateOne) RemoveCampaignTargetIDs(ids ...string) *GroupUpdateOne {
	_u.mutation.RemoveCampaignTargetIDs(ids...)
	return _u
}

// RemoveCampaignTargets removes "campaign_targets" edges to CampaignTarget entities.
func (_u *GroupUpdateOne) RemoveCampaignTargets(v ...*CampaignTarget) *GroupUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
