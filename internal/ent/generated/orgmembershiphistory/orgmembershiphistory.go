...
const (
	// Label holds the string label denoting the orgmembershiphistory type in the database.
	Label = "org_membership_history"
	...
	FieldUserID = "user_id"
	// Table holds the table name of the orgmembershiphistory in the database.
	Table = "org_membership_history"
)

// Columns holds all SQL columns for orgmembershiphistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("orgmembershiphistory: invalid enum value for operation field: %q", o)
	}
}
...
func RoleValidator(r enums.Role) error {
	...
	case "ADMIN", "MEMBER", "OWNER":
		return nil
	default:
		return fmt.Errorf("orgmembershiphistory: invalid enum value for role field: %q", r)
	}
}

// OrderOption defines the ordering options for the OrgMembershipHistory queries.
