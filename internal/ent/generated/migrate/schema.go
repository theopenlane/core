...
var (
	...
	ActionPlansColumns = []*schema.Column{
		...
		{Name: "source_definition_id", Type: field.TypeString, Nullable: true},
		{Name: "source_definition_version", Type: field.TypeString, Nullable: true},
		{Name: "source_instance_id", Type: field.TypeString, Nullable: true},
		{Name: "managed_by", Type: field.TypeString, Nullable: true},
	...
	ActionPlansTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "actionplan_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{ActionPlansColumns[12]},
			},
			{
				Name:    "actionplan_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{ActionPlansColumns[14]},
			},
			{
				Name:    "actionplan_external_file_id_owner_id",
				Unique:  false,
				Columns: []*schema.Column{ActionPlansColumns[31], ActionPlansColumns[54]},
	...
	AssessmentResponsesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{AssessmentResponsesColumns[29]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "assessment_responses_identity_holders_assessment_responses",
				Columns:    []*schema.Column{AssessmentResponsesColumns[30]},
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{AssessmentResponsesColumns[26], AssessmentResponsesColumns[11], AssessmentResponsesColumns[9]},
				Annotation: &entsql.IndexAnnotation{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{AssessmentResponsesColumns[28], AssessmentResponsesColumns[26], AssessmentResponsesColumns[11], AssessmentResponsesColumns[9]},
				Annotation: &entsql.IndexAnnotation{
	...
	AssetsColumns = []*schema.Column{
		...
		{Name: "internal_owner_identity_holder_id", Type: field.TypeString, Nullable: true},
	...
	AssetsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "assets_identity_holders_internal_owner_identity_holder",
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "asset_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{AssetsColumns[11]},
			},
			{
				Name:    "asset_integration_run_id",
				Unique:  false,
			...
			{
				Name:    "asset_source_identifier_owner_id",
				Unique:  false,
				Columns: []*schema.Column{AssetsColumns[36], AssetsColumns[55]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	// AudiencesColumns holds the columns for the "audiences" table.
	AudiencesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime, Nullable: true},
		{Name: "created_by", Type: field.TypeString, Nullable: true},
	...
	// AudiencesTable holds the schema information for the "audiences" table.
	AudiencesTable = &schema.Table{
		Name:       "audiences",
		Columns:    AudiencesColumns,
		PrimaryKey: []*schema.Column{AudiencesColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "audiences_organizations_audiences",
		...
		Indexes: []*schema.Index{
			{
				Name:    "audience_display_id_owner_id",
				Unique:  true,
				Columns: []*schema.Column{AudiencesColumns[8], AudiencesColumns[15]},
			},
			{
				Name:    "audience_owner_id_idx",
				Unique:  false,
				Columns: []*schema.Column{AudiencesColumns[15]},
			},
			{
	...
	// AudienceMembersColumns holds the columns for the "audience_members" table.
	AudienceMembersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime, Nullable: true},
		{Name: "created_by", Type: field.TypeString, Nullable: true},
	...
	// AudienceMembersTable holds the schema information for the "audience_members" table.
	AudienceMembersTable = &schema.Table{
		Name:       "audience_members",
		Columns:    AudienceMembersColumns,
		PrimaryKey: []*schema.Column{AudienceMembersColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "audience_members_audiences_audience_members",
				Columns:    []*schema.Column{AudienceMembersColumns[13]},
				RefColumns: []*schema.Column{AudiencesColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "audience_members_contacts_audience_members",
				Columns:    []*schema.Column{AudienceMembersColumns[14]},
				RefColumns: []*schema.Column{ContactsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "audience_members_groups_audience_members",
				Columns:    []*schema.Column{AudienceMembersColumns[15]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "audience_members_identity_holders_audience_members",
				Columns:    []*schema.Column{AudienceMembersColumns[16]},
				RefColumns: []*schema.Column{IdentityHoldersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "audience_members_organizations_audience_members",
				Columns:    []*schema.Column{AudienceMembersColumns[17]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "audience_members_subscribers_audience_members",
				Columns:    []*schema.Column{AudienceMembersColumns[18]},
				RefColumns: []*schema.Column{SubscribersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "audience_members_users_audience_members",
				Columns:    []*schema.Column{AudienceMembersColumns[19]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "audience_member_contact_id_idx",
				Unique:  false,
				Columns: []*schema.Column{AudienceMembersColumns[14]},
			},
			{
				Name:    "audience_member_user_id_idx",
				Unique:  false,
				Columns: []*schema.Column{AudienceMembersColumns[19]},
			},
			{
				Name:    "audience_member_group_id_idx",
				Unique:  false,
				Columns: []*schema.Column{AudienceMembersColumns[15]},
			},
			{
				Name:    "audience_member_identity_holder_id_idx",
				Unique:  false,
				Columns: []*schema.Column{AudienceMembersColumns[16]},
			},
			{
				Name:    "audience_member_subscriber_id_idx",
				Unique:  false,
				Columns: []*schema.Column{AudienceMembersColumns[18]},
			},
			{
				Name:    "audiencemember_display_id_owner_id",
				Unique:  true,
				Columns: []*schema.Column{AudienceMembersColumns[8], AudienceMembersColumns[17]},
			},
			{
				Name:    "audience_member_owner_id_idx",
				Unique:  false,
				Columns: []*schema.Column{AudienceMembersColumns[17]},
			},
			{
				Name:    "audiencemember_audience_id_email",
				Unique:  true,
				Columns: []*schema.Column{AudienceMembersColumns[13], AudienceMembersColumns[10]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	CampaignsColumns = []*schema.Column{
		...
		{Name: "recurrence_frequency", Type: field.TypeEnum, Nullable: true, Enums: []string{"YEARLY", "QUARTERLY", "BIANNUALLY", "MONTHLY", "NONE", "BIENNIALLY", "TRIENNIALLY"}, Default: "NONE"},
	...
	CampaignsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "campaigns_identity_holders_internal_owner_identity_holder",
			...
			{
				Symbol:     "campaigns_trust_centers_campaigns",
				Columns:    []*schema.Column{CampaignsColumns[43]},
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{CampaignsColumns[8], CampaignsColumns[41]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{CampaignsColumns[12], CampaignsColumns[41]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	CampaignTargetsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{CampaignTargetsColumns[11]},
			},
			{
	...
	CheckResultsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "check_results_integrations_check_results",
				Columns:    []*schema.Column{CheckResultsColumns[20]},
				RefColumns: []*schema.Column{IntegrationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			{
				Name:    "checkresult_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{CheckResultsColumns[11]},
			},
			{
				Name:    "checkresult_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{CheckResultsColumns[13]},
			},
		},
	}
	...
	ContactsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ContactsColumns[24]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "contact_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{ContactsColumns[11]},
			},
			{
				Name:    "contact_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{ContactsColumns[13]},
			},
			{
	...
	ControlsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Nullable: true, Enums: []string{"DRAFT", "PREPARING", "NEEDS_APPROVAL", "CHANGES_REQUESTED", "APPROVED", "ARCHIVED", "NOT_IMPLEMENTED", "NOT_APPLICABLE"}, Default: "NOT_IMPLEMENTED"},
		...
		{Name: "trust_center_visibility", Type: field.TypeEnum, Nullable: true, Enums: []string{"PUBLICLY_VISIBLE", "NOT_VISIBLE"}, Default: "NOT_VISIBLE"},
	...
	ControlsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ControlsColumns[10], ControlsColumns[54]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ControlsColumns[55], ControlsColumns[44]},
				Annotation: &entsql.IndexAnnotation{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ControlsColumns[55], ControlsColumns[44], ControlsColumns[54]},
				Annotation: &entsql.IndexAnnotation{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ControlsColumns[44], ControlsColumns[54]},
				Annotation: &entsql.IndexAnnotation{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ControlsColumns[16]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	CustomTypeEnumsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{CustomTypeEnumsColumns[13], CustomTypeEnumsColumns[11], CustomTypeEnumsColumns[12], CustomTypeEnumsColumns[18]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{CustomTypeEnumsColumns[11]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{CustomTypeEnumsColumns[13], CustomTypeEnumsColumns[12]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	DNSVerificationsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{DNSVerificationsColumns[9]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	DirectoryAccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{DirectoryAccountsColumns[6], DirectoryAccountsColumns[46]},
			},
			{
				Name:    "directoryaccount_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[10]},
			},
			{
				Name:    "directoryaccount_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[12]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[47], DirectoryAccountsColumns[16]},
			},
			{
				Name:    "directoryaccount_integration_id_canonical_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[45], DirectoryAccountsColumns[18]},
			},
			{
				Name:    "directoryaccount_platform_id_canonical_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[47], DirectoryAccountsColumns[18]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[44], DirectoryAccountsColumns[15]},
			},
			{
				Name:    "directoryaccount_owner_id_canonical_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[46], DirectoryAccountsColumns[18]},
			},
		},
	}
	...
	DirectoryGroupsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "directorygroup_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[10]},
			},
			{
				Name:    "directorygroup_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[12]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[35], DirectoryGroupsColumns[15]},
			},
			{
				Name:    "directorygroup_integration_id_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[33], DirectoryGroupsColumns[16]},
			},
			{
				Name:    "directorygroup_platform_id_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[35], DirectoryGroupsColumns[16]},
			},
			{
				Name:    "directorygroup_owner_id_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[34], DirectoryGroupsColumns[16]},
			},
		},
	}
	...
	DirectoryMembershipsColumns = []*schema.Column{
		...
		{Name: "environment_name", Type: field.TypeString, Nullable: true},
		{Name: "scope_name", Type: field.TypeString, Nullable: true},
		{Name: "role", Type: field.TypeEnum, Nullable: true, Enums: []string{"MEMBER", "MAINTAINER", "MANAGER", "OWNER"}, Default: "MEMBER"},
		{Name: "source", Type: field.TypeString, Nullable: true},
		{Name: "directory_name", Type: field.TypeString, Nullable: true},
		{Name: "added_at", Type: field.TypeTime, Nullable: true},
		{Name: "removed_at", Type: field.TypeTime, Nullable: true},
	...
	DirectoryMembershipsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{DirectoryMembershipsColumns[27]},
				RefColumns: []*schema.Column{PlatformsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "directory_membership_integration_id_idx",
				Unique:  false,
				Columns: []*schema.Column{DirectoryMembershipsColumns[25]},
			},
			{
				Name:    "directory_membership_platform_id_idx",
				Unique:  false,
				Columns: []*schema.Column{DirectoryMembershipsColumns[27]},
			},
			{
			...
			{
				Name:    "directorymembership_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{DirectoryMembershipsColumns[9]},
			},
			{
				Name:    "directorymembership_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{DirectoryMembershipsColumns[11]},
			},
			{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{DirectoryMembershipsColumns[23], DirectoryMembershipsColumns[24]},
				Annotation: &entsql.IndexAnnotation{
	...
	DiscussionsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{DiscussionsColumns[15]},
				RefColumns: []*schema.Column{SubcontrolsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	EmailTemplatesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "email_templates_trust_centers_email_templates",
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{EmailTemplatesColumns[29], EmailTemplatesColumns[12]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	EntitiesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "entity_integration_run_id",
				Unique:  false,
	...
	EntityTypesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{EntityTypesColumns[12], EntityTypesColumns[13]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	EvidencesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{EvidencesColumns[27]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{EvidencesColumns[13], EvidencesColumns[27]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	ExportsColumns = []*schema.Column{
		...
		{Name: "export_type", Type: field.TypeEnum, Enums: []string{"ASSESSMENT", "ASSET", "AUDIENCE", "AUDIENCE_MEMBER", "CAMPAIGN", "CHECK_RESULT", "CONTACT", "CONTROL", "DIRECTORY_MEMBERSHIP", "ENTITY", "EVIDENCE", "FINDING", "IDENTITY_HOLDER", "INTERNAL_POLICY", "PROCEDURE", "REMEDIATION", "REVIEW", "RISK", "SUBPROCESSOR", "SUBSCRIBER", "SYSTEM_DETAIL", "TASK", "TRUST_CENTER_FAQ", "TRUST_CENTER_SUBPROCESSOR", "VENDOR_RISK_SCORE", "VENDOR_SCORING_CONFIG", "VULNERABILITY"}},
		{Name: "format", Type: field.TypeEnum, Enums: []string{"CSV", "MARKDOWN", "DOCX", "PDF"}, Default: "CSV"},
	...
	FilesColumns = []*schema.Column{
		...
		{Name: "email_template_files", Type: field.TypeString, Nullable: true},
	...
	FilesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{FilesColumns[47]},
	...
	FindingsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "findings_users_internal_owner_user",
				Columns:    []*schema.Column{FindingsColumns[62]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_groups_internal_owner_group",
				Columns:    []*schema.Column{FindingsColumns[63]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_identity_holders_internal_owner_identity_holder",
				Columns:    []*schema.Column{FindingsColumns[64]},
				RefColumns: []*schema.Column{IdentityHoldersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_users_reviewed_by_user",
				Columns:    []*schema.Column{FindingsColumns[65]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_groups_reviewed_by_group",
				Columns:    []*schema.Column{FindingsColumns[66]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_identity_holders_reviewed_by_identity_holder",
				Columns:    []*schema.Column{FindingsColumns[67]},
				RefColumns: []*schema.Column{IdentityHoldersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_users_assigned_to_user",
				Columns:    []*schema.Column{FindingsColumns[68]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_groups_assigned_to_group",
				Columns:    []*schema.Column{FindingsColumns[69]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_identity_holders_assigned_to_identity_holder",
				Columns:    []*schema.Column{FindingsColumns[70]},
				RefColumns: []*schema.Column{IdentityHoldersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_custom_type_enums_environment",
				Columns:    []*schema.Column{FindingsColumns[71]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_custom_type_enums_scope",
				Columns:    []*schema.Column{FindingsColumns[72]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_custom_type_enums_finding_status",
				Columns:    []*schema.Column{FindingsColumns[73]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "findings_organizations_findings",
				Columns:    []*schema.Column{FindingsColumns[74]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{FindingsColumns[8], FindingsColumns[74]},
			},
			{
				Name:    "finding_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{FindingsColumns[12]},
			},
			{
				Name:    "finding_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{FindingsColumns[14]},
			},
			{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{FindingsColumns[25], FindingsColumns[27], FindingsColumns[74]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	FindingControlsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{FindingControlsColumns[12], FindingControlsColumns[13]},
			},
		},
	}
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "check_result_blocked_groups", Type: field.TypeString, Nullable: true},
		{Name: "check_result_editors", Type: field.TypeString, Nullable: true},
		{Name: "check_result_viewers", Type: field.TypeString, Nullable: true},
		{Name: "email_template_blocked_groups", Type: field.TypeString, Nullable: true},
		{Name: "email_template_editors", Type: field.TypeString, Nullable: true},
		{Name: "email_template_viewers", Type: field.TypeString, Nullable: true},
		{Name: "avatar_local_file_id", Type: field.TypeString, Nullable: true},
		...
		{Name: "organization_audience_creators", Type: field.TypeString, Nullable: true},
		{Name: "organization_audience_member_creators", Type: field.TypeString, Nullable: true},
		...
		{Name: "owner_id", Type: field.TypeString, Nullable: true},
		{Name: "sla_definition_blocked_groups", Type: field.TypeString, Nullable: true},
		{Name: "sla_definition_editors", Type: field.TypeString, Nullable: true},
	...
	GroupsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "groups_check_results_blocked_groups",
				Columns:    []*schema.Column{GroupsColumns[29]},
				RefColumns: []*schema.Column{CheckResultsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_check_results_editors",
				Columns:    []*schema.Column{GroupsColumns[30]},
				RefColumns: []*schema.Column{CheckResultsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_check_results_viewers",
				Columns:    []*schema.Column{GroupsColumns[31]},
				RefColumns: []*schema.Column{CheckResultsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_email_templates_blocked_groups",
				Columns:    []*schema.Column{GroupsColumns[32]},
				RefColumns: []*schema.Column{EmailTemplatesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_email_templates_editors",
				Columns:    []*schema.Column{GroupsColumns[33]},
				RefColumns: []*schema.Column{EmailTemplatesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_email_templates_viewers",
				Columns:    []*schema.Column{GroupsColumns[34]},
				RefColumns: []*schema.Column{EmailTemplatesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_files_avatar_file",
			...
			{
				Symbol:     "groups_organizations_audience_creators",
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{GroupsColumns[8], GroupsColumns[115]},
			},
			{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{GroupsColumns[10], GroupsColumns[115]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	IdentityHoldersColumns = []*schema.Column{
		...
		{Name: "internal_owner_user_id", Type: field.TypeString, Nullable: true},
		{Name: "internal_owner_group_id", Type: field.TypeString, Nullable: true},
		{Name: "internal_owner_identity_holder_id", Type: field.TypeString, Unique: true, Nullable: true},
		{Name: "environment_id", Type: field.TypeString, Nullable: true},
		{Name: "scope_id", Type: field.TypeString, Nullable: true},
	...
	IdentityHoldersTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "identity_holders_identity_holders_internal_owner_identity_holder",
			...
			},
			{
				...
				Columns:    []*schema.Column{IdentityHoldersColumns[39]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "identity_holders_users_identity_holder_profiles",
				Columns:    []*schema.Column{IdentityHoldersColumns[40]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{IdentityHoldersColumns[8], IdentityHoldersColumns[39]},
			},
			{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{IdentityHoldersColumns[15], IdentityHoldersColumns[39]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{IdentityHoldersColumns[29]},
			},
		},
	}
	...
	IntegrationRunsColumns = []*schema.Column{
		...
		{Name: "run_type", Type: field.TypeEnum, Nullable: true, Enums: []string{"MANUAL", "SCHEDULED", "WEBHOOK", "EVENT", "RECONCILE"}},
	...
	IntegrationWebhooksTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{IntegrationWebhooksColumns[21], IntegrationWebhooksColumns[9], IntegrationWebhooksColumns[19]},
				Annotation: &entsql.IndexAnnotation{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{IntegrationWebhooksColumns[11]},
				Annotation: &entsql.IndexAnnotation{
	...
	InternalPoliciesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{InternalPoliciesColumns[46]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "internal_policies_custom_type_enums_environment",
				Columns:    []*schema.Column{InternalPoliciesColumns[47]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "internal_policies_custom_type_enums_scope",
				Columns:    []*schema.Column{InternalPoliciesColumns[48]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "internal_policies_files_file",
				Columns:    []*schema.Column{InternalPoliciesColumns[49]},
				RefColumns: []*schema.Column{FilesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "internal_policies_organizations_internal_policies",
				Columns:    []*schema.Column{InternalPoliciesColumns[50]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{InternalPoliciesColumns[8], InternalPoliciesColumns[50]},
			},
			{
				Name:    "internalpolicy_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{InternalPoliciesColumns[13]},
			},
			{
				Name:    "internalpolicy_integration_run_id",
				Unique:  false,
			...
			{
				Name:    "internalpolicy_external_file_id_owner_id",
				Unique:  false,
				Columns: []*schema.Column{InternalPoliciesColumns[35], InternalPoliciesColumns[50]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{InternalPoliciesColumns[41], InternalPoliciesColumns[50]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	InvitesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{InvitesColumns[11], InvitesColumns[18]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{MappableDomainsColumns[9]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	NarrativesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{NarrativesColumns[18]},
				RefColumns: []*schema.Column{SubcontrolsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	NotesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{NotesColumns[31]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	NotificationPreferencesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{NotificationPreferencesColumns[29], NotificationPreferencesColumns[27], NotificationPreferencesColumns[8]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	NotificationTemplatesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{NotificationTemplatesColumns[33], NotificationTemplatesColumns[15], NotificationTemplatesColumns[17], NotificationTemplatesColumns[18]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{NotificationTemplatesColumns[33], NotificationTemplatesColumns[12]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	PlatformsColumns = []*schema.Column{
		...
		{Name: "business_owner_identity_holder_id", Type: field.TypeString, Nullable: true},
		...
		{Name: "technical_owner_identity_holder_id", Type: field.TypeString, Nullable: true},
		...
		{Name: "security_owner_identity_holder_id", Type: field.TypeString, Nullable: true},
	...
	PlatformsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "platforms_identity_holders_internal_owner_identity_holder",
			...
			{
				Symbol:     "platforms_identity_holders_business_owner_identity_holder",
			...
			{
				Symbol:     "platforms_identity_holders_technical_owner_identity_holder",
			...
			{
				Symbol:     "platforms_identity_holders_security_owner_identity_holder",
			...
			},
			{
				...
				Columns:    []*schema.Column{PlatformsColumns[59]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
			...
			},
			{
				...
				Columns:    []*schema.Column{PlatformsColumns[61]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "platforms_custom_type_enums_security_tier",
				Columns:    []*schema.Column{PlatformsColumns[62]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "platforms_custom_type_enums_criticality",
				Columns:    []*schema.Column{PlatformsColumns[63]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "platforms_users_platforms_owned",
				Columns:    []*schema.Column{PlatformsColumns[64]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{PlatformsColumns[24], PlatformsColumns[43]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{PlatformsColumns[23], PlatformsColumns[43]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	ProceduresTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{ProceduresColumns[46]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "procedures_custom_type_enums_procedure_kind",
				Columns:    []*schema.Column{ProceduresColumns[47]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "procedures_custom_type_enums_environment",
				Columns:    []*schema.Column{ProceduresColumns[48]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "procedures_custom_type_enums_scope",
				Columns:    []*schema.Column{ProceduresColumns[49]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "procedures_files_file",
				Columns:    []*schema.Column{ProceduresColumns[50]},
				RefColumns: []*schema.Column{FilesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ProceduresColumns[8], ProceduresColumns[44]},
			},
			{
				Name:    "procedure_source_instance_id",
				Unique:  false,
				Columns: []*schema.Column{ProceduresColumns[13]},
			},
			{
				Name:    "procedure_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{ProceduresColumns[15]},
			},
			{
			...
			{
				Name:    "procedure_external_file_id_owner_id",
				Unique:  false,
				Columns: []*schema.Column{ProceduresColumns[32], ProceduresColumns[44]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	ProgramMembershipsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ProgramMembershipsColumns[8], ProgramMembershipsColumns[7]},
			},
		},
	}
	...
	RemediationsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{RemediationsColumns[16], RemediationsColumns[17], RemediationsColumns[36]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	ReviewsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ReviewsColumns[14], ReviewsColumns[15], ReviewsColumns[32]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	RisksColumns = []*schema.Column{
		...
		{Name: "owner_id", Type: field.TypeString, Nullable: true},
		{Name: "stakeholder_user_id", Type: field.TypeString, Nullable: true},
		{Name: "stakeholder_group_id", Type: field.TypeString, Nullable: true},
		{Name: "stakeholder_identity_holder_id", Type: field.TypeString, Nullable: true},
	...
	SubcontrolsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{SubcontrolsColumns[50]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "subcontrols_users_subcontrols",
				Columns:    []*schema.Column{SubcontrolsColumns[51]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{SubcontrolsColumns[10], SubcontrolsColumns[45]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{SubcontrolsColumns[43], SubcontrolsColumns[42]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SubcontrolsColumns[43], SubcontrolsColumns[42], SubcontrolsColumns[45]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{SubcontrolsColumns[15], SubcontrolsColumns[6], SubcontrolsColumns[45]},
			},
			{
				Name:    "subcontrol_auditor_reference_id_deleted_at_owner_id",
				Unique:  false,
				Columns: []*schema.Column{SubcontrolsColumns[16], SubcontrolsColumns[6], SubcontrolsColumns[45]},
			},
		},
	}
	...
	SubprocessorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{SubprocessorsColumns[12], SubprocessorsColumns[15]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	SubscribersTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "subscribers_contacts_subscribers",
			...
			{
				Symbol:     "subscribers_trust_centers_subscribers",
				Columns:    []*schema.Column{SubscribersColumns[21]},
				RefColumns: []*schema.Column{TrustCentersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "subscribers_users_subscribers",
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{SubscribersColumns[9], SubscribersColumns[20]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL and unsubscribed = false and trust_center_id IS NULL",
				},
			},
			{
				Name:    "subscriber_email_trust_center_id",
				Unique:  true,
				Columns: []*schema.Column{SubscribersColumns[9], SubscribersColumns[21]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL and unsubscribed = false and trust_center_id IS NOT NULL",
				},
			},
		},
	}
	// SystemDetailsColumns holds the columns for the "system_details" table.
	SystemDetailsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime, Nullable: true},
		{Name: "created_by", Type: field.TypeString, Nullable: true},
	...
	// SystemDetailsTable holds the schema information for the "system_details" table.
	SystemDetailsTable = &schema.Table{
		Name:       "system_details",
		Columns:    SystemDetailsColumns,
		PrimaryKey: []*schema.Column{SystemDetailsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "system_details_organizations_system_details",
	...
	TagDefinitionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TagDefinitionsColumns[13], TagDefinitionsColumns[16]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TagDefinitionsColumns[11], TagDefinitionsColumns[16]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	TemplatesColumns = []*schema.Column{
		...
		{Name: "description", Type: field.TypeString, Nullable: true},
		{Name: "kind", Type: field.TypeEnum, Nullable: true, Enums: []string{"QUESTIONNAIRE", "TRUSTCENTER_NDA", "EXTERNAL_INTAKE"}, Default: "QUESTIONNAIRE"},
	...
	TemplatesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TemplatesColumns[14], TemplatesColumns[21], TemplatesColumns[15]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	TrustCenterCompliancesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TrustCenterCompliancesColumns[9], TrustCenterCompliancesColumns[10]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	TrustCenterDocsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{TrustCenterDocsColumns[19]},
				RefColumns: []*schema.Column{TrustCenterNdaRequestsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	TrustCenterFaqsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{TrustCenterFaqsColumns[13]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TrustCenterFaqsColumns[11], TrustCenterFaqsColumns[12]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	TrustCenterSubprocessorsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{TrustCenterSubprocessorsColumns[12]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	TrustCenterWatermarkConfigsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{TrustCenterWatermarkConfigsColumns[8]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	VendorRiskScoresColumns = []*schema.Column{
		...
		{Name: "assessment_response_vendor_risk_scores", Type: field.TypeString, Nullable: true},
		{Name: "entity_vendor_risk_scores", Type: field.TypeString, Nullable: true},
		{Name: "owner_id", Type: field.TypeString, Nullable: true},
		...
		{Name: "vendor_scoring_config_vendor_risk_scores", Type: field.TypeString, Nullable: true},
	}
	// VendorRiskScoresTable holds the schema information for the "vendor_risk_scores" table.
	VendorRiskScoresTable = &schema.Table{
		Name:       "vendor_risk_scores",
		Columns:    VendorRiskScoresColumns,
		PrimaryKey: []*schema.Column{VendorRiskScoresColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vendor_risk_scores_assessment_responses_vendor_risk_scores",
				Columns:    []*schema.Column{VendorRiskScoresColumns[19]},
				RefColumns: []*schema.Column{AssessmentResponsesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vendor_risk_scores_entities_vendor_risk_scores",
				Columns:    []*schema.Column{VendorRiskScoresColumns[20]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vendor_risk_scores_organizations_vendor_risk_scores",
				Columns:    []*schema.Column{VendorRiskScoresColumns[21]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vendor_risk_scores_vendor_scoring_configs_vendor_scoring_config",
				Columns:    []*schema.Column{VendorRiskScoresColumns[22]},
				RefColumns: []*schema.Column{VendorScoringConfigsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vendor_risk_scores_entities_entity",
				Columns:    []*schema.Column{VendorRiskScoresColumns[23]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "vendor_risk_scores_assessment_responses_assessment_response",
				Columns:    []*schema.Column{VendorRiskScoresColumns[24]},
				RefColumns: []*schema.Column{AssessmentResponsesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vendor_risk_scores_vendor_scoring_configs_vendor_risk_scores",
				Columns:    []*schema.Column{VendorRiskScoresColumns[25]},
				RefColumns: []*schema.Column{VendorScoringConfigsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	// VendorScoringConfigsColumns holds the columns for the "vendor_scoring_configs" table.
	VendorScoringConfigsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeString},
		{Name: "created_at", Type: field.TypeTime, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime, Nullable: true},
		{Name: "created_by", Type: field.TypeString, Nullable: true},
	...
	VendorScoringConfigsTable = &schema.Table{
		Name:       "vendor_scoring_configs",
		Columns:    VendorScoringConfigsColumns,
		PrimaryKey: []*schema.Column{VendorScoringConfigsColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
	...
	VulnerabilitiesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "vulnerabilities_users_internal_owner_user",
				Columns:    []*schema.Column{VulnerabilitiesColumns[68]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_groups_internal_owner_group",
				Columns:    []*schema.Column{VulnerabilitiesColumns[69]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_identity_holders_internal_owner_identity_holder",
				Columns:    []*schema.Column{VulnerabilitiesColumns[70]},
				RefColumns: []*schema.Column{IdentityHoldersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_users_reviewed_by_user",
				Columns:    []*schema.Column{VulnerabilitiesColumns[71]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_groups_reviewed_by_group",
				Columns:    []*schema.Column{VulnerabilitiesColumns[72]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_identity_holders_reviewed_by_identity_holder",
				Columns:    []*schema.Column{VulnerabilitiesColumns[73]},
				RefColumns: []*schema.Column{IdentityHoldersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_users_assigned_to_user",
				Columns:    []*schema.Column{VulnerabilitiesColumns[74]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_groups_assigned_to_group",
				Columns:    []*schema.Column{VulnerabilitiesColumns[75]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_identity_holders_assigned_to_identity_holder",
				Columns:    []*schema.Column{VulnerabilitiesColumns[76]},
				RefColumns: []*schema.Column{IdentityHoldersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_custom_type_enums_environment",
				Columns:    []*schema.Column{VulnerabilitiesColumns[77]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_custom_type_enums_scope",
				Columns:    []*schema.Column{VulnerabilitiesColumns[78]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "vulnerabilities_custom_type_enums_vulnerability_status",
				Columns:    []*schema.Column{VulnerabilitiesColumns[79]},
				RefColumns: []*schema.Column{CustomTypeEnumsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{VulnerabilitiesColumns[12]},
			},
			{
				Name:    "vulnerability_integration_run_id",
				Unique:  false,
				Columns: []*schema.Column{VulnerabilitiesColumns[14]},
			},
			{
	...
	WorkflowAssignmentsColumns = []*schema.Column{
		...
		{Name: "outcome_metadata", Type: field.TypeJSON, Nullable: true},
	...
	WorkflowAssignmentsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{WorkflowAssignmentsColumns[27]},
				RefColumns: []*schema.Column{WorkflowInstancesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{WorkflowAssignmentsColumns[24], WorkflowAssignmentsColumns[10]},
			},
		},
	}
	...
	WorkflowAssignmentTargetsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{WorkflowAssignmentTargetsColumns[14], WorkflowAssignmentTargetsColumns[10], WorkflowAssignmentTargetsColumns[15], WorkflowAssignmentTargetsColumns[16], WorkflowAssignmentTargetsColumns[11]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at IS NULL",
				},
			},
	...
	WorkflowEventsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{WorkflowEventsColumns[14]},
				RefColumns: []*schema.Column{WorkflowInstancesColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	WorkflowInstancesColumns = []*schema.Column{
		...
		{Name: "risk_id", Type: field.TypeString, Nullable: true},
		{Name: "task_id", Type: field.TypeString, Nullable: true},
		{Name: "vulnerability_id", Type: field.TypeString, Nullable: true},
	...
	WorkflowInstancesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "workflow_instances_assessments_assessment",
				Columns:    []*schema.Column{WorkflowInstancesColumns[27]},
				RefColumns: []*schema.Column{AssessmentsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_instances_assessment_responses_assessment_response",
				Columns:    []*schema.Column{WorkflowInstancesColumns[28]},
				RefColumns: []*schema.Column{AssessmentResponsesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_instances_findings_finding",
				Columns:    []*schema.Column{WorkflowInstancesColumns[29]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_instances_integrations_integration",
				Columns:    []*schema.Column{WorkflowInstancesColumns[30]},
				RefColumns: []*schema.Column{IntegrationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_instances_remediations_remediation",
				Columns:    []*schema.Column{WorkflowInstancesColumns[31]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_instances_risks_risk",
				Columns:    []*schema.Column{WorkflowInstancesColumns[32]},
				RefColumns: []*schema.Column{RisksColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_instances_tasks_task",
				Columns:    []*schema.Column{WorkflowInstancesColumns[33]},
				RefColumns: []*schema.Column{TasksColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_instances_vulnerabilities_vulnerability",
	...
	WorkflowObjectRefsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "workflow_object_refs_vulnerabilities_vulnerability",
				Columns:    []*schema.Column{WorkflowObjectRefsColumns[25]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_object_refs_risks_risk",
				Columns:    []*schema.Column{WorkflowObjectRefsColumns[26]},
				RefColumns: []*schema.Column{RisksColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_object_refs_assessments_assessment",
				Columns:    []*schema.Column{WorkflowObjectRefsColumns[27]},
				RefColumns: []*schema.Column{AssessmentsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_object_refs_assessment_responses_assessment_response",
				Columns:    []*schema.Column{WorkflowObjectRefsColumns[28]},
				RefColumns: []*schema.Column{AssessmentResponsesColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "workflow_object_refs_remediations_remediation",
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[10]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_task_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[11]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_internal_policy_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[12]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_finding_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[13]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_directory_account_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[14]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_directory_group_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[15]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_directory_membership_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[16]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_evidence_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[17]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_subcontrol_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[18]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_action_plan_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[19]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_procedure_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[20]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_campaign_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[21]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_campaign_target_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[22]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_identity_holder_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[23]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_platform_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[24]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_vulnerability_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[25]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_risk_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[26]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_assessment_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[27]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_assessment_response_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[28]},
			},
			{
				Name:    "workflowobjectref_workflow_instance_id_remediation_id",
				Unique:  true,
				Columns: []*schema.Column{WorkflowObjectRefsColumns[9], WorkflowObjectRefsColumns[29]},
			},
		},
	}
	...
	WorkflowProposalsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{WorkflowProposalsColumns[16]},
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{WorkflowProposalsColumns[16], WorkflowProposalsColumns[7]},
				Annotation: &entsql.IndexAnnotation{
	...
	// ActionPlanIntegrationRunsColumns holds the columns for the "action_plan_integration_runs" table.
	ActionPlanIntegrationRunsColumns = []*schema.Column{
		{Name: "action_plan_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// ActionPlanIntegrationRunsTable holds the schema information for the "action_plan_integration_runs" table.
	ActionPlanIntegrationRunsTable = &schema.Table{
		Name:       "action_plan_integration_runs",
		Columns:    ActionPlanIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{ActionPlanIntegrationRunsColumns[0], ActionPlanIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "action_plan_integration_runs_action_plan_id",
				Columns:    []*schema.Column{ActionPlanIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{ActionPlansColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "action_plan_integration_runs_integration_run_id",
				Columns:    []*schema.Column{ActionPlanIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	...
	// AssetIntegrationRunsColumns holds the columns for the "asset_integration_runs" table.
	AssetIntegrationRunsColumns = []*schema.Column{
		{Name: "asset_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// AssetIntegrationRunsTable holds the schema information for the "asset_integration_runs" table.
	AssetIntegrationRunsTable = &schema.Table{
		Name:       "asset_integration_runs",
		Columns:    AssetIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{AssetIntegrationRunsColumns[0], AssetIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "asset_integration_runs_asset_id",
				Columns:    []*schema.Column{AssetIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{AssetsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "asset_integration_runs_integration_run_id",
				Columns:    []*schema.Column{AssetIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// AudienceBlockedGroupsColumns holds the columns for the "audience_blocked_groups" table.
	AudienceBlockedGroupsColumns = []*schema.Column{
		{Name: "audience_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// AudienceBlockedGroupsTable holds the schema information for the "audience_blocked_groups" table.
	AudienceBlockedGroupsTable = &schema.Table{
		Name:       "audience_blocked_groups",
		Columns:    AudienceBlockedGroupsColumns,
		PrimaryKey: []*schema.Column{AudienceBlockedGroupsColumns[0], AudienceBlockedGroupsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "audience_blocked_groups_audience_id",
				Columns:    []*schema.Column{AudienceBlockedGroupsColumns[0]},
				RefColumns: []*schema.Column{AudiencesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "audience_blocked_groups_group_id",
				Columns:    []*schema.Column{AudienceBlockedGroupsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// AudienceEditorsColumns holds the columns for the "audience_editors" table.
	AudienceEditorsColumns = []*schema.Column{
		{Name: "audience_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// AudienceEditorsTable holds the schema information for the "audience_editors" table.
	AudienceEditorsTable = &schema.Table{
		Name:       "audience_editors",
		Columns:    AudienceEditorsColumns,
		PrimaryKey: []*schema.Column{AudienceEditorsColumns[0], AudienceEditorsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "audience_editors_audience_id",
				Columns:    []*schema.Column{AudienceEditorsColumns[0]},
				RefColumns: []*schema.Column{AudiencesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "audience_editors_group_id",
				Columns:    []*schema.Column{AudienceEditorsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// AudienceViewersColumns holds the columns for the "audience_viewers" table.
	AudienceViewersColumns = []*schema.Column{
		{Name: "audience_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// AudienceViewersTable holds the schema information for the "audience_viewers" table.
	AudienceViewersTable = &schema.Table{
		Name:       "audience_viewers",
		Columns:    AudienceViewersColumns,
		PrimaryKey: []*schema.Column{AudienceViewersColumns[0], AudienceViewersColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "audience_viewers_audience_id",
				Columns:    []*schema.Column{AudienceViewersColumns[0]},
				RefColumns: []*schema.Column{AudiencesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "audience_viewers_group_id",
				Columns:    []*schema.Column{AudienceViewersColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// CampaignAudiencesColumns holds the columns for the "campaign_audiences" table.
	CampaignAudiencesColumns = []*schema.Column{
		{Name: "campaign_id", Type: field.TypeString},
		{Name: "audience_id", Type: field.TypeString},
	}
	// CampaignAudiencesTable holds the schema information for the "campaign_audiences" table.
	CampaignAudiencesTable = &schema.Table{
		Name:       "campaign_audiences",
		Columns:    CampaignAudiencesColumns,
		PrimaryKey: []*schema.Column{CampaignAudiencesColumns[0], CampaignAudiencesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "campaign_audiences_campaign_id",
				Columns:    []*schema.Column{CampaignAudiencesColumns[0]},
				RefColumns: []*schema.Column{CampaignsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "campaign_audiences_audience_id",
				Columns:    []*schema.Column{CampaignAudiencesColumns[1]},
				RefColumns: []*schema.Column{AudiencesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// CheckResultIntegrationRunsColumns holds the columns for the "check_result_integration_runs" table.
	CheckResultIntegrationRunsColumns = []*schema.Column{
		{Name: "check_result_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// CheckResultIntegrationRunsTable holds the schema information for the "check_result_integration_runs" table.
	CheckResultIntegrationRunsTable = &schema.Table{
		Name:       "check_result_integration_runs",
		Columns:    CheckResultIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{CheckResultIntegrationRunsColumns[0], CheckResultIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "check_result_integration_runs_check_result_id",
				Columns:    []*schema.Column{CheckResultIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{CheckResultsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "check_result_integration_runs_integration_run_id",
				Columns:    []*schema.Column{CheckResultIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// CheckResultControlsColumns holds the columns for the "check_result_controls" table.
	CheckResultControlsColumns = []*schema.Column{
		{Name: "check_result_id", Type: field.TypeString},
		{Name: "control_id", Type: field.TypeString},
	}
	// CheckResultControlsTable holds the schema information for the "check_result_controls" table.
	CheckResultControlsTable = &schema.Table{
		Name:       "check_result_controls",
		Columns:    CheckResultControlsColumns,
		PrimaryKey: []*schema.Column{CheckResultControlsColumns[0], CheckResultControlsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "check_result_controls_check_result_id",
				Columns:    []*schema.Column{CheckResultControlsColumns[0]},
				RefColumns: []*schema.Column{CheckResultsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "check_result_controls_control_id",
				Columns:    []*schema.Column{CheckResultControlsColumns[1]},
				RefColumns: []*schema.Column{ControlsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// ContactIntegrationRunsColumns holds the columns for the "contact_integration_runs" table.
	ContactIntegrationRunsColumns = []*schema.Column{
		{Name: "contact_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// ContactIntegrationRunsTable holds the schema information for the "contact_integration_runs" table.
	ContactIntegrationRunsTable = &schema.Table{
		Name:       "contact_integration_runs",
		Columns:    ContactIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{ContactIntegrationRunsColumns[0], ContactIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "contact_integration_runs_contact_id",
				Columns:    []*schema.Column{ContactIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{ContactsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "contact_integration_runs_integration_run_id",
				Columns:    []*schema.Column{ContactIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// DirectoryAccountIntegrationRunsColumns holds the columns for the "directory_account_integration_runs" table.
	DirectoryAccountIntegrationRunsColumns = []*schema.Column{
		{Name: "directory_account_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// DirectoryAccountIntegrationRunsTable holds the schema information for the "directory_account_integration_runs" table.
	DirectoryAccountIntegrationRunsTable = &schema.Table{
		Name:       "directory_account_integration_runs",
		Columns:    DirectoryAccountIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{DirectoryAccountIntegrationRunsColumns[0], DirectoryAccountIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "directory_account_integration_runs_directory_account_id",
				Columns:    []*schema.Column{DirectoryAccountIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{DirectoryAccountsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "directory_account_integration_runs_integration_run_id",
				Columns:    []*schema.Column{DirectoryAccountIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// DirectoryGroupIntegrationRunsColumns holds the columns for the "directory_group_integration_runs" table.
	DirectoryGroupIntegrationRunsColumns = []*schema.Column{
		{Name: "directory_group_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// DirectoryGroupIntegrationRunsTable holds the schema information for the "directory_group_integration_runs" table.
	DirectoryGroupIntegrationRunsTable = &schema.Table{
		Name:       "directory_group_integration_runs",
		Columns:    DirectoryGroupIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{DirectoryGroupIntegrationRunsColumns[0], DirectoryGroupIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "directory_group_integration_runs_directory_group_id",
				Columns:    []*schema.Column{DirectoryGroupIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{DirectoryGroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "directory_group_integration_runs_integration_run_id",
				Columns:    []*schema.Column{DirectoryGroupIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// DirectoryMembershipIntegrationRunsColumns holds the columns for the "directory_membership_integration_runs" table.
	DirectoryMembershipIntegrationRunsColumns = []*schema.Column{
		{Name: "directory_membership_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// DirectoryMembershipIntegrationRunsTable holds the schema information for the "directory_membership_integration_runs" table.
	DirectoryMembershipIntegrationRunsTable = &schema.Table{
		Name:       "directory_membership_integration_runs",
		Columns:    DirectoryMembershipIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{DirectoryMembershipIntegrationRunsColumns[0], DirectoryMembershipIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "directory_membership_integration_runs_directory_membership_id",
				Columns:    []*schema.Column{DirectoryMembershipIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{DirectoryMembershipsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "directory_membership_integration_runs_integration_run_id",
				Columns:    []*schema.Column{DirectoryMembershipIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// EntityIntegrationRunsColumns holds the columns for the "entity_integration_runs" table.
	EntityIntegrationRunsColumns = []*schema.Column{
		{Name: "entity_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// EntityIntegrationRunsTable holds the schema information for the "entity_integration_runs" table.
	EntityIntegrationRunsTable = &schema.Table{
		Name:       "entity_integration_runs",
		Columns:    EntityIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{EntityIntegrationRunsColumns[0], EntityIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "entity_integration_runs_entity_id",
				Columns:    []*schema.Column{EntityIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "entity_integration_runs_integration_run_id",
				Columns:    []*schema.Column{EntityIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// EntitySystemDetailsColumns holds the columns for the "entity_system_details" table.
	EntitySystemDetailsColumns = []*schema.Column{
		{Name: "entity_id", Type: field.TypeString},
		{Name: "system_detail_id", Type: field.TypeString},
	}
	// EntitySystemDetailsTable holds the schema information for the "entity_system_details" table.
	EntitySystemDetailsTable = &schema.Table{
		Name:       "entity_system_details",
		Columns:    EntitySystemDetailsColumns,
		PrimaryKey: []*schema.Column{EntitySystemDetailsColumns[0], EntitySystemDetailsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "entity_system_details_entity_id",
				Columns:    []*schema.Column{EntitySystemDetailsColumns[0]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "entity_system_details_system_detail_id",
				Columns:    []*schema.Column{EntitySystemDetailsColumns[1]},
				RefColumns: []*schema.Column{SystemDetailsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	...
	// FindingIntegrationRunsColumns holds the columns for the "finding_integration_runs" table.
	FindingIntegrationRunsColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// FindingIntegrationRunsTable holds the schema information for the "finding_integration_runs" table.
	FindingIntegrationRunsTable = &schema.Table{
		Name:       "finding_integration_runs",
		Columns:    FindingIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{FindingIntegrationRunsColumns[0], FindingIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_integration_runs_finding_id",
				Columns:    []*schema.Column{FindingIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_integration_runs_integration_run_id",
				Columns:    []*schema.Column{FindingIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingBlockedGroupsColumns holds the columns for the "finding_blocked_groups" table.
	FindingBlockedGroupsColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// FindingBlockedGroupsTable holds the schema information for the "finding_blocked_groups" table.
	FindingBlockedGroupsTable = &schema.Table{
		Name:       "finding_blocked_groups",
		Columns:    FindingBlockedGroupsColumns,
		PrimaryKey: []*schema.Column{FindingBlockedGroupsColumns[0], FindingBlockedGroupsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_blocked_groups_finding_id",
				Columns:    []*schema.Column{FindingBlockedGroupsColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_blocked_groups_group_id",
				Columns:    []*schema.Column{FindingBlockedGroupsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingEditorsColumns holds the columns for the "finding_editors" table.
	FindingEditorsColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// FindingEditorsTable holds the schema information for the "finding_editors" table.
	FindingEditorsTable = &schema.Table{
		Name:       "finding_editors",
		Columns:    FindingEditorsColumns,
		PrimaryKey: []*schema.Column{FindingEditorsColumns[0], FindingEditorsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_editors_finding_id",
				Columns:    []*schema.Column{FindingEditorsColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_editors_group_id",
				Columns:    []*schema.Column{FindingEditorsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingVulnerabilitiesColumns holds the columns for the "finding_vulnerabilities" table.
	FindingVulnerabilitiesColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "vulnerability_id", Type: field.TypeString},
	}
	// FindingVulnerabilitiesTable holds the schema information for the "finding_vulnerabilities" table.
	FindingVulnerabilitiesTable = &schema.Table{
		Name:       "finding_vulnerabilities",
		Columns:    FindingVulnerabilitiesColumns,
		PrimaryKey: []*schema.Column{FindingVulnerabilitiesColumns[0], FindingVulnerabilitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_vulnerabilities_finding_id",
				Columns:    []*schema.Column{FindingVulnerabilitiesColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_vulnerabilities_vulnerability_id",
				Columns:    []*schema.Column{FindingVulnerabilitiesColumns[1]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// FindingSubcontrolsColumns holds the columns for the "finding_subcontrols" table.
	FindingSubcontrolsColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "subcontrol_id", Type: field.TypeString},
	}
	// FindingSubcontrolsTable holds the schema information for the "finding_subcontrols" table.
	FindingSubcontrolsTable = &schema.Table{
		Name:       "finding_subcontrols",
		Columns:    FindingSubcontrolsColumns,
		PrimaryKey: []*schema.Column{FindingSubcontrolsColumns[0], FindingSubcontrolsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_subcontrols_finding_id",
				Columns:    []*schema.Column{FindingSubcontrolsColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_subcontrols_subcontrol_id",
				Columns:    []*schema.Column{FindingSubcontrolsColumns[1]},
				RefColumns: []*schema.Column{SubcontrolsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingRisksColumns holds the columns for the "finding_risks" table.
	FindingRisksColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "risk_id", Type: field.TypeString},
	}
	// FindingRisksTable holds the schema information for the "finding_risks" table.
	FindingRisksTable = &schema.Table{
		Name:       "finding_risks",
		Columns:    FindingRisksColumns,
		PrimaryKey: []*schema.Column{FindingRisksColumns[0], FindingRisksColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_risks_finding_id",
				Columns:    []*schema.Column{FindingRisksColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_risks_risk_id",
				Columns:    []*schema.Column{FindingRisksColumns[1]},
				RefColumns: []*schema.Column{RisksColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingProgramsColumns holds the columns for the "finding_programs" table.
	FindingProgramsColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "program_id", Type: field.TypeString},
	}
	// FindingProgramsTable holds the schema information for the "finding_programs" table.
	FindingProgramsTable = &schema.Table{
		Name:       "finding_programs",
		Columns:    FindingProgramsColumns,
		PrimaryKey: []*schema.Column{FindingProgramsColumns[0], FindingProgramsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_programs_finding_id",
				Columns:    []*schema.Column{FindingProgramsColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_programs_program_id",
				Columns:    []*schema.Column{FindingProgramsColumns[1]},
				RefColumns: []*schema.Column{ProgramsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingAssetsColumns holds the columns for the "finding_assets" table.
	FindingAssetsColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "asset_id", Type: field.TypeString},
	}
	// FindingAssetsTable holds the schema information for the "finding_assets" table.
	FindingAssetsTable = &schema.Table{
		Name:       "finding_assets",
		Columns:    FindingAssetsColumns,
		PrimaryKey: []*schema.Column{FindingAssetsColumns[0], FindingAssetsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_assets_finding_id",
				Columns:    []*schema.Column{FindingAssetsColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_assets_asset_id",
				Columns:    []*schema.Column{FindingAssetsColumns[1]},
				RefColumns: []*schema.Column{AssetsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingEntitiesColumns holds the columns for the "finding_entities" table.
	FindingEntitiesColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "entity_id", Type: field.TypeString},
	}
	// FindingEntitiesTable holds the schema information for the "finding_entities" table.
	FindingEntitiesTable = &schema.Table{
		Name:       "finding_entities",
		Columns:    FindingEntitiesColumns,
		PrimaryKey: []*schema.Column{FindingEntitiesColumns[0], FindingEntitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_entities_finding_id",
				Columns:    []*schema.Column{FindingEntitiesColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_entities_entity_id",
				Columns:    []*schema.Column{FindingEntitiesColumns[1]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// FindingScansColumns holds the columns for the "finding_scans" table.
	FindingScansColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "scan_id", Type: field.TypeString},
	}
	// FindingScansTable holds the schema information for the "finding_scans" table.
	FindingScansTable = &schema.Table{
		Name:       "finding_scans",
		Columns:    FindingScansColumns,
		PrimaryKey: []*schema.Column{FindingScansColumns[0], FindingScansColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_scans_finding_id",
				Columns:    []*schema.Column{FindingScansColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_scans_scan_id",
				Columns:    []*schema.Column{FindingScansColumns[1]},
				RefColumns: []*schema.Column{ScansColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// FindingCheckResultsColumns holds the columns for the "finding_check_results" table.
	FindingCheckResultsColumns = []*schema.Column{
		{Name: "finding_id", Type: field.TypeString},
		{Name: "check_result_id", Type: field.TypeString},
	}
	// FindingCheckResultsTable holds the schema information for the "finding_check_results" table.
	FindingCheckResultsTable = &schema.Table{
		Name:       "finding_check_results",
		Columns:    FindingCheckResultsColumns,
		PrimaryKey: []*schema.Column{FindingCheckResultsColumns[0], FindingCheckResultsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "finding_check_results_finding_id",
				Columns:    []*schema.Column{FindingCheckResultsColumns[0]},
				RefColumns: []*schema.Column{FindingsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "finding_check_results_check_result_id",
				Columns:    []*schema.Column{FindingCheckResultsColumns[1]},
				RefColumns: []*schema.Column{CheckResultsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// InternalPolicyIntegrationRunsColumns holds the columns for the "internal_policy_integration_runs" table.
	InternalPolicyIntegrationRunsColumns = []*schema.Column{
		{Name: "internal_policy_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// InternalPolicyIntegrationRunsTable holds the schema information for the "internal_policy_integration_runs" table.
	InternalPolicyIntegrationRunsTable = &schema.Table{
		Name:       "internal_policy_integration_runs",
		Columns:    InternalPolicyIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{InternalPolicyIntegrationRunsColumns[0], InternalPolicyIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "internal_policy_integration_runs_internal_policy_id",
				Columns:    []*schema.Column{InternalPolicyIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{InternalPoliciesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "internal_policy_integration_runs_integration_run_id",
				Columns:    []*schema.Column{InternalPolicyIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// PlatformSystemDetailsColumns holds the columns for the "platform_system_details" table.
	PlatformSystemDetailsColumns = []*schema.Column{
		{Name: "platform_id", Type: field.TypeString},
		{Name: "system_detail_id", Type: field.TypeString},
	}
	// PlatformSystemDetailsTable holds the schema information for the "platform_system_details" table.
	PlatformSystemDetailsTable = &schema.Table{
		Name:       "platform_system_details",
		Columns:    PlatformSystemDetailsColumns,
		PrimaryKey: []*schema.Column{PlatformSystemDetailsColumns[0], PlatformSystemDetailsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "platform_system_details_platform_id",
				Columns:    []*schema.Column{PlatformSystemDetailsColumns[0]},
				RefColumns: []*schema.Column{PlatformsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "platform_system_details_system_detail_id",
				Columns:    []*schema.Column{PlatformSystemDetailsColumns[1]},
				RefColumns: []*schema.Column{SystemDetailsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// ProcedureIntegrationRunsColumns holds the columns for the "procedure_integration_runs" table.
	ProcedureIntegrationRunsColumns = []*schema.Column{
		{Name: "procedure_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// ProcedureIntegrationRunsTable holds the schema information for the "procedure_integration_runs" table.
	ProcedureIntegrationRunsTable = &schema.Table{
		Name:       "procedure_integration_runs",
		Columns:    ProcedureIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{ProcedureIntegrationRunsColumns[0], ProcedureIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "procedure_integration_runs_procedure_id",
				Columns:    []*schema.Column{ProcedureIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{ProceduresColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "procedure_integration_runs_integration_run_id",
				Columns:    []*schema.Column{ProcedureIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// ProgramSystemDetailsColumns holds the columns for the "program_system_details" table.
	ProgramSystemDetailsColumns = []*schema.Column{
		{Name: "program_id", Type: field.TypeString},
		{Name: "system_detail_id", Type: field.TypeString},
	}
	// ProgramSystemDetailsTable holds the schema information for the "program_system_details" table.
	ProgramSystemDetailsTable = &schema.Table{
		Name:       "program_system_details",
		Columns:    ProgramSystemDetailsColumns,
		PrimaryKey: []*schema.Column{ProgramSystemDetailsColumns[0], ProgramSystemDetailsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "program_system_details_program_id",
				Columns:    []*schema.Column{ProgramSystemDetailsColumns[0]},
				RefColumns: []*schema.Column{ProgramsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "program_system_details_system_detail_id",
				Columns:    []*schema.Column{ProgramSystemDetailsColumns[1]},
				RefColumns: []*schema.Column{SystemDetailsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// RemediationBlockedGroupsColumns holds the columns for the "remediation_blocked_groups" table.
	RemediationBlockedGroupsColumns = []*schema.Column{
		{Name: "remediation_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// RemediationBlockedGroupsTable holds the schema information for the "remediation_blocked_groups" table.
	RemediationBlockedGroupsTable = &schema.Table{
		Name:       "remediation_blocked_groups",
		Columns:    RemediationBlockedGroupsColumns,
		PrimaryKey: []*schema.Column{RemediationBlockedGroupsColumns[0], RemediationBlockedGroupsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "remediation_blocked_groups_remediation_id",
				Columns:    []*schema.Column{RemediationBlockedGroupsColumns[0]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "remediation_blocked_groups_group_id",
				Columns:    []*schema.Column{RemediationBlockedGroupsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// RemediationEditorsColumns holds the columns for the "remediation_editors" table.
	RemediationEditorsColumns = []*schema.Column{
		{Name: "remediation_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// RemediationEditorsTable holds the schema information for the "remediation_editors" table.
	RemediationEditorsTable = &schema.Table{
		Name:       "remediation_editors",
		Columns:    RemediationEditorsColumns,
		PrimaryKey: []*schema.Column{RemediationEditorsColumns[0], RemediationEditorsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "remediation_editors_remediation_id",
				Columns:    []*schema.Column{RemediationEditorsColumns[0]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "remediation_editors_group_id",
				Columns:    []*schema.Column{RemediationEditorsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// RemediationVulnerabilitiesColumns holds the columns for the "remediation_vulnerabilities" table.
	RemediationVulnerabilitiesColumns = []*schema.Column{
		{Name: "remediation_id", Type: field.TypeString},
		{Name: "vulnerability_id", Type: field.TypeString},
	}
	// RemediationVulnerabilitiesTable holds the schema information for the "remediation_vulnerabilities" table.
	RemediationVulnerabilitiesTable = &schema.Table{
		Name:       "remediation_vulnerabilities",
		Columns:    RemediationVulnerabilitiesColumns,
		PrimaryKey: []*schema.Column{RemediationVulnerabilitiesColumns[0], RemediationVulnerabilitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "remediation_vulnerabilities_remediation_id",
				Columns:    []*schema.Column{RemediationVulnerabilitiesColumns[0]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "remediation_vulnerabilities_vulnerability_id",
				Columns:    []*schema.Column{RemediationVulnerabilitiesColumns[1]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// RemediationSubcontrolsColumns holds the columns for the "remediation_subcontrols" table.
	RemediationSubcontrolsColumns = []*schema.Column{
		{Name: "remediation_id", Type: field.TypeString},
		{Name: "subcontrol_id", Type: field.TypeString},
	}
	// RemediationSubcontrolsTable holds the schema information for the "remediation_subcontrols" table.
	RemediationSubcontrolsTable = &schema.Table{
		Name:       "remediation_subcontrols",
		Columns:    RemediationSubcontrolsColumns,
		PrimaryKey: []*schema.Column{RemediationSubcontrolsColumns[0], RemediationSubcontrolsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "remediation_subcontrols_remediation_id",
				Columns:    []*schema.Column{RemediationSubcontrolsColumns[0]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "remediation_subcontrols_subcontrol_id",
				Columns:    []*schema.Column{RemediationSubcontrolsColumns[1]},
				RefColumns: []*schema.Column{SubcontrolsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// RemediationProgramsColumns holds the columns for the "remediation_programs" table.
	RemediationProgramsColumns = []*schema.Column{
		{Name: "remediation_id", Type: field.TypeString},
		{Name: "program_id", Type: field.TypeString},
	}
	// RemediationProgramsTable holds the schema information for the "remediation_programs" table.
	RemediationProgramsTable = &schema.Table{
		Name:       "remediation_programs",
		Columns:    RemediationProgramsColumns,
		PrimaryKey: []*schema.Column{RemediationProgramsColumns[0], RemediationProgramsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "remediation_programs_remediation_id",
				Columns:    []*schema.Column{RemediationProgramsColumns[0]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "remediation_programs_program_id",
				Columns:    []*schema.Column{RemediationProgramsColumns[1]},
				RefColumns: []*schema.Column{ProgramsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// RemediationAssetsColumns holds the columns for the "remediation_assets" table.
	RemediationAssetsColumns = []*schema.Column{
		{Name: "remediation_id", Type: field.TypeString},
		{Name: "asset_id", Type: field.TypeString},
	}
	// RemediationAssetsTable holds the schema information for the "remediation_assets" table.
	RemediationAssetsTable = &schema.Table{
		Name:       "remediation_assets",
		Columns:    RemediationAssetsColumns,
		PrimaryKey: []*schema.Column{RemediationAssetsColumns[0], RemediationAssetsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "remediation_assets_remediation_id",
				Columns:    []*schema.Column{RemediationAssetsColumns[0]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "remediation_assets_asset_id",
				Columns:    []*schema.Column{RemediationAssetsColumns[1]},
				RefColumns: []*schema.Column{AssetsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// RemediationEntitiesColumns holds the columns for the "remediation_entities" table.
	RemediationEntitiesColumns = []*schema.Column{
		{Name: "remediation_id", Type: field.TypeString},
		{Name: "entity_id", Type: field.TypeString},
	}
	// RemediationEntitiesTable holds the schema information for the "remediation_entities" table.
	RemediationEntitiesTable = &schema.Table{
		Name:       "remediation_entities",
		Columns:    RemediationEntitiesColumns,
		PrimaryKey: []*schema.Column{RemediationEntitiesColumns[0], RemediationEntitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "remediation_entities_remediation_id",
				Columns:    []*schema.Column{RemediationEntitiesColumns[0]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "remediation_entities_entity_id",
				Columns:    []*schema.Column{RemediationEntitiesColumns[1]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// ReviewBlockedGroupsColumns holds the columns for the "review_blocked_groups" table.
	ReviewBlockedGroupsColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// ReviewBlockedGroupsTable holds the schema information for the "review_blocked_groups" table.
	ReviewBlockedGroupsTable = &schema.Table{
		Name:       "review_blocked_groups",
		Columns:    ReviewBlockedGroupsColumns,
		PrimaryKey: []*schema.Column{ReviewBlockedGroupsColumns[0], ReviewBlockedGroupsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_blocked_groups_review_id",
				Columns:    []*schema.Column{ReviewBlockedGroupsColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "review_blocked_groups_group_id",
				Columns:    []*schema.Column{ReviewBlockedGroupsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// ReviewEditorsColumns holds the columns for the "review_editors" table.
	ReviewEditorsColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "group_id", Type: field.TypeString},
	}
	// ReviewEditorsTable holds the schema information for the "review_editors" table.
	ReviewEditorsTable = &schema.Table{
		Name:       "review_editors",
		Columns:    ReviewEditorsColumns,
		PrimaryKey: []*schema.Column{ReviewEditorsColumns[0], ReviewEditorsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_editors_review_id",
				Columns:    []*schema.Column{ReviewEditorsColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "review_editors_group_id",
				Columns:    []*schema.Column{ReviewEditorsColumns[1]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// ReviewVulnerabilitiesColumns holds the columns for the "review_vulnerabilities" table.
	ReviewVulnerabilitiesColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "vulnerability_id", Type: field.TypeString},
	}
	// ReviewVulnerabilitiesTable holds the schema information for the "review_vulnerabilities" table.
	ReviewVulnerabilitiesTable = &schema.Table{
		Name:       "review_vulnerabilities",
		Columns:    ReviewVulnerabilitiesColumns,
		PrimaryKey: []*schema.Column{ReviewVulnerabilitiesColumns[0], ReviewVulnerabilitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_vulnerabilities_review_id",
				Columns:    []*schema.Column{ReviewVulnerabilitiesColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "review_vulnerabilities_vulnerability_id",
				Columns:    []*schema.Column{ReviewVulnerabilitiesColumns[1]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// ReviewRemediationsColumns holds the columns for the "review_remediations" table.
	ReviewRemediationsColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "remediation_id", Type: field.TypeString},
	}
	// ReviewRemediationsTable holds the schema information for the "review_remediations" table.
	ReviewRemediationsTable = &schema.Table{
		Name:       "review_remediations",
		Columns:    ReviewRemediationsColumns,
		PrimaryKey: []*schema.Column{ReviewRemediationsColumns[0], ReviewRemediationsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_remediations_review_id",
				Columns:    []*schema.Column{ReviewRemediationsColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "review_remediations_remediation_id",
				Columns:    []*schema.Column{ReviewRemediationsColumns[1]},
				RefColumns: []*schema.Column{RemediationsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// ReviewSubcontrolsColumns holds the columns for the "review_subcontrols" table.
	ReviewSubcontrolsColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "subcontrol_id", Type: field.TypeString},
	}
	// ReviewSubcontrolsTable holds the schema information for the "review_subcontrols" table.
	ReviewSubcontrolsTable = &schema.Table{
		Name:       "review_subcontrols",
		Columns:    ReviewSubcontrolsColumns,
		PrimaryKey: []*schema.Column{ReviewSubcontrolsColumns[0], ReviewSubcontrolsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_subcontrols_review_id",
				Columns:    []*schema.Column{ReviewSubcontrolsColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
	...
	// ReviewProgramsColumns holds the columns for the "review_programs" table.
	ReviewProgramsColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "program_id", Type: field.TypeString},
	}
	// ReviewProgramsTable holds the schema information for the "review_programs" table.
	ReviewProgramsTable = &schema.Table{
		Name:       "review_programs",
		Columns:    ReviewProgramsColumns,
		PrimaryKey: []*schema.Column{ReviewProgramsColumns[0], ReviewProgramsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_programs_review_id",
				Columns:    []*schema.Column{ReviewProgramsColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "review_programs_program_id",
				Columns:    []*schema.Column{ReviewProgramsColumns[1]},
				RefColumns: []*schema.Column{ProgramsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// ReviewAssetsColumns holds the columns for the "review_assets" table.
	ReviewAssetsColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "asset_id", Type: field.TypeString},
	}
	// ReviewAssetsTable holds the schema information for the "review_assets" table.
	ReviewAssetsTable = &schema.Table{
		Name:       "review_assets",
		Columns:    ReviewAssetsColumns,
		PrimaryKey: []*schema.Column{ReviewAssetsColumns[0], ReviewAssetsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_assets_review_id",
				Columns:    []*schema.Column{ReviewAssetsColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "review_assets_asset_id",
				Columns:    []*schema.Column{ReviewAssetsColumns[1]},
				RefColumns: []*schema.Column{AssetsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// ReviewEntitiesColumns holds the columns for the "review_entities" table.
	ReviewEntitiesColumns = []*schema.Column{
		{Name: "review_id", Type: field.TypeString},
		{Name: "entity_id", Type: field.TypeString},
	}
	// ReviewEntitiesTable holds the schema information for the "review_entities" table.
	ReviewEntitiesTable = &schema.Table{
		Name:       "review_entities",
		Columns:    ReviewEntitiesColumns,
		PrimaryKey: []*schema.Column{ReviewEntitiesColumns[0], ReviewEntitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "review_entities_review_id",
				Columns:    []*schema.Column{ReviewEntitiesColumns[0]},
				RefColumns: []*schema.Column{ReviewsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "review_entities_entity_id",
				Columns:    []*schema.Column{ReviewEntitiesColumns[1]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// RiskIntegrationRunsColumns holds the columns for the "risk_integration_runs" table.
	RiskIntegrationRunsColumns = []*schema.Column{
		{Name: "risk_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// RiskIntegrationRunsTable holds the schema information for the "risk_integration_runs" table.
	RiskIntegrationRunsTable = &schema.Table{
		Name:       "risk_integration_runs",
		Columns:    RiskIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{RiskIntegrationRunsColumns[0], RiskIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "risk_integration_runs_risk_id",
				Columns:    []*schema.Column{RiskIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{RisksColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "risk_integration_runs_integration_run_id",
				Columns:    []*schema.Column{RiskIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// ScanEntitiesColumns holds the columns for the "scan_entities" table.
	ScanEntitiesColumns = []*schema.Column{
		{Name: "scan_id", Type: field.TypeString},
		{Name: "entity_id", Type: field.TypeString},
	}
	// ScanEntitiesTable holds the schema information for the "scan_entities" table.
	ScanEntitiesTable = &schema.Table{
		Name:       "scan_entities",
		Columns:    ScanEntitiesColumns,
		PrimaryKey: []*schema.Column{ScanEntitiesColumns[0], ScanEntitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "scan_entities_scan_id",
				Columns:    []*schema.Column{ScanEntitiesColumns[0]},
				RefColumns: []*schema.Column{ScansColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "scan_entities_entity_id",
				Columns:    []*schema.Column{ScanEntitiesColumns[1]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// SubcontrolScansColumns holds the columns for the "subcontrol_scans" table.
	SubcontrolScansColumns = []*schema.Column{
		{Name: "subcontrol_id", Type: field.TypeString},
		{Name: "scan_id", Type: field.TypeString},
	}
	// SubcontrolScansTable holds the schema information for the "subcontrol_scans" table.
	SubcontrolScansTable = &schema.Table{
		Name:       "subcontrol_scans",
		Columns:    SubcontrolScansColumns,
		PrimaryKey: []*schema.Column{SubcontrolScansColumns[0], SubcontrolScansColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "subcontrol_scans_subcontrol_id",
				Columns:    []*schema.Column{SubcontrolScansColumns[0]},
				RefColumns: []*schema.Column{SubcontrolsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "subcontrol_scans_scan_id",
				Columns:    []*schema.Column{SubcontrolScansColumns[1]},
				RefColumns: []*schema.Column{ScansColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// SystemDetailAssetsColumns holds the columns for the "system_detail_assets" table.
	SystemDetailAssetsColumns = []*schema.Column{
		{Name: "system_detail_id", Type: field.TypeString},
		{Name: "asset_id", Type: field.TypeString},
	}
	// SystemDetailAssetsTable holds the schema information for the "system_detail_assets" table.
	SystemDetailAssetsTable = &schema.Table{
		Name:       "system_detail_assets",
		Columns:    SystemDetailAssetsColumns,
		PrimaryKey: []*schema.Column{SystemDetailAssetsColumns[0], SystemDetailAssetsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "system_detail_assets_system_detail_id",
				Columns:    []*schema.Column{SystemDetailAssetsColumns[0]},
				RefColumns: []*schema.Column{SystemDetailsColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "system_detail_assets_asset_id",
				Columns:    []*schema.Column{SystemDetailAssetsColumns[1]},
				RefColumns: []*schema.Column{AssetsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// VulnerabilityIntegrationRunsColumns holds the columns for the "vulnerability_integration_runs" table.
	VulnerabilityIntegrationRunsColumns = []*schema.Column{
		{Name: "vulnerability_id", Type: field.TypeString},
		{Name: "integration_run_id", Type: field.TypeString},
	}
	// VulnerabilityIntegrationRunsTable holds the schema information for the "vulnerability_integration_runs" table.
	VulnerabilityIntegrationRunsTable = &schema.Table{
		Name:       "vulnerability_integration_runs",
		Columns:    VulnerabilityIntegrationRunsColumns,
		PrimaryKey: []*schema.Column{VulnerabilityIntegrationRunsColumns[0], VulnerabilityIntegrationRunsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vulnerability_integration_runs_vulnerability_id",
				Columns:    []*schema.Column{VulnerabilityIntegrationRunsColumns[0]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "vulnerability_integration_runs_integration_run_id",
				Columns:    []*schema.Column{VulnerabilityIntegrationRunsColumns[1]},
				RefColumns: []*schema.Column{IntegrationRunsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	// VulnerabilityControlsColumns holds the columns for the "vulnerability_controls" table.
	VulnerabilityControlsColumns = []*schema.Column{
		{Name: "vulnerability_id", Type: field.TypeString},
		{Name: "control_id", Type: field.TypeString},
	}
	// VulnerabilityControlsTable holds the schema information for the "vulnerability_controls" table.
	VulnerabilityControlsTable = &schema.Table{
		Name:       "vulnerability_controls",
		Columns:    VulnerabilityControlsColumns,
		PrimaryKey: []*schema.Column{VulnerabilityControlsColumns[0], VulnerabilityControlsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vulnerability_controls_vulnerability_id",
				Columns:    []*schema.Column{VulnerabilityControlsColumns[0]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "vulnerability_controls_control_id",
				Columns:    []*schema.Column{VulnerabilityControlsColumns[1]},
				RefColumns: []*schema.Column{ControlsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// VulnerabilitySubcontrolsColumns holds the columns for the "vulnerability_subcontrols" table.
	VulnerabilitySubcontrolsColumns = []*schema.Column{
		{Name: "vulnerability_id", Type: field.TypeString},
		{Name: "subcontrol_id", Type: field.TypeString},
	}
	// VulnerabilitySubcontrolsTable holds the schema information for the "vulnerability_subcontrols" table.
	VulnerabilitySubcontrolsTable = &schema.Table{
		Name:       "vulnerability_subcontrols",
		Columns:    VulnerabilitySubcontrolsColumns,
		PrimaryKey: []*schema.Column{VulnerabilitySubcontrolsColumns[0], VulnerabilitySubcontrolsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vulnerability_subcontrols_vulnerability_id",
				Columns:    []*schema.Column{VulnerabilitySubcontrolsColumns[0]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "vulnerability_subcontrols_subcontrol_id",
				Columns:    []*schema.Column{VulnerabilitySubcontrolsColumns[1]},
				RefColumns: []*schema.Column{SubcontrolsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// VulnerabilityRisksColumns holds the columns for the "vulnerability_risks" table.
	VulnerabilityRisksColumns = []*schema.Column{
		{Name: "vulnerability_id", Type: field.TypeString},
		{Name: "risk_id", Type: field.TypeString},
	}
	// VulnerabilityRisksTable holds the schema information for the "vulnerability_risks" table.
	VulnerabilityRisksTable = &schema.Table{
		Name:       "vulnerability_risks",
		Columns:    VulnerabilityRisksColumns,
		PrimaryKey: []*schema.Column{VulnerabilityRisksColumns[0], VulnerabilityRisksColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vulnerability_risks_vulnerability_id",
				Columns:    []*schema.Column{VulnerabilityRisksColumns[0]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "vulnerability_risks_risk_id",
				Columns:    []*schema.Column{VulnerabilityRisksColumns[1]},
				RefColumns: []*schema.Column{RisksColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// VulnerabilityProgramsColumns holds the columns for the "vulnerability_programs" table.
	VulnerabilityProgramsColumns = []*schema.Column{
		{Name: "vulnerability_id", Type: field.TypeString},
		{Name: "program_id", Type: field.TypeString},
	}
	// VulnerabilityProgramsTable holds the schema information for the "vulnerability_programs" table.
	VulnerabilityProgramsTable = &schema.Table{
		Name:       "vulnerability_programs",
		Columns:    VulnerabilityProgramsColumns,
		PrimaryKey: []*schema.Column{VulnerabilityProgramsColumns[0], VulnerabilityProgramsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vulnerability_programs_vulnerability_id",
				Columns:    []*schema.Column{VulnerabilityProgramsColumns[0]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "vulnerability_programs_program_id",
				Columns:    []*schema.Column{VulnerabilityProgramsColumns[1]},
				RefColumns: []*schema.Column{ProgramsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// VulnerabilityAssetsColumns holds the columns for the "vulnerability_assets" table.
	VulnerabilityAssetsColumns = []*schema.Column{
		{Name: "vulnerability_id", Type: field.TypeString},
		{Name: "asset_id", Type: field.TypeString},
	}
	// VulnerabilityAssetsTable holds the schema information for the "vulnerability_assets" table.
	VulnerabilityAssetsTable = &schema.Table{
		Name:       "vulnerability_assets",
		Columns:    VulnerabilityAssetsColumns,
		PrimaryKey: []*schema.Column{VulnerabilityAssetsColumns[0], VulnerabilityAssetsColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vulnerability_assets_vulnerability_id",
				Columns:    []*schema.Column{VulnerabilityAssetsColumns[0]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "vulnerability_assets_asset_id",
				Columns:    []*schema.Column{VulnerabilityAssetsColumns[1]},
				RefColumns: []*schema.Column{AssetsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	}
	// VulnerabilityEntitiesColumns holds the columns for the "vulnerability_entities" table.
	VulnerabilityEntitiesColumns = []*schema.Column{
		{Name: "vulnerability_id", Type: field.TypeString},
		{Name: "entity_id", Type: field.TypeString},
	}
	// VulnerabilityEntitiesTable holds the schema information for the "vulnerability_entities" table.
	VulnerabilityEntitiesTable = &schema.Table{
		Name:       "vulnerability_entities",
		Columns:    VulnerabilityEntitiesColumns,
		PrimaryKey: []*schema.Column{VulnerabilityEntitiesColumns[0], VulnerabilityEntitiesColumns[1]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "vulnerability_entities_vulnerability_id",
				Columns:    []*schema.Column{VulnerabilityEntitiesColumns[0]},
				RefColumns: []*schema.Column{VulnerabilitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
				Symbol:     "vulnerability_entities_entity_id",
				Columns:    []*schema.Column{VulnerabilityEntitiesColumns[1]},
				RefColumns: []*schema.Column{EntitiesColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
	...
	Tables = []*schema.Table{
		...
		UsersTable,
		UserSettingsTable,
		VendorRiskScoresTable,
		VendorScoringConfigsTable,
		...
		ActionPlanIntegrationRunsTable,
		ActionPlanBlockedGroupsTable,
		ActionPlanEditorsTable,
		ActionPlanViewersTable,
		ActionPlanTasksTable,
		AssetIntegrationRunsTable,
		AssetConnectedAssetsTable,
		AudienceBlockedGroupsTable,
		AudienceEditorsTable,
		AudienceViewersTable,
		...
		CampaignAudiencesTable,
		CheckResultIntegrationRunsTable,
		CheckResultControlsTable,
		ContactIntegrationRunsTable,
		ContactFilesTable,
		...
		DirectoryAccountIntegrationRunsTable,
		DirectoryGroupIntegrationRunsTable,
		DirectoryMembershipIntegrationRunsTable,
		DocumentDataFilesTable,
		EntityIntegrationRunsTable,
		...
		FileEventsTable,
		FileSecretsTable,
		FindingIntegrationRunsTable,
		FindingBlockedGroupsTable,
		FindingEditorsTable,
		FindingVulnerabilitiesTable,
		FindingActionPlansTable,
		FindingSubcontrolsTable,
		FindingRisksTable,
		FindingProgramsTable,
		FindingAssetsTable,
		FindingEntitiesTable,
		FindingScansTable,
		FindingTasksTable,
		FindingDirectoryAccountsTable,
		FindingIdentityHoldersTable,
		FindingCheckResultsTable,
		GroupEventsTable,
		GroupFilesTable,
		GroupTasksTable,
		...
		InternalPolicyIntegrationRunsTable,
		...
		PlatformSystemDetailsTable,
		ProcedureIntegrationRunsTable,
		...
		ProgramSystemDetailsTable,
		RemediationBlockedGroupsTable,
		RemediationEditorsTable,
		RemediationFindingsTable,
		RemediationVulnerabilitiesTable,
		RemediationActionPlansTable,
		RemediationControlsTable,
		RemediationSubcontrolsTable,
		RemediationRisksTable,
		RemediationProgramsTable,
		RemediationAssetsTable,
		RemediationEntitiesTable,
		ReviewBlockedGroupsTable,
		ReviewEditorsTable,
		ReviewFindingsTable,
		...
		SystemDetailAssetsTable,
		TaskEvidenceTable,
		TemplateFilesTable,
		UserEventsTable,
		VulnerabilityIntegrationRunsTable,
		VulnerabilityActionPlansTable,
		VulnerabilityControlsTable,
		VulnerabilitySubcontrolsTable,
		VulnerabilityRisksTable,
		VulnerabilityProgramsTable,
		VulnerabilityAssetsTable,
		VulnerabilityEntitiesTable,
...
func init() {
	...
	AssetsTable.ForeignKeys[2].RefTable = IdentityHoldersTable
	...
	AssetsTable.ForeignKeys[10].RefTable = CustomTypeEnumsTable
	...
	AssetsTable.ForeignKeys[14].RefTable = RisksTable
	AudiencesTable.ForeignKeys[0].RefTable = OrganizationsTable
	AudienceMembersTable.ForeignKeys[0].RefTable = AudiencesTable
	AudienceMembersTable.ForeignKeys[1].RefTable = ContactsTable
	AudienceMembersTable.ForeignKeys[2].RefTable = GroupsTable
	AudienceMembersTable.ForeignKeys[3].RefTable = IdentityHoldersTable
	AudienceMembersTable.ForeignKeys[4].RefTable = OrganizationsTable
	AudienceMembersTable.ForeignKeys[5].RefTable = SubscribersTable
	AudienceMembersTable.ForeignKeys[6].RefTable = UsersTable
	...
	CampaignsTable.ForeignKeys[3].RefTable = IdentityHoldersTable
	...
	CampaignsTable.ForeignKeys[9].RefTable = TrustCentersTable
	...
	CampaignTargetsTable.ForeignKeys[4].RefTable = SubscribersTable
	CampaignTargetsTable.ForeignKeys[5].RefTable = UsersTable
	CheckResultsTable.ForeignKeys[0].RefTable = IntegrationsTable
	...
	DirectoryAccountsTable.ForeignKeys[3].RefTable = IdentityHoldersTable
	DirectoryAccountsTable.ForeignKeys[4].RefTable = IntegrationsTable
	DirectoryAccountsTable.ForeignKeys[5].RefTable = OrganizationsTable
	DirectoryAccountsTable.ForeignKeys[6].RefTable = PlatformsTable
	...
	DirectoryGroupsTable.ForeignKeys[3].RefTable = OrganizationsTable
	DirectoryGroupsTable.ForeignKeys[4].RefTable = PlatformsTable
	...
	DirectoryMembershipsTable.ForeignKeys[4].RefTable = IntegrationsTable
	DirectoryMembershipsTable.ForeignKeys[5].RefTable = OrganizationsTable
	DirectoryMembershipsTable.ForeignKeys[6].RefTable = PlatformsTable
	...
	EmailTemplatesTable.ForeignKeys[2].RefTable = TrustCentersTable
	...
	EntitiesTable.ForeignKeys[2].RefTable = IdentityHoldersTable
	...
	FilesTable.ForeignKeys[0].RefTable = EmailTemplatesTable
	...
	FindingsTable.ForeignKeys[0].RefTable = UsersTable
	FindingsTable.ForeignKeys[1].RefTable = GroupsTable
	FindingsTable.ForeignKeys[2].RefTable = IdentityHoldersTable
	FindingsTable.ForeignKeys[3].RefTable = UsersTable
	FindingsTable.ForeignKeys[4].RefTable = GroupsTable
	FindingsTable.ForeignKeys[5].RefTable = IdentityHoldersTable
	FindingsTable.ForeignKeys[6].RefTable = UsersTable
	FindingsTable.ForeignKeys[7].RefTable = GroupsTable
	FindingsTable.ForeignKeys[8].RefTable = IdentityHoldersTable
	FindingsTable.ForeignKeys[9].RefTable = CustomTypeEnumsTable
	FindingsTable.ForeignKeys[10].RefTable = CustomTypeEnumsTable
	FindingsTable.ForeignKeys[11].RefTable = CustomTypeEnumsTable
	FindingsTable.ForeignKeys[12].RefTable = OrganizationsTable
	...
	GroupsTable.ForeignKeys[6].RefTable = CheckResultsTable
	GroupsTable.ForeignKeys[7].RefTable = CheckResultsTable
	GroupsTable.ForeignKeys[8].RefTable = CheckResultsTable
	GroupsTable.ForeignKeys[9].RefTable = EmailTemplatesTable
	GroupsTable.ForeignKeys[10].RefTable = EmailTemplatesTable
	GroupsTable.ForeignKeys[11].RefTable = EmailTemplatesTable
	GroupsTable.ForeignKeys[12].RefTable = FilesTable
	GroupsTable.ForeignKeys[13].RefTable = IdentityHoldersTable
	GroupsTable.ForeignKeys[14].RefTable = IdentityHoldersTable
	GroupsTable.ForeignKeys[15].RefTable = IdentityHoldersTable
	...
	GroupsTable.ForeignKeys[38].RefTable = OrganizationsTable
	...
	GroupsTable.ForeignKeys[94].RefTable = SLADefinitionsTable
	GroupsTable.ForeignKeys[95].RefTable = TrustCentersTable
	GroupsTable.ForeignKeys[96].RefTable = TrustCentersTable
	GroupsTable.ForeignKeys[97].RefTable = TrustCenterCompliancesTable
	GroupsTable.ForeignKeys[98].RefTable = TrustCenterCompliancesTable
	GroupsTable.ForeignKeys[99].RefTable = TrustCenterDocsTable
	GroupsTable.ForeignKeys[100].RefTable = TrustCenterDocsTable
	GroupsTable.ForeignKeys[101].RefTable = TrustCenterEntitiesTable
	GroupsTable.ForeignKeys[102].RefTable = TrustCenterEntitiesTable
	GroupsTable.ForeignKeys[103].RefTable = TrustCenterFaqsTable
	GroupsTable.ForeignKeys[104].RefTable = TrustCenterFaqsTable
	GroupsTable.ForeignKeys[105].RefTable = TrustCenterNdaRequestsTable
	GroupsTable.ForeignKeys[106].RefTable = TrustCenterNdaRequestsTable
	...
	IdentityHoldersTable.ForeignKeys[2].RefTable = IdentityHoldersTable
	IdentityHoldersTable.ForeignKeys[3].RefTable = CustomTypeEnumsTable
	IdentityHoldersTable.ForeignKeys[4].RefTable = CustomTypeEnumsTable
	IdentityHoldersTable.ForeignKeys[5].RefTable = EntitiesTable
	IdentityHoldersTable.ForeignKeys[6].RefTable = OrganizationsTable
	IdentityHoldersTable.ForeignKeys[7].RefTable = UsersTable
	...
	IntegrationRunsTable.ForeignKeys[1].RefTable = OrganizationsTable
	...
	PlatformsTable.ForeignKeys[5].RefTable = IdentityHoldersTable
	PlatformsTable.ForeignKeys[6].RefTable = UsersTable
	PlatformsTable.ForeignKeys[7].RefTable = GroupsTable
	PlatformsTable.ForeignKeys[8].RefTable = IdentityHoldersTable
	PlatformsTable.ForeignKeys[9].RefTable = UsersTable
	PlatformsTable.ForeignKeys[10].RefTable = GroupsTable
	PlatformsTable.ForeignKeys[11].RefTable = IdentityHoldersTable
	PlatformsTable.ForeignKeys[12].RefTable = UsersTable
	PlatformsTable.ForeignKeys[13].RefTable = GroupsTable
	PlatformsTable.ForeignKeys[14].RefTable = IdentityHoldersTable
	...
	PlatformsTable.ForeignKeys[19].RefTable = CustomTypeEnumsTable
	PlatformsTable.ForeignKeys[20].RefTable = CustomTypeEnumsTable
	PlatformsTable.ForeignKeys[21].RefTable = CustomTypeEnumsTable
	PlatformsTable.ForeignKeys[22].RefTable = CustomTypeEnumsTable
	PlatformsTable.ForeignKeys[23].RefTable = UsersTable
	...
	ReviewsTable.ForeignKeys[1].RefTable = CustomTypeEnumsTable
	...
	RisksTable.ForeignKeys[3].RefTable = OrganizationsTable
	RisksTable.ForeignKeys[4].RefTable = UsersTable
	RisksTable.ForeignKeys[5].RefTable = GroupsTable
	RisksTable.ForeignKeys[6].RefTable = IdentityHoldersTable
	RisksTable.ForeignKeys[7].RefTable = UsersTable
	RisksTable.ForeignKeys[8].RefTable = GroupsTable
	RisksTable.ForeignKeys[9].RefTable = IdentityHoldersTable
	RisksTable.ForeignKeys[10].RefTable = CustomTypeEnumsTable
	RisksTable.ForeignKeys[11].RefTable = CustomTypeEnumsTable
	RisksTable.ForeignKeys[12].RefTable = CustomTypeEnumsTable
	RisksTable.ForeignKeys[13].RefTable = CustomTypeEnumsTable
	RisksTable.ForeignKeys[14].RefTable = GroupsTable
	RisksTable.ForeignKeys[15].RefTable = GroupsTable
	SLADefinitionsTable.ForeignKeys[0].RefTable = OrganizationsTable
	ScansTable.ForeignKeys[0].RefTable = OrganizationsTable
	ScansTable.ForeignKeys[1].RefTable = PlatformsTable
	ScansTable.ForeignKeys[2].RefTable = RisksTable
	ScansTable.ForeignKeys[3].RefTable = UsersTable
	ScansTable.ForeignKeys[4].RefTable = GroupsTable
	ScansTable.ForeignKeys[5].RefTable = IdentityHoldersTable
	ScansTable.ForeignKeys[6].RefTable = UsersTable
	ScansTable.ForeignKeys[7].RefTable = GroupsTable
	...
	SubscribersTable.ForeignKeys[0].RefTable = ContactsTable
	SubscribersTable.ForeignKeys[1].RefTable = OrganizationsTable
	SubscribersTable.ForeignKeys[2].RefTable = TrustCentersTable
	SubscribersTable.ForeignKeys[3].RefTable = UsersTable
	SystemDetailsTable.ForeignKeys[0].RefTable = OrganizationsTable
	...
	VendorRiskScoresTable.ForeignKeys[0].RefTable = AssessmentResponsesTable
	VendorRiskScoresTable.ForeignKeys[1].RefTable = EntitiesTable
	VendorRiskScoresTable.ForeignKeys[2].RefTable = OrganizationsTable
	VendorRiskScoresTable.ForeignKeys[3].RefTable = VendorScoringConfigsTable
	VendorRiskScoresTable.ForeignKeys[4].RefTable = EntitiesTable
	VendorRiskScoresTable.ForeignKeys[5].RefTable = AssessmentResponsesTable
	VendorRiskScoresTable.ForeignKeys[6].RefTable = VendorScoringConfigsTable
	VendorScoringConfigsTable.ForeignKeys[0].RefTable = OrganizationsTable
	VulnerabilitiesTable.ForeignKeys[0].RefTable = OrganizationsTable
	VulnerabilitiesTable.ForeignKeys[1].RefTable = UsersTable
	VulnerabilitiesTable.ForeignKeys[2].RefTable = GroupsTable
	VulnerabilitiesTable.ForeignKeys[3].RefTable = IdentityHoldersTable
	VulnerabilitiesTable.ForeignKeys[4].RefTable = UsersTable
	VulnerabilitiesTable.ForeignKeys[5].RefTable = GroupsTable
	VulnerabilitiesTable.ForeignKeys[6].RefTable = IdentityHoldersTable
	VulnerabilitiesTable.ForeignKeys[7].RefTable = UsersTable
	VulnerabilitiesTable.ForeignKeys[8].RefTable = GroupsTable
	VulnerabilitiesTable.ForeignKeys[9].RefTable = IdentityHoldersTable
	VulnerabilitiesTable.ForeignKeys[10].RefTable = CustomTypeEnumsTable
	VulnerabilitiesTable.ForeignKeys[11].RefTable = CustomTypeEnumsTable
	VulnerabilitiesTable.ForeignKeys[12].RefTable = CustomTypeEnumsTable
	...
	WorkflowInstancesTable.ForeignKeys[12].RefTable = AssessmentsTable
	WorkflowInstancesTable.ForeignKeys[13].RefTable = AssessmentResponsesTable
	WorkflowInstancesTable.ForeignKeys[14].RefTable = FindingsTable
	WorkflowInstancesTable.ForeignKeys[15].RefTable = IntegrationsTable
	WorkflowInstancesTable.ForeignKeys[16].RefTable = RemediationsTable
	WorkflowInstancesTable.ForeignKeys[17].RefTable = RisksTable
	WorkflowInstancesTable.ForeignKeys[18].RefTable = TasksTable
	WorkflowInstancesTable.ForeignKeys[19].RefTable = VulnerabilitiesTable
	WorkflowInstancesTable.ForeignKeys[20].RefTable = WorkflowProposalsTable
	...
	WorkflowObjectRefsTable.ForeignKeys[18].RefTable = VulnerabilitiesTable
	WorkflowObjectRefsTable.ForeignKeys[19].RefTable = RisksTable
	WorkflowObjectRefsTable.ForeignKeys[20].RefTable = AssessmentsTable
	WorkflowObjectRefsTable.ForeignKeys[21].RefTable = AssessmentResponsesTable
	WorkflowObjectRefsTable.ForeignKeys[22].RefTable = RemediationsTable
	...
	ActionPlanIntegrationRunsTable.ForeignKeys[0].RefTable = ActionPlansTable
	ActionPlanIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	...
	AssetIntegrationRunsTable.ForeignKeys[0].RefTable = AssetsTable
	AssetIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	AssetConnectedAssetsTable.ForeignKeys[0].RefTable = AssetsTable
	AssetConnectedAssetsTable.ForeignKeys[1].RefTable = AssetsTable
	AudienceBlockedGroupsTable.ForeignKeys[0].RefTable = AudiencesTable
	AudienceBlockedGroupsTable.ForeignKeys[1].RefTable = GroupsTable
	AudienceEditorsTable.ForeignKeys[0].RefTable = AudiencesTable
	AudienceEditorsTable.ForeignKeys[1].RefTable = GroupsTable
	AudienceViewersTable.ForeignKeys[0].RefTable = AudiencesTable
	AudienceViewersTable.ForeignKeys[1].RefTable = GroupsTable
	...
	CampaignAudiencesTable.ForeignKeys[0].RefTable = CampaignsTable
	CampaignAudiencesTable.ForeignKeys[1].RefTable = AudiencesTable
	CheckResultIntegrationRunsTable.ForeignKeys[0].RefTable = CheckResultsTable
	CheckResultIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	CheckResultControlsTable.ForeignKeys[0].RefTable = CheckResultsTable
	CheckResultControlsTable.ForeignKeys[1].RefTable = ControlsTable
	ContactIntegrationRunsTable.ForeignKeys[0].RefTable = ContactsTable
	ContactIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	...
	DirectoryAccountIntegrationRunsTable.ForeignKeys[0].RefTable = DirectoryAccountsTable
	DirectoryAccountIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	DirectoryGroupIntegrationRunsTable.ForeignKeys[0].RefTable = DirectoryGroupsTable
	DirectoryGroupIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	DirectoryMembershipIntegrationRunsTable.ForeignKeys[0].RefTable = DirectoryMembershipsTable
	DirectoryMembershipIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	DocumentDataFilesTable.ForeignKeys[0].RefTable = DocumentDataTable
	DocumentDataFilesTable.ForeignKeys[1].RefTable = FilesTable
	EntityIntegrationRunsTable.ForeignKeys[0].RefTable = EntitiesTable
	EntityIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	...
	EntitySystemDetailsTable.ForeignKeys[0].RefTable = EntitiesTable
	EntitySystemDetailsTable.ForeignKeys[1].RefTable = SystemDetailsTable
	...
	FindingIntegrationRunsTable.ForeignKeys[0].RefTable = FindingsTable
	FindingIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	FindingBlockedGroupsTable.ForeignKeys[0].RefTable = FindingsTable
	FindingBlockedGroupsTable.ForeignKeys[1].RefTable = GroupsTable
	FindingEditorsTable.ForeignKeys[0].RefTable = FindingsTable
	FindingEditorsTable.ForeignKeys[1].RefTable = GroupsTable
	FindingVulnerabilitiesTable.ForeignKeys[0].RefTable = FindingsTable
	FindingVulnerabilitiesTable.ForeignKeys[1].RefTable = VulnerabilitiesTable
	...
	FindingSubcontrolsTable.ForeignKeys[0].RefTable = FindingsTable
	FindingSubcontrolsTable.ForeignKeys[1].RefTable = SubcontrolsTable
	FindingRisksTable.ForeignKeys[0].RefTable = FindingsTable
	FindingRisksTable.ForeignKeys[1].RefTable = RisksTable
	FindingProgramsTable.ForeignKeys[0].RefTable = FindingsTable
	FindingProgramsTable.ForeignKeys[1].RefTable = ProgramsTable
	FindingAssetsTable.ForeignKeys[0].RefTable = FindingsTable
	FindingAssetsTable.ForeignKeys[1].RefTable = AssetsTable
	FindingEntitiesTable.ForeignKeys[0].RefTable = FindingsTable
	FindingEntitiesTable.ForeignKeys[1].RefTable = EntitiesTable
	FindingScansTable.ForeignKeys[0].RefTable = FindingsTable
	FindingScansTable.ForeignKeys[1].RefTable = ScansTable
	...
	FindingCheckResultsTable.ForeignKeys[0].RefTable = FindingsTable
	FindingCheckResultsTable.ForeignKeys[1].RefTable = CheckResultsTable
	...
	InternalPolicyIntegrationRunsTable.ForeignKeys[0].RefTable = InternalPoliciesTable
	InternalPolicyIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	...
	PlatformSystemDetailsTable.ForeignKeys[0].RefTable = PlatformsTable
	PlatformSystemDetailsTable.ForeignKeys[1].RefTable = SystemDetailsTable
	ProcedureIntegrationRunsTable.ForeignKeys[0].RefTable = ProceduresTable
	ProcedureIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	...
	ProgramSystemDetailsTable.ForeignKeys[0].RefTable = ProgramsTable
	ProgramSystemDetailsTable.ForeignKeys[1].RefTable = SystemDetailsTable
	RemediationBlockedGroupsTable.ForeignKeys[0].RefTable = RemediationsTable
	RemediationBlockedGroupsTable.ForeignKeys[1].RefTable = GroupsTable
	RemediationEditorsTable.ForeignKeys[0].RefTable = RemediationsTable
	RemediationEditorsTable.ForeignKeys[1].RefTable = GroupsTable
	...
	RemediationVulnerabilitiesTable.ForeignKeys[0].RefTable = RemediationsTable
	RemediationVulnerabilitiesTable.ForeignKeys[1].RefTable = VulnerabilitiesTable
	...
	RemediationProgramsTable.ForeignKeys[0].RefTable = RemediationsTable
	RemediationProgramsTable.ForeignKeys[1].RefTable = ProgramsTable
	RemediationAssetsTable.ForeignKeys[0].RefTable = RemediationsTable
	RemediationAssetsTable.ForeignKeys[1].RefTable = AssetsTable
	RemediationEntitiesTable.ForeignKeys[0].RefTable = RemediationsTable
	RemediationEntitiesTable.ForeignKeys[1].RefTable = EntitiesTable
	ReviewBlockedGroupsTable.ForeignKeys[0].RefTable = ReviewsTable
	ReviewBlockedGroupsTable.ForeignKeys[1].RefTable = GroupsTable
	ReviewEditorsTable.ForeignKeys[0].RefTable = ReviewsTable
	ReviewEditorsTable.ForeignKeys[1].RefTable = GroupsTable
	...
	ReviewVulnerabilitiesTable.ForeignKeys[1].RefTable = VulnerabilitiesTable
	ReviewActionPlansTable.ForeignKeys[0].RefTable = ReviewsTable
	ReviewActionPlansTable.ForeignKeys[1].RefTable = ActionPlansTable
	ReviewRemediationsTable.ForeignKeys[0].RefTable = ReviewsTable
	ReviewRemediationsTable.ForeignKeys[1].RefTable = RemediationsTable
	...
	ReviewProgramsTable.ForeignKeys[0].RefTable = ReviewsTable
	ReviewProgramsTable.ForeignKeys[1].RefTable = ProgramsTable
	ReviewAssetsTable.ForeignKeys[0].RefTable = ReviewsTable
	ReviewAssetsTable.ForeignKeys[1].RefTable = AssetsTable
	ReviewEntitiesTable.ForeignKeys[0].RefTable = ReviewsTable
	ReviewEntitiesTable.ForeignKeys[1].RefTable = EntitiesTable
	...
	RiskIntegrationRunsTable.ForeignKeys[0].RefTable = RisksTable
	RiskIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	...
	ScanEntitiesTable.ForeignKeys[0].RefTable = ScansTable
	ScanEntitiesTable.ForeignKeys[1].RefTable = EntitiesTable
	...
	SubcontrolScansTable.ForeignKeys[0].RefTable = SubcontrolsTable
	...
	SystemDetailAssetsTable.ForeignKeys[0].RefTable = SystemDetailsTable
	SystemDetailAssetsTable.ForeignKeys[1].RefTable = AssetsTable
	...
	VulnerabilityIntegrationRunsTable.ForeignKeys[0].RefTable = VulnerabilitiesTable
	VulnerabilityIntegrationRunsTable.ForeignKeys[1].RefTable = IntegrationRunsTable
	...
	VulnerabilityControlsTable.ForeignKeys[0].RefTable = VulnerabilitiesTable
	VulnerabilityControlsTable.ForeignKeys[1].RefTable = ControlsTable
	VulnerabilitySubcontrolsTable.ForeignKeys[0].RefTable = VulnerabilitiesTable
	VulnerabilitySubcontrolsTable.ForeignKeys[1].RefTable = SubcontrolsTable
	VulnerabilityRisksTable.ForeignKeys[0].RefTable = VulnerabilitiesTable
	VulnerabilityRisksTable.ForeignKeys[1].RefTable = RisksTable
	VulnerabilityProgramsTable.ForeignKeys[0].RefTable = VulnerabilitiesTable
	VulnerabilityProgramsTable.ForeignKeys[1].RefTable = ProgramsTable
	VulnerabilityAssetsTable.ForeignKeys[0].RefTable = VulnerabilitiesTable
	VulnerabilityAssetsTable.ForeignKeys[1].RefTable = AssetsTable
	VulnerabilityEntitiesTable.ForeignKeys[0].RefTable = VulnerabilitiesTable
	VulnerabilityEntitiesTable.ForeignKeys[1].RefTable = EntitiesTable
