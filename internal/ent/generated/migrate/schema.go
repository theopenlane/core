	...
	DirectoryAccountsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{DirectoryAccountsColumns[48]},
				RefColumns: []*schema.Column{IntegrationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "directory_accounts_organizations_directory_accounts",
				Columns:    []*schema.Column{DirectoryAccountsColumns[49]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "directory_accounts_platforms_directory_accounts",
				Columns:    []*schema.Column{DirectoryAccountsColumns[50]},
				RefColumns: []*schema.Column{PlatformsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{DirectoryAccountsColumns[6], DirectoryAccountsColumns[49]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[50], DirectoryAccountsColumns[16]},
			},
			{
				Name:    "directoryaccount_integration_id_canonical_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[48], DirectoryAccountsColumns[18]},
			},
			{
				Name:    "directoryaccount_platform_id_canonical_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[50], DirectoryAccountsColumns[18]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[47], DirectoryAccountsColumns[15]},
			},
			{
				Name:    "directoryaccount_owner_id_canonical_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryAccountsColumns[49], DirectoryAccountsColumns[18]},
			},
		},
	}
	...
	DirectoryGroupsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{DirectoryGroupsColumns[36]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "directory_groups_platforms_directory_groups",
				Columns:    []*schema.Column{DirectoryGroupsColumns[37]},
				RefColumns: []*schema.Column{PlatformsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{DirectoryGroupsColumns[6], DirectoryGroupsColumns[36]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[37], DirectoryGroupsColumns[15]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[37], DirectoryGroupsColumns[16]},
			},
			{
				Name:    "directorygroup_owner_id_email",
				Unique:  false,
				Columns: []*schema.Column{DirectoryGroupsColumns[36], DirectoryGroupsColumns[16]},
			},
		},
	}
	...
	DirectoryMembershipsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{DirectoryMembershipsColumns[28]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "directory_memberships_platforms_directory_memberships",
				Columns:    []*schema.Column{DirectoryMembershipsColumns[29]},
				RefColumns: []*schema.Column{PlatformsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{DirectoryMembershipsColumns[6], DirectoryMembershipsColumns[28]},
			},
			{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{DirectoryMembershipsColumns[25], DirectoryMembershipsColumns[26]},
				Annotation: &entsql.IndexAnnotation{
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{FindingsColumns[8], FindingsColumns[70]},
			},
			{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{FindingsColumns[24], FindingsColumns[26], FindingsColumns[70]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
	...
	RisksTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{RisksColumns[8], RisksColumns[46]},
			},
			{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{RisksColumns[23], RisksColumns[46]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{RisksColumns[20], RisksColumns[46]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
...
func init() {
	...
	FindingsTable.ForeignKeys[6].RefTable = CustomTypeEnumsTable
	FindingsTable.ForeignKeys[7].RefTable = CustomTypeEnumsTable
	FindingsTable.ForeignKeys[8].RefTable = CustomTypeEnumsTable
	FindingsTable.ForeignKeys[9].RefTable = OrganizationsTable
	...
	VulnerabilitiesTable.ForeignKeys[7].RefTable = CustomTypeEnumsTable
	VulnerabilitiesTable.ForeignKeys[8].RefTable = CustomTypeEnumsTable
	VulnerabilitiesTable.ForeignKeys[9].RefTable = CustomTypeEnumsTable
