...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "organization_export_creators", Type: field.TypeString, Nullable: true},
		...
		{Name: "organization_user_setting_creators", Type: field.TypeString, Nullable: true},
		...
		{Name: "sla_definition_viewers", Type: field.TypeString, Nullable: true},
	...
	GroupsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "groups_organizations_export_creators",
			...
			{
				Symbol:     "groups_organizations_integration_creators",
				Columns:    []*schema.Column{GroupsColumns[63]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_organizations_integration_webhook_creators",
			...
			{
				Symbol:     "groups_organizations_organization_creators",
			...
			{
				Symbol:     "groups_organizations_user_creators",
				Columns:    []*schema.Column{GroupsColumns[100]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_organizations_user_setting_creators",
			...
			{
				Symbol:     "groups_organizations_workflow_assignment_creators",
				Columns:    []*schema.Column{GroupsColumns[104]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_organizations_workflow_assignment_target_creators",
			...
			{
				Symbol:     "groups_organizations_workflow_event_creators",
				Columns:    []*schema.Column{GroupsColumns[107]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_organizations_workflow_instance_creators",
				Columns:    []*schema.Column{GroupsColumns[108]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_organizations_workflow_object_ref_creators",
				Columns:    []*schema.Column{GroupsColumns[109]},
				RefColumns: []*schema.Column{OrganizationsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "groups_organizations_workflow_proposal_creators",
...
func init() {
	...
	EmailTemplatesTable.ForeignKeys[3].RefTable = WorkflowInstancesTable
	...
	GroupsTable.ForeignKeys[12].RefTable = FindingsTable
	GroupsTable.ForeignKeys[13].RefTable = FindingsTable
	GroupsTable.ForeignKeys[14].RefTable = FindingsTable
	GroupsTable.ForeignKeys[15].RefTable = FilesTable
	GroupsTable.ForeignKeys[16].RefTable = IdentityHoldersTable
	GroupsTable.ForeignKeys[17].RefTable = IdentityHoldersTable
	GroupsTable.ForeignKeys[18].RefTable = IdentityHoldersTable
	...
	GroupsTable.ForeignKeys[98].RefTable = RemediationsTable
	GroupsTable.ForeignKeys[99].RefTable = RemediationsTable
	GroupsTable.ForeignKeys[100].RefTable = RemediationsTable
	GroupsTable.ForeignKeys[101].RefTable = ReviewsTable
	GroupsTable.ForeignKeys[102].RefTable = ReviewsTable
	GroupsTable.ForeignKeys[103].RefTable = ReviewsTable
	GroupsTable.ForeignKeys[104].RefTable = SLADefinitionsTable
	GroupsTable.ForeignKeys[105].RefTable = SLADefinitionsTable
	GroupsTable.ForeignKeys[106].RefTable = SLADefinitionsTable
	GroupsTable.ForeignKeys[107].RefTable = TrustCentersTable
	GroupsTable.ForeignKeys[108].RefTable = TrustCentersTable
	GroupsTable.ForeignKeys[109].RefTable = TrustCenterCompliancesTable
	GroupsTable.ForeignKeys[110].RefTable = TrustCenterCompliancesTable
	GroupsTable.ForeignKeys[111].RefTable = TrustCenterDocsTable
	GroupsTable.ForeignKeys[112].RefTable = TrustCenterDocsTable
	GroupsTable.ForeignKeys[113].RefTable = TrustCenterEntitiesTable
	GroupsTable.ForeignKeys[114].RefTable = TrustCenterEntitiesTable
	GroupsTable.ForeignKeys[115].RefTable = TrustCenterFaqsTable
	GroupsTable.ForeignKeys[116].RefTable = TrustCenterFaqsTable
	GroupsTable.ForeignKeys[117].RefTable = TrustCenterNdaRequestsTable
	GroupsTable.ForeignKeys[118].RefTable = TrustCenterNdaRequestsTable
	GroupsTable.ForeignKeys[119].RefTable = TrustCenterSettingsTable
	GroupsTable.ForeignKeys[120].RefTable = TrustCenterSettingsTable
	GroupsTable.ForeignKeys[121].RefTable = TrustCenterSubprocessorsTable
	GroupsTable.ForeignKeys[122].RefTable = TrustCenterSubprocessorsTable
	GroupsTable.ForeignKeys[123].RefTable = TrustCenterWatermarkConfigsTable
	GroupsTable.ForeignKeys[124].RefTable = TrustCenterWatermarkConfigsTable
	GroupsTable.ForeignKeys[125].RefTable = VulnerabilitiesTable
	GroupsTable.ForeignKeys[126].RefTable = VulnerabilitiesTable
	GroupsTable.ForeignKeys[127].RefTable = VulnerabilitiesTable
	GroupsTable.ForeignKeys[128].RefTable = WorkflowDefinitionsTable
	GroupsTable.ForeignKeys[129].RefTable = WorkflowDefinitionsTable
	GroupsTable.ForeignKeys[130].RefTable = WorkflowDefinitionsTable
