...
var (
	...
	ControlsColumns = []*schema.Column{
		...
		{Name: "delegate_id", Type: field.TypeString, Nullable: true},
		{Name: "mapped_control_from_control", Type: field.TypeString, Nullable: true},
		{Name: "mapped_control_to_control", Type: field.TypeString, Nullable: true},
		{Name: "owner_id", Type: field.TypeString, Nullable: true},
	...
	MappedControlsColumns = []*schema.Column{
		...
		{Name: "deleted_by", Type: field.TypeString, Nullable: true},
		{Name: "tags", Type: field.TypeJSON, Nullable: true},
		{Name: "mapping_type", Type: field.TypeEnum, Nullable: true, Enums: []string{"EQUAL", "SUPERSET", "SUBSET", "INTERSECT"}, Default: "EQUAL"},
	...
	SubcontrolsColumns = []*schema.Column{
		...
		{Name: "mapped_control_from_subcontrol", Type: field.TypeString, Nullable: true},
		{Name: "mapped_control_to_subcontrol", Type: field.TypeString, Nullable: true},
		{Name: "owner_id", Type: field.TypeString, Nullable: true},
	...
	SubcontrolsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "subcontrols_mapped_controls_from_subcontrol",
				Columns:    []*schema.Column{SubcontrolsColumns[27]},
				RefColumns: []*schema.Column{MappedControlsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "subcontrols_mapped_controls_to_subcontrol",
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{SubcontrolsColumns[26], SubcontrolsColumns[25]},
				Annotation: &entsql.IndexAnnotation{
					Where: "deleted_at is NULL",
				},
			},
