...
func HasCreatedBy() predicate.UserSetting {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.UserSetting {
	return predicate.UserSetting(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.UserSetting {
	return predicate.UserSetting(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.UserSetting {
	return predicate.UserSetting(func(s *sql.Selector) {
