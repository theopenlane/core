...
// was not loaded in eager-loading, or loaded but was not found.
func (e ExportEdges) FileOrErr() (*File, error) {
	if e.File != nil {
		return e.File, nil
...
func (*Export) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case export.FieldID, export.FieldCreatedBy, export.FieldUpdatedBy, export.FieldDeletedBy, export.FieldOwnerID, export.FieldExportType, export.FieldItemID, export.FieldStatus, export.FieldRequestorID, export.FieldFileID:
...
func (e *Export) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case export.FieldItemID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field item_id", values[i])
			} else if value.Valid {
				e.ItemID = value.String
			}
		...
		case export.FieldFileID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field file_id", values[i])
			} else if value.Valid {
				e.FileID = value.String
			}
		default:
...
// QueryFile queries the "file" edge of the Export entity.
func (e *Export) QueryFile() *FileQuery {
	return NewExportClient(e.config).QueryFile(e)
}
