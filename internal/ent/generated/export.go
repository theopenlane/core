...
func (*Export) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case export.FieldFields, export.FieldExportMetadata:
			values[i] = new([]byte)
		case export.FieldID, export.FieldCreatedBy, export.FieldUpdatedBy, export.FieldUpdatedByImpersonator, export.FieldDeletedBy, export.FieldRequestorID, export.FieldOwnerID, export.FieldExportType, export.FieldFormat, export.FieldStatus, export.FieldFilters, export.FieldErrorMessage, export.FieldMode:
...
func (_m *Export) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case export.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
