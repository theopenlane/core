...
func (tcsc *TrustCenterSettingCreate) SetTags(s []string) *TrustCenterSettingCreate {
	tcsc.mutation.SetTags(s)
	return tcsc
}

// SetOwnerID sets the "owner_id" field.
func (tcsc *TrustCenterSettingCreate) SetOwnerID(s string) *TrustCenterSettingCreate {
	tcsc.mutation.SetOwnerID(s)
	return tcsc
}

// SetNillableOwnerID sets the "owner_id" field if the given value is not nil.
func (tcsc *TrustCenterSettingCreate) SetNillableOwnerID(s *string) *TrustCenterSettingCreate {
	if s != nil {
		tcsc.SetOwnerID(*s)
	}
	return tcsc
...
func (tcsc *TrustCenterSettingCreate) SetOwner(o *Organization) *TrustCenterSettingCreate {
	return tcsc.SetOwnerID(o.ID)
}
...
func (tcsc *TrustCenterSettingCreate) defaults() error {
	...
	if _, ok := tcsc.mutation.Tags(); !ok {
		v := trustcentersetting.DefaultTags
...
func (tcsc *TrustCenterSettingCreate) check() error {
	if v, ok := tcsc.mutation.OwnerID(); ok {
		if err := trustcentersetting.OwnerIDValidator(v); err != nil {
			return &ValidationError{Name: "owner_id", err: fmt.Errorf(`generated: validator failed for field "TrustCenterSetting.owner_id": %w`, err)}
		}
	}
	if _, ok := tcsc.mutation.TrustCenterID(); !ok {
		return &ValidationError{Name: "trust_center_id", err: errors.New(`generated: missing required field "TrustCenterSetting.trust_center_id"`)}
	}
	...
	if len(tcsc.mutation.TrustCenterIDs()) == 0 {
		return &ValidationError{Name: "trust_center", err: errors.New(`generated: missing required edge "TrustCenterSetting.trust_center"`)}
	}
	return nil
}
...
func (tcsc *TrustCenterSettingCreate) createSpec() (*TrustCenterSetting, *sqlgraph.CreateSpec) {
	...
	if value, ok := tcsc.mutation.Tags(); ok {
		_spec.SetField(trustcentersetting.FieldTags, field.TypeJSON, value)
		_node.Tags = value
	}
	...
	if nodes := tcsc.mutation.OwnerIDs(); len(nodes) > 0 {
