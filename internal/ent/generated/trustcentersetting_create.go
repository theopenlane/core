...
func (_c *TrustCenterSettingCreate) SetUpdatedByImpersonator(v string) *TrustCenterSettingCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *TrustCenterSettingCreate) SetNillableUpdatedByImpersonator(v *string) *TrustCenterSettingCreate {
	if v != nil {
...
func (_c *TrustCenterSettingCreate) AddBlockedGroupIDs(ids ...string) *TrustCenterSettingCreate {
	_c.mutation.AddBlockedGroupIDs(ids...)
	return _c
}

// AddBlockedGroups adds the "blocked_groups" edges to the Group entity.
func (_c *TrustCenterSettingCreate) AddBlockedGroups(v ...*Group) *TrustCenterSettingCreate {
...
func (_c *TrustCenterSettingCreate) AddEditorIDs(ids ...string) *TrustCenterSettingCreate {
	_c.mutation.AddEditorIDs(ids...)
	return _c
}

// AddEditors adds the "editors" edges to the Group entity.
func (_c *TrustCenterSettingCreate) AddEditors(v ...*Group) *TrustCenterSettingCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TrustCenterSettingCreate) SetNdaApproverGroup(v *Group) *TrustCenterSettingCreate {
	return _c.SetNdaApproverGroupID(v.ID)
}
...
func (_c *TrustCenterSettingCreate) createSpec() (*TrustCenterSetting, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(trustcentersetting.FieldUpdatedByImpersonator, field.TypeString, value)
	...
	if nodes := _c.mutation.NdaApproverGroupIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.NdaApproverGroupID = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
