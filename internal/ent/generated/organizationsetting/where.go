...
func HasCreatedBy() predicate.OrganizationSetting {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.OrganizationSetting {
	return predicate.OrganizationSetting(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.OrganizationSetting {
	return predicate.OrganizationSetting(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.OrganizationSetting {
	return predicate.OrganizationSetting(func(s *sql.Selector) {
