...
func (ehu *EntityHistoryUpdate) SetDeletedByID(s string) *EntityHistoryUpdate {
	ehu.mutation.SetDeletedByID(s)
	return ehu
}

// SetNillableDeletedByID sets the "deleted_by_id" field if the given value is not nil.
func (ehu *EntityHistoryUpdate) SetNillableDeletedByID(s *string) *EntityHistoryUpdate {
	if s != nil {
		ehu.SetDeletedByID(*s)
	}
	return ehu
}

// ClearDeletedByID clears the value of the "deleted_by_id" field.
func (ehu *EntityHistoryUpdate) ClearDeletedByID() *EntityHistoryUpdate {
	ehu.mutation.ClearDeletedByID()
	return ehu
}
...
func (ehu *EntityHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ehu.mutation.DeletedByID(); ok {
...
// SetDeletedByID sets the "deleted_by_id" field.
func (ehuo *EntityHistoryUpdateOne) SetDeletedByID(s string) *EntityHistoryUpdateOne {
	ehuo.mutation.SetDeletedByID(s)
	return ehuo
}

// SetNillableDeletedByID sets the "deleted_by_id" field if the given value is not nil.
func (ehuo *EntityHistoryUpdateOne) SetNillableDeletedByID(s *string) *EntityHistoryUpdateOne {
	if s != nil {
		ehuo.SetDeletedByID(*s)
	}
	return ehuo
}

// ClearDeletedByID clears the value of the "deleted_by_id" field.
func (ehuo *EntityHistoryUpdateOne) ClearDeletedByID() *EntityHistoryUpdateOne {
	ehuo.mutation.ClearDeletedByID()
	return ehuo
}
...
func (ehuo *EntityHistoryUpdateOne) sqlSave(ctx context.Context) (_node *EntityHistory, err error) {
	...
	if value, ok := ehuo.mutation.DeletedByID(); ok {
		_spec.SetField(entityhistory.FieldDeletedByID, field.TypeString, value)
	}
