...
func (*JobRunnerRegistrationToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case jobrunnerregistrationtoken.FieldTags:
			values[i] = new([]byte)
		case jobrunnerregistrationtoken.FieldID, jobrunnerregistrationtoken.FieldCreatedBy, jobrunnerregistrationtoken.FieldUpdatedBy, jobrunnerregistrationtoken.FieldUpdatedByImpersonator, jobrunnerregistrationtoken.FieldDeletedBy, jobrunnerregistrationtoken.FieldOwnerID, jobrunnerregistrationtoken.FieldToken, jobrunnerregistrationtoken.FieldJobRunnerID:
...
func (_m *JobRunnerRegistrationToken) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case jobrunnerregistrationtoken.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
