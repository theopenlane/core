...
func (*GroupMembership) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case groupmembership.FieldID, groupmembership.FieldCreatedBy, groupmembership.FieldUpdatedBy, groupmembership.FieldUpdatedByImpersonator, groupmembership.FieldRole, groupmembership.FieldGroupID, groupmembership.FieldUserID:
...
func (_m *GroupMembership) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case groupmembership.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
