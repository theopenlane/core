...
func (c *Client) WithHistory() {
	...
	for _, hook := range history.HistoryHooks[*ControlImplementationMutation]() {
	...
	for _, hook := range history.HistoryHooks[*EvidenceMutation]() {
		c.Evidence.Use(hook)
	}
	...
	for _, hook := range history.HistoryHooks[*MappedControlMutation]() {
	...
	for _, hook := range history.HistoryHooks[*ProgramMembershipMutation]() {
