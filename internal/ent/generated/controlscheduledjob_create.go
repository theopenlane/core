...
func (csjc *ControlScheduledJobCreate) SetControlID(s string) *ControlScheduledJobCreate {
	csjc.mutation.SetControlID(s)
	return csjc
}

// SetNillableControlID sets the "control_id" field if the given value is not nil.
func (csjc *ControlScheduledJobCreate) SetNillableControlID(s *string) *ControlScheduledJobCreate {
	if s != nil {
		csjc.SetControlID(*s)
	}
	return csjc
...
func (csjc *ControlScheduledJobCreate) SetControl(c *Control) *ControlScheduledJobCreate {
	return csjc.SetControlID(c.ID)
}
...
func (csjc *ControlScheduledJobCreate) createSpec() (*ControlScheduledJob, *sqlgraph.CreateSpec) {
	...
	if nodes := csjc.mutation.ControlIDs(); len(nodes) > 0 {
