...
func (*UserSetting) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usersetting.FieldID, usersetting.FieldCreatedBy, usersetting.FieldUpdatedBy, usersetting.FieldUpdatedByImpersonator, usersetting.FieldDeletedBy, usersetting.FieldUserID, usersetting.FieldDelegateUserID, usersetting.FieldStatus, usersetting.FieldPhoneNumber:
...
func (_m *UserSetting) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usersetting.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
