...
func (_q *SLADefinitionQuery) QueryOwner() *OrganizationQuery {
...
func (_q *SLADefinitionQuery) QueryBlockedGroups() *GroupQuery {
...
func (_q *SLADefinitionQuery) QueryEditors() *GroupQuery {
	query := (&GroupClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *SLADefinitionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SLADefinitionQuery) FirstIDX(ctx context.Context) string {
...
func (_q *SLADefinitionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SLADefinitionQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *SLADefinitionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *SLADefinitionQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SLADefinitionQuery) WithOwner(opts ...func(*OrganizationQuery)) *SLADefinitionQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
...
func (_q *SLADefinitionQuery) WithBlockedGroups(opts ...func(*GroupQuery)) *SLADefinitionQuery {
	query := (&GroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *SLADefinitionQuery) WithEditors(opts ...func(*GroupQuery)) *SLADefinitionQuery {
	query := (&GroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(sladefinition.FieldCreatedAt).
...
//
//	client.SLADefinition.Query().
//		Select(sladefinition.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *SLADefinitionQuery) prepareQuery(ctx context.Context) error {
	...
	if sladefinition.Policy == nil {
		return errors.New("generated: uninitialized sladefinition.Policy (forgotten import generated/runtime?)")
	}
	if err := sladefinition.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *SLADefinitionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SLADefinition, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.SLADefinition
	...
	if query := _q.withBlockedGroups; query != nil {
		if err := _q.loadBlockedGroups(ctx, query, nodes,
			func(n *SLADefinition) { n.Edges.BlockedGroups = []*Group{} },
			func(n *SLADefinition, e *Group) { n.Edges.BlockedGroups = append(n.Edges.BlockedGroups, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withEditors; query != nil {
		if err := _q.loadEditors(ctx, query, nodes,
			func(n *SLADefinition) { n.Edges.Editors = []*Group{} },
			func(n *SLADefinition, e *Group) { n.Edges.Editors = append(n.Edges.Editors, e) }); err != nil {
			return nil, err
		}
	}
	...
	for name, query := range _q.withNamedBlockedGroups {
		if err := _q.loadBlockedGroups(ctx, query, nodes,
			...
			func(n *SLADefinition, e *Group) { n.appendNamedBlockedGroups(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *SLADefinitionQuery) loadOwner(ctx context.Context, query *OrganizationQuery, nodes []*SLADefinition, init func(*SLADefinition), assign func(*SLADefinition, *Organization)) error {
...
func (_q *SLADefinitionQuery) loadBlockedGroups(ctx context.Context, query *GroupQuery, nodes []*SLADefinition, init func(*SLADefinition), assign func(*SLADefinition, *Group)) error {
	...
	query.Where(predicate.Group(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(sladefinition.BlockedGroupsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.sla_definition_blocked_groups
		if fk == nil {
			return fmt.Errorf(`foreign-key "sla_definition_blocked_groups" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "sla_definition_blocked_groups" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *SLADefinitionQuery) loadEditors(ctx context.Context, query *GroupQuery, nodes []*SLADefinition, init func(*SLADefinition), assign func(*SLADefinition, *Group)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*SLADefinition)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.Group(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(sladefinition.EditorsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.sla_definition_editors
		if fk == nil {
			return fmt.Errorf(`foreign-key "sla_definition_editors" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
func (_q *SLADefinitionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(sladefinition.Table, sladefinition.Columns, sqlgraph.NewFieldSpec(sladefinition.FieldID, field.TypeString))
	_spec.From = _q.sql
...
func (_q *SLADefinitionQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.SLADefinition)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
...
func (_q *SLADefinitionQuery) Modify(modifiers ...func(s *sql.Selector)) *SLADefinitionSelect {
...
func (_q *SLADefinitionQuery) WithNamedBlockedGroups(name string, opts ...func(*GroupQuery)) *SLADefinitionQuery {
	query := (&GroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *SLADefinitionQuery) WithNamedEditors(name string, opts ...func(*GroupQuery)) *SLADefinitionQuery {
	query := (&GroupClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (sdq *SLADefinitionQuery) CountIDs(ctx context.Context) (int, error) {
	logx.FromContext(ctx).Debug().Str("query_type", "SLADefinition").Str("operation", "count_ids").Msg("CountIDs: starting")
	...
	logx.FromContext(ctx).Debug().Str("query_type", "SLADefinition").Str("operation", "count_ids").Int("count", len(ids)).Msg("CountIDs: completed")
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *SLADefinitionSelect) Modify(modifiers ...func(s *sql.Selector)) *SLADefinitionSelect {
