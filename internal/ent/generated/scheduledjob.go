...
type ScheduledJobEdges struct {
	...
	// ScheduledJobSetting holds the value of the scheduled_job_setting edge.
	ScheduledJobSetting *ScheduledJobSetting `json:"scheduled_job_setting,omitempty"`
...
// ScheduledJobSettingOrErr returns the ScheduledJobSetting value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e ScheduledJobEdges) ScheduledJobSettingOrErr() (*ScheduledJobSetting, error) {
	if e.ScheduledJobSetting != nil {
		return e.ScheduledJobSetting, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: scheduledjobsetting.Label}
	}
	return nil, &NotLoadedError{edge: "scheduled_job_setting"}
}
...
// QueryScheduledJobSetting queries the "scheduled_job_setting" edge of the ScheduledJob entity.
func (sj *ScheduledJob) QueryScheduledJobSetting() *ScheduledJobSettingQuery {
	return NewScheduledJobClient(sj.config).QueryScheduledJobSetting(sj)
}
