...
func (e ControlScheduledJobEdges) ControlOrErr() (*Control, error) {
	if e.Control != nil {
...
func (*ControlScheduledJob) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case controlscheduledjob.FieldConfiguration, controlscheduledjob.FieldCadence:
			values[i] = new([]byte)
		case controlscheduledjob.FieldID, controlscheduledjob.FieldCreatedBy, controlscheduledjob.FieldUpdatedBy, controlscheduledjob.FieldDeletedBy, controlscheduledjob.FieldControlID, controlscheduledjob.FieldScheduledJobID, controlscheduledjob.FieldCron:
...
func (csj *ControlScheduledJob) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case controlscheduledjob.FieldControlID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field control_id", values[i])
			} else if value.Valid {
				csj.ControlID = value.String
			}
		case controlscheduledjob.FieldScheduledJobID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field scheduled_job_id", values[i])
			} else if value.Valid {
				csj.ScheduledJobID = value.String
			}
...
// QueryControl queries the "control" edge of the ControlScheduledJob entity.
func (csj *ControlScheduledJob) QueryControl() *ControlQuery {
	return NewControlScheduledJobClient(csj.config).QueryControl(csj)
}
...
func (csj *ControlScheduledJob) String() string {
	...
	builder.WriteString(csj.ControlID)
	builder.WriteString(", ")
	builder.WriteString("scheduled_job_id=")
	builder.WriteString(csj.ScheduledJobID)
	builder.WriteString(", ")
