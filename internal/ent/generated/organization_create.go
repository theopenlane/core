...
func (_c *OrganizationCreate) AddDirectoryAccountCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddDirectoryAccountCreatorIDs(ids...)
	return _c
}

// AddDirectoryAccountCreators adds the "directory_account_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddDirectoryAccountCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddDirectoryAccountCreatorIDs(ids...)
}

// AddDirectoryGroupCreatorIDs adds the "directory_group_creators" edge to the Group entity by IDs.
func (_c *OrganizationCreate) AddDirectoryGroupCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddDirectoryGroupCreatorIDs(ids...)
	return _c
}

// AddDirectoryGroupCreators adds the "directory_group_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddDirectoryGroupCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddDirectoryGroupCreatorIDs(ids...)
}

// AddDirectoryMembershipCreatorIDs adds the "directory_membership_creators" edge to the Group entity by IDs.
func (_c *OrganizationCreate) AddDirectoryMembershipCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddDirectoryMembershipCreatorIDs(ids...)
	return _c
}

// AddDirectoryMembershipCreators adds the "directory_membership_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddDirectoryMembershipCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *OrganizationCreate) AddDocumentDataCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddDocumentDataCreatorIDs(ids...)
	return _c
}

// AddDocumentDataCreators adds the "document_data_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddDocumentDataCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddDocumentDataCreatorIDs(ids...)
}
...
func (_c *OrganizationCreate) AddGroupMembershipCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddGroupMembershipCreatorIDs(ids...)
	return _c
}

// AddGroupMembershipCreators adds the "group_membership_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddGroupMembershipCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddGroupMembershipCreatorIDs(ids...)
}

// AddGroupSettingCreatorIDs adds the "group_setting_creators" edge to the Group entity by IDs.
func (_c *OrganizationCreate) AddGroupSettingCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddGroupSettingCreatorIDs(ids...)
	return _c
}

// AddGroupSettingCreators adds the "group_setting_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddGroupSettingCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddGroupSettingCreatorIDs(ids...)
}

// AddHushCreatorIDs adds the "hush_creators" edge to the Group entity by IDs.
func (_c *OrganizationCreate) AddHushCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddHushCreatorIDs(ids...)
	return _c
}

// AddHushCreators adds the "hush_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddHushCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddHushCreatorIDs(ids...)
}
...
func (_c *OrganizationCreate) AddInviteCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddInviteCreatorIDs(ids...)
	return _c
}

// AddInviteCreators adds the "invite_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddInviteCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *OrganizationCreate) AddOrgMembershipCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddOrgMembershipCreatorIDs(ids...)
	return _c
}

// AddOrgMembershipCreators adds the "org_membership_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddOrgMembershipCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddOrgMembershipCreatorIDs(ids...)
}
...
func (_c *OrganizationCreate) AddProgramMembershipCreatorIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddProgramMembershipCreatorIDs(ids...)
	return _c
}

// AddProgramMembershipCreators adds the "program_membership_creators" edges to the Group entity.
func (_c *OrganizationCreate) AddProgramMembershipCreators(v ...*Group) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddProgramMembershipCreatorIDs(ids...)
}
...
func (_c *OrganizationCreate) createSpec() (*Organization, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.DirectoryAccountCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.DirectoryGroupCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.DirectoryMembershipCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.DocumentDataCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.GroupMembershipCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.GroupSettingCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.HushCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.InviteCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.OrgMembershipCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.ProgramMembershipCreatorsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
