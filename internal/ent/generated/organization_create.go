...
func (_c *OrganizationCreate) AddOrganizationImpersonationEventIDs(ids ...string) *OrganizationCreate {
	_c.mutation.AddOrganizationImpersonationEventIDs(ids...)
	return _c
}

// AddOrganizationImpersonationEvents adds the "organization_impersonation_events" edges to the ImpersonationEvent entity.
func (_c *OrganizationCreate) AddOrganizationImpersonationEvents(v ...*ImpersonationEvent) *OrganizationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddOrganizationImpersonationEventIDs(ids...)
}
...
func (_c *OrganizationCreate) createSpec() (*Organization, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.OrganizationImpersonationEventsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
