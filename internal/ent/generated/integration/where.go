...
func HasCreatedBy() predicate.Integration {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.Integration {
	return predicate.Integration(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.Integration {
	return predicate.Integration(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.Integration {
	return predicate.Integration(func(s *sql.Selector) {
