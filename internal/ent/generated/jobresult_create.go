...
func (_c *JobResultCreate) SetUpdatedByImpersonator(v string) *JobResultCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *JobResultCreate) SetNillableUpdatedByImpersonator(v *string) *JobResultCreate {
	if v != nil {
