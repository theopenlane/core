...
func (_c *AssessmentResponseHistoryCreate) SetTags(v []string) *AssessmentResponseHistoryCreate {
...
func (_c *AssessmentResponseHistoryCreate) SetResponderID(v string) *AssessmentResponseHistoryCreate {
...
func (_c *AssessmentResponseHistoryCreate) SetResponseDataID(v string) *AssessmentResponseHistoryCreate {
	_c.mutation.SetResponseDataID(v)
	return _c
}

// SetNillableResponseDataID sets the "response_data_id" field if the given value is not nil.
func (_c *AssessmentResponseHistoryCreate) SetNillableResponseDataID(v *string) *AssessmentResponseHistoryCreate {
	if v != nil {
...
func (_c *AssessmentResponseHistoryCreate) check() error {
	...
	if _, ok := _c.mutation.ResponderID(); !ok {
		return &ValidationError{Name: "responder_id", err: errors.New(`generated: missing required field "AssessmentResponseHistory.responder_id"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
...
func (_c *AssessmentResponseHistoryCreate) createSpec() (*AssessmentResponseHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ResponderID(); ok {
		_spec.SetField(assessmentresponsehistory.FieldResponderID, field.TypeString, value)
	...
	if value, ok := _c.mutation.ResponseDataID(); ok {
