...
func (_c *TaskCreate) SetTaskKindID(id string) *TaskCreate {
	_c.mutation.SetTaskKindID(id)
	return _c
}

// SetNillableTaskKindID sets the "task_kind" edge to the CustomTypeEnum entity by ID if the given value is not nil.
func (_c *TaskCreate) SetNillableTaskKindID(id *string) *TaskCreate {
	if id != nil {
		_c = _c.SetTaskKindID(*id)
	}
	return _c
}
