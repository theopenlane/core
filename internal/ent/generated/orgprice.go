...
func (*OrgPrice) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case orgprice.FieldID, orgprice.FieldCreatedBy, orgprice.FieldUpdatedBy, orgprice.FieldUpdatedByImpersonator, orgprice.FieldDeletedBy, orgprice.FieldOwnerID, orgprice.FieldStripePriceID, orgprice.FieldStatus, orgprice.FieldProductID, orgprice.FieldSubscriptionID:
...
func (_m *OrgPrice) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case orgprice.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
