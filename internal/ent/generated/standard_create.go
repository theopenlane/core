...
func (_c *StandardCreate) SetUpdatedByImpersonator(v string) *StandardCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *StandardCreate) SetNillableUpdatedByImpersonator(v *string) *StandardCreate {
	if v != nil {
...
func (_c *StandardCreate) createSpec() (*Standard, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(standard.FieldUpdatedByImpersonator, field.TypeString, value)
