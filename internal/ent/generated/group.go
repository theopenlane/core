...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.ForeignKeys[5]: // asset_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[6]: // email_branding_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[7]: // email_branding_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[8]: // email_branding_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[9]: // finding_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[10]: // finding_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[11]: // finding_viewers
			values[i] = new(sql.NullString)
		...
		case group.ForeignKeys[20]: // organization_campaign_target_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[21]: // organization_contact_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[22]: // organization_control_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[23]: // organization_control_implementation_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[24]: // organization_control_objective_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[25]: // organization_discussion_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[26]: // organization_email_branding_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[27]: // organization_email_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[28]: // organization_entity_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[29]: // organization_evidence_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[30]: // organization_finding_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[31]: // organization_group_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[32]: // organization_identity_holder_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[33]: // organization_integration_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[34]: // organization_integration_webhook_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[35]: // organization_internal_policy_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[36]: // organization_job_runner_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[37]: // organization_job_runner_registration_token_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[38]: // organization_job_runner_token_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[39]: // organization_job_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[40]: // organization_mapped_control_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[41]: // organization_narrative_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[42]: // organization_notification_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[43]: // organization_platform_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[44]: // organization_procedure_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[45]: // organization_program_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[46]: // organization_remediation_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[47]: // organization_review_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[48]: // organization_risk_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[49]: // organization_scan_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[50]: // organization_scheduled_job_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[51]: // organization_scheduled_job_run_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[52]: // organization_standard_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[53]: // organization_subcontrol_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[54]: // organization_subprocessor_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[55]: // organization_system_detail_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[56]: // organization_task_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[57]: // organization_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[58]: // organization_trust_center_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[59]: // organization_trust_center_compliance_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[60]: // organization_trust_center_doc_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[61]: // organization_trust_center_entity_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[62]: // organization_trust_center_faq_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[63]: // organization_trust_center_nda_request_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[64]: // organization_trust_center_subprocessor_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[65]: // organization_trust_center_watermark_config_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[66]: // organization_user_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[67]: // organization_user_setting_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[68]: // organization_vulnerability_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[69]: // organization_workflow_assignment_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[70]: // organization_workflow_assignment_target_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[71]: // organization_workflow_definition_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[72]: // organization_workflow_event_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[73]: // organization_workflow_instance_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[74]: // organization_workflow_object_ref_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[75]: // organization_workflow_proposal_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[76]: // organization_campaigns_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[77]: // organization_compliance_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[78]: // organization_group_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[79]: // organization_policies_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[80]: // organization_registry_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[81]: // organization_risk_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[82]: // organization_trust_center_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[83]: // organization_workflows_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[84]: // remediation_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[85]: // remediation_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[86]: // remediation_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[87]: // review_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[88]: // review_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[89]: // review_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[90]: // trust_center_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[91]: // trust_center_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[92]: // trust_center_compliance_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[93]: // trust_center_compliance_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[94]: // trust_center_doc_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[95]: // trust_center_doc_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[96]: // trust_center_entity_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[97]: // trust_center_entity_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[98]: // trust_center_faq_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[99]: // trust_center_faq_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[100]: // trust_center_nda_request_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[101]: // trust_center_nda_request_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[102]: // trust_center_setting_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[103]: // trust_center_setting_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[104]: // trust_center_subprocessor_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[105]: // trust_center_subprocessor_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[106]: // trust_center_watermark_config_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[107]: // trust_center_watermark_config_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[108]: // vulnerability_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[109]: // vulnerability_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[110]: // vulnerability_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[111]: // workflow_definition_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[112]: // workflow_definition_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[113]: // workflow_definition_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[114]: // workflow_definition_groups
			values[i] = new(sql.NullString)
		default:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.ForeignKeys[6]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field email_branding_blocked_groups", values[i])
			} else if value.Valid {
				_m.email_branding_blocked_groups = new(string)
				*_m.email_branding_blocked_groups = value.String
			}
		case group.ForeignKeys[7]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field email_branding_editors", values[i])
			} else if value.Valid {
				_m.email_branding_editors = new(string)
				*_m.email_branding_editors = value.String
			}
		case group.ForeignKeys[8]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field email_branding_viewers", values[i])
			} else if value.Valid {
				_m.email_branding_viewers = new(string)
				*_m.email_branding_viewers = value.String
			}
