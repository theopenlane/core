...
type Group struct {
	...
	check_result_blocked_groups                         *string
	check_result_editors                                *string
	check_result_viewers                                *string
	email_template_blocked_groups                       *string
	email_template_editors                              *string
	email_template_viewers                              *string
	...
	organization_api_token_creators                     *string
	organization_assessment_creators                    *string
	organization_asset_creators                         *string
	organization_audience_creators                      *string
	organization_audience_member_creators               *string
	organization_campaign_creators                      *string
	organization_campaign_target_creators               *string
	organization_check_result_creators                  *string
	organization_contact_creators                       *string
	...
	organization_custom_domain_creators                 *string
	organization_custom_type_enum_creators              *string
	organization_directory_account_creators             *string
	organization_directory_group_creators               *string
	organization_directory_membership_creators          *string
	organization_directory_sync_run_creators            *string
	organization_discussion_creators                    *string
	organization_document_data_creators                 *string
	organization_email_template_creators                *string
	organization_entity_creators                        *string
	organization_entity_type_creators                   *string
	organization_evidence_creators                      *string
	organization_file_creators                          *string
	organization_finding_creators                       *string
	organization_finding_control_creators               *string
	organization_group_creators                         *string
	organization_group_membership_creators              *string
	organization_group_setting_creators                 *string
	organization_hush_creators                          *string
	organization_identity_holder_creators               *string
	organization_internal_policy_creators               *string
	organization_invite_creators                        *string
	organization_mapped_control_creators                *string
	organization_narrative_creators                     *string
	organization_note_creators                          *string
	organization_notification_template_creators         *string
	organization_org_membership_creators                *string
	organization_platform_creators                      *string
	organization_procedure_creators                     *string
	organization_program_creators                       *string
	organization_program_membership_creators            *string
	...
	organization_sla_definition_creators                *string
	organization_standard_creators                      *string
	organization_subcontrol_creators                    *string
	organization_subprocessor_creators                  *string
	organization_subscriber_creators                    *string
	organization_system_detail_creators                 *string
	organization_tag_definition_creators                *string
	organization_task_creators                          *string
	organization_template_creators                      *string
	organization_trust_center_creators                  *string
	...
	organization_trust_center_watermark_config_creators *string
	organization_vendor_risk_score_creators             *string
	organization_vendor_scoring_config_creators         *string
	organization_vulnerability_creators                 *string
	organization_workflow_definition_creators           *string
	organization_campaigns_manager                      *string
	organization_compliance_manager                     *string
	organization_group_manager                          *string
	organization_policies_manager                       *string
	organization_registry_manager                       *string
	organization_risk_manager                           *string
	organization_trust_center_manager                   *string
	organization_workflows_manager                      *string
	sla_definition_blocked_groups                       *string
	sla_definition_editors                              *string
...
type GroupEdges struct {
	...
	// ActionPlanEditors holds the value of the action_plan_editors edge.
	ActionPlanEditors []*ActionPlan `json:"action_plan_editors,omitempty"`
	// ActionPlanBlockedGroups holds the value of the action_plan_blocked_groups edge.
	ActionPlanBlockedGroups []*ActionPlan `json:"action_plan_blocked_groups,omitempty"`
	// ActionPlanViewers holds the value of the action_plan_viewers edge.
	ActionPlanViewers []*ActionPlan `json:"action_plan_viewers,omitempty"`
	// PlatformEditors holds the value of the platform_editors edge.
	PlatformEditors []*Platform `json:"platform_editors,omitempty"`
	// PlatformBlockedGroups holds the value of the platform_blocked_groups edge.
	PlatformBlockedGroups []*Platform `json:"platform_blocked_groups,omitempty"`
	// PlatformViewers holds the value of the platform_viewers edge.
	PlatformViewers []*Platform `json:"platform_viewers,omitempty"`
	// CampaignEditors holds the value of the campaign_editors edge.
	CampaignEditors []*Campaign `json:"campaign_editors,omitempty"`
	// CampaignBlockedGroups holds the value of the campaign_blocked_groups edge.
	CampaignBlockedGroups []*Campaign `json:"campaign_blocked_groups,omitempty"`
	// CampaignViewers holds the value of the campaign_viewers edge.
	CampaignViewers []*Campaign `json:"campaign_viewers,omitempty"`
	// AudienceEditors holds the value of the audience_editors edge.
	AudienceEditors []*Audience `json:"audience_editors,omitempty"`
	// AudienceBlockedGroups holds the value of the audience_blocked_groups edge.
	AudienceBlockedGroups []*Audience `json:"audience_blocked_groups,omitempty"`
	// AudienceViewers holds the value of the audience_viewers edge.
	AudienceViewers []*Audience `json:"audience_viewers,omitempty"`
	...
	// FindingEditors holds the value of the finding_editors edge.
	FindingEditors []*Finding `json:"finding_editors,omitempty"`
	// FindingBlockedGroups holds the value of the finding_blocked_groups edge.
	FindingBlockedGroups []*Finding `json:"finding_blocked_groups,omitempty"`
	// ReviewEditors holds the value of the review_editors edge.
	ReviewEditors []*Review `json:"review_editors,omitempty"`
	// ReviewBlockedGroups holds the value of the review_blocked_groups edge.
	ReviewBlockedGroups []*Review `json:"review_blocked_groups,omitempty"`
	// RemediationEditors holds the value of the remediation_editors edge.
	RemediationEditors []*Remediation `json:"remediation_editors,omitempty"`
	// RemediationBlockedGroups holds the value of the remediation_blocked_groups edge.
	RemediationBlockedGroups []*Remediation `json:"remediation_blocked_groups,omitempty"`
	...
	namedActionPlanEditors                  map[string][]*ActionPlan
	namedActionPlanBlockedGroups            map[string][]*ActionPlan
	namedActionPlanViewers                  map[string][]*ActionPlan
	namedPlatformEditors                    map[string][]*Platform
	namedPlatformBlockedGroups              map[string][]*Platform
	namedPlatformViewers                    map[string][]*Platform
	namedCampaignEditors                    map[string][]*Campaign
	namedCampaignBlockedGroups              map[string][]*Campaign
	namedCampaignViewers                    map[string][]*Campaign
	namedAudienceEditors                    map[string][]*Audience
	namedAudienceBlockedGroups              map[string][]*Audience
	namedAudienceViewers                    map[string][]*Audience
	...
	namedFindingEditors                     map[string][]*Finding
	namedFindingBlockedGroups               map[string][]*Finding
	namedReviewEditors                      map[string][]*Review
	namedReviewBlockedGroups                map[string][]*Review
	namedRemediationEditors                 map[string][]*Remediation
	namedRemediationBlockedGroups           map[string][]*Remediation
...
// ActionPlanEditorsOrErr returns the ActionPlanEditors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) ActionPlanEditorsOrErr() ([]*ActionPlan, error) {
	if e.loadedTypes[16] {
		return e.ActionPlanEditors, nil
	}
	return nil, &NotLoadedError{edge: "action_plan_editors"}
}

// ActionPlanBlockedGroupsOrErr returns the ActionPlanBlockedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) ActionPlanBlockedGroupsOrErr() ([]*ActionPlan, error) {
	if e.loadedTypes[17] {
		return e.ActionPlanBlockedGroups, nil
	}
	return nil, &NotLoadedError{edge: "action_plan_blocked_groups"}
}

// ActionPlanViewersOrErr returns the ActionPlanViewers value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) ActionPlanViewersOrErr() ([]*ActionPlan, error) {
	if e.loadedTypes[18] {
		return e.ActionPlanViewers, nil
	}
	return nil, &NotLoadedError{edge: "action_plan_viewers"}
}

// PlatformEditorsOrErr returns the PlatformEditors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) PlatformEditorsOrErr() ([]*Platform, error) {
	if e.loadedTypes[19] {
		return e.PlatformEditors, nil
	}
	return nil, &NotLoadedError{edge: "platform_editors"}
}

// PlatformBlockedGroupsOrErr returns the PlatformBlockedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) PlatformBlockedGroupsOrErr() ([]*Platform, error) {
	if e.loadedTypes[20] {
		return e.PlatformBlockedGroups, nil
	}
	return nil, &NotLoadedError{edge: "platform_blocked_groups"}
}

// PlatformViewersOrErr returns the PlatformViewers value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) PlatformViewersOrErr() ([]*Platform, error) {
	if e.loadedTypes[21] {
		return e.PlatformViewers, nil
	}
	return nil, &NotLoadedError{edge: "platform_viewers"}
}

// CampaignEditorsOrErr returns the CampaignEditors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) CampaignEditorsOrErr() ([]*Campaign, error) {
	if e.loadedTypes[22] {
		return e.CampaignEditors, nil
	}
	return nil, &NotLoadedError{edge: "campaign_editors"}
}

// CampaignBlockedGroupsOrErr returns the CampaignBlockedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) CampaignBlockedGroupsOrErr() ([]*Campaign, error) {
	if e.loadedTypes[23] {
		return e.CampaignBlockedGroups, nil
	}
	return nil, &NotLoadedError{edge: "campaign_blocked_groups"}
}

// CampaignViewersOrErr returns the CampaignViewers value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) CampaignViewersOrErr() ([]*Campaign, error) {
	if e.loadedTypes[24] {
		return e.CampaignViewers, nil
	}
	return nil, &NotLoadedError{edge: "campaign_viewers"}
}

// AudienceEditorsOrErr returns the AudienceEditors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) AudienceEditorsOrErr() ([]*Audience, error) {
	if e.loadedTypes[25] {
		return e.AudienceEditors, nil
	}
	return nil, &NotLoadedError{edge: "audience_editors"}
}

// AudienceBlockedGroupsOrErr returns the AudienceBlockedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) AudienceBlockedGroupsOrErr() ([]*Audience, error) {
	if e.loadedTypes[26] {
		return e.AudienceBlockedGroups, nil
	}
	return nil, &NotLoadedError{edge: "audience_blocked_groups"}
}

// AudienceViewersOrErr returns the AudienceViewers value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) AudienceViewersOrErr() ([]*Audience, error) {
	if e.loadedTypes[27] {
		return e.AudienceViewers, nil
	}
	return nil, &NotLoadedError{edge: "audience_viewers"}
}
...
// FindingEditorsOrErr returns the FindingEditors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) FindingEditorsOrErr() ([]*Finding, error) {
	if e.loadedTypes[40] {
		return e.FindingEditors, nil
	}
	return nil, &NotLoadedError{edge: "finding_editors"}
}

// FindingBlockedGroupsOrErr returns the FindingBlockedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) FindingBlockedGroupsOrErr() ([]*Finding, error) {
	if e.loadedTypes[41] {
		return e.FindingBlockedGroups, nil
	}
	return nil, &NotLoadedError{edge: "finding_blocked_groups"}
}

// ReviewEditorsOrErr returns the ReviewEditors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) ReviewEditorsOrErr() ([]*Review, error) {
	if e.loadedTypes[42] {
		return e.ReviewEditors, nil
	}
	return nil, &NotLoadedError{edge: "review_editors"}
}

// ReviewBlockedGroupsOrErr returns the ReviewBlockedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) ReviewBlockedGroupsOrErr() ([]*Review, error) {
	if e.loadedTypes[43] {
		return e.ReviewBlockedGroups, nil
	}
	return nil, &NotLoadedError{edge: "review_blocked_groups"}
}

// RemediationEditorsOrErr returns the RemediationEditors value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) RemediationEditorsOrErr() ([]*Remediation, error) {
	if e.loadedTypes[44] {
		return e.RemediationEditors, nil
	}
	return nil, &NotLoadedError{edge: "remediation_editors"}
}

// RemediationBlockedGroupsOrErr returns the RemediationBlockedGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) RemediationBlockedGroupsOrErr() ([]*Remediation, error) {
	if e.loadedTypes[45] {
		return e.RemediationBlockedGroups, nil
	}
	return nil, &NotLoadedError{edge: "remediation_blocked_groups"}
}
...
// was not loaded in eager-loading.
func (e GroupEdges) AudienceMembersOrErr() ([]*AudienceMember, error) {
	if e.loadedTypes[55] {
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.ForeignKeys[5]: // asset_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[6]: // check_result_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[7]: // check_result_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[8]: // check_result_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[9]: // email_template_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[10]: // email_template_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[11]: // email_template_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[12]: // identity_holder_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[13]: // identity_holder_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[14]: // identity_holder_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[15]: // organization_action_plan_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[16]: // organization_api_token_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[17]: // organization_assessment_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[18]: // organization_asset_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[19]: // organization_audience_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[20]: // organization_audience_member_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[21]: // organization_campaign_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[22]: // organization_campaign_target_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[23]: // organization_check_result_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[24]: // organization_contact_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[25]: // organization_control_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[26]: // organization_control_implementation_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[27]: // organization_control_objective_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[28]: // organization_custom_domain_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[29]: // organization_custom_type_enum_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[30]: // organization_directory_account_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[31]: // organization_directory_group_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[32]: // organization_directory_membership_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[33]: // organization_directory_sync_run_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[34]: // organization_discussion_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[35]: // organization_document_data_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[36]: // organization_email_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[37]: // organization_entity_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[38]: // organization_entity_type_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[39]: // organization_evidence_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[40]: // organization_file_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[41]: // organization_finding_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[42]: // organization_finding_control_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[43]: // organization_group_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[44]: // organization_group_membership_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[45]: // organization_group_setting_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[46]: // organization_hush_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[47]: // organization_identity_holder_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[48]: // organization_internal_policy_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[49]: // organization_invite_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[50]: // organization_mapped_control_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[51]: // organization_narrative_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[52]: // organization_note_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[53]: // organization_notification_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[54]: // organization_org_membership_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[55]: // organization_platform_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[56]: // organization_procedure_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[57]: // organization_program_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[58]: // organization_program_membership_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[59]: // organization_remediation_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[60]: // organization_review_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[61]: // organization_risk_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[62]: // organization_scan_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[63]: // organization_sla_definition_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[64]: // organization_standard_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[65]: // organization_subcontrol_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[66]: // organization_subprocessor_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[67]: // organization_subscriber_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[68]: // organization_system_detail_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[69]: // organization_tag_definition_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[70]: // organization_task_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[71]: // organization_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[72]: // organization_trust_center_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[73]: // organization_trust_center_compliance_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[74]: // organization_trust_center_doc_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[75]: // organization_trust_center_entity_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[76]: // organization_trust_center_faq_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[77]: // organization_trust_center_nda_request_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[78]: // organization_trust_center_subprocessor_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[79]: // organization_trust_center_watermark_config_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[80]: // organization_vendor_risk_score_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[81]: // organization_vendor_scoring_config_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[82]: // organization_vulnerability_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[83]: // organization_workflow_definition_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[84]: // organization_campaigns_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[85]: // organization_compliance_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[86]: // organization_group_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[87]: // organization_policies_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[88]: // organization_registry_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[89]: // organization_risk_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[90]: // organization_trust_center_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[91]: // organization_workflows_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[92]: // sla_definition_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[93]: // sla_definition_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[94]: // trust_center_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[95]: // trust_center_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[96]: // trust_center_compliance_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[97]: // trust_center_compliance_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[98]: // trust_center_doc_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[99]: // trust_center_doc_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[100]: // trust_center_entity_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[101]: // trust_center_entity_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[102]: // trust_center_faq_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[103]: // trust_center_faq_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[104]: // trust_center_nda_request_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[105]: // trust_center_nda_request_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[106]: // trust_center_setting_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[107]: // trust_center_setting_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[108]: // trust_center_subprocessor_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[109]: // trust_center_subprocessor_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[110]: // trust_center_watermark_config_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[111]: // trust_center_watermark_config_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[112]: // vulnerability_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[113]: // vulnerability_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[114]: // vulnerability_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[115]: // workflow_definition_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[116]: // workflow_definition_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[117]: // workflow_definition_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[118]: // workflow_definition_groups
			values[i] = new(sql.NullString)
		default:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case group.ForeignKeys[6]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field check_result_blocked_groups", values[i])
			} else if value.Valid {
				_m.check_result_blocked_groups = new(string)
				*_m.check_result_blocked_groups = value.String
			}
		case group.ForeignKeys[7]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field check_result_editors", values[i])
			} else if value.Valid {
				_m.check_result_editors = new(string)
				*_m.check_result_editors = value.String
			}
		case group.ForeignKeys[8]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field check_result_viewers", values[i])
			} else if value.Valid {
				_m.check_result_viewers = new(string)
				*_m.check_result_viewers = value.String
			}
		case group.ForeignKeys[9]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field email_template_blocked_groups", values[i])
			} else if value.Valid {
				_m.email_template_blocked_groups = new(string)
				*_m.email_template_blocked_groups = value.String
			}
		case group.ForeignKeys[10]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field email_template_editors", values[i])
			} else if value.Valid {
				_m.email_template_editors = new(string)
				*_m.email_template_editors = value.String
			}
		case group.ForeignKeys[11]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field email_template_viewers", values[i])
			} else if value.Valid {
				_m.email_template_viewers = new(string)
				*_m.email_template_viewers = value.String
			}
		case group.ForeignKeys[12]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field identity_holder_blocked_groups", values[i])
			} else if value.Valid {
				_m.identity_holder_blocked_groups = new(string)
				*_m.identity_holder_blocked_groups = value.String
			}
		case group.ForeignKeys[13]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field identity_holder_editors", values[i])
			} else if value.Valid {
				_m.identity_holder_editors = new(string)
				*_m.identity_holder_editors = value.String
			}
		case group.ForeignKeys[14]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field identity_holder_viewers", values[i])
			} else if value.Valid {
				_m.identity_holder_viewers = new(string)
				*_m.identity_holder_viewers = value.String
			}
		...
		case group.ForeignKeys[16]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_api_token_creators", values[i])
			} else if value.Valid {
				_m.organization_api_token_creators = new(string)
				*_m.organization_api_token_creators = value.String
			}
		...
		case group.ForeignKeys[19]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_audience_creators", values[i])
			} else if value.Valid {
				_m.organization_audience_creators = new(string)
				*_m.organization_audience_creators = value.String
			}
		case group.ForeignKeys[20]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_audience_member_creators", values[i])
			} else if value.Valid {
				_m.organization_audience_member_creators = new(string)
				*_m.organization_audience_member_creators = value.String
			}
		...
		case group.ForeignKeys[23]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_check_result_creators", values[i])
			} else if value.Valid {
				_m.organization_check_result_creators = new(string)
				*_m.organization_check_result_creators = value.String
			}
		case group.ForeignKeys[24]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_contact_creators", values[i])
			} else if value.Valid {
				_m.organization_contact_creators = new(string)
				*_m.organization_contact_creators = value.String
			}
		...
		case group.ForeignKeys[28]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_custom_domain_creators", values[i])
			} else if value.Valid {
				_m.organization_custom_domain_creators = new(string)
				*_m.organization_custom_domain_creators = value.String
			}
		case group.ForeignKeys[29]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_custom_type_enum_creators", values[i])
			} else if value.Valid {
				_m.organization_custom_type_enum_creators = new(string)
				*_m.organization_custom_type_enum_creators = value.String
			}
		case group.ForeignKeys[30]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_directory_account_creators", values[i])
			} else if value.Valid {
				_m.organization_directory_account_creators = new(string)
				*_m.organization_directory_account_creators = value.String
			}
		case group.ForeignKeys[31]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_directory_group_creators", values[i])
			} else if value.Valid {
				_m.organization_directory_group_creators = new(string)
				*_m.organization_directory_group_creators = value.String
			}
		case group.ForeignKeys[32]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_directory_membership_creators", values[i])
			} else if value.Valid {
				_m.organization_directory_membership_creators = new(string)
				*_m.organization_directory_membership_creators = value.String
			}
		case group.ForeignKeys[33]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_directory_sync_run_creators", values[i])
			} else if value.Valid {
				_m.organization_directory_sync_run_creators = new(string)
				*_m.organization_directory_sync_run_creators = value.String
			}
		case group.ForeignKeys[34]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_discussion_creators", values[i])
			} else if value.Valid {
				_m.organization_discussion_creators = new(string)
				*_m.organization_discussion_creators = value.String
			}
		case group.ForeignKeys[35]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_document_data_creators", values[i])
			} else if value.Valid {
				_m.organization_document_data_creators = new(string)
				*_m.organization_document_data_creators = value.String
			}
		case group.ForeignKeys[36]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_email_template_creators", values[i])
			} else if value.Valid {
				_m.organization_email_template_creators = new(string)
				*_m.organization_email_template_creators = value.String
			}
		...
		case group.ForeignKeys[38]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_entity_type_creators", values[i])
			} else if value.Valid {
				_m.organization_entity_type_creators = new(string)
				*_m.organization_entity_type_creators = value.String
			}
		...
		case group.ForeignKeys[40]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_file_creators", values[i])
			} else if value.Valid {
				_m.organization_file_creators = new(string)
				*_m.organization_file_creators = value.String
			}
		...
		case group.ForeignKeys[42]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_finding_control_creators", values[i])
			} else if value.Valid {
				_m.organization_finding_control_creators = new(string)
				*_m.organization_finding_control_creators = value.String
			}
		...
		case group.ForeignKeys[44]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_group_membership_creators", values[i])
			} else if value.Valid {
				_m.organization_group_membership_creators = new(string)
				*_m.organization_group_membership_creators = value.String
			}
		case group.ForeignKeys[45]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_group_setting_creators", values[i])
			} else if value.Valid {
				_m.organization_group_setting_creators = new(string)
				*_m.organization_group_setting_creators = value.String
			}
		case group.ForeignKeys[46]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_hush_creators", values[i])
			} else if value.Valid {
				_m.organization_hush_creators = new(string)
				*_m.organization_hush_creators = value.String
			}
		...
		case group.ForeignKeys[49]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_invite_creators", values[i])
			} else if value.Valid {
				_m.organization_invite_creators = new(string)
				*_m.organization_invite_creators = value.String
			}
		...
		case group.ForeignKeys[52]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_note_creators", values[i])
			} else if value.Valid {
				_m.organization_note_creators = new(string)
				*_m.organization_note_creators = value.String
			}
		case group.ForeignKeys[53]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_notification_template_creators", values[i])
			} else if value.Valid {
				_m.organization_notification_template_creators = new(string)
				*_m.organization_notification_template_creators = value.String
			}
		case group.ForeignKeys[54]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_org_membership_creators", values[i])
			} else if value.Valid {
				_m.organization_org_membership_creators = new(string)
				*_m.organization_org_membership_creators = value.String
			}
		...
		case group.ForeignKeys[58]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_program_membership_creators", values[i])
			} else if value.Valid {
				_m.organization_program_membership_creators = new(string)
				*_m.organization_program_membership_creators = value.String
			}
		...
		case group.ForeignKeys[63]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_sla_definition_creators", values[i])
			} else if value.Valid {
				_m.organization_sla_definition_creators = new(string)
				*_m.organization_sla_definition_creators = value.String
			}
		...
		case group.ForeignKeys[67]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_subscriber_creators", values[i])
			} else if value.Valid {
				_m.organization_subscriber_creators = new(string)
				*_m.organization_subscriber_creators = value.String
			}
		...
		case group.ForeignKeys[69]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_tag_definition_creators", values[i])
			} else if value.Valid {
				_m.organization_tag_definition_creators = new(string)
				*_m.organization_tag_definition_creators = value.String
			}
		case group.ForeignKeys[70]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_task_creators", values[i])
			} else if value.Valid {
				_m.organization_task_creators = new(string)
				*_m.organization_task_creators = value.String
			}
		...
		case group.ForeignKeys[72]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_trust_center_creators", values[i])
			} else if value.Valid {
				_m.organization_trust_center_creators = new(string)
				*_m.organization_trust_center_creators = value.String
			}
		...
		case group.ForeignKeys[79]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_trust_center_watermark_config_creators", values[i])
			} else if value.Valid {
				_m.organization_trust_center_watermark_config_creators = new(string)
				*_m.organization_trust_center_watermark_config_creators = value.String
			}
		case group.ForeignKeys[80]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_vendor_risk_score_creators", values[i])
			} else if value.Valid {
				_m.organization_vendor_risk_score_creators = new(string)
				*_m.organization_vendor_risk_score_creators = value.String
			}
		case group.ForeignKeys[81]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_vendor_scoring_config_creators", values[i])
			} else if value.Valid {
				_m.organization_vendor_scoring_config_creators = new(string)
				*_m.organization_vendor_scoring_config_creators = value.String
			}
		...
		case group.ForeignKeys[84]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_campaigns_manager", values[i])
			} else if value.Valid {
				_m.organization_campaigns_manager = new(string)
				*_m.organization_campaigns_manager = value.String
			}
		case group.ForeignKeys[85]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_compliance_manager", values[i])
			} else if value.Valid {
				_m.organization_compliance_manager = new(string)
				*_m.organization_compliance_manager = value.String
			}
		case group.ForeignKeys[86]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_group_manager", values[i])
			} else if value.Valid {
				_m.organization_group_manager = new(string)
				*_m.organization_group_manager = value.String
			}
		case group.ForeignKeys[87]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_policies_manager", values[i])
			} else if value.Valid {
				_m.organization_policies_manager = new(string)
				*_m.organization_policies_manager = value.String
			}
		case group.ForeignKeys[88]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_registry_manager", values[i])
			} else if value.Valid {
				_m.organization_registry_manager = new(string)
				*_m.organization_registry_manager = value.String
			}
		case group.ForeignKeys[89]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_risk_manager", values[i])
			} else if value.Valid {
				_m.organization_risk_manager = new(string)
				*_m.organization_risk_manager = value.String
			}
		case group.ForeignKeys[90]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_trust_center_manager", values[i])
			} else if value.Valid {
				_m.organization_trust_center_manager = new(string)
				*_m.organization_trust_center_manager = value.String
			}
		case group.ForeignKeys[91]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_workflows_manager", values[i])
			} else if value.Valid {
				_m.organization_workflows_manager = new(string)
				*_m.organization_workflows_manager = value.String
			}
		case group.ForeignKeys[92]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field sla_definition_blocked_groups", values[i])
			} else if value.Valid {
				_m.sla_definition_blocked_groups = new(string)
				*_m.sla_definition_blocked_groups = value.String
			}
		case group.ForeignKeys[93]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field sla_definition_editors", values[i])
			} else if value.Valid {
				_m.sla_definition_editors = new(string)
				*_m.sla_definition_editors = value.String
			}
		case group.ForeignKeys[94]:
			if value, ok := values[i].(*sql.NullString); !ok {
...
// QueryActionPlanEditors queries the "action_plan_editors" edge of the Group entity.
func (_m *Group) QueryActionPlanEditors() *ActionPlanQuery {
	return NewGroupClient(_m.config).QueryActionPlanEditors(_m)
}

// QueryActionPlanBlockedGroups queries the "action_plan_blocked_groups" edge of the Group entity.
func (_m *Group) QueryActionPlanBlockedGroups() *ActionPlanQuery {
	return NewGroupClient(_m.config).QueryActionPlanBlockedGroups(_m)
}

// QueryActionPlanViewers queries the "action_plan_viewers" edge of the Group entity.
func (_m *Group) QueryActionPlanViewers() *ActionPlanQuery {
	return NewGroupClient(_m.config).QueryActionPlanViewers(_m)
}

// QueryPlatformEditors queries the "platform_editors" edge of the Group entity.
func (_m *Group) QueryPlatformEditors() *PlatformQuery {
	return NewGroupClient(_m.config).QueryPlatformEditors(_m)
}

// QueryPlatformBlockedGroups queries the "platform_blocked_groups" edge of the Group entity.
func (_m *Group) QueryPlatformBlockedGroups() *PlatformQuery {
	return NewGroupClient(_m.config).QueryPlatformBlockedGroups(_m)
}

// QueryPlatformViewers queries the "platform_viewers" edge of the Group entity.
func (_m *Group) QueryPlatformViewers() *PlatformQuery {
	return NewGroupClient(_m.config).QueryPlatformViewers(_m)
}

// QueryCampaignEditors queries the "campaign_editors" edge of the Group entity.
func (_m *Group) QueryCampaignEditors() *CampaignQuery {
	return NewGroupClient(_m.config).QueryCampaignEditors(_m)
}

// QueryCampaignBlockedGroups queries the "campaign_blocked_groups" edge of the Group entity.
func (_m *Group) QueryCampaignBlockedGroups() *CampaignQuery {
	return NewGroupClient(_m.config).QueryCampaignBlockedGroups(_m)
}

// QueryCampaignViewers queries the "campaign_viewers" edge of the Group entity.
func (_m *Group) QueryCampaignViewers() *CampaignQuery {
	return NewGroupClient(_m.config).QueryCampaignViewers(_m)
}

// QueryAudienceEditors queries the "audience_editors" edge of the Group entity.
func (_m *Group) QueryAudienceEditors() *AudienceQuery {
	return NewGroupClient(_m.config).QueryAudienceEditors(_m)
}

// QueryAudienceBlockedGroups queries the "audience_blocked_groups" edge of the Group entity.
func (_m *Group) QueryAudienceBlockedGroups() *AudienceQuery {
	return NewGroupClient(_m.config).QueryAudienceBlockedGroups(_m)
}

// QueryAudienceViewers queries the "audience_viewers" edge of the Group entity.
func (_m *Group) QueryAudienceViewers() *AudienceQuery {
	return NewGroupClient(_m.config).QueryAudienceViewers(_m)
}
...
// QueryFindingEditors queries the "finding_editors" edge of the Group entity.
func (_m *Group) QueryFindingEditors() *FindingQuery {
	return NewGroupClient(_m.config).QueryFindingEditors(_m)
}

// QueryFindingBlockedGroups queries the "finding_blocked_groups" edge of the Group entity.
func (_m *Group) QueryFindingBlockedGroups() *FindingQuery {
	return NewGroupClient(_m.config).QueryFindingBlockedGroups(_m)
}

// QueryReviewEditors queries the "review_editors" edge of the Group entity.
func (_m *Group) QueryReviewEditors() *ReviewQuery {
	return NewGroupClient(_m.config).QueryReviewEditors(_m)
}

// QueryReviewBlockedGroups queries the "review_blocked_groups" edge of the Group entity.
func (_m *Group) QueryReviewBlockedGroups() *ReviewQuery {
	return NewGroupClient(_m.config).QueryReviewBlockedGroups(_m)
}

// QueryRemediationEditors queries the "remediation_editors" edge of the Group entity.
func (_m *Group) QueryRemediationEditors() *RemediationQuery {
	return NewGroupClient(_m.config).QueryRemediationEditors(_m)
}

// QueryRemediationBlockedGroups queries the "remediation_blocked_groups" edge of the Group entity.
func (_m *Group) QueryRemediationBlockedGroups() *RemediationQuery {
	return NewGroupClient(_m.config).QueryRemediationBlockedGroups(_m)
}
...
// QueryAudienceMembers queries the "audience_members" edge of the Group entity.
func (_m *Group) QueryAudienceMembers() *AudienceMemberQuery {
	return NewGroupClient(_m.config).QueryAudienceMembers(_m)
}
...
// NamedActionPlanEditors returns the ActionPlanEditors named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedActionPlanEditors(name string) ([]*ActionPlan, error) {
	if _m.Edges.namedActionPlanEditors == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedActionPlanEditors[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedActionPlanEditors(name string, edges ...*ActionPlan) {
	if _m.Edges.namedActionPlanEditors == nil {
		_m.Edges.namedActionPlanEditors = make(map[string][]*ActionPlan)
	}
	if len(edges) == 0 {
		_m.Edges.namedActionPlanEditors[name] = []*ActionPlan{}
	} else {
		_m.Edges.namedActionPlanEditors[name] = append(_m.Edges.namedActionPlanEditors[name], edges...)
	}
}

// NamedActionPlanBlockedGroups returns the ActionPlanBlockedGroups named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedActionPlanBlockedGroups(name string) ([]*ActionPlan, error) {
	if _m.Edges.namedActionPlanBlockedGroups == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedActionPlanBlockedGroups[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedActionPlanBlockedGroups(name string, edges ...*ActionPlan) {
	if _m.Edges.namedActionPlanBlockedGroups == nil {
		_m.Edges.namedActionPlanBlockedGroups = make(map[string][]*ActionPlan)
	}
	if len(edges) == 0 {
		_m.Edges.namedActionPlanBlockedGroups[name] = []*ActionPlan{}
	} else {
		_m.Edges.namedActionPlanBlockedGroups[name] = append(_m.Edges.namedActionPlanBlockedGroups[name], edges...)
	}
}

// NamedActionPlanViewers returns the ActionPlanViewers named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedActionPlanViewers(name string) ([]*ActionPlan, error) {
	if _m.Edges.namedActionPlanViewers == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedActionPlanViewers[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedActionPlanViewers(name string, edges ...*ActionPlan) {
	if _m.Edges.namedActionPlanViewers == nil {
		_m.Edges.namedActionPlanViewers = make(map[string][]*ActionPlan)
	}
	if len(edges) == 0 {
		_m.Edges.namedActionPlanViewers[name] = []*ActionPlan{}
	} else {
		_m.Edges.namedActionPlanViewers[name] = append(_m.Edges.namedActionPlanViewers[name], edges...)
	}
}

// NamedPlatformEditors returns the PlatformEditors named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedPlatformEditors(name string) ([]*Platform, error) {
	if _m.Edges.namedPlatformEditors == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedPlatformEditors[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedPlatformEditors(name string, edges ...*Platform) {
	if _m.Edges.namedPlatformEditors == nil {
		_m.Edges.namedPlatformEditors = make(map[string][]*Platform)
	}
	if len(edges) == 0 {
		_m.Edges.namedPlatformEditors[name] = []*Platform{}
	} else {
		_m.Edges.namedPlatformEditors[name] = append(_m.Edges.namedPlatformEditors[name], edges...)
	}
}

// NamedPlatformBlockedGroups returns the PlatformBlockedGroups named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedPlatformBlockedGroups(name string) ([]*Platform, error) {
	if _m.Edges.namedPlatformBlockedGroups == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedPlatformBlockedGroups[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedPlatformBlockedGroups(name string, edges ...*Platform) {
	if _m.Edges.namedPlatformBlockedGroups == nil {
		_m.Edges.namedPlatformBlockedGroups = make(map[string][]*Platform)
	}
	if len(edges) == 0 {
		_m.Edges.namedPlatformBlockedGroups[name] = []*Platform{}
	} else {
		_m.Edges.namedPlatformBlockedGroups[name] = append(_m.Edges.namedPlatformBlockedGroups[name], edges...)
	}
}

// NamedPlatformViewers returns the PlatformViewers named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedPlatformViewers(name string) ([]*Platform, error) {
	if _m.Edges.namedPlatformViewers == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedPlatformViewers[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedPlatformViewers(name string, edges ...*Platform) {
	if _m.Edges.namedPlatformViewers == nil {
		_m.Edges.namedPlatformViewers = make(map[string][]*Platform)
	}
	if len(edges) == 0 {
		_m.Edges.namedPlatformViewers[name] = []*Platform{}
	} else {
		_m.Edges.namedPlatformViewers[name] = append(_m.Edges.namedPlatformViewers[name], edges...)
	}
}

// NamedCampaignEditors returns the CampaignEditors named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedCampaignEditors(name string) ([]*Campaign, error) {
	if _m.Edges.namedCampaignEditors == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedCampaignEditors[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedCampaignEditors(name string, edges ...*Campaign) {
	if _m.Edges.namedCampaignEditors == nil {
		_m.Edges.namedCampaignEditors = make(map[string][]*Campaign)
	}
	if len(edges) == 0 {
		_m.Edges.namedCampaignEditors[name] = []*Campaign{}
	} else {
		_m.Edges.namedCampaignEditors[name] = append(_m.Edges.namedCampaignEditors[name], edges...)
	}
}

// NamedCampaignBlockedGroups returns the CampaignBlockedGroups named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedCampaignBlockedGroups(name string) ([]*Campaign, error) {
	if _m.Edges.namedCampaignBlockedGroups == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedCampaignBlockedGroups[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedCampaignBlockedGroups(name string, edges ...*Campaign) {
	if _m.Edges.namedCampaignBlockedGroups == nil {
		_m.Edges.namedCampaignBlockedGroups = make(map[string][]*Campaign)
	}
	if len(edges) == 0 {
		_m.Edges.namedCampaignBlockedGroups[name] = []*Campaign{}
	} else {
		_m.Edges.namedCampaignBlockedGroups[name] = append(_m.Edges.namedCampaignBlockedGroups[name], edges...)
	}
}

// NamedCampaignViewers returns the CampaignViewers named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedCampaignViewers(name string) ([]*Campaign, error) {
	if _m.Edges.namedCampaignViewers == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedCampaignViewers[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedCampaignViewers(name string, edges ...*Campaign) {
	if _m.Edges.namedCampaignViewers == nil {
		_m.Edges.namedCampaignViewers = make(map[string][]*Campaign)
	}
	if len(edges) == 0 {
		_m.Edges.namedCampaignViewers[name] = []*Campaign{}
	} else {
		_m.Edges.namedCampaignViewers[name] = append(_m.Edges.namedCampaignViewers[name], edges...)
	}
}

// NamedAudienceEditors returns the AudienceEditors named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedAudienceEditors(name string) ([]*Audience, error) {
	if _m.Edges.namedAudienceEditors == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedAudienceEditors[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedAudienceEditors(name string, edges ...*Audience) {
	if _m.Edges.namedAudienceEditors == nil {
		_m.Edges.namedAudienceEditors = make(map[string][]*Audience)
	}
	if len(edges) == 0 {
		_m.Edges.namedAudienceEditors[name] = []*Audience{}
	} else {
		_m.Edges.namedAudienceEditors[name] = append(_m.Edges.namedAudienceEditors[name], edges...)
	}
}

// NamedAudienceBlockedGroups returns the AudienceBlockedGroups named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedAudienceBlockedGroups(name string) ([]*Audience, error) {
	if _m.Edges.namedAudienceBlockedGroups == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedAudienceBlockedGroups[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedAudienceBlockedGroups(name string, edges ...*Audience) {
	if _m.Edges.namedAudienceBlockedGroups == nil {
		_m.Edges.namedAudienceBlockedGroups = make(map[string][]*Audience)
	}
	if len(edges) == 0 {
		_m.Edges.namedAudienceBlockedGroups[name] = []*Audience{}
	} else {
		_m.Edges.namedAudienceBlockedGroups[name] = append(_m.Edges.namedAudienceBlockedGroups[name], edges...)
	}
}

// NamedAudienceViewers returns the AudienceViewers named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedAudienceViewers(name string) ([]*Audience, error) {
	if _m.Edges.namedAudienceViewers == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedAudienceViewers[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedAudienceViewers(name string, edges ...*Audience) {
	if _m.Edges.namedAudienceViewers == nil {
		_m.Edges.namedAudienceViewers = make(map[string][]*Audience)
	}
	if len(edges) == 0 {
		_m.Edges.namedAudienceViewers[name] = []*Audience{}
	} else {
		_m.Edges.namedAudienceViewers[name] = append(_m.Edges.namedAudienceViewers[name], edges...)
	}
}
...
// NamedFindingEditors returns the FindingEditors named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedFindingEditors(name string) ([]*Finding, error) {
	if _m.Edges.namedFindingEditors == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedFindingEditors[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedFindingEditors(name string, edges ...*Finding) {
	if _m.Edges.namedFindingEditors == nil {
		_m.Edges.namedFindingEditors = make(map[string][]*Finding)
	}
	if len(edges) == 0 {
		_m.Edges.namedFindingEditors[name] = []*Finding{}
	} else {
		_m.Edges.namedFindingEditors[name] = append(_m.Edges.namedFindingEditors[name], edges...)
	}
}

// NamedFindingBlockedGroups returns the FindingBlockedGroups named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedFindingBlockedGroups(name string) ([]*Finding, error) {
	if _m.Edges.namedFindingBlockedGroups == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedFindingBlockedGroups[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedFindingBlockedGroups(name string, edges ...*Finding) {
	if _m.Edges.namedFindingBlockedGroups == nil {
		_m.Edges.namedFindingBlockedGroups = make(map[string][]*Finding)
	}
	if len(edges) == 0 {
		_m.Edges.namedFindingBlockedGroups[name] = []*Finding{}
	} else {
		_m.Edges.namedFindingBlockedGroups[name] = append(_m.Edges.namedFindingBlockedGroups[name], edges...)
	}
}

// NamedReviewEditors returns the ReviewEditors named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedReviewEditors(name string) ([]*Review, error) {
	if _m.Edges.namedReviewEditors == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedReviewEditors[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedReviewEditors(name string, edges ...*Review) {
	if _m.Edges.namedReviewEditors == nil {
		_m.Edges.namedReviewEditors = make(map[string][]*Review)
	}
	if len(edges) == 0 {
		_m.Edges.namedReviewEditors[name] = []*Review{}
	} else {
		_m.Edges.namedReviewEditors[name] = append(_m.Edges.namedReviewEditors[name], edges...)
	}
}

// NamedReviewBlockedGroups returns the ReviewBlockedGroups named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedReviewBlockedGroups(name string) ([]*Review, error) {
	if _m.Edges.namedReviewBlockedGroups == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedReviewBlockedGroups[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedReviewBlockedGroups(name string, edges ...*Review) {
	if _m.Edges.namedReviewBlockedGroups == nil {
		_m.Edges.namedReviewBlockedGroups = make(map[string][]*Review)
	}
	if len(edges) == 0 {
		_m.Edges.namedReviewBlockedGroups[name] = []*Review{}
	} else {
		_m.Edges.namedReviewBlockedGroups[name] = append(_m.Edges.namedReviewBlockedGroups[name], edges...)
	}
}

// NamedRemediationEditors returns the RemediationEditors named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedRemediationEditors(name string) ([]*Remediation, error) {
	if _m.Edges.namedRemediationEditors == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedRemediationEditors[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedRemediationEditors(name string, edges ...*Remediation) {
	if _m.Edges.namedRemediationEditors == nil {
		_m.Edges.namedRemediationEditors = make(map[string][]*Remediation)
	}
	if len(edges) == 0 {
		_m.Edges.namedRemediationEditors[name] = []*Remediation{}
	} else {
		_m.Edges.namedRemediationEditors[name] = append(_m.Edges.namedRemediationEditors[name], edges...)
	}
}

// NamedRemediationBlockedGroups returns the RemediationBlockedGroups named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Group) NamedRemediationBlockedGroups(name string) ([]*Remediation, error) {
	if _m.Edges.namedRemediationBlockedGroups == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedRemediationBlockedGroups[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Group) appendNamedRemediationBlockedGroups(name string, edges ...*Remediation) {
	if _m.Edges.namedRemediationBlockedGroups == nil {
		_m.Edges.namedRemediationBlockedGroups = make(map[string][]*Remediation)
	}
	if len(edges) == 0 {
		_m.Edges.namedRemediationBlockedGroups[name] = []*Remediation{}
	} else {
		_m.Edges.namedRemediationBlockedGroups[name] = append(_m.Edges.namedRemediationBlockedGroups[name], edges...)
	}
}
...
// loaded in eager-loading with this name.
func (_m *Group) NamedAudienceMembers(name string) ([]*AudienceMember, error) {
...
func (_m *Group) appendNamedAudienceMembers(name string, edges ...*AudienceMember) {
	if _m.Edges.namedAudienceMembers == nil {
