...
type Group struct {
	...
	organization_export_creators                        *string
	...
	organization_integration_creators                   *string
	organization_integration_webhook_creators           *string
	...
	organization_organization_creators                  *string
	...
	organization_user_creators                          *string
	organization_user_setting_creators                  *string
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.ForeignKeys[29]: // organization_custom_type_enum_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[30]: // organization_discussion_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[31]: // organization_email_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[32]: // organization_entity_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[33]: // organization_entity_type_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[34]: // organization_evidence_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[35]: // organization_export_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[36]: // organization_file_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[37]: // organization_finding_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[38]: // organization_group_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[39]: // organization_identity_holder_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[40]: // organization_integration_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[41]: // organization_integration_webhook_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[42]: // organization_internal_policy_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[43]: // organization_job_runner_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[44]: // organization_job_runner_registration_token_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[45]: // organization_job_runner_token_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[46]: // organization_job_template_creators
			values[i] = new(sql.NullString)
		...
		case group.ForeignKeys[50]: // organization_notification_template_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[51]: // organization_organization_creators
			values[i] = new(sql.NullString)
		...
		case group.ForeignKeys[54]: // organization_program_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[55]: // organization_remediation_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[56]: // organization_review_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[57]: // organization_risk_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[58]: // organization_scan_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[59]: // organization_scheduled_job_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[60]: // organization_scheduled_job_run_creators
			values[i] = new(sql.NullString)
		...
		case group.ForeignKeys[76]: // organization_trust_center_watermark_config_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[77]: // organization_user_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[78]: // organization_user_setting_creators
			values[i] = new(sql.NullString)
		...
		case group.ForeignKeys[80]: // organization_vulnerability_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[81]: // organization_workflow_assignment_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[82]: // organization_workflow_assignment_target_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[83]: // organization_workflow_definition_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[84]: // organization_workflow_event_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[85]: // organization_workflow_instance_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[86]: // organization_workflow_object_ref_creators
			values[i] = new(sql.NullString)
		case group.ForeignKeys[87]: // organization_workflow_proposal_creators
			values[i] = new(sql.NullString)
		...
		case group.ForeignKeys[95]: // organization_workflows_manager
			values[i] = new(sql.NullString)
		case group.ForeignKeys[96]: // remediation_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[97]: // remediation_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[98]: // remediation_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[99]: // review_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[100]: // review_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[101]: // review_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[102]: // sla_definition_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[103]: // sla_definition_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[104]: // sla_definition_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[105]: // trust_center_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[106]: // trust_center_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[107]: // trust_center_compliance_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[108]: // trust_center_compliance_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[109]: // trust_center_doc_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[110]: // trust_center_doc_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[111]: // trust_center_entity_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[112]: // trust_center_entity_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[113]: // trust_center_faq_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[114]: // trust_center_faq_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[115]: // trust_center_nda_request_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[116]: // trust_center_nda_request_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[117]: // trust_center_setting_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[118]: // trust_center_setting_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[119]: // trust_center_subprocessor_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[120]: // trust_center_subprocessor_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[121]: // trust_center_watermark_config_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[122]: // trust_center_watermark_config_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[123]: // vulnerability_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[124]: // vulnerability_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[125]: // vulnerability_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[126]: // workflow_definition_blocked_groups
			values[i] = new(sql.NullString)
		case group.ForeignKeys[127]: // workflow_definition_editors
			values[i] = new(sql.NullString)
		case group.ForeignKeys[128]: // workflow_definition_viewers
			values[i] = new(sql.NullString)
		case group.ForeignKeys[129]: // workflow_definition_groups
			values[i] = new(sql.NullString)
		default:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.ForeignKeys[35]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_export_creators", values[i])
			} else if value.Valid {
				_m.organization_export_creators = new(string)
				*_m.organization_export_creators = value.String
			}
		...
		case group.ForeignKeys[40]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_integration_creators", values[i])
			} else if value.Valid {
				_m.organization_integration_creators = new(string)
				*_m.organization_integration_creators = value.String
			}
		case group.ForeignKeys[41]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_integration_webhook_creators", values[i])
			} else if value.Valid {
				_m.organization_integration_webhook_creators = new(string)
				*_m.organization_integration_webhook_creators = value.String
			}
		...
		case group.ForeignKeys[51]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_organization_creators", values[i])
			} else if value.Valid {
				_m.organization_organization_creators = new(string)
				*_m.organization_organization_creators = value.String
			}
		...
		case group.ForeignKeys[77]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_user_creators", values[i])
			} else if value.Valid {
				_m.organization_user_creators = new(string)
				*_m.organization_user_creators = value.String
			}
		case group.ForeignKeys[78]:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field organization_user_setting_creators", values[i])
			} else if value.Valid {
				_m.organization_user_setting_creators = new(string)
				*_m.organization_user_setting_creators = value.String
			}
