...
const (
	// Label holds the string label denoting the trustcentercontrolhistory type in the database.
	Label = "trust_center_control_history"
	...
	// Table holds the table name of the trustcentercontrolhistory in the database.
	Table = "trust_center_control_history"
)

// Columns holds all SQL columns for trustcentercontrolhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldRef,
...
func OperationValidator(o history.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("trustcentercontrolhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the TrustCenterControlHistory queries.
