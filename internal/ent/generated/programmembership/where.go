...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.ProgramMembership {
	return predicate.ProgramMembership(func(s *sql.Selector) {
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.ProgramMembership {
	return predicate.ProgramMembership(func(s *sql.Selector) {
