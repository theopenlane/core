...
func (_c *IntegrationCreate) SetUpdatedByImpersonator(v string) *IntegrationCreate {
	_c.mutation.SetUpdatedByImpersonator(v)
	return _c
}

// SetNillableUpdatedByImpersonator sets the "updated_by_impersonator" field if the given value is not nil.
func (_c *IntegrationCreate) SetNillableUpdatedByImpersonator(v *string) *IntegrationCreate {
	if v != nil {
...
func (_c *IntegrationCreate) AddInternalPolicyIDs(ids ...string) *IntegrationCreate {
	_c.mutation.AddInternalPolicyIDs(ids...)
	return _c
}

// AddInternalPolicies adds the "internal_policies" edges to the InternalPolicy entity.
func (_c *IntegrationCreate) AddInternalPolicies(v ...*InternalPolicy) *IntegrationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *IntegrationCreate) AddCheckResults(v ...*CheckResult) *IntegrationCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *IntegrationCreate) createSpec() (*Integration, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UpdatedByImpersonator(); ok {
		_spec.SetField(integration.FieldUpdatedByImpersonator, field.TypeString, value)
