...
func (sju *ScheduledJobUpdate) SetIsMarketplace(b bool) *ScheduledJobUpdate {
	sju.mutation.SetIsMarketplace(b)
	return sju
}

// SetNillableIsMarketplace sets the "is_marketplace" field if the given value is not nil.
func (sju *ScheduledJobUpdate) SetNillableIsMarketplace(b *bool) *ScheduledJobUpdate {
	if b != nil {
		sju.SetIsMarketplace(*b)
	}
	return sju
}
...
func (sju *ScheduledJobUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := sju.mutation.IsMarketplace(); ok {
...
// SetIsMarketplace sets the "is_marketplace" field.
func (sjuo *ScheduledJobUpdateOne) SetIsMarketplace(b bool) *ScheduledJobUpdateOne {
	sjuo.mutation.SetIsMarketplace(b)
	return sjuo
}

// SetNillableIsMarketplace sets the "is_marketplace" field if the given value is not nil.
func (sjuo *ScheduledJobUpdateOne) SetNillableIsMarketplace(b *bool) *ScheduledJobUpdateOne {
	if b != nil {
		sjuo.SetIsMarketplace(*b)
	}
	return sjuo
}
...
func (sjuo *ScheduledJobUpdateOne) sqlSave(ctx context.Context) (_node *ScheduledJob, err error) {
	...
	if value, ok := sjuo.mutation.IsMarketplace(); ok {
		_spec.SetField(scheduledjob.FieldIsMarketplace, field.TypeBool, value)
	}
