...
func (sju *ScheduledJobUpdate) SetEnvironment(ee enums.JobEnvironment) *ScheduledJobUpdate {
	sju.mutation.SetEnvironment(ee)
	return sju
}

// SetNillableEnvironment sets the "environment" field if the given value is not nil.
func (sju *ScheduledJobUpdate) SetNillableEnvironment(ee *enums.JobEnvironment) *ScheduledJobUpdate {
	if ee != nil {
		sju.SetEnvironment(*ee)
	}
	return sju
}
...
func (sju *ScheduledJobUpdate) SetScheduledJobSetting(s *ScheduledJobSetting) *ScheduledJobUpdate {
	return sju.SetScheduledJobSettingID(s.ID)
}
...
func (sju *ScheduledJobUpdate) ClearScheduledJobSetting() *ScheduledJobUpdate {
	sju.mutation.ClearScheduledJobSetting()
	return sju
}
...
func (sju *ScheduledJobUpdate) check() error {
	...
	if v, ok := sju.mutation.Environment(); ok {
	...
	if sju.mutation.ScheduledJobSettingCleared() && len(sju.mutation.ScheduledJobSettingIDs()) > 0 {
		return errors.New(`generated: clearing a required unique edge "ScheduledJob.scheduled_job_setting"`)
	}
	return nil
}
...
func (sju *ScheduledJobUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := sju.mutation.Environment(); ok {
	...
	if sju.mutation.ScheduledJobSettingCleared() {
		...
		edge.Schema = sju.schemaConfig.ScheduledJobSetting
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := sju.mutation.ScheduledJobSettingIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   scheduledjob.ScheduledJobSettingTable,
...
// SetEnvironment sets the "environment" field.
func (sjuo *ScheduledJobUpdateOne) SetEnvironment(ee enums.JobEnvironment) *ScheduledJobUpdateOne {
	sjuo.mutation.SetEnvironment(ee)
	return sjuo
}

// SetNillableEnvironment sets the "environment" field if the given value is not nil.
func (sjuo *ScheduledJobUpdateOne) SetNillableEnvironment(ee *enums.JobEnvironment) *ScheduledJobUpdateOne {
	if ee != nil {
		sjuo.SetEnvironment(*ee)
	}
	return sjuo
}
...
// SetScheduledJobSetting sets the "scheduled_job_setting" edge to the ScheduledJobSetting entity.
func (sjuo *ScheduledJobUpdateOne) SetScheduledJobSetting(s *ScheduledJobSetting) *ScheduledJobUpdateOne {
	return sjuo.SetScheduledJobSettingID(s.ID)
}
...
// ClearScheduledJobSetting clears the "scheduled_job_setting" edge to the ScheduledJobSetting entity.
func (sjuo *ScheduledJobUpdateOne) ClearScheduledJobSetting() *ScheduledJobUpdateOne {
	sjuo.mutation.ClearScheduledJobSetting()
	return sjuo
}
...
func (sjuo *ScheduledJobUpdateOne) check() error {
	...
	if v, ok := sjuo.mutation.Environment(); ok {
		if err := scheduledjob.EnvironmentValidator(v); err != nil {
			return &ValidationError{Name: "environment", err: fmt.Errorf(`generated: validator failed for field "ScheduledJob.environment": %w`, err)}
		}
	}
	if sjuo.mutation.ScheduledJobSettingCleared() && len(sjuo.mutation.ScheduledJobSettingIDs()) > 0 {
		return errors.New(`generated: clearing a required unique edge "ScheduledJob.scheduled_job_setting"`)
	}
	return nil
}
...
func (sjuo *ScheduledJobUpdateOne) sqlSave(ctx context.Context) (_node *ScheduledJob, err error) {
	...
	if value, ok := sjuo.mutation.Environment(); ok {
		_spec.SetField(scheduledjob.FieldEnvironment, field.TypeEnum, value)
	}
	...
	if sjuo.mutation.ScheduledJobSettingCleared() {
		...
		edge.Schema = sjuo.schemaConfig.ScheduledJobSetting
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := sjuo.mutation.ScheduledJobSettingIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   scheduledjob.ScheduledJobSettingTable,
