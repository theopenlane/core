...
const (
	// Label holds the string label denoting the audience type in the database.
	Label = "audience"
	...
	// Table holds the table name of the audience in the database.
	Table = "audiences"
	// OwnerTable is the table that holds the owner relation/edge.
	OwnerTable = "audiences"
	...
	BlockedGroupsTable = "audience_blocked_groups"
...
// Columns holds all SQL columns for audience fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
func AudienceTypeValidator(at enums.AudienceType) error {
	...
	case "MANUAL", "DYNAMIC":
		return nil
	default:
		return fmt.Errorf("audience: invalid enum value for audience_type field: %q", at)
	}
}

// OrderOption defines the ordering options for the Audience queries.
