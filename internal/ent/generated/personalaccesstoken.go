...
func (*PersonalAccessToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case personalaccesstoken.FieldID, personalaccesstoken.FieldCreatedBy, personalaccesstoken.FieldUpdatedBy, personalaccesstoken.FieldUpdatedByImpersonator, personalaccesstoken.FieldDeletedBy, personalaccesstoken.FieldOwnerID, personalaccesstoken.FieldName, personalaccesstoken.FieldToken, personalaccesstoken.FieldDescription, personalaccesstoken.FieldRevokedReason, personalaccesstoken.FieldRevokedBy:
...
func (_m *PersonalAccessToken) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case personalaccesstoken.FieldUpdatedByImpersonator:
			if value, ok := values[i].(*sql.NullString); !ok {
