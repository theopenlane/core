...
func HasCreatedBy() predicate.Template {
...
func HasCreatedByWith(preds ...predicate.ChangeActor) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
...
func HasUpdatedBy() predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpdatedByWith(preds ...predicate.ChangeActor) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
