...
func (e WebauthnEdges) CreatedByUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e WebauthnEdges) UpdatedByUserOrErr() (*User, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e WebauthnEdges) CreatedByServiceOrErr() (*APIToken, error) {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e WebauthnEdges) UpdatedByServiceOrErr() (*APIToken, error) {
...
func (*Webauthn) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case webauthn.FieldID, webauthn.FieldCreatedByID, webauthn.FieldUpdatedByID, webauthn.FieldCreatedByUserID, webauthn.FieldUpdatedByUserID, webauthn.FieldCreatedByServiceID, webauthn.FieldUpdatedByServiceID, webauthn.FieldMappingID, webauthn.FieldOwnerID, webauthn.FieldAttestationType:
...
// QueryCreatedByUser queries the "created_by_user" edge of the Webauthn entity.
func (w *Webauthn) QueryCreatedByUser() *UserQuery {
	return NewWebauthnClient(w.config).QueryCreatedByUser(w)
}

// QueryUpdatedByUser queries the "updated_by_user" edge of the Webauthn entity.
func (w *Webauthn) QueryUpdatedByUser() *UserQuery {
	return NewWebauthnClient(w.config).QueryUpdatedByUser(w)
}

// QueryCreatedByService queries the "created_by_service" edge of the Webauthn entity.
func (w *Webauthn) QueryCreatedByService() *APITokenQuery {
	return NewWebauthnClient(w.config).QueryCreatedByService(w)
}

// QueryUpdatedByService queries the "updated_by_service" edge of the Webauthn entity.
func (w *Webauthn) QueryUpdatedByService() *APITokenQuery {
	return NewWebauthnClient(w.config).QueryUpdatedByService(w)
}
...
func (w *Webauthn) String() string {
	...
	builder.WriteString(w.CreatedByUserID)
	builder.WriteString(", ")
	builder.WriteString("updated_by_user_id=")
	builder.WriteString(w.UpdatedByUserID)
	builder.WriteString(", ")
	builder.WriteString("created_by_service_id=")
	builder.WriteString(w.CreatedByServiceID)
	builder.WriteString(", ")
	builder.WriteString("updated_by_service_id=")
	builder.WriteString(w.UpdatedByServiceID)
	builder.WriteString(", ")
