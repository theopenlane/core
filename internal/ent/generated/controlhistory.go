...
func (*ControlHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case controlhistory.FieldID, controlhistory.FieldRef, controlhistory.FieldCreatedBy, controlhistory.FieldUpdatedBy, controlhistory.FieldDeletedBy, controlhistory.FieldDisplayID, controlhistory.FieldOwnerID, controlhistory.FieldRefCode, controlhistory.FieldDescription, controlhistory.FieldStatus, controlhistory.FieldSource, controlhistory.FieldControlType, controlhistory.FieldCategory, controlhistory.FieldCategoryID, controlhistory.FieldSubcategory, controlhistory.FieldStandardID:
