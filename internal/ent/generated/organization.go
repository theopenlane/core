...
type OrganizationEdges struct {
	...
	// IntegrationRecommendations holds the value of the integration_recommendations edge.
	...
	namedIntegrationRecommendations         map[string][]*IntegrationRecommendation
...
// IntegrationRecommendationsOrErr returns the IntegrationRecommendations value or an error if the edge
// was not loaded in eager-loading.
func (e OrganizationEdges) IntegrationRecommendationsOrErr() ([]*IntegrationRecommendation, error) {
	if e.loadedTypes[89] {
		return e.IntegrationRecommendations, nil
	}
	return nil, &NotLoadedError{edge: "integration_recommendations"}
}
...
// QueryIntegrationRecommendations queries the "integration_recommendations" edge of the Organization entity.
func (_m *Organization) QueryIntegrationRecommendations() *IntegrationRecommendationQuery {
	return NewOrganizationClient(_m.config).QueryIntegrationRecommendations(_m)
}
...
// NamedIntegrationRecommendations returns the IntegrationRecommendations named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Organization) NamedIntegrationRecommendations(name string) ([]*IntegrationRecommendation, error) {
	if _m.Edges.namedIntegrationRecommendations == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedIntegrationRecommendations[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Organization) appendNamedIntegrationRecommendations(name string, edges ...*IntegrationRecommendation) {
	if _m.Edges.namedIntegrationRecommendations == nil {
		_m.Edges.namedIntegrationRecommendations = make(map[string][]*IntegrationRecommendation)
	}
	if len(edges) == 0 {
		_m.Edges.namedIntegrationRecommendations[name] = []*IntegrationRecommendation{}
	} else {
		_m.Edges.namedIntegrationRecommendations[name] = append(_m.Edges.namedIntegrationRecommendations[name], edges...)
	}
}
