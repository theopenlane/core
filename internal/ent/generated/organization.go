...
type OrganizationEdges struct {
	...
	// groups that are allowed to create email_brandings
	EmailBrandingCreators []*Group `json:"email_branding_creators,omitempty"`
	...
	// EmailBrandings holds the value of the email_brandings edge.
	EmailBrandings []*EmailBranding `json:"email_brandings,omitempty"`
	...
	namedEmailBrandingCreators              map[string][]*Group
	...
	namedEmailBrandings                     map[string][]*EmailBranding
...
// EmailBrandingCreatorsOrErr returns the EmailBrandingCreators value or an error if the edge
// was not loaded in eager-loading.
func (e OrganizationEdges) EmailBrandingCreatorsOrErr() ([]*Group, error) {
	if e.loadedTypes[11] {
		return e.EmailBrandingCreators, nil
	}
	return nil, &NotLoadedError{edge: "email_branding_creators"}
}
...
// EmailBrandingsOrErr returns the EmailBrandings value or an error if the edge
// was not loaded in eager-loading.
func (e OrganizationEdges) EmailBrandingsOrErr() ([]*EmailBranding, error) {
	if e.loadedTypes[74] {
		return e.EmailBrandings, nil
	}
	return nil, &NotLoadedError{edge: "email_brandings"}
}
...
// QueryEmailBrandingCreators queries the "email_branding_creators" edge of the Organization entity.
func (_m *Organization) QueryEmailBrandingCreators() *GroupQuery {
	return NewOrganizationClient(_m.config).QueryEmailBrandingCreators(_m)
}
...
// QueryEmailBrandings queries the "email_brandings" edge of the Organization entity.
func (_m *Organization) QueryEmailBrandings() *EmailBrandingQuery {
	return NewOrganizationClient(_m.config).QueryEmailBrandings(_m)
}
...
// NamedEmailBrandingCreators returns the EmailBrandingCreators named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Organization) NamedEmailBrandingCreators(name string) ([]*Group, error) {
	if _m.Edges.namedEmailBrandingCreators == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedEmailBrandingCreators[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Organization) appendNamedEmailBrandingCreators(name string, edges ...*Group) {
	if _m.Edges.namedEmailBrandingCreators == nil {
		_m.Edges.namedEmailBrandingCreators = make(map[string][]*Group)
	}
	if len(edges) == 0 {
		_m.Edges.namedEmailBrandingCreators[name] = []*Group{}
	} else {
		_m.Edges.namedEmailBrandingCreators[name] = append(_m.Edges.namedEmailBrandingCreators[name], edges...)
	}
}
...
// NamedEmailBrandings returns the EmailBrandings named value or an error if the edge was not
// loaded in eager-loading with this name.
func (_m *Organization) NamedEmailBrandings(name string) ([]*EmailBranding, error) {
	if _m.Edges.namedEmailBrandings == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := _m.Edges.namedEmailBrandings[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (_m *Organization) appendNamedEmailBrandings(name string, edges ...*EmailBranding) {
	if _m.Edges.namedEmailBrandings == nil {
		_m.Edges.namedEmailBrandings = make(map[string][]*EmailBranding)
	}
	if len(edges) == 0 {
		_m.Edges.namedEmailBrandings[name] = []*EmailBranding{}
	} else {
		_m.Edges.namedEmailBrandings[name] = append(_m.Edges.namedEmailBrandings[name], edges...)
	}
}
