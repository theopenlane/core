...
// HasScheduledJobSetting applies the HasEdge predicate on the "scheduled_job_setting" edge.
func HasScheduledJobSetting() predicate.ScheduledJob {
	return predicate.ScheduledJob(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
		...
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.ScheduledJobSetting
		step.Edge.Schema = schemaConfig.ScheduledJobSetting
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasScheduledJobSettingWith applies the HasEdge predicate on the "scheduled_job_setting" edge with a given conditions (other predicates).
func HasScheduledJobSettingWith(preds ...predicate.ScheduledJobSetting) predicate.ScheduledJob {
	return predicate.ScheduledJob(func(s *sql.Selector) {
		step := newScheduledJobSettingStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.ScheduledJobSetting
		step.Edge.Schema = schemaConfig.ScheduledJobSetting
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
