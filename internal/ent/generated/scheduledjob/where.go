...
// IsMarketplace applies equality check predicate on the "is_marketplace" field. It's identical to IsMarketplaceEQ.
func IsMarketplace(v bool) predicate.ScheduledJob {
	return predicate.ScheduledJob(sql.FieldEQ(FieldIsMarketplace, v))
}
...
func EnvironmentEQ(v enums.JobEnvironment) predicate.ScheduledJob {
	vc := v
	return predicate.ScheduledJob(sql.FieldEQ(FieldEnvironment, vc))
}

// EnvironmentNEQ applies the NEQ predicate on the "environment" field.
func EnvironmentNEQ(v enums.JobEnvironment) predicate.ScheduledJob {
	vc := v
	return predicate.ScheduledJob(sql.FieldNEQ(FieldEnvironment, vc))
}

// EnvironmentIn applies the In predicate on the "environment" field.
func EnvironmentIn(vs ...enums.JobEnvironment) predicate.ScheduledJob {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.ScheduledJob(sql.FieldIn(FieldEnvironment, v...))
}

// EnvironmentNotIn applies the NotIn predicate on the "environment" field.
func EnvironmentNotIn(vs ...enums.JobEnvironment) predicate.ScheduledJob {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.ScheduledJob(sql.FieldNotIn(FieldEnvironment, v...))
}
...
// IsMarketplaceEQ applies the EQ predicate on the "is_marketplace" field.
func IsMarketplaceEQ(v bool) predicate.ScheduledJob {
	return predicate.ScheduledJob(sql.FieldEQ(FieldIsMarketplace, v))
}

// IsMarketplaceNEQ applies the NEQ predicate on the "is_marketplace" field.
func IsMarketplaceNEQ(v bool) predicate.ScheduledJob {
	return predicate.ScheduledJob(sql.FieldNEQ(FieldIsMarketplace, v))
}
