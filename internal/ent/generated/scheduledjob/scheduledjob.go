...
const (
	...
	FieldScript = "script"
	// FieldIsMarketplace holds the string denoting the is_marketplace field in the database.
	FieldIsMarketplace = "is_marketplace"
...
var (
	...
	// DefaultIsMarketplace holds the default value on creation for the "is_marketplace" field.
	DefaultIsMarketplace bool
...
// ByIsMarketplace orders the results by the is_marketplace field.
func ByIsMarketplace(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldIsMarketplace, opts...).ToFunc()
}
