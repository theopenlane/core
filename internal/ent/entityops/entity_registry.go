...
func init() {
	...
	SchemaOnboarding.Fields = []FieldDescriptor{
		...
		{Name: "compliance", Label: "Compliance", Type: "map[string]interface {}", TaskRules: []TaskRuleDescriptor{{RuleID: "framework", EachElement: "value.frameworks", Trigger: "createOnly"}, {RuleID: "framework-generic", Expression: "!(has(value.frameworks) && size(value.frameworks) > 0)", Trigger: "createOnly"}, {RuleID: "import-existing-controls", Expression: "value.has_existing_controls == true", Trigger: "createOnly"}, {RuleID: "import-template-controls", Expression: "!(has(value.has_existing_controls) && value.has_existing_controls == true)", Trigger: "createOnly"}, {RuleID: "import-existing-policies", Expression: "value.has_existing_policies == true", Trigger: "createOnly"}, {RuleID: "import-policy-templates", Expression: "!(has(value.has_existing_policies) && value.has_existing_policies == true)", Trigger: "createOnly"}, {RuleID: "has-auditor-at-onboarding", Expression: "value.auditor_status == 'yes'", Trigger: "createOnly"}, {RuleID: "wants-auditor-recommendation", Expression: "value.auditor_status == 'recommendations'", Trigger: "createOnly"}, {RuleID: "wants-partner-recommendation", Expression: "value.vciso_preference == 'connect_vciso_partner'", Trigger: "createOnly"}, {RuleID: "demo-requested", Expression: "value.demo_requested == true || (!(has(value.auditor_status) && (value.auditor_status == 'yes' || value.auditor_status == 'recommendations')) && !(has(value.vciso_preference) && value.vciso_preference == 'connect_vciso_partner'))", Trigger: "createOnly"}}},
		{Name: "deleted_at", Label: "DeletedAt", Type: "time.Time"},
		{Name: "deleted_by", Label: "DeletedBy", Type: "string", MatchKey: true},
		{Name: "demo_requested", Label: "DemoRequested", Type: "bool"},
