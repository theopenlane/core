...
func CreateOrganization(ctx context.Context, client *openlaneclient.OpenlaneClient, name, description string) (string, error) {
	input := genclient.CreateOrganizationInput{
		Name:        name,
...
func CreatePAT(ctx context.Context, client *openlaneclient.OpenlaneClient, orgID, name, description string) (string, error) {
	input := genclient.CreatePersonalAccessTokenInput{
		Name:            name,
		Description:     &description,
...
func CreateEvidenceWithFile(ctx context.Context, client *openlaneclient.OpenlaneClient, name, desc string, upload *graphql.Upload) (*genclient.CreateEvidence, error) {
	status := enums.EvidenceStatusSubmitted

	input := genclient.CreateEvidenceInput{
		Name:        name,
		Description: &desc,
		Status:      &status,
	}
