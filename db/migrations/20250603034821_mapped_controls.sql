...
-- Modify "groups" table
ALTER TABLE "groups" ADD COLUMN "mapped_control_blocked_groups" character varying NULL, ADD COLUMN "mapped_control_editors" character varying NULL, ADD CONSTRAINT "groups_mapped_controls_blocked_groups" FOREIGN KEY ("mapped_control_blocked_groups") REFERENCES "mapped_controls" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "groups_mapped_controls_editors" FOREIGN KEY ("mapped_control_editors") REFERENCES "mapped_controls" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
