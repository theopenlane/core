...
-- Modify "groups" table
ALTER TABLE "groups" ADD COLUMN "organization_assessment_creators" character varying NULL, ADD CONSTRAINT "groups_organizations_assessment_creators" FOREIGN KEY ("organization_assessment_creators") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
