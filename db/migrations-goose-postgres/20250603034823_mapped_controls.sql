...
ALTER TABLE "groups" DROP CONSTRAINT "groups_mapped_controls_editors", DROP CONSTRAINT "groups_mapped_controls_blocked_groups", DROP COLUMN "mapped_control_editors", DROP COLUMN "mapped_control_blocked_groups";
