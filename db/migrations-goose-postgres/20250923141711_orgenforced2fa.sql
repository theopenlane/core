...
ALTER TABLE "organization_setting_history" ADD COLUMN "allow_matching_domains_autojoin" boolean NULL DEFAULT false, ADD COLUMN "saml_signin_url" character varying NULL, ADD COLUMN "saml_issuer" character varying NULL, ADD COLUMN "saml_cert" character varying NULL, ADD COLUMN "multifactor_auth_enforced" boolean NULL DEFAULT false;
-- modify "organization_settings" table
ALTER TABLE "organization_settings" ADD COLUMN "allow_matching_domains_autojoin" boolean NULL DEFAULT false, ADD COLUMN "saml_signin_url" character varying NULL, ADD COLUMN "saml_issuer" character varying NULL, ADD COLUMN "saml_cert" character varying NULL, ADD COLUMN "multifactor_auth_enforced" boolean NULL DEFAULT false;
