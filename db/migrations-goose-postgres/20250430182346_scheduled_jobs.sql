...
-- +goose Down
-- reverse: create index "scheduledjobsetting_id" to table: "scheduled_job_settings"
DROP INDEX "scheduledjobsetting_id";
-- reverse: create index "scheduled_job_settings_scheduled_job_id_key" to table: "scheduled_job_settings"
DROP INDEX "scheduled_job_settings_scheduled_job_id_key";
-- reverse: create "scheduled_job_settings" table
DROP TABLE "scheduled_job_settings";
