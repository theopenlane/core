...
ALTER TABLE "file_history" DROP COLUMN "file_name", DROP COLUMN "file_extension", DROP COLUMN "file_size", DROP COLUMN "content_type", ALTER COLUMN "store_key" DROP NOT NULL, DROP COLUMN "category", DROP COLUMN "annotation", ADD COLUMN "provided_file_name" character varying NOT NULL, ADD COLUMN "provided_file_extension" character varying NOT NULL, ADD COLUMN "provided_file_size" bigint NULL, ADD COLUMN "persisted_file_size" bigint NULL, ADD COLUMN "detected_mime_type" character varying NULL, ADD COLUMN "md5_hash" character varying NULL, ADD COLUMN "detected_content_type" character varying NOT NULL, ADD COLUMN "correlation_id" character varying NULL, ADD COLUMN "category_type" character varying NULL, ADD COLUMN "uri" character varying NULL, ADD COLUMN "storage_scheme" character varying NULL, ADD COLUMN "storage_volume" character varying NULL, ADD COLUMN "storage_path" character varying NULL, ADD COLUMN "file_contents" bytea NULL;
-- modify "files" table
ALTER TABLE "files" DROP COLUMN "file_name", DROP COLUMN "file_extension", DROP COLUMN "file_size", DROP COLUMN "content_type", ALTER COLUMN "store_key" DROP NOT NULL, DROP COLUMN "category", DROP COLUMN "annotation", DROP COLUMN "user_files", ADD COLUMN "provided_file_name" character varying NOT NULL, ADD COLUMN "provided_file_extension" character varying NOT NULL, ADD COLUMN "provided_file_size" bigint NULL, ADD COLUMN "persisted_file_size" bigint NULL, ADD COLUMN "detected_mime_type" character varying NULL, ADD COLUMN "md5_hash" character varying NULL, ADD COLUMN "detected_content_type" character varying NOT NULL, ADD COLUMN "correlation_id" character varying NULL, ADD COLUMN "category_type" character varying NULL, ADD COLUMN "uri" character varying NULL, ADD COLUMN "storage_scheme" character varying NULL, ADD COLUMN "storage_volume" character varying NULL, ADD COLUMN "storage_path" character varying NULL, ADD COLUMN "file_contents" bytea NULL;
...
ALTER TABLE "files" DROP COLUMN "file_contents", DROP COLUMN "storage_path", DROP COLUMN "storage_volume", DROP COLUMN "storage_scheme", DROP COLUMN "uri", DROP COLUMN "category_type", DROP COLUMN "correlation_id", DROP COLUMN "detected_content_type", DROP COLUMN "md5_hash", DROP COLUMN "detected_mime_type", DROP COLUMN "persisted_file_size", DROP COLUMN "provided_file_size", DROP COLUMN "provided_file_extension", DROP COLUMN "provided_file_name", ADD COLUMN "user_files" character varying NULL, ADD COLUMN "annotation" character varying NULL, ADD COLUMN "category" character varying NULL, ALTER COLUMN "store_key" SET NOT NULL, ADD COLUMN "content_type" character varying NOT NULL, ADD COLUMN "file_size" bigint NULL, ADD COLUMN "file_extension" character varying NOT NULL, ADD COLUMN "file_name" character varying NOT NULL;
-- reverse: modify "file_history" table
ALTER TABLE "file_history" DROP COLUMN "file_contents", DROP COLUMN "storage_path", DROP COLUMN "storage_volume", DROP COLUMN "storage_scheme", DROP COLUMN "uri", DROP COLUMN "category_type", DROP COLUMN "correlation_id", DROP COLUMN "detected_content_type", DROP COLUMN "md5_hash", DROP COLUMN "detected_mime_type", DROP COLUMN "persisted_file_size", DROP COLUMN "provided_file_size", DROP COLUMN "provided_file_extension", DROP COLUMN "provided_file_name", ADD COLUMN "annotation" character varying NULL, ADD COLUMN "category" character varying NULL, ALTER COLUMN "store_key" SET NOT NULL, ADD COLUMN "content_type" character varying NOT NULL, ADD COLUMN "file_size" bigint NULL, ADD COLUMN "file_extension" character varying NOT NULL, ADD COLUMN "file_name" character varying NOT NULL;
