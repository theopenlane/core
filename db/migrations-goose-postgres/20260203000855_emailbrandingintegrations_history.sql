...
CREATE TABLE "email_branding_history" ("id" character varying NOT NULL, "history_time" timestamptz NOT NULL, "ref" character varying NULL, "operation" character varying NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "created_by" character varying NULL, "updated_by" character varying NULL, "deleted_at" timestamptz NULL, "deleted_by" character varying NULL, "tags" jsonb NULL, "owner_id" character varying NULL, "name" character varying NOT NULL, "brand_name" character varying NULL, "logo_remote_url" character varying NULL, "primary_color" character varying NULL, "secondary_color" character varying NULL, "background_color" character varying NULL, "text_color" character varying NULL, "button_color" character varying NULL, "button_text_color" character varying NULL, "link_color" character varying NULL, "font_family" character varying NULL DEFAULT 'HELVETICA', "is_default" boolean NULL DEFAULT false, PRIMARY KEY ("id"));
