...
ALTER TABLE "assessment_responses" ALTER COLUMN "email" DROP NOT NULL, ADD COLUMN "display_name" character varying NULL;
...
ALTER TABLE "assessment_responses" DROP COLUMN "display_name", ALTER COLUMN "email" SET NOT NULL;
