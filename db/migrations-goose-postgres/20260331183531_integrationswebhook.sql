...
ALTER TABLE "identity_holders" ALTER COLUMN "identity_holder_type" SET DEFAULT 'UNSPECIFIED';
...
-- modify "assets" table
ALTER TABLE "assets" ADD COLUMN "observed_at" timestamptz NULL, ADD COLUMN "integration_id" character varying NULL, ADD CONSTRAINT "assets_integrations_assets" FOREIGN KEY ("integration_id") REFERENCES "integrations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;

-- +goose Down
-- reverse: modify "assets" table
ALTER TABLE "assets" DROP CONSTRAINT "assets_integrations_assets", DROP COLUMN "integration_id", DROP COLUMN "observed_at";
...
ALTER TABLE "identity_holders" ALTER COLUMN "identity_holder_type" SET DEFAULT 'EMPLOYEE';
