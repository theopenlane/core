...
ALTER TABLE "finding_history" ADD COLUMN "finding_status_name" character varying NULL, ADD COLUMN "finding_status_id" character varying NULL, ADD COLUMN "security_level" character varying NULL DEFAULT 'NONE';
-- modify "vulnerability_history" table
ALTER TABLE "vulnerability_history" ADD COLUMN "vulnerability_status_name" character varying NULL, ADD COLUMN "vulnerability_status_id" character varying NULL, ADD COLUMN "security_level" character varying NULL DEFAULT 'NONE';
...
ALTER TABLE "vulnerability_history" DROP COLUMN "security_level", DROP COLUMN "vulnerability_status_id", DROP COLUMN "vulnerability_status_name";
-- reverse: modify "finding_history" table
ALTER TABLE "finding_history" DROP COLUMN "security_level", DROP COLUMN "finding_status_id", DROP COLUMN "finding_status_name";
