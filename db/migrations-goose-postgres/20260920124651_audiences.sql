...
-- +goose Down
-- reverse: create index "campaign_audiences_audience_id_idx" to table: "campaign_audiences"
DROP INDEX "campaign_audiences_audience_id_idx";
-- reverse: create "campaign_audiences" table
DROP TABLE "campaign_audiences";
-- reverse: create index "audience_viewers_group_id_idx" to table: "audience_viewers"
DROP INDEX "audience_viewers_group_id_idx";
-- reverse: create "audience_viewers" table
DROP TABLE "audience_viewers";
-- reverse: create index "audiencemember_display_id_owner_id" to table: "audience_members"
...
DROP INDEX "audiencemember_audience_id_email";
-- reverse: create index "audience_member_user_id_idx" to table: "audience_members"
DROP INDEX "audience_member_user_id_idx";
-- reverse: create index "audience_member_subscriber_id_idx" to table: "audience_members"
DROP INDEX "audience_member_subscriber_id_idx";
-- reverse: create index "audience_member_owner_id_idx" to table: "audience_members"
DROP INDEX "audience_member_owner_id_idx";
-- reverse: create index "audience_member_identity_holder_id_idx" to table: "audience_members"
...
DROP INDEX "audience_member_group_id_idx";
-- reverse: create index "audience_member_contact_id_idx" to table: "audience_members"
DROP INDEX "audience_member_contact_id_idx";
-- reverse: create "audience_members" table
DROP TABLE "audience_members";
-- reverse: create index "audience_editors_group_id_idx" to table: "audience_editors"
DROP INDEX "audience_editors_group_id_idx";
-- reverse: create "audience_editors" table
DROP TABLE "audience_editors";
-- reverse: create index "audience_blocked_groups_group_id_idx" to table: "audience_blocked_groups"
DROP INDEX "audience_blocked_groups_group_id_idx";
-- reverse: create "audience_blocked_groups" table
DROP TABLE "audience_blocked_groups";
-- reverse: modify "groups" table
ALTER TABLE "groups" DROP CONSTRAINT "groups_organizations_audience_member_creators", DROP CONSTRAINT "groups_organizations_audience_creators", DROP COLUMN "organization_audience_member_creators", DROP COLUMN "organization_audience_creators";
-- reverse: create index "audience_owner_id_idx" to table: "audiences"
DROP INDEX "audience_owner_id_idx";
-- reverse: create index "audience_name_audience_type_owner_id_filters" to table: "audiences"
DROP INDEX "audience_name_audience_type_owner_id_filters";
-- reverse: create index "audience_display_id_owner_id" to table: "audiences"
DROP INDEX "audience_display_id_owner_id";
-- reverse: create "audiences" table
