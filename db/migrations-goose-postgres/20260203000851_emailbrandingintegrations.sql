...
CREATE TABLE "email_brandings" ("id" character varying NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "created_by" character varying NULL, "updated_by" character varying NULL, "deleted_at" timestamptz NULL, "deleted_by" character varying NULL, "tags" jsonb NULL, "name" character varying NOT NULL, "brand_name" character varying NULL, "logo_remote_url" character varying NULL, "primary_color" character varying NULL, "secondary_color" character varying NULL, "background_color" character varying NULL, "text_color" character varying NULL, "button_color" character varying NULL, "button_text_color" character varying NULL, "link_color" character varying NULL, "font_family" character varying NULL DEFAULT 'HELVETICA', "is_default" boolean NULL DEFAULT false, "owner_id" character varying NULL, PRIMARY KEY ("id"), CONSTRAINT "email_brandings_organizations_email_brandings" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
...
-- modify "groups" table
ALTER TABLE "groups" ADD COLUMN "email_branding_blocked_groups" character varying NULL, ADD COLUMN "email_branding_editors" character varying NULL, ADD COLUMN "email_branding_viewers" character varying NULL, ADD CONSTRAINT "groups_email_brandings_blocked_groups" FOREIGN KEY ("email_branding_blocked_groups") REFERENCES "email_brandings" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "groups_email_brandings_editors" FOREIGN KEY ("email_branding_editors") REFERENCES "email_brandings" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "groups_email_brandings_viewers" FOREIGN KEY ("email_branding_viewers") REFERENCES "email_brandings" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
-- create "integration_runs" table
CREATE TABLE "integration_runs" ("id" character varying NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "created_by" character varying NULL, "updated_by" character varying NULL, "deleted_at" timestamptz NULL, "deleted_by" character varying NULL, "operation_name" character varying NULL, "operation_kind" character varying NULL, "run_type" character varying NULL, "status" character varying NOT NULL DEFAULT 'PENDING', "started_at" timestamptz NOT NULL, "finished_at" timestamptz NULL, "duration_ms" bigint NULL, "summary" character varying NULL, "error" text NULL, "metrics" jsonb NULL, "integration_id" character varying NULL, "request_file_id" character varying NULL, "response_file_id" character varying NULL, "event_id" character varying NULL, "owner_id" character varying NULL, PRIMARY KEY ("id"), CONSTRAINT "integration_runs_events_event" FOREIGN KEY ("event_id") REFERENCES "events" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "integration_runs_files_request_file" FOREIGN KEY ("request_file_id") REFERENCES "files" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "integration_runs_files_response_file" FOREIGN KEY ("response_file_id") REFERENCES "files" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "integration_runs_integrations_integration_runs" FOREIGN KEY ("integration_id") REFERENCES "integrations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "integration_runs_organizations_integration_runs" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
...
ALTER TABLE "notifications" ADD COLUMN "template_id" character varying NULL, ADD CONSTRAINT "notifications_notification_templates_notifications" FOREIGN KEY ("template_id") REFERENCES "notification_templates" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;

-- +goose Down
-- reverse: modify "notifications" table
ALTER TABLE "notifications" DROP CONSTRAINT "notifications_notification_templates_notifications", DROP COLUMN "template_id";
...
ALTER TABLE "groups" DROP CONSTRAINT "groups_email_brandings_viewers", DROP CONSTRAINT "groups_email_brandings_editors", DROP CONSTRAINT "groups_email_brandings_blocked_groups", DROP COLUMN "email_branding_viewers", DROP COLUMN "email_branding_editors", DROP COLUMN "email_branding_blocked_groups";
