...
ALTER TABLE "scheduled_job_history" DROP COLUMN "tags", DROP COLUMN "system_owned", DROP COLUMN "title", DROP COLUMN "description", DROP COLUMN "platform", DROP COLUMN "windmill_path", DROP COLUMN "download_url", ADD COLUMN "job_id" character varying NOT NULL, ADD COLUMN "job_runner_id" character varying NULL;
-- create "job_template_history" table
CREATE TABLE "job_template_history" ("id" character varying NOT NULL, "history_time" timestamptz NOT NULL, "ref" character varying NULL, "operation" character varying NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "created_by" character varying NULL, "updated_by" character varying NULL, "deleted_at" timestamptz NULL, "deleted_by" character varying NULL, "display_id" character varying NOT NULL, "tags" jsonb NULL, "owner_id" character varying NULL, "system_owned" boolean NULL DEFAULT false, "title" character varying NOT NULL, "description" character varying NULL, "platform" character varying NOT NULL, "windmill_path" character varying NOT NULL, "download_url" character varying NOT NULL, "configuration" jsonb NULL, "cron" character varying NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "job_templates" ("id" character varying NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "created_by" character varying NULL, "updated_by" character varying NULL, "deleted_at" timestamptz NULL, "deleted_by" character varying NULL, "display_id" character varying NOT NULL, "tags" jsonb NULL, "system_owned" boolean NULL DEFAULT false, "title" character varying NOT NULL, "description" character varying NULL, "platform" character varying NOT NULL, "windmill_path" character varying NOT NULL, "download_url" character varying NOT NULL, "configuration" jsonb NULL, "cron" character varying NULL, "owner_id" character varying NULL, PRIMARY KEY ("id"), CONSTRAINT "job_templates_organizations_job_templates" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
...
ALTER TABLE "scheduled_jobs" DROP CONSTRAINT "scheduled_jobs_organizations_jobs", DROP COLUMN "tags", DROP COLUMN "system_owned", DROP COLUMN "title", DROP COLUMN "description", DROP COLUMN "platform", DROP COLUMN "windmill_path", DROP COLUMN "download_url", ADD COLUMN "job_id" character varying NOT NULL, ADD COLUMN "job_runner_id" character varying NULL, ADD CONSTRAINT "scheduled_jobs_job_runners_job_runner" FOREIGN KEY ("job_runner_id") REFERENCES "job_runners" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "scheduled_jobs_job_templates_job_template" FOREIGN KEY ("job_id") REFERENCES "job_templates" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, ADD CONSTRAINT "scheduled_jobs_organizations_scheduled_jobs" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
...
ALTER TABLE "scheduled_jobs" DROP CONSTRAINT "scheduled_jobs_organizations_scheduled_jobs", DROP CONSTRAINT "scheduled_jobs_job_templates_job_template", DROP CONSTRAINT "scheduled_jobs_job_runners_job_runner", DROP COLUMN "job_runner_id", DROP COLUMN "job_id", ADD COLUMN "download_url" character varying NOT NULL, ADD COLUMN "windmill_path" character varying NOT NULL, ADD COLUMN "platform" character varying NOT NULL, ADD COLUMN "description" character varying NULL, ADD COLUMN "title" character varying NOT NULL, ADD COLUMN "system_owned" boolean NULL DEFAULT false, ADD COLUMN "tags" jsonb NULL, ADD CONSTRAINT "scheduled_jobs_organizations_jobs" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
...
ALTER TABLE "scheduled_job_history" DROP COLUMN "job_runner_id", DROP COLUMN "job_id", ADD COLUMN "download_url" character varying NOT NULL, ADD COLUMN "windmill_path" character varying NOT NULL, ADD COLUMN "platform" character varying NOT NULL, ADD COLUMN "description" character varying NULL, ADD COLUMN "title" character varying NOT NULL, ADD COLUMN "system_owned" boolean NULL DEFAULT false, ADD COLUMN "tags" jsonb NULL;
