...
ALTER TABLE "organizations" DROP COLUMN "slug_name", DROP COLUMN "updated_by_impersonator";
-- reverse: modify "organization_settings" table
ALTER TABLE "organization_settings" DROP COLUMN "allow_support_access", DROP COLUMN "sso_exempt_domains", DROP COLUMN "jit_allowed_email_domains", DROP COLUMN "identity_provider_jit_provisioning", DROP COLUMN "updated_by_impersonator";
