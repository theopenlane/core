...
-- create "tasks" table
CREATE TABLE "tasks" ("id" character varying NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "created_by" character varying NULL, "updated_by" character varying NULL, "mapping_id" character varying NOT NULL, "deleted_at" timestamptz NULL, "deleted_by" character varying NULL, "tags" jsonb NULL, "title" character varying NOT NULL, "description" character varying NULL, "details" jsonb NULL, "status" character varying NOT NULL DEFAULT 'OPEN', "due" timestamptz NULL, "completed" timestamptz NULL, "user_assigner_tasks" character varying NOT NULL, "user_assignee_tasks" character varying NULL, PRIMARY KEY ("id"), CONSTRAINT "tasks_users_assignee_tasks" FOREIGN KEY ("user_assignee_tasks") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "tasks_users_assigner_tasks" FOREIGN KEY ("user_assigner_tasks") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
