...
-- +goose Down
-- reverse: create index "trustcenterndarequesthistory_history_time" to table: "trust_center_nda_request_history"
DROP INDEX "trustcenterndarequesthistory_history_time";
-- reverse: create "trust_center_nda_request_history" table
DROP TABLE "trust_center_nda_request_history";
-- reverse: modify "trust_center_setting_history" table
ALTER TABLE "trust_center_setting_history" DROP COLUMN "nda_approval_required", DROP COLUMN "security_contact", DROP COLUMN "company_domain", DROP COLUMN "remove_branding";
-- reverse: modify "note_history" table
ALTER TABLE "note_history" DROP COLUMN "title";
