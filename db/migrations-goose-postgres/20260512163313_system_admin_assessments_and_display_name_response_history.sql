...
ALTER TABLE "assessment_response_history" ALTER COLUMN "email" DROP NOT NULL, ADD COLUMN "display_name" character varying NULL;
...
ALTER TABLE "assessment_response_history" DROP COLUMN "display_name", ALTER COLUMN "email" SET NOT NULL;
