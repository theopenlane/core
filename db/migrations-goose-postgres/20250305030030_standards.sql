...
ALTER TABLE "subcontrol_history" DROP COLUMN "name", DROP COLUMN "subcontrol_type", DROP COLUMN "version", DROP COLUMN "subcontrol_number", DROP COLUMN "family", DROP COLUMN "class", ALTER COLUMN "source" SET DEFAULT 'USER_DEFINED', DROP COLUMN "mapped_frameworks", DROP COLUMN "implementation_evidence", DROP COLUMN "implementation_status", DROP COLUMN "implementation_date", DROP COLUMN "implementation_verification", DROP COLUMN "implementation_verification_date", DROP COLUMN "details", DROP COLUMN "example_evidence", ADD COLUMN "example_evidence" jsonb, ADD COLUMN "ref_code" character varying NOT NULL, ADD COLUMN "control_type" character varying NULL DEFAULT 'PREVENTATIVE', ADD COLUMN "category" character varying NULL, ADD COLUMN "category_id" character varying NULL, ADD COLUMN "subcategory" character varying NULL, ADD COLUMN "mapped_categories" jsonb NULL, ADD COLUMN "assessment_objectives" jsonb NULL, ADD COLUMN "assessment_methods" jsonb NULL, ADD COLUMN "control_questions" jsonb NULL, ADD COLUMN "implementation_guidance" jsonb NULL, ADD COLUMN "references" jsonb NULL, ADD COLUMN "control_id" character varying NOT NULL;
-- modify "subcontrols" table
ALTER TABLE "subcontrols" DROP COLUMN "name", DROP COLUMN "subcontrol_type", DROP COLUMN "version", DROP COLUMN "subcontrol_number", DROP COLUMN "family", DROP COLUMN "class", ALTER COLUMN "source" SET DEFAULT 'USER_DEFINED', DROP COLUMN "mapped_frameworks", DROP COLUMN "implementation_evidence", DROP COLUMN "implementation_status", DROP COLUMN "implementation_date", DROP COLUMN "implementation_verification", DROP COLUMN "implementation_verification_date", DROP COLUMN "details", DROP COLUMN "control_objective_subcontrols", DROP COLUMN "example_evidence", ADD COLUMN "example_evidence" jsonb, ADD COLUMN "ref_code" character varying NOT NULL, ADD COLUMN "control_type" character varying NULL DEFAULT 'PREVENTATIVE', ADD COLUMN "category" character varying NULL, ADD COLUMN "category_id" character varying NULL, ADD COLUMN "subcategory" character varying NULL, ADD COLUMN "mapped_categories" jsonb NULL, ADD COLUMN "assessment_objectives" jsonb NULL, ADD COLUMN "assessment_methods" jsonb NULL, ADD COLUMN "control_questions" jsonb NULL, ADD COLUMN "implementation_guidance" jsonb NULL, ADD COLUMN "references" jsonb NULL, ADD COLUMN "control_id" character varying NOT NULL, ADD COLUMN "program_subcontrols" character varying NULL, ADD COLUMN "subcontrol_control_owner" character varying NULL, ADD COLUMN "subcontrol_delegate" character varying NULL;
...
-- reverse: modify "subcontrols" table
ALTER TABLE "subcontrols" DROP COLUMN "subcontrol_delegate", DROP COLUMN "subcontrol_control_owner", DROP COLUMN "program_subcontrols", DROP COLUMN "control_id", DROP COLUMN "references", DROP COLUMN "implementation_guidance", DROP COLUMN "control_questions", DROP COLUMN "assessment_methods", DROP COLUMN "assessment_objectives", DROP COLUMN "mapped_categories", DROP COLUMN "subcategory", DROP COLUMN "category_id", DROP COLUMN "category", DROP COLUMN "control_type", DROP COLUMN "ref_code", ALTER COLUMN "example_evidence" TYPE text, ADD COLUMN "control_objective_subcontrols" character varying NULL, ADD COLUMN "details" jsonb NULL, ADD COLUMN "implementation_verification_date" timestamptz NULL, ADD COLUMN "implementation_verification" character varying NULL, ADD COLUMN "implementation_date" timestamptz NULL, ADD COLUMN "implementation_status" character varying NULL, ADD COLUMN "implementation_evidence" character varying NULL, ADD COLUMN "mapped_frameworks" text NULL, ALTER COLUMN "source" DROP DEFAULT, ADD COLUMN "class" character varying NULL, ADD COLUMN "family" text NULL, ADD COLUMN "subcontrol_number" character varying NULL, ADD COLUMN "version" character varying NULL, ADD COLUMN "subcontrol_type" character varying NULL, ADD COLUMN "name" character varying NOT NULL;
-- reverse: modify "subcontrol_history" table
ALTER TABLE "subcontrol_history" DROP COLUMN "control_id", DROP COLUMN "references", DROP COLUMN "implementation_guidance", DROP COLUMN "control_questions", DROP COLUMN "assessment_methods", DROP COLUMN "assessment_objectives", DROP COLUMN "mapped_categories", DROP COLUMN "subcategory", DROP COLUMN "category_id", DROP COLUMN "category", DROP COLUMN "control_type", DROP COLUMN "ref_code", ALTER COLUMN "example_evidence" TYPE text, ADD COLUMN "details" jsonb NULL, ADD COLUMN "implementation_verification_date" timestamptz NULL, ADD COLUMN "implementation_verification" character varying NULL, ADD COLUMN "implementation_date" timestamptz NULL, ADD COLUMN "implementation_status" character varying NULL, ADD COLUMN "implementation_evidence" character varying NULL, ADD COLUMN "mapped_frameworks" text NULL, ALTER COLUMN "source" DROP DEFAULT, ADD COLUMN "class" character varying NULL, ADD COLUMN "family" text NULL, ADD COLUMN "subcontrol_number" character varying NULL, ADD COLUMN "version" character varying NULL, ADD COLUMN "subcontrol_type" character varying NULL, ADD COLUMN "name" character varying NOT NULL;
-- reverse: modify "standards" table
...
-- reverse: modify "controls" table
ALTER TABLE "controls" DROP COLUMN "subcontrol_mapped_controls", DROP COLUMN "standard_id", DROP COLUMN "control_delegate", DROP COLUMN "control_control_owner", DROP COLUMN "control_mapped_controls", DROP COLUMN "control_implementation", DROP COLUMN "references", DROP COLUMN "implementation_guidance", DROP COLUMN "control_questions", DROP COLUMN "assessment_methods", DROP COLUMN "assessment_objectives", DROP COLUMN "mapped_categories", DROP COLUMN "subcategory", DROP COLUMN "category_id", DROP COLUMN "category", DROP COLUMN "ref_code", ALTER COLUMN "example_evidence" TYPE text, ADD COLUMN "control_objective_controls" character varying NULL, ADD COLUMN "details" jsonb NULL, ADD COLUMN "mapped_frameworks" text NULL, ADD COLUMN "satisfies" text NULL, ALTER COLUMN "source" DROP DEFAULT, ADD COLUMN "class" character varying NULL, ADD COLUMN "family" text NULL, ADD COLUMN "control_number" character varying NULL, ADD COLUMN "version" character varying NULL, ALTER COLUMN "control_type" DROP DEFAULT, ADD COLUMN "name" character varying NOT NULL;
-- reverse: modify "control_objectives" table
ALTER TABLE "control_objectives" DROP COLUMN "subcategory", DROP COLUMN "category", DROP COLUMN "desired_outcome", ADD COLUMN "example_evidence" text NULL, ADD COLUMN "control_control_objectives" character varying NULL, ADD COLUMN "details" jsonb NULL, ADD COLUMN "mapped_frameworks" text NULL, ALTER COLUMN "source" DROP DEFAULT, ADD COLUMN "class" character varying NULL, ADD COLUMN "family" text NULL, ADD COLUMN "control_number" character varying NULL, ADD COLUMN "description" text NULL;
-- reverse: modify "control_objective_history" table
ALTER TABLE "control_objective_history" DROP COLUMN "subcategory", DROP COLUMN "category", DROP COLUMN "desired_outcome", ADD COLUMN "example_evidence" text NULL, ADD COLUMN "details" jsonb NULL, ADD COLUMN "mapped_frameworks" text NULL, ALTER COLUMN "source" DROP DEFAULT, ADD COLUMN "class" character varying NULL, ADD COLUMN "family" text NULL, ADD COLUMN "control_number" character varying NULL, ADD COLUMN "description" text NULL;
-- reverse: modify "control_history" table
ALTER TABLE "control_history" DROP COLUMN "standard_id", DROP COLUMN "references", DROP COLUMN "implementation_guidance", DROP COLUMN "control_questions", DROP COLUMN "assessment_methods", DROP COLUMN "assessment_objectives", DROP COLUMN "mapped_categories", DROP COLUMN "subcategory", DROP COLUMN "category_id", DROP COLUMN "category", DROP COLUMN "ref_code", ALTER COLUMN "example_evidence" TYPE text, ADD COLUMN "details" jsonb NULL, ADD COLUMN "mapped_frameworks" text NULL, ADD COLUMN "satisfies" text NULL, ALTER COLUMN "source" DROP DEFAULT, ADD COLUMN "class" character varying NULL, ADD COLUMN "family" text NULL, ADD COLUMN "control_number" character varying NULL, ADD COLUMN "version" character varying NULL, ALTER COLUMN "control_type" DROP DEFAULT, ADD COLUMN "name" character varying NOT NULL;
-- reverse: modify "action_plans" table
