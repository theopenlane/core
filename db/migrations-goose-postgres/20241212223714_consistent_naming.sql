...
-- reverse: create "standard_control_objectives" table
DROP TABLE "standard_control_objectives";
-- reverse: create "standard_action_plans" table
DROP TABLE "standard_action_plans";
...
ALTER TABLE "org_subscriptions" DROP CONSTRAINT "org_subscriptions_organizations_org_subscriptions", ADD CONSTRAINT "org_subscriptions_organizations_orgsubscriptions" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
...
ALTER TABLE "internal_policies" DROP CONSTRAINT "internal_policies_organizations_internal_policies", ADD CONSTRAINT "internal_policies_organizations_internalpolicies" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
-- reverse: modify "entity_types" table
ALTER TABLE "entity_types" DROP CONSTRAINT "entity_types_organizations_entity_types", ADD CONSTRAINT "entity_types_organizations_entitytypes" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
-- reverse: modify "document_data" table
ALTER TABLE "document_data" DROP CONSTRAINT "document_data_organizations_document_data", ADD CONSTRAINT "document_data_organizations_documentdata" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
-- reverse: modify "control_objectives" table
ALTER TABLE "control_objectives" DROP CONSTRAINT "control_objectives_organizations_control_objectives", DROP CONSTRAINT "control_objectives_controls_control_objectives", DROP COLUMN "control_control_objectives", ADD COLUMN "control_controlobjectives" character varying NULL, ADD CONSTRAINT "control_objectives_organizations_controlobjectives" FOREIGN KEY ("owner_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;
