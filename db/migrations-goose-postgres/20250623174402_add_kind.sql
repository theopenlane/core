...
ALTER TABLE "template_history" ADD COLUMN "kind" character varying NOT NULL DEFAULT 'QUESTIONNAIRE';
-- modify "templates" table
ALTER TABLE "templates" ADD COLUMN "kind" character varying NOT NULL DEFAULT 'QUESTIONNAIRE';
