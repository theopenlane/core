...
ALTER TABLE "entitlement_history" ALTER COLUMN "expires" SET DEFAULT true, ADD COLUMN "cancelled_date" timestamptz NULL, ADD COLUMN "bill_starting" timestamptz NOT NULL, ADD COLUMN "active" boolean NOT NULL DEFAULT true;
...
ALTER TABLE "entitlements" ALTER COLUMN "expires" SET DEFAULT true, ADD COLUMN "cancelled_date" timestamptz NULL, ADD COLUMN "bill_starting" timestamptz NOT NULL, ADD COLUMN "active" boolean NOT NULL DEFAULT true;
...
ALTER TABLE "entitlements" DROP COLUMN "active", DROP COLUMN "bill_starting", DROP COLUMN "cancelled_date", ALTER COLUMN "expires" SET DEFAULT false;
...
ALTER TABLE "entitlement_history" DROP COLUMN "active", DROP COLUMN "bill_starting", DROP COLUMN "cancelled_date", ALTER COLUMN "expires" SET DEFAULT false;
