...
func get(ctx context.Context) error {
	...
	if trustCenterID != "" {
		o, err := client.GetTrustCenterWatermarkConfigs(ctx, nil, nil, &openlaneclient.TrustCenterWatermarkConfigWhereInput{
	...
	o, err := client.GetAllTrustCenterWatermarkConfigs(ctx)
	cobra.CheckErr(err)
