...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "delete an existing control",
...
func init() {
	...
	deleteCmd.Flags().StringP("id", "i", "", "control id to delete")
}
...
func deleteValidation() (string, error) {
	...
	if id == "" {
		return "", cmd.NewRequiredFieldMissingError("control id")
	}
...
func delete(ctx context.Context) error {
	...
	o, err := client.DeleteControl(ctx, id)
	cobra.CheckErr(err)
