...
func createPreviewSettingsValidation() (input openlaneclient.CreateTrustCenterPreviewSettingInput, err error) {
...
func consolePreviewSettingsOutput(e *openlaneclient.CreateTrustCenterPreviewSetting) error {
