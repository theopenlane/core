...
var command = &cobra.Command{
	...
	Short: "the subcommands for working with entitlementHistories",
}
...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *openlaneclient.GetAllEntitlementHistories:
		var nodes []*openlaneclient.GetAllEntitlementHistories_EntitlementHistories_Edges_Node
		...
		e = nodes
	case *openlaneclient.GetEntitlementHistories:
		var nodes []*openlaneclient.GetEntitlementHistories_EntitlementHistories_Edges_Node
	...
	var list []openlaneclient.EntitlementHistory

	err = json.Unmarshal(s, &list)
	if err != nil {
		var in openlaneclient.EntitlementHistory
...
func tableOutput(out []openlaneclient.EntitlementHistory) {
