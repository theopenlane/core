...
var deleteCmd = &cobra.Command{
	Use:   "delete",
	Short: "delete an existing trust center control",
...
func init() {
	...
	deleteCmd.Flags().StringP("id", "i", "", "trust center control id to delete")
}
...
// delete an existing trust center control in the platform
func delete(ctx context.Context) error {
	...
	o, err := client.DeleteTrustCenterControl(ctx, id)
	cobra.CheckErr(err)
